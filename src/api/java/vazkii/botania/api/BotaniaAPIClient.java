...
public final class BotaniaAPIClient {
     ...
     * Call this DURING PREINIT. Calling it anytime after blockModels have already baked does not guarantee that your
     * model will work.
     ...
     *
     * @param subTileName The String ID of the subtile
     * @param model       A path to a blockstate json and variant to be used the block. The item model will be drawn
     *                    from the same blockstate json, from variant "inventory"
     */
    public static void registerSubtileModel(String subTileName, ModelResourceLocation model) {
        registerSubtileModel(
            subTileName,
            model,
            new ModelResourceLocation(model.getResourceDomain() + ":" + model.getResourcePath(), "inventory"));
    }

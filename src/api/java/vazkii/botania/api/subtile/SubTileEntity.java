...
public class SubTileEntity {
    ...
    /**
     * Triggered by {@link TileEntity#receiveClientEvent} via {@link net.minecraft.block.Block#eventReceived} and
     * {@link World#addBlockEvent}
     */
    ...
    /**
     * @see IWandBindable#canSelect(EntityPlayer, ItemStack, net.minecraft.util.math.BlockPos,
    ...
    /**
     * @see IWandBindable#bindTo(EntityPlayer, ItemStack, net.minecraft.util.math.BlockPos,
     *      net.minecraft.util.EnumFacing)
     */

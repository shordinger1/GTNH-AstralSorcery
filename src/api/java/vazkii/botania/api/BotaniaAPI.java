...
public final class BotaniaAPI {
    ...
    public static final ArmorMaterial manasteelArmorMaterial = EnumHelper.addArmorMaterial(
        "MANASTEEL",
        "manasteel",
        16,
        new int[]{2, 5, 6, 2},
        ...
        0);
    public static final ToolMaterial manasteelToolMaterial = EnumHelper
        .addToolMaterial("MANASTEEL", 3, 300, 6.2F, 2F, 20);

    public static final ArmorMaterial elementiumArmorMaterial = EnumHelper.addArmorMaterial(
        "B_ELEMENTIUM",
        "b_elementium",
        18,
        new int[]{2, 5, 6, 2},
        ...
        SoundEvents.ITEM_ARMOR_EQUIP_IRON,
        0);
    public static final ToolMaterial elementiumToolMaterial = EnumHelper
        .addToolMaterial("B_ELEMENTIUM", 3, 720, 6.2F, 2F, 20);

    public static final ArmorMaterial terrasteelArmorMaterial = EnumHelper.addArmorMaterial(
        "TERRASTEEL",
        "terrasteel",
        34,
        new int[]{3, 6, 8, 3},
        ...
        3F);
    public static final ToolMaterial terrasteelToolMaterial = EnumHelper
        .addToolMaterial("TERRASTEEL", 4, 2300, 9F, 3F, 26);

    public static final ArmorMaterial manaweaveArmorMaterial = EnumHelper.addArmorMaterial(
        "MANAWEAVE",
        "manaweave",
        5,
        new int[]{1, 2, 2, 1},
    ...
    static {
        ...
        IWikiProvider buildcraftWiki = new SimpleWikiProvider(
            "BuildCraft Wiki",
            "http://www.mod-buildcraft.com/wiki/doku.php?id=%s");
        ...
        registerModWiki(
            "Witchery",
            new SimpleWikiProvider("Witchery Wiki", "https://sites.google.com/site/witcherymod/%s", "-", true));
    ...
    public static boolean isBlockBlacklistedFromMagnet(IBlockState state) {
        return isBlockBlacklistedFromMagnet(
            state.getBlock(),
            state.getBlock()
     ...
     * @param input       The block that works as an input for the recipe. Can be a Block or an oredict String.
     * @param outputState The blockstate to be placed upon recipe completion.
     * @param time        The amount of time in ticks to complete this recipe. Note that this is ticks on your block,
     *                    not total time.
     ...
     */
    public static RecipeManaInfusion registerMiniSubTile(String key, Class<? extends SubTileEntity> subtileClass,
                                                         String original) {
     ...
     */
    public static void registerSubTileSignature(Class<? extends SubTileEntity> subtileClass,
                                                SubTileSignature signature) {
    ...
    public static SubTileSignature getSignatureForClass(Class<? extends SubTileEntity> subtileClass) {
        if (!subTileSignatures.containsKey(subtileClass)) registerSubTileSignature(
            subtileClass,
            new BasicSignature(
                subTiles.inverse()
                    .get(subtileClass)));
    ...
    public static void addOreWeightNether(String ore, int weight) {
        if (ore.contains("Nether") && OreDictionary.getOres(ore.replace("Nether", ""))
            .size() == 0) return;

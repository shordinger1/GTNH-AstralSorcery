...
public class RecipeMiniFlower extends RecipeManaInfusion {
    ...
    public RecipeMiniFlower(String flower, String mini, int mana) {
        super(
            BotaniaAPI.internalHandler.getSubTileAsStack(flower),
            BotaniaAPI.internalHandler.getSubTileAsStack(mini),
            mana);
    ...
    public boolean matches(ItemStack stack) {
        ...
        String input = getInput() instanceof String ? (String) getInput()
            : BotaniaAPI.internalHandler.getStackSubTileKey((ItemStack) getInput());

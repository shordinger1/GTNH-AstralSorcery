...
public class BlockStateContainer {
    ...
    private final AstralBlock block;
    private final ImmutableSortedMap<String, IProperty<?>> properties;
    private final ImmutableList<IBlockState> validStates;

    public BlockStateContainer(AstralBlock blockIn, IProperty<?>... properties) {
        this(blockIn, properties, null);
    }

    protected StateImplementation createState(AstralBlock block, ImmutableMap<IProperty<?>, Comparable<?>> properties, @Nullable ImmutableMap<net.minecraftforge.common.property.IUnlistedProperty<?>, java.util.Optional<?>> unlistedProperties) {
        return new StateImplementation(block, properties);
    }

    protected BlockStateContainer(AstralBlock blockIn, IProperty<?>[] properties, ImmutableMap<net.minecraftforge.common.property.IUnlistedProperty<?>, java.util.Optional<?>> unlistedProperties) {
        this.block = blockIn;
        ...
        List<StateImplementation> list1 = Lists.<BlockStateContainer.StateImplementation>newArrayList();
    ...
    public static class StateImplementation extends BlockStateBase {
        ...
        protected StateImplementation(AstralBlock blockIn, ImmutableMap<IProperty<?>, Comparable<?>> propertiesIn) {
            this.block = blockIn;
            this.properties = propertiesIn;
        }

        protected StateImplementation(AstralBlock blockIn, ImmutableMap<IProperty<?>, Comparable<?>> propertiesIn, ImmutableTable<IProperty<?>, Comparable<?>, IBlockState> propertyValueTable) {
            this.block = blockIn;
            this.properties = propertiesIn;
        ...
        public void buildPropertyValueTable(Map<Map<IProperty<?>, Comparable<?>>, BlockStateContainer.StateImplementation> map) {
            if (this.propertyValueTable != null) {
                ...
                for (Map.Entry<IProperty<?>, Comparable<?>> iPropertyComparableEntry : this.properties.entrySet()) {
        ...
        public int getWeakPower(IBlockAccess blockAccess, BlockPos pos, ForgeDirection side) {
        ...
        public int getStrongPower(IBlockAccess blockAccess, BlockPos pos, ForgeDirection side) {
        ...
        @SideOnly(Side.CLIENT)
        public boolean shouldSideBeRendered(IBlockAccess blockAccess, BlockPos pos, ForgeDirection facing) {
        ...
        public BlockFaceShape getBlockFaceShape(IBlockAccess worldIn, BlockPos pos, ForgeDirection facing) {
        ...
        @Override
        public boolean isSideSolid(IBlockAccess world, BlockPos pos, ForgeDirection side) {
            return this.block.isSideSolid(this, world, pos, side);
        }

        @Override
        public boolean doesSideBlockChestOpening(IBlockAccess world, BlockPos pos, ForgeDirection side) {
            return this.block.doesSideBlockChestOpening(this, world, pos, side);
        }

        @Override
        public boolean doesSideBlockRendering(IBlockAccess world, BlockPos pos, ForgeDirection side) {

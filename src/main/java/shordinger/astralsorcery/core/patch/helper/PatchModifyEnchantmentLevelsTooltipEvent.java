...
public class PatchModifyEnchantmentLevelsTooltipEvent extends ClassPatch {
    ...
    public void patch(ClassNode cn) {
        ...
        mn.instructions.insertBefore(
            n,
            new TypeInsnNode(Opcodes.NEW, "hellfirepvp/astralsorcery/common/event/ItemEnchantmentTooltipEvent"));
        ...
        mn.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "hellfirepvp/astralsorcery/common/event/ItemEnchantmentTooltipEvent",
                "<init>",

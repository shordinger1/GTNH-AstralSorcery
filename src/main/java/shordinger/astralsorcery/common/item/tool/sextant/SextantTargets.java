...
import shordinger.astralsorcery.common.util.StructureFinder;
...
public class SextantTargets {
    ...
    public static final SextantFinder.ASStructure TARGET_MOUNTAIN_SHRINE = new SextantFinder.ASStructure(
    ...
    public static final SextantFinder.ASStructure TARGET_DESERT_SHRINE = new SextantFinder.ASStructure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "desert_shrine",
        0xFFFFC82E,
    ...
    public static final SextantFinder.ASStructure TARGET_SMALL_SHRINE = new SextantFinder.ASStructure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "small_shrine",
        0xFF2ED400,
    ...
    public static final SextantFinder.Structure TARGET_VANILLA_VILLAGE = new SextantFinder.Structure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "village",
        0xFFC39909,
        true,
        StructureFinder.STRUCT_VILLAGE,
        296D / 312D,
        32D / 280D,
        16D / 312D,
        16D / 280D);

    public static final SextantFinder.Structure TARGET_VANILLA_MONUMENT = new SextantFinder.Structure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "oceanmonument",
        0xFF8F38E6,
        true,
        StructureFinder.STRUCT_MONUMENT,
        296D / 312D,
        16D / 280D,
        16D / 312D,
        16D / 280D);

    public static final SextantFinder.Structure TARGET_VANILLA_TEMPLE = new SextantFinder.Structure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "temple",
        0xFFC3C3C3,
        true,
        StructureFinder.STRUCT_TEMPLE,
        280D / 312D,
        0D,
        16D / 312D,
        16D / 280D);

    public static final SextantFinder.Structure TARGET_VANILLA_FORTRESS = new SextantFinder.Structure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "fortress",
        0xFF9C1D15,
        true,
        StructureFinder.STRUCT_FORTRESS,
        280D / 312D,
        32D / 280D,
        16D / 312D,
        16D / 280D);

    public static final SextantFinder.Structure TARGET_VANILLA_ENDCITY = new SextantFinder.Structure(
        AssetLoader.TextureLocation.GUI,
        "gridsextant",
        "endcity",
        0xFF96066F,
        true,
        StructureFinder.STRUCT_ENDCITY,
        280D / 312D,
        16D / 280D,
        16D / 312D,
        16D / 280D);

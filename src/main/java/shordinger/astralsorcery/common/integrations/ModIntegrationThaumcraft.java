...
import shordinger.astralsorcery.common.integrations.mods.thaumcraft.perks.AttributeTypeRunicShielding;
import shordinger.astralsorcery.common.integrations.mods.thaumcraft.perks.ModifierPerkThaumcraft;
import shordinger.astralsorcery.common.integrations.mods.thaumcraft.perks.key.KeyEnergyShield;
...
public class ModIntegrationThaumcraft {
    ...
    public static final String ATTR_TYPE_RUNIC_SHIELDING = AstralSorcery.MODID + ".compat."
        + Mods.THAUMCRAFT.modid
        + ".runicshield";
    ...
    public void onPerkRegister(APIRegistryEvent.PerkRegister register) {
        ...
        ModifierPerkThaumcraft incShield2 = new ModifierPerkThaumcraft("mod_tc_inc_runic_1", 22, 28)
            .setNameOverride(incShield);
        incShield2.addModifier(0.1F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_RUNIC_SHIELDING);
        ModifierPerkThaumcraft incShield3 = new ModifierPerkThaumcraft("mod_tc_inc_runic_2", 20, 30)
            .setNameOverride(incShield);
        incShield3.addModifier(0.07F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_RUNIC_SHIELDING);
        ModifierPerkThaumcraft incShield4 = new ModifierPerkThaumcraft("mod_tc_inc_runic_3", 16, 28)
            .setNameOverride(incShield);
        incShield4.addModifier(0.07F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_RUNIC_SHIELDING);
        ModifierPerkThaumcraft incShield5 = new ModifierPerkThaumcraft("mod_tc_inc_runic_4", 17, 32)
            .setNameOverride(incShield);

...
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeAllElementalResist;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeArrowSpeed;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeBreakSpeed;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeCritChance;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeCritMultiplier;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeDodge;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeEnchantmentEffectiveness;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeLifeLeech;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeLifeRecovery;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributePotionDuration;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeProjectileAttackDamage;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeThorns;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeArmor;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeArmorToughness;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeAttackSpeed;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeMaxHealth;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeMaxReach;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeMeleeAttackDamage;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeMovementSpeed;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypePerkEffect;
import shordinger.astralsorcery.common.constellation.perk.attribute.type.AttributeTypeSwimSpeed;
import shordinger.astralsorcery.common.constellation.perk.reader.AttributeReader;
import shordinger.astralsorcery.common.constellation.perk.reader.impl.AddedPercentageAttributeReader;
import shordinger.astralsorcery.common.constellation.perk.reader.impl.BreakSpeedAttributeReader;
import shordinger.astralsorcery.common.constellation.perk.reader.impl.PercentageAttributeReader;
import shordinger.astralsorcery.common.constellation.perk.reader.impl.VanillaAttributeReader;
import shordinger.astralsorcery.common.constellation.perk.tree.PerkTree;
import shordinger.astralsorcery.common.constellation.perk.tree.PerkTree.PointConnector;
import shordinger.astralsorcery.common.constellation.perk.tree.PerkTreePoint;
import shordinger.astralsorcery.common.constellation.perk.tree.constellation.PerkAlcara;
import shordinger.astralsorcery.common.constellation.perk.tree.constellation.PerkGelu;
import shordinger.astralsorcery.common.constellation.perk.tree.constellation.PerkUlteria;
import shordinger.astralsorcery.common.constellation.perk.tree.constellation.PerkVorux;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.CoreRootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.GemSlotMajorPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.KeyPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.MajorPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.PerkTreeConnector;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyAddEnchantment;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyAreaOfEffect;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyBleed;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyChainMining;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyCheatDeath;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyCleanseBadPotions;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyCullAttack;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyDamageArmor;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyDamageEffect;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyDigTypes;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyDisarm;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyGrowable;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyLastBreath;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyLightningArc;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyMagnetDrops;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyMantleFlight;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyMending;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyNoArmor;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyNoKnockBack;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyProjectileDistance;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyProjectileProximity;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyRampage;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyReach;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyReducedFood;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeySpawnLights;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyStepAssist;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyStoneEnrichment;
import shordinger.astralsorcery.common.constellation.perk.tree.nodes.key.KeyVoidTrash;
import shordinger.astralsorcery.common.constellation.perk.tree.root.AevitasRootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.root.ArmaraRootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.root.DiscidiaRootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.root.EvorsioRootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.root.RootPerk;
import shordinger.astralsorcery.common.constellation.perk.tree.root.VicioRootPerk;
...
public class RegistryPerks {
    ...
    private static AttributeModifierPerk perkRootMajorDamage, perkRootMajorHealth, perkRootMajorMovespeed,
        perkRootMajorArmor, perkRootMajorHarvest;
    ...
    public static void postProcessPerks() {
        List<AbstractPerk> copyPerks = PerkTree.PERK_TREE.getPerkPoints()
            .stream()
    ...
    private static void initializeMinorConstellationPerks() {
        ...
        AttributeModifierPerk perkGelu2 = new AttributeModifierPerk("gelu_inc_perkexp_1", 25, 16)
            .setNameOverride(perkGelu1);
        ...
        AttributeModifierPerk perkUlteria2 = new AttributeModifierPerk("ulteria_more_perkexp_1", -26, 17)
            .setNameOverride(perkUlteria1);
        ...
        AttributeModifierPerk perkVorux2 = new AttributeModifierPerk("vorux_inc_perkeff_1", 12, -29)
            .setNameOverride(perkVorux1);
        ...
        AttributeModifierPerk perkAlcara2 = new AttributeModifierPerk("alcara_more_perkeff_1", -27, -15)
            .setNameOverride(perkAlcara1);
    ...
    private static void initializeOuterVicioPerks() {
        ...
        AttributeModifierPerk perkVR5 = new AttributeModifierPerk("outer_s_inc_trv_4", -12, 24)
            .setNameOverride(perkVR1);
        ...
        AttributeModifierPerk lssArmorLife2 = new AttributeModifierPerk("flight_life_armor_1", 5, 31)
            .setNameOverride(lssArmorLife1);
        lssArmorLife2.addModifier(0.05F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_MOVESPEED);
        AttributeModifierPerk lssArmorLife3 = new AttributeModifierPerk("flight_life_armor_2", 4, 32)
            .setNameOverride(lssArmorLife1);
        ...
        AttributeModifierPerk atsReach2 = new AttributeModifierPerk("magnet_ats_reach_1", -9, 24)
            .setNameOverride(atsReach1);
    ...
    private static void initializeOuterArmaraPerks() {
        ...
        perkDef1.addModifier(
            addedIncArmorEle,
            PerkAttributeModifier.Mode.ADDED_MULTIPLY,
            ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        AttributeModifierPerk perkDef2 = new AttributeModifierPerk("outer_s_inc_def_1", 24, 1)
            .setNameOverride(perkDef1);
        perkDef2.addModifier(addedIncArmorEle, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_ARMOR);
        perkDef2.addModifier(
            addedIncArmorEle,
            PerkAttributeModifier.Mode.ADDED_MULTIPLY,
            ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        AttributeModifierPerk perkDef3 = new AttributeModifierPerk("outer_s_inc_def_2", 26, 9)
            .setNameOverride(perkDef1);
        perkDef3.addModifier(addedIncArmorEle, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_ARMOR);
        perkDef3.addModifier(
            addedIncArmorEle,
            PerkAttributeModifier.Mode.ADDED_MULTIPLY,
            ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        AttributeModifierPerk perkDef4 = new AttributeModifierPerk("outer_s_inc_def_3", 22, 15)
            .setNameOverride(perkDef1);
        perkDef4.addModifier(addedIncArmorEle, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_ARMOR);
        perkDef4.addModifier(
            addedIncArmorEle,
            PerkAttributeModifier.Mode.ADDED_MULTIPLY,
            ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        AttributeModifierPerk perkDef5 = new AttributeModifierPerk("outer_s_inc_def_4", 20, 20)
            .setNameOverride(perkDef1);
        perkDef5.addModifier(addedIncArmorEle, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_ARMOR);
        perkDef5.addModifier(
            addedIncArmorEle,
            PerkAttributeModifier.Mode.ADDED_MULTIPLY,
            ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        ...
        AttributeModifierPerk perkPerkEffSlot2 = new AttributeModifierPerk("def_gem_path_1", 14, 21)
            .setNameOverride(perkPerkEffSlot1);
        ...
        AttributeModifierPerk perkIncLRedA2 = new AttributeModifierPerk("unwav_life_armor_1", 28, 12)
            .setNameOverride(perkIncLRedA1);
        ...
        AttributeModifierPerk perkIncArmor2 = new AttributeModifierPerk("bol_red_inc_armor_1", 27, 3)
            .setNameOverride(perkIncArmor1);
        perkIncArmor2.addModifier(0.06F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_ARMOR);
        AttributeModifierPerk perkIncArmor3 = new AttributeModifierPerk("bol_red_inc_armor_2", 28, 2)
            .setNameOverride(perkIncArmor1);
    ...
    private static void initializeOuterDiscidiaPerks() {
        ...
        AttributeModifierPerk perkDmg2 = new AttributeModifierPerk("outer_s_inc_dmg_1", 3, -28)
            .setNameOverride(perkDmg1);
        ...
        AttributeModifierPerk perkDmg3 = new AttributeModifierPerk("outer_s_inc_dmg_2", 11, -25)
            .setNameOverride(perkDmg1);
        ...
        AttributeModifierPerk perkDmg4 = new AttributeModifierPerk("outer_s_inc_dmg_3", 19, -23)
            .setNameOverride(perkDmg1);
        ...
        AttributeModifierPerk perkDmg5 = new AttributeModifierPerk("outer_s_inc_dmg_4", 23, -17)
            .setNameOverride(perkDmg1);
        ...
        AttributeModifierPerk perkDmg6 = new AttributeModifierPerk("outer_s_inc_dmg_5", 25, -11)
            .setNameOverride(perkDmg1);
        ...
        perkPerkEffSlot1.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkPerkEffSlot2 = new AttributeModifierPerk("dsc_gem_path_1", 17, -21)
            .setNameOverride(perkPerkEffSlot1);
        perkPerkEffSlot2.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        ...
        AttributeModifierPerk perkIncAts2 = new AttributeModifierPerk("inc_ats_ailm_1", 8, -23)
            .setNameOverride(perkIncAts1);
        ...
        AttributeModifierPerk perkIncMs2 = new AttributeModifierPerk("inc_cull_ms_1", 22, -11)
            .setNameOverride(perkIncMs1);
        ...
        AttributeModifierPerk perkCrJ2 = new AttributeModifierPerk("crit_inc_chance_proj_1", 1, -24)
            .setNameOverride(perkCrJ1);
        ...
        AttributeModifierPerk perkCrM2 = new AttributeModifierPerk("crit_inc_chance_melee_1", 26, -19)
            .setNameOverride(perkCrM1);
    ...
    private static void initializeOuterEvorsioPerks() {
        ...
        AttributeModifierPerk perkMine2 = new AttributeModifierPerk("outer_s_inc_mine_1", -27, -9)
            .setNameOverride(perkMine1);
        perkMine2.addModifier(addedIncMining, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_HARVEST_SPEED);
        AttributeModifierPerk perkMine3 = new AttributeModifierPerk("outer_s_inc_mine_2", -23, -15)
            .setNameOverride(perkMine1);
        perkMine3.addModifier(addedIncMining, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_HARVEST_SPEED);
        AttributeModifierPerk perkMine4 = new AttributeModifierPerk("outer_s_inc_mine_3", -18, -19)
            .setNameOverride(perkMine1);
        perkMine4.addModifier(addedIncMining, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_HARVEST_SPEED);
        AttributeModifierPerk perkMine5 = new AttributeModifierPerk("outer_s_inc_mine_4", -12, -24)
            .setNameOverride(perkMine1);
        ...
        perkPerkEffSlot1.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkPerkEffSlot2 = new AttributeModifierPerk("ev_gem_path_1", -18, -15)
            .setNameOverride(perkPerkEffSlot1);
        perkPerkEffSlot2.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        ...
        AttributeModifierPerk perkReach2 = new AttributeModifierPerk("inc_reach_sweep_1", -19, -21)
            .setNameOverride(perkReach1);
        perkReach2.addModifier(0.03F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_REACH);
        AttributeModifierPerk perkReach3 = new AttributeModifierPerk("inc_reach_sweep_2", -20, -22)
            .setNameOverride(perkReach1);
        ...
        AttributeModifierPerk perkLessMine2 = new AttributeModifierPerk("less_hrv_speed_1", -32, -5)
            .setNameOverride(perkLessMine1);
    ...
    private static void initializeOuterAevitasPerks() {
        ...
        AttributeModifierPerk perkLife2 = new AttributeModifierPerk("outer_s_inc_life_1", -20, 18)
            .setNameOverride(perkLife1);
        perkLife2.addModifier(addedIncLife, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_HEALTH);
        AttributeModifierPerk perkLife3 = new AttributeModifierPerk("outer_s_inc_life_2", -25, 14)
            .setNameOverride(perkLife1);
        perkLife3.addModifier(addedIncLife, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_HEALTH);
        AttributeModifierPerk perkLife4 = new AttributeModifierPerk("outer_s_inc_life_3", -26, 8)
            .setNameOverride(perkLife1);
        perkLife4.addModifier(addedIncLife, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_HEALTH);
        AttributeModifierPerk perkLife5 = new AttributeModifierPerk("outer_s_inc_life_4", -28, 2)
            .setNameOverride(perkLife1);
        ...
        perkPerkEffSlot1.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkPerkEffSlot2 = new AttributeModifierPerk("life_gem_path_1", -17, 17)
            .setNameOverride(perkPerkEffSlot1);
        perkPerkEffSlot2.addModifier(1.02F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        ...
        AttributeModifierPerk perkEffectMine2 = new AttributeModifierPerk("inc_mine_perk_1", -17, 26)
            .setNameOverride(perkEffectMine1);
        ...
        AttributeModifierPerk perkIncRec2 = new AttributeModifierPerk("inc_life_rec_1", -29, 8)
            .setNameOverride(perkIncRec1);
    ...
    private static void initializePerkEffectPerks() {
        ...
        majorPerkEffect1
            .addModifier(addedIncPerkEffect, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
    ...
    private static void initializeVicioKeyPerks() {
        ...
        AttributeModifierPerk perkSwimSpeed2 = new AttributeModifierPerk("key_path_swim_conversion_1", -3, 24)
            .setNameOverride(perkSwimSpeed1);
        perkSwimSpeed2.addModifier(0.1F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_SWIMSPEED);
        AttributeModifierPerk perkSwimSpeed3 = new AttributeModifierPerk("key_path_swim_conversion_2", -2, 25)
            .setNameOverride(perkSwimSpeed1);
        ...
        swimSpeedConversion.addConverter(new PerkConverter() {
            ...
            @Nonnull
            @Override
            public Collection<PerkAttributeModifier> gainExtraModifiers(EntityPlayer player, PlayerProgress progress,
                                                                        PerkAttributeModifier modifier, @Nullable AbstractPerk owningPerk) {
                List<PerkAttributeModifier> modifiers = Lists.newArrayList();
                if (modifier.getAttributeType()
                    .equals(ATTR_TYPE_MOVESPEED)) {
                    PerkAttributeModifier mod;
                    switch (modifier.getMode()) {
                        case ADDITION:
                        case ADDED_MULTIPLY:
                            mod = modifier.gainAsExtraModifier(
                                this,
                                ATTR_TYPE_SWIMSPEED,
                                modifier.getMode(),
                                modifier.getValue(player, progress) / 2F);
                            modifiers.add(mod);
                            break;
        ...
        AttributeModifierPerk incAttackSpeed2 = new AttributeModifierPerk("major_ats_inc_ats_1", 8, 15)
            .setNameOverride(incAttackSpeed1);
        ...
        AttributeModifierPerk incMovespeedStepAssist1 = new AttributeModifierPerk(
            "key_stepassist_path_movespeed",
            -6,
            18);
        incMovespeedStepAssist1.addModifier(0.05F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_MOVESPEED);
        AttributeModifierPerk incMovespeedStepAssist2 = new AttributeModifierPerk(
            "key_stepassist_path_movespeed_1",
            -7,
            17).setNameOverride(incMovespeedStepAssist1);
        ...
        AttributeModifierPerk lightsMs2 = new AttributeModifierPerk("key_lights_path_ms_1", 7, 16)
            .setNameOverride(lightsMs1);
        ...
        AttributeModifierPerk redFoodPathDodge2 = new AttributeModifierPerk("key_redfood_path_dodge_1", 2, 23)
            .setNameOverride(redFoodPathDodge1);
        redFoodPathDodge2.addModifier(0.1F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_DODGE);
        AttributeModifierPerk redFoodPathDodge3 = new AttributeModifierPerk("key_redfood_path_dodge_2", 3, 24)
            .setNameOverride(redFoodPathDodge1);
    ...
    private static void initializeArmaraKeyPerks() {
        ...
        AttributeModifierPerk perkALC2 = new AttributeModifierPerk("key_alc_inc_armor_1", 16, -3)
            .setNameOverride(perkALC1);
        ...
        keyArmorConversion.addConverter(new PerkConverter() {
            ...
            public PerkAttributeModifier convertModifier(EntityPlayer player, PlayerProgress progress,
                                                         PerkAttributeModifier modifier, @Nullable AbstractPerk owningPerk) {
                if (modifier.getAttributeType()
                    .equals(ATTR_TYPE_ARMOR)) {
                    return modifier
                        .convertModifier(ATTR_TYPE_HEALTH, modifier.getMode(), modifier.getValue(player, progress));
                }
                return modifier;
            }
            ...
            public Collection<PerkAttributeModifier> gainExtraModifiers(EntityPlayer player, PlayerProgress progress,
                ...
                if (modifier.getAttributeType()
                    ...
                    PerkAttributeModifier mod;
                    mod = modifier
                        .gainAsExtraModifier(this, ATTR_TYPE_ARMOR, PerkAttributeModifier.Mode.STACKING_MULTIPLY, 0F);
                    modifiers.add(mod);
                    mod = modifier.gainAsExtraModifier(
                        this,
        ...
        AttributeModifierPerk perkPhEle2 = new AttributeModifierPerk("key_phoenix_path_1", 17, 15)
            .setNameOverride(perkPhEle1);
        perkPhEle2.addModifier(0.05F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
        AttributeModifierPerk perkPhEle3 = new AttributeModifierPerk("key_phoenix_path_2", 18, 16)
            .setNameOverride(perkPhEle1);
        ...
        AttributeModifierPerk perkArmor2 = new AttributeModifierPerk("inc_added_armor_1", 22, 4)
            .setNameOverride(perkArmor1);
        perkArmor2.addModifier(1F, PerkAttributeModifier.Mode.ADDITION, ATTR_TYPE_ARMOR);
        AttributeModifierPerk perkArmor3 = new AttributeModifierPerk("inc_added_armor_2", 23, 5)
            .setNameOverride(perkArmor1);
    ...
    private static void initializeDiscidiaKeyPerks() {
        ...
        AttributeModifierPerk perkDst2 = new AttributeModifierPerk("key_dst_less_dmg_2", 18, -16)
            .setNameOverride(perkDst1);
        ...
        AttributeModifierPerk perkDst3 = new AttributeModifierPerk("key_dst_less_dmg_3", 13, -19)
            .setNameOverride(perkDst1);
        perkDst3.addModifier(0.9F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_PROJ_DAMAGE);
        AttributeModifierPerk perkDst4 = new AttributeModifierPerk("key_dst_less_dmg_4", 14, -20)
            .setNameOverride(perkDst1);
        ...
        AttributeModifierPerk perkRPDmg2 = new AttributeModifierPerk("key_rampage_path_node_dmg_1", 4, -16)
            .setNameOverride(perkRPDmg);
        ...
        AttributeModifierPerk perkFD2 = new AttributeModifierPerk("ds_inc_potion_duration_1", 22, -5)
            .setNameOverride(perkFD1);
    ...
    private static void initializeEvorsioKeyPerks() {
        ...
        AttributeModifierPerk perkLL2 = new AttributeModifierPerk("key_lastbreath_path_node_1", -6, -16)
            .setNameOverride(perkLL1);
        ...
        AttributeModifierPerk perkDTM2 = new AttributeModifierPerk("key_digtypes_path_node_inc_1", -14, -7)
            .setNameOverride(perkDTM1);
        ...
        AttributeModifierPerk perkAD2 = new AttributeModifierPerk("key_disarm_path_node_1", -17, -1)
            .setNameOverride(perkAD1);
        perkAD2.addModifier(1.05F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_MELEE_DAMAGE);
        AttributeModifierPerk perkAD3 = new AttributeModifierPerk("key_disarm_path_node_2", -18, -2)
            .setNameOverride(perkAD1);
        ...
        AttributeModifierPerk perkACH3 = new AttributeModifierPerk("key_arc_chains_1", -5, -22)
            .setNameOverride(perkACH1);
        ...
        AttributeModifierPerk perkChainL2 = new AttributeModifierPerk("key_chain_mining_length_1", -22, -10)
            .setNameOverride(perkChainL1);
        ...
        AttributeModifierPerk perkChanceL2 = new AttributeModifierPerk("key_chain_mining_chance_1", -23, -5)
            .setNameOverride(perkChanceL1);
        ...
        AttributeModifierPerk perkFD2 = new AttributeModifierPerk("ev_inc_potion_duration_1", -14, -17)
            .setNameOverride(perkFD1);
    ...
    private static void initializeAevitasKeyPerks() {
        ...
        AttributeModifierPerk perkReachP2 = new AttributeModifierPerk("key_reach_path_node_1", -11, 12)
            .setNameOverride(perkReachP1);
        ...
        AttributeModifierPerk perkSEP2 = new AttributeModifierPerk("key_enrich_path_node_1", -19, 12)
            .setNameOverride(perkSEP1);
        perkSEP2.addModifier(0.04F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_HARVEST_SPEED);
        AttributeModifierPerk perkSEP3 = new AttributeModifierPerk("key_enrich_path_node_2", -20, 13)
            .setNameOverride(perkSEP1);
        ...
        AttributeModifierPerk perkMD3 = new AttributeModifierPerk("key_mending_path_node_2", -23, 3)
            .setNameOverride(perkMD2);
        ...
        AttributeModifierPerk perkGP2 = new AttributeModifierPerk("key_growables_path_node_1", -10, 14)
            .setNameOverride(perkGP1);
        perkGP2.addModifier(0.15F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_LIFE_RECOVERY);
        AttributeModifierPerk perkGP3 = new AttributeModifierPerk("key_growables_path_node_2", -11, 15)
            .setNameOverride(perkGP1);
    ...
    private static void initializeTreeConnectorPerks() {
        ...
        AttributeModifierPerk perkEvorsioCh2 = new AttributeModifierPerk("threshold_evorsio_1", -15, -30)
            .setNameOverride(perkEvorsioCh1);
        perkEvorsioCh2.addModifier(more_ch, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EXP);
        AttributeModifierPerk perkEvorsioCh3 = new AttributeModifierPerk("threshold_evorsio_2", -11, -30)
            .setNameOverride(perkEvorsioCh1);
        ...
        AttributeModifierPerk perkArmaraCh2 = new AttributeModifierPerk("threshold_armara_1", 32, -2)
            .setNameOverride(perkArmaraCh1);
        perkArmaraCh2.addModifier(more_ch, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EXP);
        AttributeModifierPerk perkArmaraCh3 = new AttributeModifierPerk("threshold_armara_2", 32, -6)
            .setNameOverride(perkArmaraCh1);
        ...
        AttributeModifierPerk perkVicioCh2 = new AttributeModifierPerk("threshold_vicio_1", -4, 33)
            .setNameOverride(perkVicioCh1);
        perkVicioCh2.addModifier(more_ch, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EXP);
        AttributeModifierPerk perkVicioCh3 = new AttributeModifierPerk("threshold_vicio_2", -8, 33)
            .setNameOverride(perkVicioCh1);
    ...
    private static void initializePerkExteriorTravelWheel() {
        ...
        AttributeModifierPerk perkEff2 = new AttributeModifierPerk("base_inc_perkeffect_t4_1", -3, -20)
            .setNameOverride(perkEff1);
        perkEff2.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff3 = new AttributeModifierPerk("base_inc_perkeffect_t4_2", 5, -21)
            .setNameOverride(perkEff1);
        perkEff3.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff4 = new AttributeModifierPerk("base_inc_perkeffect_t4_3", 9, -18)
            .setNameOverride(perkEff1);
        ...
        // Discidia -> Armara
        AttributeModifierPerk perkEff5 = new AttributeModifierPerk("base_inc_perkeffect_t4_4", 17, -12)
            .setNameOverride(perkEff1);
        perkEff5.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff6 = new AttributeModifierPerk("base_inc_perkeffect_t4_5", 19, -7)
            .setNameOverride(perkEff1);
        perkEff6.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff7 = new AttributeModifierPerk("base_inc_perkeffect_t4_6", 18, -1)
            .setNameOverride(perkEff1);
        perkEff7.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff8 = new AttributeModifierPerk("base_inc_perkeffect_t4_7", 19, 6)
            .setNameOverride(perkEff1);
        ...
        // Armara -> Vicio
        AttributeModifierPerk perkEff9 = new AttributeModifierPerk("base_inc_perkeffect_t4_9", 15, 13)
            .setNameOverride(perkEff1);
        perkEff9.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff10 = new AttributeModifierPerk("base_inc_perkeffect_t4_10", 14, 17)
            .setNameOverride(perkEff1);
        perkEff10.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff11 = new AttributeModifierPerk("base_inc_perkeffect_t4_11", 9, 18)
            .setNameOverride(perkEff1);
        perkEff11.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff12 = new AttributeModifierPerk("base_inc_perkeffect_t4_12", 5, 19)
            .setNameOverride(perkEff1);
        ...
        // Vicio -> Aevitas
        AttributeModifierPerk perkEff13 = new AttributeModifierPerk("base_inc_perkeffect_t4_13", -5, 20)
            .setNameOverride(perkEff1);
        perkEff13.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff14 = new AttributeModifierPerk("base_inc_perkeffect_t4_14", -9, 19)
            .setNameOverride(perkEff1);
        perkEff14.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff15 = new AttributeModifierPerk("base_inc_perkeffect_t4_15", -14, 17)
            .setNameOverride(perkEff1);
        perkEff15.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff16 = new AttributeModifierPerk("base_inc_perkeffect_t4_16", -16, 12)
            .setNameOverride(perkEff1);
        ...
        // Aevitas -> Evorsio
        AttributeModifierPerk perkEff17 = new AttributeModifierPerk("base_inc_perkeffect_t4_17", -19, 4)
            .setNameOverride(perkEff1);
        perkEff17.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff18 = new AttributeModifierPerk("base_inc_perkeffect_t4_18", -20, -1)
            .setNameOverride(perkEff1);
        perkEff18.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff19 = new AttributeModifierPerk("base_inc_perkeffect_t4_19", -18, -6)
            .setNameOverride(perkEff1);
        perkEff19.addModifier(inc_t4, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff20 = new AttributeModifierPerk("base_inc_perkeffect_t4_20", -16, -10)
            .setNameOverride(perkEff1);
    ...
    private static void initializeEvorsioBranch() {
        ...
        AttributeModifierPerk perkM2 = new AttributeModifierPerk("med_inc_hrv_speed_1", -13, -11)
            .setNameOverride(perkM1);
        ...
        AttributeModifierPerk perkS1 = new AttributeModifierPerk("med_inc_hrv_speed_2", -10, -13)
            .setNameOverride(perkM1);
        perkS1.addModifier(0.05F, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_HARVEST_SPEED);
        AttributeModifierPerk perkS2 = new AttributeModifierPerk("med_inc_hrv_speed_3", -12, -13)
            .setNameOverride(perkM1);
    ...
    private static void initializeDiscidiaBranch() {
        ...
        AttributeModifierPerk perkP2 = new AttributeModifierPerk("med_inc_proj_damage_1", 13, -12)
            .setNameOverride(perkP1);
        ...
        AttributeModifierPerk perkM2 = new AttributeModifierPerk("med_inc_melee_damage_1", 12, -14)
            .setNameOverride(perkM1);
    ...
    private static void initializeArmaraBranch() {
        ...
        perkResArmor
            .addModifier(1.06F, PerkAttributeModifier.Mode.STACKING_MULTIPLY, ATTR_TYPE_INC_ALL_ELEMENTAL_RESIST);
    ...
    private static void initializePerkCore() {
        ...
        AttributeModifierPerk perkEff2 = new AttributeModifierPerk("base_inc_perkeffect_t1_1", 2, 1)
            .setNameOverride(perkEff1);
        perkEff2.addModifier(inc_t1, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff3 = new AttributeModifierPerk("base_inc_perkeffect_t1_2", -1, 2)
            .setNameOverride(perkEff1);
        perkEff3.addModifier(inc_t1, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEff4 = new AttributeModifierPerk("base_inc_perkeffect_t1_3", -2, -1)
            .setNameOverride(perkEff1);
    ...
    private static void initializePerkInteriorTravelWheel() {
        ...
        AttributeModifierPerk perkEffectEvDis2 = new AttributeModifierPerk("base_inc_perkeffect_t2_1", 1, -8)
            .setNameOverride(perkEffectEvDis1);
        perkEffectEvDis2.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectEvDis3 = new AttributeModifierPerk("base_inc_perkeffect_t2_2", 0, -5)
            .setNameOverride(perkEffectEvDis1);
        perkEffectEvDis3.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);

        AttributeModifierPerk perkEffectDisArm1 = new AttributeModifierPerk("base_inc_perkeffect_t2_3", 10, -2)
            .setNameOverride(perkEffectEvDis1);
        perkEffectDisArm1.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectDisArm2 = new AttributeModifierPerk("base_inc_perkeffect_t2_4", 7, -3)
            .setNameOverride(perkEffectEvDis1);
        perkEffectDisArm2.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectDisArm3 = new AttributeModifierPerk("base_inc_perkeffect_t2_5", 4, -1)
            .setNameOverride(perkEffectEvDis1);
        perkEffectDisArm3.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);

        AttributeModifierPerk perkEffectArmVic1 = new AttributeModifierPerk("base_inc_perkeffect_t2_6", 6, 9)
            .setNameOverride(perkEffectEvDis1);
        perkEffectArmVic1.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectArmVic2 = new AttributeModifierPerk("base_inc_perkeffect_t2_7", 4, 6)
            .setNameOverride(perkEffectEvDis1);
        perkEffectArmVic2.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectArmVic3 = new AttributeModifierPerk("base_inc_perkeffect_t2_8", 1, 4)
            .setNameOverride(perkEffectEvDis1);
        perkEffectArmVic3.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);

        AttributeModifierPerk perkEffectVicAev1 = new AttributeModifierPerk("base_inc_perkeffect_t2_9", -6, 9)
            .setNameOverride(perkEffectEvDis1);
        perkEffectVicAev1.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectVicAev2 = new AttributeModifierPerk("base_inc_perkeffect_t2_10", -5, 5)
            .setNameOverride(perkEffectEvDis1);
        perkEffectVicAev2.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectVicAev3 = new AttributeModifierPerk("base_inc_perkeffect_t2_11", -2, 4)
            .setNameOverride(perkEffectEvDis1);
        perkEffectVicAev3.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);

        AttributeModifierPerk perkEffectAevEv1 = new AttributeModifierPerk("base_inc_perkeffect_t2_12", -10, -2)
            .setNameOverride(perkEffectEvDis1);
        perkEffectAevEv1.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectAevEv2 = new AttributeModifierPerk("base_inc_perkeffect_t2_13", -7, -1)
            .setNameOverride(perkEffectEvDis1);
        perkEffectAevEv2.addModifier(inc_t2, PerkAttributeModifier.Mode.ADDED_MULTIPLY, ATTR_TYPE_INC_PERK_EFFECT);
        AttributeModifierPerk perkEffectAevEv3 = new AttributeModifierPerk("base_inc_perkeffect_t2_14", -5, -2)
            .setNameOverride(perkEffectEvDis1);
    ...
    private static void initializeRootPerkWheel() {
        ...
        PERK_TREE.registerPerk(perkEffectArmVic3)
            .connect(perkEffectArmVic2)
            .connect(perkRootMajorMovespeed);
    ...
    private static void initializeEvorsioRoot() {
        ...
        AttributeModifierPerk breakRoot2 = new AttributeModifierPerk("base_inc_harvest_1", -6, -9)
            .setNameOverride(breakRoot1);
    ...
    private static void initializeArmaraRoot() {
        ...
        AttributeModifierPerk armorRoot2 = new AttributeModifierPerk("base_inc_armor_1", 8, 5)
            .setNameOverride(armorRoot1);
    ...
    private static void initializeAevitasRoot() {
        ...
        AttributeModifierPerk lifeRoot2 = new AttributeModifierPerk("base_inc_life_1", -8, 5)
            .setNameOverride(lifeRoot1);

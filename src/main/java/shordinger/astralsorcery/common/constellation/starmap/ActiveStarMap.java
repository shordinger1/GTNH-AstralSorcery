...
public class ActiveStarMap {
    ...
    public boolean tryApplyEnchantments(ItemStack stack) {
        ...
        lblEnchantments:
        for (Map.Entry<IConstellation, List<ConstellationMapEffectRegistry.EnchantmentMapEffect>> entry : effectMap
            .entrySet()) {
        ...
        for (IConstellation c : starProportions.keySet()) {
            ...
            if (me != null) {
                for (ConstellationMapEffectRegistry.PotionMapEffect effect : me.potionEffects) {
                    ...
                    PotionEffect eff;
                    if ((eff = MiscUtils.iterativeSearch(
                        applicableEffects,
                        (pe) -> pe.getPotion()
                            .equals(effect.potion)))
                        != null) {

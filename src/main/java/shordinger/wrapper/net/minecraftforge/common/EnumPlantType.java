...
public enum EnumPlantType {
    ...
    /**
     * Getting a custom {@link EnumPlantType}, or an existing one if it has the same name as that one. Your plant should
     * implement {@link IPlantable}
     * and return this custom type in {@link IPlantable#getPlantType(IBlockAccess, BlockPos)}.
     *
     * <p>
     * If your new plant grows on blocks like any one of them above, never create a new {@link EnumPlantType}.
     ...
     * which you are supposed to override this function in your new block and create a new plant type to grow on that
     * block.
     *
     * <p>
     * You can create an instance of your plant type in your API and let your/others mods access it. It will be faster
    ...
    public static EnumPlantType getPlantType(String name) {
        for (EnumPlantType t : values()) {
            if (t.name()
                .equalsIgnoreCase(name)) return t;
        }

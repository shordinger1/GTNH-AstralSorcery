...
package shordinger.wrapper.net.minecraftforge.common.ticket;
...
public abstract class SimpleTicket<T> {
     ...
     * <br>
     * Should <b>not</b> be called if you just want to register a ticket to a system like the
     * {@link net.minecraftforge.common.FarmlandWaterManager}
     */
    @SafeVarargs
    public final void setManager(@Nonnull ITicketManager<T> masterManager,
                                 @Nonnull ITicketManager<T>... dummyManagers) {
     ...
     * After this call, any calls to {@link #isValid()} should return false unless it is registered again using
     * {@link #validate()}
     */

...
public class FakePlayerFactory {
    ...
    private static GameProfile MINECRAFT = new GameProfile(
    ...
    public static void unloadWorld(WorldServer world) {
        fakePlayers.entrySet()
            .removeIf(entry -> entry.getValue().world == world);
        if (MINECRAFT_PLAYER != null && MINECRAFT_PLAYER.get() != null && MINECRAFT_PLAYER.get().world == world) // This
        // shouldn't
        // be
        // strictly
        // necessary,

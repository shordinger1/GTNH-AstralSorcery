...
package shordinger.wrapper.net.minecraftforge.common.brewing;
...
public class VanillaBrewingRecipe implements IBrewingRecipe {
    ...
    public boolean isInput(@Nonnull ItemStack stack) {
        ...
        return item == Items.POTIONITEM || item == Items.SPLASH_POTION
     ...
     * It brews the potion by doing the bit-shifting magic and then checking if the new PotionEffect list is different
     * to the old one,

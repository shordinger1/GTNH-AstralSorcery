...
import shordinger.wrapper.net.minecraftforge.fml.client.config.GuiEditArray;
import shordinger.wrapper.net.minecraftforge.fml.client.config.GuiEditArrayEntries;
import shordinger.wrapper.net.minecraftforge.fml.client.config.GuiEditArrayEntries.IArrayEntry;
...
public class Property {
    ...
    Property(String name, String value, Type type, boolean read, String[] validValues, String[] validValuesDisplay,
             String langKey) {
        setName(name);
        this.value = value;
    ...
    Property(String name, String[] values, Type type, boolean read, String[] validValues, String[] validValuesDisplay,
             String langKey) {
        setName(name);
        this.type = type;
    ...
    /**
     * Sets the flag for whether or not this Property can be edited while a world is running. Care should be taken to
     * ensure
     * that only properties that are truly dynamic can be changed from the in-game options menu. When set to false the
     * Property will be
     * editable from both the main menu Mods list config screen and the in-game Mod Options config screen. When set to
     * true the Property
    ...
    /**
     * Returns whether or not this Property is able to be edited while a world is running using the in-game Mod Options
     * screen
     * as well as the Mods list screen, or only from the Mods list screen. Setting this flag to true will disable
     * editing of
    ...
    /**
     * Sets the maximum length of this list/array Property. Only important if isList() == true. If the current values
     * array or default
     * values array is longer than the new maximum it will be resized. If calling both this method and
     * setIsListLengthFixed(true), this
    ...
    /**
     * Sets the flag for whether this list/array Property has a fixed length. Only important if isList() == true. If
     * calling both this
     ...
     * This class
     * MUST provide a constructor with the following parameter types: {@link GuiConfig} (the owning GuiConfig screen
     * will be provided),
     * {@link GuiConfigEntries} (the owning GuiConfigEntries will be provided), {@link IConfigElement} (the
     * IConfigElement for this Property
     * will be provided).
     *
    ...
    /**
     * Gets the custom IConfigEntry class that should be used in place of the standard entry class for this Property
     * type, or null if
     * none has been set.
     *
    ...
    /**
     * Sets a custom IGuiEditListEntry class that should be used in place of the standard entry class for this Property
     * type. This class
     * MUST provide a constructor with the following parameter types: {@link GuiEditArray} (the owning GuiEditArray
     * screen will be provided),
     * {@link GuiEditArrayEntries} (the parent GuiEditArrayEntries will be provided), {@link IConfigElement} (the
     * IConfigElement for this Property
    ...
    /**
     * Gets the custom IArrayEntry class that should be used in place of the standard entry class for this Property
     * type, or null if
     * none has been set.
     *
    ...
    /**
     * Sets the localization language key for this Property so that the config GUI screens are nice and pretty <3. The
     * string languageKey +
    ...
    /**
     * Sets the array of valid values that this String Property can be set to. When an array of valid values is defined
     * for a Property the
     ...
     * When an array of valid values is defined for a Property the GUI control for that property will be a value cycle
     * button.
     *
    ...
    /**
     * Gets the array of the config GUI display versions of the valid values that this String Property can be set to, or
     * null or empty if not defined.
     *
    ...
    /**
     * Returns the value in this property as a boolean, if the value is not a valid boolean, it will return the provided
     * default.
     *
     * @return The value as a boolean, or the default
     */
    ...
    /**
     * Returns the value in this property as a double, if the value is not a valid double, it will return the provided
     * default.
     *
     * @return The value
     */

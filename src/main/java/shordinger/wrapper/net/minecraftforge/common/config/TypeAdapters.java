...
import shordinger.wrapper.net.minecraftforge.common.config.Property.Type;
...
class TypeAdapters {
    ...
    static ITypeAdapter BoolA = new ITypeAdapter() {
        ...
        @Override
        public Object getValue(Property prop) {
            return Booleans.asList(prop.getBooleanList())
                .toArray(new Boolean[prop.getBooleanList().length]);
        }
    ...
    static ITypeAdapter FltA = new ITypeAdapter() {
        ...
        @Override
        public Object getValue(Property prop) {
            return Floats.asList(Floats.toArray(Doubles.asList(prop.getDoubleList())))
                .toArray(new Float[prop.getDoubleList().length]);
        }
    ...
    static ITypeAdapter DblA = new ITypeAdapter() {
        ...
        @Override
        public Object getValue(Property prop) {
            return Doubles.asList(prop.getDoubleList())
                .toArray(new Double[prop.getDoubleList().length]);
        }
    ...
    static ITypeAdapter BytA = new ITypeAdapter() {
        ...
        @Override
        public Object getValue(Property prop) {
            return Bytes.asList(Bytes.toArray(Ints.asList(prop.getIntList())))
                .toArray(new Byte[prop.getIntList().length]);
        }
    ...
    static ITypeAdapter chrA = new ITypeAdapter() {
        ...
        private int[] toPrim(char[] v) {
            ...
            for (int x = 0; x < v.length; x++) ret[x] = v[x];
            return ret;
        }
        ...
        public Object getValue(Property prop) {
            ...
            for (int x = 0; x < v.length; x++) ret[x] = (char) v[x];
            return ret;
        }
    ...
    static ITypeAdapter ChrA = new ITypeAdapter() {
        ...
        private int[] toPrim(Character[] v) {
            if (v == null) return new int[0];
            int[] ret = new int[v.length];
            for (int x = 0; x < v.length; x++) ret[x] = v[x] == null ? 0 : v[x];
            return ret;
        }
        ...
        public Object getValue(Property prop) {
            ...
            for (int x = 0; x < v.length; x++) ret[x] = Character.valueOf((char) v[x]);
            return ret;
        }
    ...
    static ITypeAdapter ShrtA = new ITypeAdapter() {
        ...
        public Object getValue(Property prop) {
            ...
            for (int x = 0; x < ret.length; x++) ret[x] = Short.valueOf((short) v[x]);
            return ret;
        }
    ...
    static ITypeAdapter IntA = new ITypeAdapter() {
        ...
        @Override
        public Object getValue(Property prop) {
            return Ints.asList(prop.getIntList())
                .toArray(new Integer[prop.getIntList().length]);
        }

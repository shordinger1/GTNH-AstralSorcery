...
import shordinger.wrapper.net.minecraft.item.crafting.RecipeBookCloning;
import shordinger.wrapper.net.minecraft.item.crafting.RecipeFireworks;
import shordinger.wrapper.net.minecraft.item.crafting.RecipeRepairItem;
import shordinger.wrapper.net.minecraft.item.crafting.RecipeTippedArrow;
import shordinger.wrapper.net.minecraft.item.crafting.RecipesArmorDyes;
import shordinger.wrapper.net.minecraft.item.crafting.RecipesBanners.RecipeAddPattern;
import shordinger.wrapper.net.minecraft.item.crafting.RecipesBanners.RecipeDuplicatePattern;
import shordinger.wrapper.net.minecraft.item.crafting.RecipesMapCloning;
import shordinger.wrapper.net.minecraft.item.crafting.RecipesMapExtending;
...
import shordinger.wrapper.net.minecraft.item.crafting.ShieldRecipes;
...
@Deprecated // DO NOT USE IN 1.12 UNTIL THIS DEPRECATION MARKER IS REMOVED THIS WILL MOST LIKELY BE DELETED YOU HAVE
// BEEN WARNED
public class RecipeSorter implements Comparator<IRecipe> {
    ...
    private RecipeSorter() {
        ...
        register("minecraft:shield_deco", ShieldRecipes.Decoration.class, SHAPELESS, "after:minecraft:shapeless"); // Size
        // 2
        ...
        register("minecraft:pattern_dupe", RecipeDuplicatePattern.class, SHAPELESS, "after:minecraft:shapeless"); // Size
        // 2
    ...
    private static int getPriority(IRecipe recipe) {
        ...
        if (ret == null) {
            if (!warned.contains(cls)) {
                FMLLog.bigWarning(
                    "Unknown recipe class! {} Modders need to register their recipe types with {}",
                    cls.getName(),
                    RecipeSorter.class.getName());
                warned.add(cls);
            }
            cls = cls.getSuperclass();
            while (cls != Object.class) {

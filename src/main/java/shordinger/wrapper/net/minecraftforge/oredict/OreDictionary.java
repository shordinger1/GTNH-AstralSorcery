...
////        ItemStack[] exclusions = new ItemStack[]{new ItemStack(Blocks.LAPIS_BLOCK), new ItemStack(Items.COOKIE),
////            new ItemStack(Blocks.STONEBRICK), new ItemStack(Blocks.STONE_SLAB, 1, WILDCARD_VALUE),
////            new ItemStack(Blocks.STONE_STAIRS), new ItemStack(Blocks.COBBLESTONE_WALL), new ItemStack(Blocks.OAK_FENCE),
////            new ItemStack(Blocks.OAK_FENCE_GATE), new ItemStack(Blocks.OAK_STAIRS), new ItemStack(Blocks.SPRUCE_FENCE),
////            new ItemStack(Blocks.SPRUCE_FENCE_GATE), new ItemStack(Blocks.SPRUCE_STAIRS),
////            new ItemStack(Blocks.BIRCH_FENCE_GATE), new ItemStack(Blocks.BIRCH_FENCE),
////            new ItemStack(Blocks.BIRCH_STAIRS), new ItemStack(Blocks.JUNGLE_FENCE),
////            new ItemStack(Blocks.JUNGLE_FENCE_GATE), new ItemStack(Blocks.JUNGLE_STAIRS),
////            new ItemStack(Blocks.ACACIA_FENCE), new ItemStack(Blocks.ACACIA_FENCE_GATE),
////            new ItemStack(Blocks.ACACIA_STAIRS), new ItemStack(Blocks.DARK_OAK_FENCE),
////            new ItemStack(Blocks.DARK_OAK_FENCE_GATE), new ItemStack(Blocks.DARK_OAK_STAIRS),
////            new ItemStack(Blocks.WOODEN_SLAB, 1, WILDCARD_VALUE), new ItemStack(Blocks.GLASS_PANE),
////            new ItemStack(Blocks.BONE_BLOCK), // Bone Block, to prevent conversion of dyes into bone meal.
////            new ItemStack(Items.BOAT), new ItemStack(Items.SPRUCE_BOAT), new ItemStack(Items.BIRCH_BOAT),
////            new ItemStack(Items.JUNGLE_BOAT), new ItemStack(Items.ACACIA_BOAT), new ItemStack(Items.DARK_OAK_BOAT),
////            new ItemStack(Items.OAK_DOOR), new ItemStack(Items.SPRUCE_DOOR), new ItemStack(Items.BIRCH_DOOR),
////            new ItemStack(Items.JUNGLE_DOOR), new ItemStack(Items.ACACIA_DOOR), new ItemStack(Items.DARK_OAK_DOOR),
...
////                                    FMLLog.log.info(
////                                        "Invalid recipe found with multiple oredict ingredients in the same ingredient..."); // TODO:
////                                    // Write
////                                    // a
////                                    // dumper?
////                                    skip = true;
...
////                            // FMLLog.info("Invalid recipe found with ingredient that partially matches ore
////                            // entries..."); //TODO: Write a dumper?
////                            skip = true;
////                        }
////                        if (skip) break;
////                    }
...
////                            String recipeName = obj.getRegistryName()
////                                .getResourcePath();
////                            FMLLog.log.debug(
////                                "Replaced {} of the recipe \'{}\' with \"{}\".",
...
//        return net.minecraftforge.oredict.OreDictionary.getOreID(name);
//    }
//
//    /**
...
//
//        // HACK: use the registry name's ID. It is unique and it knows about substitutions. Fallback to a -1 value (what
//        // Item.getIDForItem would have returned) in the case where the registry is not aware of the item yet
//        // IT should be noted that -1 will fail the gate further down, if an entry already exists with value -1 for this
//        // name. This is what is broken and being warned about.
//        // APPARENTLY it's quite common to do this. OreDictionary should be considered alongside Recipes - you can't
//        // make them properly until you've registered with the game.
...
//            && ((target.getMetadata() == WILDCARD_VALUE && !strict) || target.getMetadata() == input.getMetadata()));
//    }
//
//    // Convenience functions that make for cleaner code mod side. They all drill down to registerOre(String, int,
//    // ItemStack)
...
//            FMLLog.bigWarning(
//                "A broken ore dictionary registration with name {} has occurred. It adds an item (type: {}) which is currently unknown to the game registry. This dictionary item can only support a single value when"

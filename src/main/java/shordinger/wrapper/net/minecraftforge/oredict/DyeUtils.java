...
public class DyeUtils {
    ...
    private static final String[] dyeOredicts = new String[]{"dyeWhite", "dyeOrange", "dyeMagenta", "dyeLightBlue",
        "dyeYellow", "dyeLime", "dyePink", "dyeGray", "dyeLightGray", "dyeCyan", "dyePurple", "dyeBlue", "dyeBrown",
    ...
    /**
     * Similar to {@link #metaFromStack(ItemStack)}, except that it returns the raw integer (with a {@code -1}
     * sentinel);
    ...
    /**
     * Similar to {@link #dyeDamageFromStack(ItemStack)}, except that it returns the raw integer (with a {@code -1}
     * sentinel);
     * this follows vanilla conventions.
     *
     * @param stack the item stack

 ...
 * process your packet. Supply the class to
 * {@link SimpleNetworkWrapper#registerMessage(Class, Class, int, net.minecraftforge.fml.relauncher.Side)}
 ...
 * @param <REPLY> This is the reply type - it is the message you expect to <em>send</em> in reply. You can use IMessage
 *                as the type here

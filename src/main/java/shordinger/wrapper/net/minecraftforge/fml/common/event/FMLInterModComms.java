...
public class FMLInterModComms {
    ...
    public static class IMCEvent extends FMLEvent {
        ...
        public void applyModContainer(ModContainer activeContainer) {
            ...
            FMLLog.log.trace(
                "Attempting to deliver {} IMC messages to mod {}",
                modMessages.get(activeContainer.getModId())
                    .size(),
                activeContainer.getModId());
        }
    ...
    public static final class IMCMessage {
        ...
        public <T, V> Optional<Function<T, V>> getFunctionValue(Class<T> functionFrom, Class<V> functionTo) {
            ...
            try {
                Function<T, V> f = Class.forName((String) value)
                    .asSubclass(Function.class)
                    .newInstance();
                return Optional.of(f);
            } catch (Exception e) {
                FMLLog.log.info(
                    "An error occurred instantiating the IMC function. key: {} value: {}, caller: {}",
                    key,
                    value,
                    sender);
                return Optional.empty();
     ...
     */
    public static void sendRuntimeFunctionMessage(Object sourceMod, String modId, String key,
    ...
    private static boolean enqueueStartupMessage(String modTarget, IMCMessage message) {
        ...
        enqueueMessage(
            ...
            modTarget,
            message);
        return Loader.isModLoaded(modTarget) && !Loader.instance()
            .hasReachedState(LoaderState.POSTINITIALIZATION);
    ...
    private static void enqueueMessage(Object sourceMod, String modTarget, IMCMessage message) {
        ...
        if (sourceMod instanceof ModContainer) {
            ...
            mc = FMLCommonHandler.instance()
                .findContainerFor(sourceMod);
        }

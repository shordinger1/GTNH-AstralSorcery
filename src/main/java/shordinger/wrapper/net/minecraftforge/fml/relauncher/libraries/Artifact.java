...
public class Artifact implements Comparable<Artifact> {
    ...
    public String getFilename() {
        if (this.filename == null) {
            ...
            sb.append(artifact)
                .append('-')
                .append(version);
            if (isSnapshot() && timestamp != null) sb.append('-')
                .append(getTimestamp());
            if (classifier != null) sb.append('-')
                .append(classifier);
            sb.append('.')
                .append(extension);
    ...
    public File getSnapshotMeta() {
        if (!isSnapshot()) throw new IllegalStateException("Attempted to call date suffix on non-snapshot");
        return (repo != null ? repo : LibraryManager.getDefaultRepo())
            .getFile(getFolder() + File.separatorChar + SnapshotJson.META_JSON_FILE);
    }
    ...
    public boolean matchesID(Artifact o) {
        ...
        return group.equals(o.group) && artifact.equals(o.artifact)
            && (o.classifier == null ? classifier == null : o.classifier.equals(classifier)); // TODO: Case sensitive?
    }

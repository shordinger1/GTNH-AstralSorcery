...
public class VersionRange {
    ...
    public static VersionRange createFromVersionSpec(@Nullable String spec) // Forge: Added @Nullable
        ...
        while (process.startsWith("[") || process.startsWith("(")) {
            ...
            if (upperBound != null) {
                if (restriction.getLowerBound() == null || restriction.getLowerBound()
    ...
    private static Restriction parseRestriction(String spec) throws InvalidVersionSpecificationException {
        ...
        String process = spec.substring(1, spec.length() - 1)
            .trim();
        ...
        if (index < 0) {
            ...
            String lowerBound = process.substring(0, index)
                .trim();
            String upperBound = process.substring(index + 1)
                .trim();
    ...
    public static VersionRange createFromVersion(String version, ArtifactVersion existing) // Forge: Added existing
    // argument
    {
    ...
    private List<Restriction> intersection(List<Restriction> r1, List<Restriction> r2) {
        ...
        while (!done) {
            if (res1.getLowerBound() == null || res2.getUpperBound() == null
                || res1.getLowerBound()
                .compareTo(res2.getUpperBound()) <= 0) {
                if (res1.getUpperBound() == null || res2.getLowerBound() == null
                    || res1.getUpperBound()
                    .compareTo(res2.getLowerBound()) >= 0) {
                    ...
                    if (res1.getLowerBound() == null) {
                        ...
                        int comparison = res1.getLowerBound()
                            .compareTo(res2.getLowerBound());
                        if (comparison < 0) {
                            lower = res2.getLowerBound();
                            lowerInclusive = res2.isLowerBoundInclusive();
                    ...
                    if (res1.getUpperBound() == null) {
                        ...
                        int comparison = res1.getUpperBound()
                            .compareTo(res2.getUpperBound());
                        if (comparison < 0) {
                            upper = res1.getUpperBound();
                            upperInclusive = res1.isUpperBoundInclusive();
                        } else if (comparison == 0) {
    ...
    public String toString() {
        if (recommendedVersion != null) {
            ...
            return Joiner.on(',')
                .join(restrictions); // Forge: Changeed from iterator loop to joiner.
        }
    }
    ...
    public boolean isUnboundedAbove() {
        return restrictions.size() == 1 && restrictions.get(0)
            .getUpperBound() == null
            && !restrictions.get(0)

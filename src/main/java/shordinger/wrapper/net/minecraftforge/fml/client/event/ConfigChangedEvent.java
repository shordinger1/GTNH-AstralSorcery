...
package shordinger.wrapper.net.minecraftforge.fml.client.event;
...
public class ConfigChangedEvent extends Event {
    ...
    public ConfigChangedEvent(String modID, @Nullable String configID, boolean isWorldRunning,
     ...
     * 2) the configID field has been set to a non-null value for the GuiConfig screen<br/>
     * <br/>
     * Modders should check the modID field of the event to ensure they are only acting on their own config screen's
     * event!
     */
    public static class OnConfigChangedEvent extends ConfigChangedEvent {

        public OnConfigChangedEvent(String modID, @Nullable String configID, boolean isWorldRunning,
                                    boolean requiresMcRestart) {
    ...
    /**
     * This event is provided for mods to consume if they want to be able to check if other mods' configs have been
     * changed.
    ...
    public static class PostConfigChangedEvent extends ConfigChangedEvent {
        ...
        public PostConfigChangedEvent(String modID, @Nullable String configID, boolean isWorldRunning,
                                      boolean requiresMcRestart) {
            super(modID, configID, isWorldRunning, requiresMcRestart);
        }
    }

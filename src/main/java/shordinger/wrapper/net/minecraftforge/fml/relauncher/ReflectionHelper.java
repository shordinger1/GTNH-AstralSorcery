...
public class ReflectionHelper {
     ...
     * @param fieldObfName The obfuscated name of the field to find (used in obfuscated environments, i.e.
     *                     "maxStackSize").
     ...
     * @param methodObfName  The obfuscated name of the method to find (used in obfuscated environments, i.e.
     *                       "getWorldTime").
     *                       If the name you are looking for is on a class that is never obfuscated, this should be
     *                       null.
    ...
    public static Method findMethod(@Nonnull Class<?> clazz, @Nonnull String methodName, @Nullable String methodObfName,
        ...
        String nameToFind = FMLLaunchHandler.isDeobfuscatedEnvironment() ? methodName
     ...
     */
    @Nonnull
    public static <T> Constructor<T> findConstructor(@Nonnull final Class<T> klass,

...
package shordinger.wrapper.net.minecraftforge.fml.common.discovery.asm;
...
public class ASMModParser {
    ...
    public void beginNewTypeName(String typeQName, int classVersion, String superClassQName, String[] interfaces) {
        ...
        for (String intf : interfaces) this.interfaces.add(intf);
    }

    public void startClassAnnotation(String annotationName) {
        ModAnnotation ann = new ModAnnotation(
            AnnotationType.CLASS,
            Type.getType(annotationName),
            this.asmType.getClassName());
    ...
    public void addAnnotationEnumProperty(String name, String desc, String value) {
        annotations.getFirst()
            .addEnumProperty(name, desc, value);

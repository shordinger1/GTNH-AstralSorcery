...
import shordinger.wrapper.net.minecraftforge.fml.relauncher.FMLRelaunchLog;

/**
 * FMLs logging class. <b>Internal use only, NOT FOR MOD LOGGING!</b> Mods use your own log, see
 * {@link FMLPreInitializationEvent#getModLog()}.

...
public class GuiSelectStringEntries extends GuiListExtended {
    ...
    public static class EntryComparator implements Comparator<Entry<Object, String>> {
        ...
        public int compare(Entry<Object, String> o1, Entry<Object, String> o2) {
            int compare = o1.getValue()
                .toLowerCase(Locale.US)
                .compareTo(
                    o2.getValue()
                        .toLowerCase(Locale.US));

            if (compare == 0) compare = o1.getKey()
                .toString()
                .toLowerCase(Locale.US)
                .compareTo(
                    o2.getKey()
    ...
    protected void elementClicked(int index, boolean doubleClick, int mouseX, int mouseY) {
        selectedIndex = index;
        owningScreen.currentValue = listEntries.get(index)
            .getValue();
    }
    ...
    public void saveChanges() {
        if (owningScreen.slotIndex != -1 && owningScreen.parentScreen != null
            ...
            && ((GuiConfig) owningScreen.parentScreen).entryList
    ...
    public static class ListEntry implements IGuiSelectStringListEntry {
        ...
        public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
            ...
            owningList.mc.fontRenderer
                .drawString(value.getValue(), x + 1, y, slotIndex == owningList.selectedIndex ? 16777215 : 14737632);
        }

...
/**
 * This interface provides the information needed by GuiConfig and GuiConfigEntries to display config elements for
 * editing.
 *
 * @author bspkrs
 */
public interface IConfigElement {
     ...
     * provide a constructor with the following parameter types: {@link GuiConfig}, {@link GuiConfigEntries},
     * {@link IConfigElement}
     *
     ...
     * following parameter types: {@link GuiEditArray}, {@link GuiEditArrayEntries}, {@link IConfigElement},
     * {@link Object}
     *
    ...
    /**
     * [Property, Category] Gets a language key for localization of config GUI entry names. If the same key is specified
     * with .tooltip
     * appended to the end, that key will return a localized tooltip when the mouse hovers over the property
     * label/category button.
     */
    String getLanguageKey();

    /**
     * [Property, Category] Gets the comment for this object. Used for the tooltip if getLanguageKey() + ".tooltip" is
     * not defined in the
     * .lang file.
     */
    String getComment();
    ...
    /**
     * [Property, Category] Whether or not this element is safe to modify while a world is running. For Categories
     * return false if ANY properties
    ...
    /**
     * [Property] Gets this property value as a list. Generally you should be sure of whether the property is a list
     * before calling this.
     */
    Object[] getList();
    ...
    /**
     * [Property] Gets a String array of valid values for this property. This is generally used for String properties to
     * allow the user to
    ...
    /**
     * [Property] Gets a String array of the versions of this property's valid values that will display in the config
     * GUI.

    ...
    public static void inject(ModContainer mod, ASMDataTable data, Side side) {
        ...
        for (ASMDataTable.ASMData targ : targets) {
            try {
                ...
                List<ModAnnotation.EnumHolder> sidesEnum = (List<ModAnnotation.EnumHolder>) targ.getAnnotationInfo()
                    .get("value");
                ...
                if (sides == DEFAULT || sides.contains(side)) {
                    ...
                    String amodid = (String) targ.getAnnotationInfo()
                        .get("modid");
                    ...
                    FMLLog.log.debug(
                        "Registering @EventBusSubscriber for {} for mod {}",
                        targ.getClassName(),
                        mod.getModId());
                ...
                FMLLog.log.error(
                    "An error occurred trying to load an EventBusSubscriber {} for modid {}",
                    targ.getClassName(),
                    mod.getModId(),
                    e);

...
package shordinger.wrapper.net.minecraftforge.fml.common.asm;
...
import shordinger.wrapper.net.minecraftforge.fml.common.asm.transformers.deobf.FMLDeobfuscatingRemapper;
import shordinger.wrapper.net.minecraftforge.fml.common.patcher.ClassPatchManager;
...
public class FMLSanityChecker implements IFMLCallHook {
    ...
    private static final String FMLFINGERPRINT = "51:0A:FB:4C:AF:A4:A0:F2:F5:CF:C5:0E:B4:CC:3C:30:24:4A:E3:8E"
        .toLowerCase()
        .replace(":", "");
    private static final String FORGEFINGERPRINT = "E3:C3:D5:0C:7C:98:6D:F7:4C:64:5C:0A:C5:46:39:74:1C:90:A5:57"
        .toLowerCase()
        .replace(":", "");
    private static final String MCFINGERPRINT = "CD:99:95:96:56:F7:53:DC:28:D8:63:B4:67:69:F7:F8:FB:AE:FC:FC"
        .toLowerCase()
        .replace(":", "");
    ...
    public Void call() throws Exception {
            ...
            if (certificates != null) {
                ...
                for (Certificate cert : certificates) {
                    ...
                    if (fingerprint.equals(FMLFINGERPRINT)) {
                        ...
                        FMLLog.log.info(
                            "Found valid fingerprint for Minecraft Forge. Certificate fingerprint {}",
                            fingerprint);
                        goodFML = true;
                    } else {
        ...
        try {
            ...
            codeSource = cbr.getProtectionDomain()
                .getCodeSource();
        } catch (Exception e) {
        ...
        if (fmlIsJar && !goodMC
            ...
            .equals("jar")) {
            try {
                String mcPath = codeSource.getLocation()
                    .getPath()
                    .substring(5);
                ...
                if (certificates != null) {
                    ...
                    for (Certificate cert : certificates) {
                        ...
                        if (fingerprint.equals(MCFINGERPRINT)) {
                            FMLLog.log
                                .info("Found valid fingerprint for Minecraft. Certificate fingerprint {}", fingerprint);
                            goodMC = true;
                        }
                    }
                }
        ...
        if (!goodMC) {
            FMLLog.log.error(
                "The minecraft jar {} appears to be corrupt! There has been CRITICAL TAMPERING WITH MINECRAFT, it is highly unlikely minecraft will work! STOP NOW, get a clean copy and try again!",
                codeSource.getLocation()
                    .getFile());
            if (!Boolean.parseBoolean(System.getProperty("fml.ignoreInvalidMinecraftCertificates", "false"))) {
                ...
                FMLLog.log.error(
                    "Technical information: ClientBrandRetriever was at {}, there were {} certificates for it",
                    codeSource.getLocation(),
                    certCount);
            }
        }

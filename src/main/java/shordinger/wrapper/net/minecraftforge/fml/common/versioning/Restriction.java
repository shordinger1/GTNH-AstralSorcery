 ...
 */
package shordinger.wrapper.net.minecraftforge.fml.common.versioning;
...
public class Restriction {
    ...
    public Restriction(@Nullable ArtifactVersion lowerBound, boolean lowerBoundInclusive,
                       @Nullable ArtifactVersion upperBound, // Forge: Added @Nullable
    ...
    public String toStringFriendly() {
        if (getLowerBound() == null && getUpperBound() == null) {
            ...
            if (getLowerBound().getVersionString()
                .equals(getUpperBound().getVersionString())) {
                return getLowerBound().getVersionString();
            } else {
                if (isLowerBoundInclusive() && isUpperBoundInclusive()) {
                    return I18n.translateToLocalFormatted(
                        "fml.messages.version.restriction.bounded.inclusive",
                        getLowerBound(),
                        getUpperBound());
                    ...
                    return I18n.translateToLocalFormatted(
                        "fml.messages.version.restriction.bounded.lowerexclusive",
                        getLowerBound(),
                        getUpperBound());
                } else {
                    return I18n.translateToLocalFormatted(
                        "fml.messages.version.restriction.bounded.exclusive",
                        getLowerBound(),
                        getUpperBound());
                }
            }
            ...
            if (isLowerBoundInclusive()) {
                return I18n
                    .translateToLocalFormatted("fml.messages.version.restriction.lower.inclusive", getLowerBound());
            } else {
                return I18n
                    .translateToLocalFormatted("fml.messages.version.restriction.lower.exclusive", getLowerBound());
            }
        } else {
            if (isUpperBoundInclusive()) {
                return I18n
                    .translateToLocalFormatted("fml.messages.version.restriction.upper.inclusive", getUpperBound());
            } else {
                return I18n
                    .translateToLocalFormatted("fml.messages.version.restriction.upper.exclusive", getUpperBound());
            }
        }
    }
}

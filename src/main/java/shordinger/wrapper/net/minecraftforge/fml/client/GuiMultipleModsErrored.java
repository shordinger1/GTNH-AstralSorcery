...
public class GuiMultipleModsErrored extends GuiErrorBase {
    ...
    public void initGui() {
        ...
        for (MissingModsException exception : missingModsExceptions) {
            additionalSize += exception.getMissingModInfos()
                .size() * 10;
        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(
            this.fontRenderer,
            I18n.format(
                "fml.messages.mod.missing.multiple",
                missingModsExceptions.size() + wrongMinecraftExceptions.size()),
            this.width / 2,
            10,
            0xFFFFFF);
    ...
    private class GuiList extends GuiScrollingList {
        ...
        protected void drawSlot(int slotIdx, int entryRight, int slotTop, int slotBuffer, Tessellator tess) {
            ...
            if (!wrongMinecraftExceptions.isEmpty()) {
                renderer.drawString(
                    TextFormatting.UNDERLINE + I18n.format(
                        "fml.messages.mod.wrongminecraft",
                        Loader.instance()
                ...
                for (WrongMinecraftVersionException exception : wrongMinecraftExceptions) {
                    renderer.drawString(
                        I18n.format(
                            "fml.messages.mod.wrongminecraft.requirement",
                            TextFormatting.BOLD + exception.mod.getName() + TextFormatting.RESET,
                            exception.mod.getModId(),
                ...
                offset += 5;
                renderer.drawString(
                    I18n.format("fml.messages.mod.wrongminecraft.fix.multiple"),
                    this.left,
                    offset,
                    0xFFFFFF);
                offset += 20;
            ...
            if (!missingModsExceptions.isEmpty()) {
                renderer.drawString(
                    I18n.format("fml.messages.mod.missing.dependencies.multiple.issues"),
                    this.left,
                    offset,
                    0xFFFFFF);
                offset += 15;
                for (MissingModsException exception : missingModsExceptions) {
                    ...
                    for (MissingModsException.MissingModInfo versionInfo : exception.getMissingModInfos()) {
                        ...
                        if (currentVersion == null) {
                            ...
                            missingReason = I18n.format(
                                "fml.messages.mod.missing.dependencies.you.have",
                        ...
                        if (versionInfo.isRequired()) {
                            ...
                            message = I18n
                                .format("fml.messages.mod.missing.dependencies.compatible.with", versionInfoText);
                        }
                        offset += 10;

...
/**
 * An event driven network channel, using {@link FMLNetworkEvent.CustomPacketEvent} and
 * {@link FMLNetworkEvent.CustomNetworkEvent}
 ...
 * possible to enhance the netty pipeline, and I would expect highly unexpected results if it were modified
 * reflectively.
...
public class FMLEventChannel {
    ...
    private static EventFactory factory = FMLCommonHandler.instance()
        .getSide() == Side.CLIENT ? EventFactory.CLIENT : EventFactory.SERVER;

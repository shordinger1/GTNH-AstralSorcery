...
public interface ILanguageAdapter {
    ...
    public static class ScalaAdapter implements ILanguageAdapter {
        ...
        public Object getNewInstance(FMLModContainer container, Class<?> scalaObjectClass, ClassLoader classLoader,
            ...
            return sObjectClass.getField("MODULE$")
                .get(null);
        }
        ...
        public void setProxy(Field target, Class<?> proxyTarget, Object proxy)
            ...
            // singletons.
            Object targetInstance = proxyTarget.getField("MODULE$")
                .get(null);
            ...
            try {
                ...
                for (Method setter : proxyTarget.getMethods()) {
                    ...
                    if (setterName.equals(setter.getName()) &&
                        ...
                        setterParameters.length == 1 && setterParameters[0].isAssignableFrom(proxy.getClass())) {
                        // Here goes nothing...
            ...
            if (proxyTarget.getName()
                ...
                for (Field target : proxyTarget.getDeclaredFields()) {
                    ...
                    if (target.getAnnotation(SidedProxy.class) != null) {
                        String targetType = side.isClient() ? target.getAnnotation(SidedProxy.class)
                            .clientSide()
                            : target.getAnnotation(SidedProxy.class)
                            .serverSide();
                        try {
                            Object proxy = Class.forName(targetType, true, loader)
                                .newInstance();

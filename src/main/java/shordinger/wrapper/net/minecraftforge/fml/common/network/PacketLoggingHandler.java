...
import shordinger.wrapper.net.minecraft.network.EnumPacketDirection;
import shordinger.wrapper.net.minecraft.network.NettyVarint21FrameDecoder;
import shordinger.wrapper.net.minecraft.network.NettyVarint21FrameEncoder;
...
public class PacketLoggingHandler {
    ...
    public static void register(NetworkManager manager) {
        ChannelPipeline pipeline = manager.channel()
            .pipeline();

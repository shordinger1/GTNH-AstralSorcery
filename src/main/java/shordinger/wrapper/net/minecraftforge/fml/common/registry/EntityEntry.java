...
import shordinger.wrapper.net.minecraftforge.registries.IForgeRegistryEntry.Impl;
...
public class EntityEntry extends Impl<EntityEntry> {
    ...
    public void setEgg(EntityEggInfo egg) {
        this.egg = egg;
        if (this.getRegistryName() != null) EntityList.ENTITY_EGGS.put(this.getRegistryName(), egg);
    }

...
import shordinger.wrapper.net.minecraftforge.fml.client.GuiMultipleModsErrored;
...
public class MultipleModsErrored extends EnhancedRuntimeException implements IDisplayableError {
    ...
    public MultipleModsErrored(List<WrongMinecraftVersionException> wrongMinecraftExceptions,
                               List<MissingModsException> missingModsExceptions) {

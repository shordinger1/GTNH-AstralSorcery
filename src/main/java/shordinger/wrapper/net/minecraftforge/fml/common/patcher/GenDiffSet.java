...
import shordinger.wrapper.net.minecraftforge.fml.repackage.com.nothome.delta.Delta;
...
public class GenDiffSet {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String killTarget = args[4]; // "true" if we should destroy the target file if it generated a successful
        // .binpatch
        ...
        for (String name : remapper.getObfedClasses()) {
            ...
            if (targetFile.exists()) {
                ...
                String targetClassName = remapper.map(name)
                    .replace('/', '.');

...
import shordinger.wrapper.net.minecraftforge.fml.common.IFMLHandledException;
...
public abstract class CustomModLoadingErrorDisplayException extends EnhancedRuntimeException
    implements IFMLHandledException, IDisplayableError {
     ...
     * <p>
     * <br/>
     * <em>Warning: Minecraft is in a deep error state.</em> <strong>All</strong> it can do is stop.
     ...
     */
    public abstract void drawScreen(GuiErrorScreen errorScreen, FontRenderer fontRenderer, int mouseRelX, int mouseRelY,
                                    float tickTime);
    ...
    ; // Do Nothing unless the modder wants
    // to.

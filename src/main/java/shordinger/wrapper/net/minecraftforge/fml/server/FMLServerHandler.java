...
package shordinger.wrapper.net.minecraftforge.fml.server;
...
import shordinger.wrapper.net.minecraft.server.dedicated.PendingCommand;
...
public class FMLServerHandler implements IFMLSidedHandler {
    ...
    private FMLServerHandler() {
        injectedModContainers = FMLCommonHandler.instance()
            .beginLoading(this);
    }
    ...
    public void addModAsResource(ModContainer container) {
        String langFile = "assets/" + container.getModId()
            .toLowerCase() + "/lang/en_us.lang";
        String langFile2 = "assets/" + container.getModId()
            .toLowerCase() + "/lang/en_US.lang";
        ...
        try {
            ...
            if (stream != null) LanguageMap.inject(stream);

...
import shordinger.wrapper.net.minecraftforge.items.wrapper.PlayerMainInvWrapper;
...
public class ItemHandlerHelper {
    ...
    public static boolean canItemStacksStack(@Nonnull ItemStack a, @Nonnull ItemStack b) {
        if (a.isEmpty() || !a.isItemEqual(b) || a.hasTagCompound() != b.hasTagCompound()) return false;

        return (!a.hasTagCompound() || a.getTagCompound()
            .equals(b.getTagCompound())) && a.areCapsCompatible(b);
    }
        ...
        if (inv == null) {
            ...
            for (int j = 0; j < inv.getSlots(); ++j) {
                ...
                if (!itemstack.isEmpty()) {
                    proportion += (float) itemstack.getCount()

...
package shordinger.wrapper.net.minecraftforge.items;
...
public class VanillaDoubleChestItemHandler extends WeakReference<TileEntityChest> implements IItemHandlerModifiable {
    ...
    public static final VanillaDoubleChestItemHandler NO_ADJACENT_CHESTS_INSTANCE = new VanillaDoubleChestItemHandler(
        null,
        null,
        false);
    ...
    public VanillaDoubleChestItemHandler(@Nullable TileEntityChest mainChest, @Nullable TileEntityChest other,
    ...
    public static VanillaDoubleChestItemHandler get(TileEntityChest chest) {
        ...
        if (world == null || pos == null || !world.isBlockLoaded(pos)) return null; // Still loading
            ...
            if (block == blockType) {
                ...
                if (otherTE instanceof TileEntityChest) {
                    ...
                    return new VanillaDoubleChestItemHandler(
                        chest,
                        otherChest,
                        enumfacing != net.minecraft.util.EnumFacing.WEST
    ...
    public TileEntityChest getChest(boolean accessingUpper) {
        if (accessingUpper == mainChestIsUpper) return mainChest;
        else {
    ...
    public ItemStack insertItem(int slot, @Nonnull ItemStack stack, boolean simulate) {
        ...
        ItemStack ret = chest.getSingleChestHandler()
            .insertItem(targetSlot, stack, simulate);
    ...
    public ItemStack extractItem(int slot, int amount, boolean simulate) {
        ...
        ItemStack ret = chest.getSingleChestHandler()
            .extractItem(targetSlot, amount, simulate);
    ...
    public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
        ...
        TileEntityChest chest = getChest(accessingUpperChest);
        if (chest != null) {
            return chest.getSingleChestHandler()
                .isItemValid(targetSlot, stack);
        }
        return true;
    }
    ...
    public boolean needsRefresh() {
        if (this == NO_ADJACENT_CHESTS_INSTANCE) return false;
        TileEntityChest tileEntityChest = get();

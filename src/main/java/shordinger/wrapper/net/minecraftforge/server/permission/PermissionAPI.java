...
package shordinger.wrapper.net.minecraftforge.server.permission;
...
import shordinger.wrapper.net.minecraftforge.server.permission.context.IContext;
import shordinger.wrapper.net.minecraftforge.server.permission.context.PlayerContext;
...
public class PermissionAPI {
    ...
    public static void setPermissionHandler(IPermissionHandler handler) {
        ...
        Preconditions.checkState(
            Loader.instance()
                .getLoaderState()
                .ordinal() <= LoaderState.PREINITIALIZATION.ordinal(),
     ...
     *
     * @param node  Permission node, best if it's lowercase and contains '.' (e.g.
     *              <code>"modid.subgroup.permission_id"</code>)
    ...
    public static String registerNode(String node, DefaultPermissionLevel level, String desc) {
        ...
        Preconditions.checkState(
            Loader.instance()
                .getLoaderState()
                .ordinal() > LoaderState.PREINITIALIZATION.ordinal(),
            "Can't register permission nodes before Init!");

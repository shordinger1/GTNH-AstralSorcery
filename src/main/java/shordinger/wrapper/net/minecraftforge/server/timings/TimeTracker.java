...
package shordinger.wrapper.net.minecraftforge.server.timings;
...
/**
 * A class to assist in the collection of data to measure the update times of ticking objects {currently Tile Entities
 * and Entities}
 *
 * @param <T>
 */
public class TimeTracker<T> {
    ...
    private Map<T, int[]> timings = new MapMaker().weakKeys()
        .makeMap();

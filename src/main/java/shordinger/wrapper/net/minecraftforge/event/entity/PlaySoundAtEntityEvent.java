 ...
 * {@link EntityPlayerSP#playSound(SoundEvent, float, float)} and
 * {@link World#playSound(EntityPlayer, double, double, double, SoundEvent, SoundCategory, float, float)}.<br>
 * <br>
 ...
 * Changing the {@link #name} field will cause the sound of this name to be played instead of the originally intended
 * sound.<br>
 * <br>

...
public class ZombieEvent extends EntityEvent {
     ...
     * {@link ForgeEventFactory#fireZombieSummonAid(EntityZombie, World, int, int, int, EntityLivingBase, double)}.
     * <p>
    ...
    public static class SummonAidEvent extends ZombieEvent {
        ...
        public SummonAidEvent(EntityZombie entity, World world, int x, int y, int z, EntityLivingBase attacker,
                              double summonChance) {
            super(entity);
            this.world = world;
            this.x = x;

 ...
 * {@link ForgeHooks#onLivingDrops(EntityLivingBase, DamageSource, ArrayList, int, boolean)}.<br>
 * <br>
...
public class LivingDropsEvent extends LivingEvent {
    ...
    public LivingDropsEvent(EntityLivingBase entity, DamageSource source, List<EntityItem> drops, int lootingLevel,
                            boolean recentlyHit) {
        super(entity);
        this.source = source;
        this.drops = drops;

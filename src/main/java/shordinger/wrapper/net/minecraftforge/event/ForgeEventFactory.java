...
import shordinger.wrapper.net.minecraft.block.BlockPortal;
...
import shordinger.wrapper.net.minecraft.entity.player.EntityPlayer.SleepResult;
import shordinger.wrapper.net.minecraft.entity.projectile.EntityArrow;
import shordinger.wrapper.net.minecraft.entity.projectile.EntityFireball;
...
import shordinger.wrapper.net.minecraft.village.Village;
...
import shordinger.wrapper.net.minecraft.world.storage.IPlayerFileData;
...
import shordinger.wrapper.net.minecraftforge.client.event.ClientChatEvent;
import shordinger.wrapper.net.minecraftforge.client.event.ClientChatReceivedEvent;
import shordinger.wrapper.net.minecraftforge.client.event.RenderBlockOverlayEvent;
import shordinger.wrapper.net.minecraftforge.client.event.RenderBlockOverlayEvent.OverlayType;
...
import shordinger.wrapper.net.minecraftforge.event.brewing.PlayerBrewedPotionEvent;
import shordinger.wrapper.net.minecraftforge.event.brewing.PotionBrewEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.EntityEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.EntityMobGriefingEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.EntityMountEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.EntityStruckByLightningEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.PlaySoundAtEntityEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.ProjectileImpactEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.ThrowableImpactEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.item.ItemExpireEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.AnimalTameEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingDestroyBlockEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingEntityUseItemEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingExperienceDropEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingHealEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingPackSizeEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingSpawnEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.living.LivingSpawnEvent.AllowDespawn;
import shordinger.wrapper.net.minecraftforge.event.entity.living.ZombieEvent.SummonAidEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.ArrowLooseEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.ArrowNockEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.BonemealEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.EntityItemPickupEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.FillBucketEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.ItemTooltipEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerDestroyItemEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerDropsEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerFlyableFallEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerSetSpawnEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerSleepInBedEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.PlayerWakeUpEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.SleepingLocationCheckEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.SleepingTimeCheckEvent;
import shordinger.wrapper.net.minecraftforge.event.entity.player.UseHoeEvent;
import shordinger.wrapper.net.minecraftforge.event.furnace.FurnaceFuelBurnTimeEvent;
import shordinger.wrapper.net.minecraftforge.event.terraingen.ChunkGeneratorEvent;
import shordinger.wrapper.net.minecraftforge.event.terraingen.PopulateChunkEvent;
import shordinger.wrapper.net.minecraftforge.event.village.MerchantTradeOffersEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.CreateFluidSourceEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.EntityMultiPlaceEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.EntityPlaceEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.MultiPlaceEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.NeighborNotifyEvent;
import shordinger.wrapper.net.minecraftforge.event.world.BlockEvent.PlaceEvent;
import shordinger.wrapper.net.minecraftforge.event.world.ExplosionEvent;
import shordinger.wrapper.net.minecraftforge.event.world.GetCollisionBoxesEvent;
import shordinger.wrapper.net.minecraftforge.event.world.WorldEvent;
import shordinger.wrapper.net.minecraftforge.fml.common.ObfuscationReflectionHelper;
...
public class ForgeEventFactory {
    ...
    public static EntityMultiPlaceEvent onMultiBlockPlace(@Nullable Entity entity, List<BlockSnapshot> blockSnapshots,
        ...
        IBlockState placedAgainst = snap.getWorld()
            .getBlockState(
                snap.getPos()
    ...
    public static MultiPlaceEvent onPlayerMultiBlockPlace(EntityPlayer player, List<BlockSnapshot> blockSnapshots,
                                                          EnumFacing direction, EnumHand hand) {
        BlockSnapshot snap = blockSnapshots.get(0);
        IBlockState placedAgainst = snap.getWorld()
            .getBlockState(
                snap.getPos()
    ...
    public static EntityPlaceEvent onBlockPlace(@Nullable Entity entity, @Nonnull BlockSnapshot blockSnapshot,
                                                @Nonnull EnumFacing direction) {
        IBlockState placedAgainst = blockSnapshot.getWorld()
            .getBlockState(
    ...
    public static PlaceEvent onPlayerBlockPlace(@Nonnull EntityPlayer player, @Nonnull BlockSnapshot blockSnapshot,
                                                @Nonnull EnumFacing direction, @Nonnull EnumHand hand) {
        IBlockState placedAgainst = blockSnapshot.getWorld()
            .getBlockState(
                blockSnapshot.getPos()
                    .offset(direction.getOpposite()));
    ...
    public static NeighborNotifyEvent onNeighborNotify(World world, BlockPos pos, IBlockState state,
    ...
    public static Result canEntitySpawn(EntityLiving entity, World world, float x, float y, float z,
        ...
        LivingSpawnEvent.CheckSpawn event = new LivingSpawnEvent.CheckSpawn(entity, world, x, y, z, isSpawner); // TODO:
        // replace
        // isSpawner
        // with
        // null
    ...
    @Nullable
    public static List<Biome.SpawnListEntry> getPotentialSpawns(WorldServer world, EnumCreatureType type, BlockPos pos,
                                                                List<Biome.SpawnListEntry> oldList) {
    ...
    public static int getMaxSpawnPackSize(EntityLiving entity) {
        ...
        return maxCanSpawnEvent.getResult() == Result.ALLOW ? maxCanSpawnEvent.getMaxPackSize()
    ...
    public static float fireBlockHarvesting(List<ItemStack> drops, World world, BlockPos pos, IBlockState state,
                                            int fortune, float dropChance, boolean silkTouch, EntityPlayer player) {
    ...
    public static IBlockState fireFluidPlaceBlockEvent(World world, BlockPos pos, BlockPos liquidPos,
                                                       IBlockState state) {
    ...
    public static ItemTooltipEvent onItemTooltip(ItemStack itemStack, @Nullable EntityPlayer entityPlayer,
                                                 List<String> toolTip, ITooltipFlag flags) {
        ItemTooltipEvent event = new ItemTooltipEvent(itemStack, entityPlayer, toolTip, flags);
        MinecraftForge.EVENT_BUS.post(event);
        return event;
    }

    public static SummonAidEvent fireZombieSummonAid(EntityZombie zombie, World world, int x, int y, int z,
                                                     EntityLivingBase attacker, double summonChance) {
    ...
    public static int onApplyBonemeal(@Nonnull EntityPlayer player, @Nonnull World world, @Nonnull BlockPos pos,
                                      @Nonnull IBlockState state, @Nonnull ItemStack stack, @Nullable EnumHand hand) {
    ...
    @Nullable
    public static ActionResult<ItemStack> onBucketUse(@Nonnull EntityPlayer player, @Nonnull World world,
        ...
        if (event.getResult() == Result.ALLOW) {
            ...
            stack.shrink(1);
            if (stack.isEmpty()) return new ActionResult<ItemStack>(EnumActionResult.SUCCESS, event.getFilledBucket());
    ...
    public static PlaySoundAtEntityEvent onPlaySoundAtEntity(Entity entity, SoundEvent name, SoundCategory category,
    ...
    public static int onItemExpire(EntityItem entity, @Nonnull ItemStack item) {
        ...
        ItemExpireEvent event = new ItemExpireEvent(
            ...
            (item.isEmpty() ? 6000
                : item.getItem()
                .getEntityLifespan(item, entity.world)));
        if (!MinecraftForge.EVENT_BUS.post(event)) return -1;
    ...
    public static void onPlayerDrops(EntityPlayer player, DamageSource cause, List<EntityItem> capturedDrops,
                                     boolean recentlyHit) {
    ...
    public static boolean canMountEntity(Entity entityMounting, Entity entityBeingMounted, boolean isMounting) {
        boolean isCanceled = MinecraftForge.EVENT_BUS
            .post(new EntityMountEvent(entityMounting, entityBeingMounted, entityMounting.world, isMounting));

        if (isCanceled) {
            entityMounting.setPositionAndRotation(
                entityMounting.posX,
                entityMounting.posY,
                entityMounting.posZ,
                entityMounting.prevRotationYaw,
    ...
    public static void onPlayerWakeup(EntityPlayer player, boolean wakeImmediately, boolean updateWorldFlag,
                                      boolean setSpawn) {
    ...
    public static void onPlayerClone(EntityPlayer player, EntityPlayer oldPlayer, boolean wasDeath) {
        MinecraftForge.EVENT_BUS
            .post(new net.minecraftforge.event.entity.player.PlayerEvent.Clone(player, oldPlayer, wasDeath));
    }
    ...
    public static boolean renderBlockOverlay(EntityPlayer player, float renderPartialTicks, OverlayType type,
    ...
    public static boolean fireSleepingLocationCheck(EntityPlayer player, BlockPos sleepingLocation) {
        ...
        if (canContinueSleep == Result.DEFAULT) {
            ...
            return state.getBlock()
                .isBed(state, player.world, player.bedLocation, player);
    ...
    public static boolean fireSleepingTimeCheck(EntityPlayer player, BlockPos sleepingLocation) {
        ...
        Result canContinueSleep = evt.getResult();
        if (canContinueSleep == Result.DEFAULT) return !player.world.isDaytime();
        else return canContinueSleep == Result.ALLOW;
    }

    public static ActionResult<ItemStack> onArrowNock(ItemStack item, World world, EntityPlayer player, EnumHand hand,
                                                      boolean hasAmmo) {
    ...
    public static void onChunkPopulate(boolean pre, IChunkGenerator gen, World world, Random rand, int x, int z,
                                       boolean hasVillageGenerated) {
        MinecraftForge.EVENT_BUS.post(
            pre ? new PopulateChunkEvent.Pre(gen, world, rand, x, z, hasVillageGenerated)
                : new PopulateChunkEvent.Post(gen, world, rand, x, z, hasVillageGenerated));
    }
    ...
    public static boolean onTrySpawnPortal(World world, BlockPos pos, BlockPortal.Size size) {
        return MinecraftForge.EVENT_BUS
            .post(new BlockEvent.PortalSpawnEvent(world, pos, world.getBlockState(pos), size));
    }

    public static int onEnchantmentLevelSet(World world, BlockPos pos, int enchantRow, int power, ItemStack itemStack,
                                            int level) {
        net.minecraftforge.event.enchanting.EnchantmentLevelSetEvent e = new net.minecraftforge.event.enchanting.EnchantmentLevelSetEvent(
            world,
            pos,
            enchantRow,
            power,
    ...
    public static boolean gatherCollisionBoxes(World world, Entity entity, AxisAlignedBB aabb,
    ...
    public static boolean getMobGriefingEvent(World world, Entity entity) {
        ...
        return result == Result.DEFAULT ? world.getGameRules()
            .getBoolean("mobGriefing") : result == Result.ALLOW;
    }
    ...
    public static MerchantRecipeList listTradeOffers(IMerchant merchant, EntityPlayer player,
                                                     @Nullable MerchantRecipeList list) {

...
import shordinger.wrapper.net.minecraft.world.gen.NoiseGeneratorOctaves;
import shordinger.wrapper.net.minecraft.world.gen.NoiseGeneratorPerlin;
import shordinger.wrapper.net.minecraft.world.gen.NoiseGeneratorSimplex;
...
public class InitNoiseGensEvent<T extends InitNoiseGensEvent.Context> extends WorldEvent {
    ...
    public static class ContextOverworld extends Context {
        ...
        public ContextOverworld(NoiseGeneratorOctaves lperlin1, NoiseGeneratorOctaves lperlin2,
                                NoiseGeneratorOctaves perlin, NoiseGeneratorPerlin height, NoiseGeneratorOctaves scale,
                                NoiseGeneratorOctaves depth, NoiseGeneratorOctaves forest) {
    ...
    public static class ContextHell extends Context {
        ...
        public ContextHell(NoiseGeneratorOctaves lperlin1, NoiseGeneratorOctaves lperlin2, NoiseGeneratorOctaves perlin,
                           NoiseGeneratorOctaves perlin2, NoiseGeneratorOctaves perlin3, NoiseGeneratorOctaves scale,

...
public class PlayerInteractEvent extends PlayerEvent {
     ...
     * <p>
     * Let result be the return value of {@link Entity#applyPlayerInteraction}, or {@link #cancellationResult} if the
     * event is cancelled.
     * If we are on the client and result is not {@link EnumActionResult#SUCCESS}, the client will then try
     * {@link EntityInteract}.
     */
    @Cancelable
     ...
     * <p>
     * This event is fired only if the result of the above {@link EntityInteractSpecific} is not
     * {@link EnumActionResult#SUCCESS}.
     * This event's state affects whether {@link Entity#processInitialInteract} and
     * {@link net.minecraft.item.Item#itemInteractionForEntity} are called.
     * <p>
     * Let result be {@link EnumActionResult#SUCCESS} if {@link Entity#processInitialInteract} or
     * {@link net.minecraft.item.Item#itemInteractionForEntity} return true,
     ...
     * This event controls which of {@link net.minecraft.block.Block#onBlockActivated} and/or
     * {@link net.minecraft.item.Item#onItemUse}
     ...
     * <p>
     * Let result be a return value of the above three methods, or {@link #cancellationResult} if the event is
     * cancelled.
     * If we are on the client and result is not {@link EnumActionResult#SUCCESS}, the client will then try
     * {@link RightClickItem}.
     * <p>
    ...
    public static class RightClickBlock extends PlayerInteractEvent {
        ...
        /**
         * @return If {@link net.minecraft.item.Item#onItemUseFirst} and {@link net.minecraft.item.Item#onItemUse}
         * should be called
         */
         ...
         * DEFAULT: Default behaviour (sneak will not use block, unless all items return true in
         * {@link net.minecraft.item.Item#doesSneakBypassUse}).
     ...
     * Note that this is NOT fired if the player is targeting a block {@link RightClickBlock} or entity
     * {@link EntityInteract} {@link EntityInteractSpecific}.
     * <p>
     * Let result be the return value of {@link net.minecraft.item.Item#onItemRightClick}, or
     * {@link #cancellationResult} if the event is cancelled.
     * If we are on the client and result is not {@link EnumActionResult#SUCCESS}, the client will then continue to
     * other hands.
     */
    @Cancelable
     ...
     * The server is not aware of when the client right clicks empty space with an empty hand, you will need to tell the
     * server yourself.
     ...
     * This event controls which of {@link net.minecraft.block.Block#onBlockClicked} and/or the item harvesting methods
     * will be called
    ...
    public static class LeftClickBlock extends PlayerInteractEvent {
        ...
        /**
         * @return If {@link net.minecraft.block.Block#onBlockClicked} should be called. Changing this has no effect in
         * creative mode
         */
        public Result getUseBlock() {
            return useBlock;
        ...
        /**
         * @return If the block should be attempted to be mined with the current item. Changing this has no effect in
         * creative mode
         */
        public Result getUseItem() {
            return useItem;
    ...
    /**
     * @return The effective, i.e. logical, side of this interaction. This will be {@link Side#CLIENT} on the client
     * thread, and {@link Side#SERVER} on the server thread.
     */
    public Side getSide() {
    ...
    /**
     * @return The EnumActionResult that will be returned to vanilla if the event is cancelled, instead of calling the
     * relevant
     * method of the event. By default, this is {@link EnumActionResult#PASS}, meaning cancelled events will
     * cause
    ...
    /**
     * Set the EnumActionResult that will be returned to vanilla if the event is cancelled, instead of calling the
     * relevant
     * method of the event.
     * Note that this only has an effect on {@link RightClickBlock}, {@link RightClickItem}, {@link EntityInteract}, and
     * {@link EntityInteractSpecific}.
     */

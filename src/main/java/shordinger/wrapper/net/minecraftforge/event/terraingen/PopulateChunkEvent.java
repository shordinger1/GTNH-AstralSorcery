 ...
 * <br>
 * All children of this event are fired on the {@link MinecraftForge#EVENT_BUS}, except {@link Populate}, which fires on
 * the {@link MinecraftForge#TERRAIN_GEN_BUS}.<br>
 **/
public class PopulateChunkEvent extends ChunkGeneratorEvent {
    ...
    public PopulateChunkEvent(IChunkGenerator gen, World world, Random rand, int chunkX, int chunkZ,
    ...
    public static class Post extends PopulateChunkEvent {
        ...
        public Post(IChunkGenerator chunkProvider, World world, Random rand, int chunkX, int chunkZ,
                    boolean hasVillageGenerated) {
    ...
    public static class Populate extends PopulateChunkEvent {
        ...
        public Populate(IChunkGenerator gen, World world, Random rand, int chunkX, int chunkZ,
                        boolean hasVillageGenerated, EventType type) {
            super(gen, world, rand, chunkX, chunkZ, hasVillageGenerated);
            this.type = type;
        }
    }

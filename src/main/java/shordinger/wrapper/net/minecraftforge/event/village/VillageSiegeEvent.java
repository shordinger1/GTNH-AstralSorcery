...
package shordinger.wrapper.net.minecraftforge.event.village;
...
public class VillageSiegeEvent extends Event {
    ...
    public VillageSiegeEvent(VillageSiege siege, World world, EntityPlayer player, Village village,

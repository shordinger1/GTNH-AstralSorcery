...
public class LivingSpawnEvent extends LivingEvent {
    ...
    public static class CheckSpawn extends LivingSpawnEvent {
        ...
        public CheckSpawn(EntityLiving entity, World world, float x, float y, float z,
                          @Nullable MobSpawnerBaseLogic spawner) {
     ...
     * {@link ForgeEventFactory#doSpecialSpawn(EntityLiving, World, float, float, float)}.<br>
     * <br>
    ...
    public static class SpecialSpawn extends LivingSpawnEvent {
        ...
        /**
         * @deprecated Use
         * {@link SpecialSpawn#SpecialSpawn(EntityLiving, World, float, float, float, MobSpawnerBaseLogic)}
        ...
        /**
         * @param spawner the position of a tileentity or approximate position of an entity that initiated the spawn if
         *                any
         */
        public SpecialSpawn(EntityLiving entity, World world, float x, float y, float z,
                            @Nullable MobSpawnerBaseLogic spawner) {

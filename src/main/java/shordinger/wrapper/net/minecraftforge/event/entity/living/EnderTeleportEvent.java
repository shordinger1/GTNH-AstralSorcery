...
/**
 * Event for when an Enderman/Shulker teleports or an ender pearl is used. Can be used to either modify the target
 * position, or cancel the teleport outright.
 *
 * @author Mithion
 */
@Cancelable
public class EnderTeleportEvent extends LivingEvent {
    ...
    public EnderTeleportEvent(EntityLivingBase entity, double targetX, double targetY, double targetZ,
                              float attackDamage) {
        super(entity);

...
package shordinger.wrapper.net.minecraftforge.event.furnace;
...
public class FurnaceFuelBurnTimeEvent extends Event {
     ...
     * A value of -1 will let vanilla decide on the fuel value, this is the default for
     * {@link Item#getItemBurnTime(ItemStack)}.
     */

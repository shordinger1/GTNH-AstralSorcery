...
import shordinger.wrapper.net.minecraftforge.fluids.capability.wrappers.FluidBucketWrapper;
...
public class UniversalBucket extends Item {
    ...
    public void onFillBucket(FillBucketEvent event) {
        ...
        FluidActionResult filledResult = FluidUtil
            .tryPickUpFluid(singleBucket, event.getEntityPlayer(), world, pos, target.sideHit);

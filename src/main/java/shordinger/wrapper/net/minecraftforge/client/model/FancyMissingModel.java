...
final class FancyMissingModel implements IModel {
    ...
    private static final TRSRTransformation smallTransformation = TRSRTransformation
    ...
    private static final LoadingCache<VertexFormat, SimpleModelFontRenderer> fontCache = CacheBuilder.newBuilder()
        .maximumSize(3)
        .build(new CacheLoader<VertexFormat, SimpleModelFontRenderer>() {
    ...
    public IBakedModel bake(IModelState state, VertexFormat format,
        ...
        return new BakedModel(
            bigMissing,
            smallMissing,
            fontCache.getUnchecked(format),
            message,
            bakedTextureGetter.apply(font2));
    }
    ...
    static final class BakedModel implements IBakedModel {
        ...
        public BakedModel(IBakedModel bigMissing, IBakedModel smallMissing, SimpleModelFontRenderer fontRenderer,
                          String message, TextureAtlasSprite fontTexture) {
        ...
        public BakedModel(IBakedModel smallMissing, SimpleModelFontRenderer fontRenderer, String message,
                          TextureAtlasSprite fontTexture, BakedModel big) {
                ...
                if (quads == null) {
                    ...
                    for (int y = 0; y < splitLines.size(); y++) {
                        fontRenderer.drawString(
                            splitLines.get(y),
                            0,
                            (int) ((y - splitLines.size() / 2f) * fontRenderer.FONT_HEIGHT) + 0x40,
                            0xFF00FFFF);
                    }
        ...
        public Pair<? extends IBakedModel, Matrix4f> handlePerspective(
            ...
            switch (cameraTransformType) {
                ...
                case FIRST_PERSON_LEFT_HAND:
                    transform = new TRSRTransformation(
                        new Vector3f(-0.62f, 0.5f, -.5f),
                        new Quat4f(1, -1, -1, 1),
                        null,
                        null);
                    big = false;

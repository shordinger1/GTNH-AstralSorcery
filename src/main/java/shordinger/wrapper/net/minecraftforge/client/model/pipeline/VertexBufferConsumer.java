...
public class VertexBufferConsumer implements IVertexConsumer {
    ...
    public void put(int e, float... data) {
        ...
        if (renderer.isColorDisabled() && format.getElement(e)
    ...
    private void checkVertexFormat() {
        if (quadData == null || renderer.getVertexFormat()
            .getSize() != quadData.length) {
            quadData = new int[renderer.getVertexFormat()
                .getSize()];
        }
    }

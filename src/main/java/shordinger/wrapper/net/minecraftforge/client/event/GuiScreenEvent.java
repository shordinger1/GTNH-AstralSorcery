...
public class GuiScreenEvent extends Event {
    ...
    public static class InitGuiEvent extends GuiScreenEvent {
         ...
         * {@link GuiScreen#width}, and {@link GuiScreen#height}.<br/>
         * <br/>
         * <p>
         * If canceled the following lines are skipped in
         * {@link GuiScreen#setWorldAndResolution(Minecraft, int, int)}:<br/>
    ...
    public static class MouseInputEvent extends GuiScreenEvent {
         ...
         * Cancel this event when you successfully use the mouse input to prevent other handlers from using the same
         * input.
         */
        @Cancelable

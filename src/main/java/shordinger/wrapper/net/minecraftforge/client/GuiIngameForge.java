...
import shordinger.wrapper.net.minecraft.client.gui.GuiOverlayDebug;
...
import shordinger.wrapper.net.minecraftforge.client.event.RenderGameOverlayEvent.ElementType;
...
public class GuiIngameForge extends GuiIngame {
    ...
    public void renderGameOverlay(float partialTicks) {
        ...
        if (scoreplayerteam != null) {
            int slot = scoreplayerteam.getColor()
                .getColorIndex();
    ...
    public void renderFood(int width, int height) {
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            if (player.getFoodStats()
                .getSaturationLevel() <= 0.0F && updateCounter % (level * 3 + 1) == 0) {
    ...
    protected void renderToolHighlight(ScaledResolution res) {
        if (this.mc.gameSettings.heldItemTooltips && !this.mc.playerController.isSpectator()) {
            ...
            if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty()) {
                ...
                name = this.highlightingItemStack.getItem()
                    .getHighlightTip(this.highlightingItemStack, name);
                ...
                if (opacity > 0) {
                    ...
                    GlStateManager.tryBlendFuncSeparate(
                        ...
                        GlStateManager.SourceFactor.ONE,
                        GlStateManager.DestFactor.ZERO);
                    FontRenderer font = highlightingItemStack.getItem()
                        .getFontRenderer(highlightingItemStack);
                    if (font != null) {
        ...
        if (overlayMessageTime > 0) {
            ...
            if (opacity > 0) {
                ...
                fontrenderer.drawString(
                    overlayMessage,
                    -fontrenderer.getStringWidth(overlayMessage) / 2,
                    -4,
                    color | (opacity << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
        ...
        if (titlesTimer > 0) {
            ...
            if (opacity > 8) {
                ...
                this.getFontRenderer()
                    .drawString(
                        this.displayedTitle,
                        (float) (-this.getFontRenderer()
                            .getStringWidth(this.displayedTitle) / 2),
                        -10.0F,
                        16777215 | l,
                        true);
                GlStateManager.popMatrix();
                ...
                this.getFontRenderer()
                    .drawString(
                        ...
                        (float) (-this.getFontRenderer()
                            .getStringWidth(this.displayedSubTitle) / 2),
                        5.0F,
                        16777215 | l,
                        true);
                GlStateManager.popMatrix();
    ...
    protected void renderPlayerList(int width, int height) {
        ScoreObjective scoreobjective = this.mc.world.getScoreboard()
        ...
        if (mc.gameSettings.keyBindPlayerList.isKeyDown()
            && (!mc.isIntegratedServerRunning() || handler.getPlayerInfoMap()
            .size() > 1 || scoreobjective != null)) {
    ...
    private class GuiOverlayDebugForge extends GuiOverlayDebug {
        ...
        private List<String> getLeft() {
            ...
            ret.add("");
            ret.add(
                "Debug: Pie [shift]: " + (this.mc.gameSettings.showDebugProfilerChart ? "visible" : "hidden")
                    + " FPS [alt]: "

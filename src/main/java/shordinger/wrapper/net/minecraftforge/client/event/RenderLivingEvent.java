...
public abstract class RenderLivingEvent<T extends EntityLivingBase> extends Event {
    ...
    public RenderLivingEvent(EntityLivingBase entity, RenderLivingBase<T> renderer, float partialRenderTick, double x,
                             double y, double z) {
        this.entity = entity;
    ...
    public static class Pre<T extends EntityLivingBase> extends RenderLivingEvent<T> {
        ...
        public Pre(EntityLivingBase entity, RenderLivingBase<T> renderer, float partialRenderTick, double x, double y,
                   double z) {
    ...
    public static class Post<T extends EntityLivingBase> extends RenderLivingEvent<T> {
        ...
        public Post(EntityLivingBase entity, RenderLivingBase<T> renderer, float partialRenderTick, double x, double y,
                    double z) {
            super(entity, renderer, partialRenderTick, x, y, z);
        }
    }

...
public class CloudRenderer implements ISelectiveResourceReloadListener {
    ...
    private void vertices(BufferBuilder buffer) {
        ...
        while (sectX1 < sectEnd) {
            ...
            if (sectX1 > sectEnd) sectX1 = sectEnd;
            ...
            while (sectZ1 < sectEnd) {
                ...
                if (sectZ1 > sectEnd) sectZ1 = sectEnd;
                ...
                // Bottom
                buffer.pos(sectX0, 0, sectZ0)
                    .tex(u0, v0)
                    .color(bCol, bCol, bCol, ALPHA)
                    .endVertex();
                buffer.pos(sectX1, 0, sectZ0)
                    .tex(u1, v0)
                    .color(bCol, bCol, bCol, ALPHA)
                    .endVertex();
                buffer.pos(sectX1, 0, sectZ1)
                    .tex(u1, v1)
                    .color(bCol, bCol, bCol, ALPHA)
                    .endVertex();
                buffer.pos(sectX0, 0, sectZ1)
                    .tex(u0, v1)
                    .color(bCol, bCol, bCol, ALPHA)
                    .endVertex();
                ...
                if (fancy) {
                    ...
                    buffer.pos(sectX0, HEIGHT, sectZ0)
                        ...
                        .color(1, 1, 1, ALPHA)
                        .endVertex();
                    buffer.pos(sectX0, HEIGHT, sectZ1)
                        .tex(u0, v1)
                        .color(1, 1, 1, ALPHA)
                        .endVertex();
                    buffer.pos(sectX1, HEIGHT, sectZ1)
                        .tex(u1, v1)
                        .color(1, 1, 1, ALPHA)
                        .endVertex();
                    ...
                    for (slice = sectX0; slice < sectX1; ) {
                        ...
                        if (slice > -CULL_DIST) {
                            slice += INSET;
                            buffer.pos(slice, 0, sectZ1)
                                .tex(sliceCoord0, v1)
                                .color(0.9F, 0.9F, 0.9F, ALPHA)
                                .endVertex();
                            buffer.pos(slice, HEIGHT, sectZ1)
                                .tex(sliceCoord1, v1)
                                .color(0.9F, 0.9F, 0.9F, ALPHA)
                                .endVertex();
                    ...
                    for (slice = sectZ0; slice < sectZ1; ) {
                        ...
                        if (slice > -CULL_DIST) {
                            slice += INSET;
                            buffer.pos(sectX0, 0, slice)
                                .tex(u0, sliceCoord0)
                                .color(0.8F, 0.8F, 0.8F, ALPHA)
                                .endVertex();
                            buffer.pos(sectX0, HEIGHT, slice)
                                .tex(u0, sliceCoord1)
                                .color(0.8F, 0.8F, 0.8F, ALPHA)
                                .endVertex();
                            buffer.pos(sectX1, HEIGHT, slice)
                                .tex(u1, sliceCoord1)
                                .color(0.8F, 0.8F, 0.8F, ALPHA)
                                .endVertex();
                            buffer.pos(sectX1, 0, slice)
                                .tex(u1, sliceCoord0)
                                .color(0.8F, 0.8F, 0.8F, ALPHA)
                                .endVertex();
                            slice -= INSET;
    ...
    private void build() {
        ...
        if (OpenGlHelper.useVbo()) vbo = new VertexBuffer(FORMAT);
        else GlStateManager.glNewList(displayList = GLAllocation.generateDisplayLists(1), GL11.GL_COMPILE);
    ...
    public void checkSettings() {
        boolean newEnabled = ForgeModContainer.forgeCloudsEnabled && mc.gameSettings.shouldRenderClouds() != 0
            && mc.world != null
    ...
    public boolean render(int cloudTicks, float partialTicks) {
        ...
        if (COLOR_TEX == null) COLOR_TEX = new DynamicTexture(1, 1);
        ...
        ByteBuffer buffer = Tessellator.getInstance()
            .getBuffer()
            .getByteBuffer();
        ...
        if (OpenGlHelper.useVbo()) {
            ...
            for (int i = 0; i < FORMAT.getElementCount(); i++)
                FORMAT.getElements()
                    .get(i)
                    .getUsage()
                    .preDraw(FORMAT, i, FORMAT.getSize(), buffer);
            buffer.position(0);
        }

        // Depth pass to prevent insides rendering from the outside.
        GlStateManager.colorMask(false, false, false, false);
        if (OpenGlHelper.useVbo()) vbo.drawArrays(GL11.GL_QUADS);
        else GlStateManager.callList(displayList);
        ...
        for (int i = 0; i < FORMAT.getElementCount(); i++)
            FORMAT.getElements()
                .get(i)
                .getUsage()
                .postDraw(FORMAT, i, FORMAT.getSize(), buffer);
        buffer.position(0);

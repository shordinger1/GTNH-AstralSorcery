...
public interface IForgeRegistryEntry<V> {
     ...
     * <p>
     * If a name already exists, or this Item is already registered in a registry, then an IllegalStateException is
     * thrown.
     * <p>
    ...
    /**
     * A unique identifier for this entry, if this entry is registered already it will return it's official registry
     * name.
    ...
    public static class Impl<T extends IForgeRegistryEntry<T>> implements IForgeRegistryEntry<T> {
        ...
        public final T setRegistryName(String name) {
            if (getRegistryName() != null) throw new IllegalStateException(

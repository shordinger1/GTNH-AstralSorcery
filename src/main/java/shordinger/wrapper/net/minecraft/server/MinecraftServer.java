...
import shordinger.wrapper.net.minecraft.command.ICommandManager;
...
import shordinger.wrapper.net.minecraft.network.NetworkSystem;
...
import shordinger.wrapper.net.minecraft.server.dedicated.DedicatedServer;
...
import shordinger.wrapper.net.minecraft.world.ServerWorldEventHandler;
import shordinger.wrapper.net.minecraft.world.World;
import shordinger.wrapper.net.minecraft.world.WorldServer;
import shordinger.wrapper.net.minecraft.world.WorldServerDemo;
import shordinger.wrapper.net.minecraft.world.WorldServerMulti;
...
public abstract class MinecraftServer extends net.minecraft.server.MinecraftServer implements ICommandSender, Runnable, IThreadListener, ISnooperInfo {
    ...
    public MinecraftServer(File anvilFileIn, Proxy proxyIn, DataFixer dataFixerIn,
    ...
    public void convertMapIfNeeded(String worldNameIn) {
        if (this.getActiveAnvilConverter()
            .isOldMapFormat(worldNameIn)) {
            LOGGER.info("Converting map!");
            this.setUserMessage("menu.convertingLevel");
            this.getActiveAnvilConverter()
                .convertMapFormat(worldNameIn, new IProgressUpdate() {
    ...
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
        ...
        if (false) { // Forge Dead code, reimplemented below
            for (int i = 0; i < this.worlds.length; ++i) {
                ...
                if (i == 0) {
                    if (this.isDemo()) {
                        this.worlds[i] = (WorldServer) (new WorldServerDemo(
                            this,
                            isavehandler,
                            worldinfo,
                            j,
                        ...
                        this.worlds[i] = (WorldServer) (new WorldServer(
                            this,
                            isavehandler,
                            worldinfo,
                            j,
                    ...
                    this.worlds[i] = (WorldServer) (new WorldServerMulti(
                        this,
                        isavehandler,
                        j,
                        this.worlds[0],
                ...
                if (!this.isSinglePlayer()) {
                    this.worlds[i].getWorldInfo()
                        .setGameType(this.getGameType());
                }
            }
        } // Forge: End dead code

        WorldServer overWorld = (WorldServer) (isDemo()
            ? new WorldServerDemo(this, isavehandler, worldinfo, 0, profiler).init()
            : new WorldServer(this, isavehandler, worldinfo, 0, profiler).init());
        overWorld.initialize(worldsettings);
        for (int dim : net.minecraftforge.common.DimensionManager.getStaticDimensionIDs()) {
            WorldServer world = (dim == 0 ? overWorld
                : (WorldServer) new WorldServerMulti(this, isavehandler, dim, overWorld, profiler).init());
        ...
        for (int l1 = -192; l1 <= 192 && this.isServerRunning(); l1 += 16) {
            for (int i2 = -192; i2 <= 192 && this.isServerRunning(); i2 += 16) {
                ...
                worldserver.getChunkProvider()
                    .provideChunk(blockpos.getX() + l1 >> 4, blockpos.getZ() + i2 >> 4);
            }
        }
        ...
        if (file1.isFile()) {
            try {
                this.setResourcePack(
                    "level://" + URLEncoder.encode(worldNameIn, StandardCharsets.UTF_8.toString())
                        + "/"
                        + "resources.zip",
                    "");
    ...
    public void applyServerIconToResponse(ServerStatusResponse response) {
        ...
        if (!file1.exists()) {
            file1 = this.getActiveAnvilConverter()
                .getFile(this.getFolderName(), "icon.png");
        }
    ...
    public boolean isWorldIconSet() {
        this.worldIconSet = this.worldIconSet || this.getWorldIconFile()
            .isFile();
    ...
    public File getWorldIconFile() {
        return this.getActiveAnvilConverter()
            .getFile(this.getFolderName(), "icon.png");
    }
    ...
    public void tick() {
        ...
        if (i - this.nanoTimeSinceStatusRefresh >= 5000000000L) {
            ...
            for (int k = 0; k < agameprofile.length; ++k) {
                agameprofile[k] = ((EntityPlayerMP) this.playerList.getPlayers()
                    .get(j + k)).getGameProfile();
            }

            Collections.shuffle(Arrays.asList(agameprofile));
            this.statusResponse.getPlayers()
                .setPlayers(agameprofile);
        ...
        for (int x = 0; x < ids.length; x++) {
            ...
            if (id == 0 || this.getAllowNether()) {
                ...
                try {
                    ...
                    CrashReport crashreport1 = CrashReport
                        .makeCrashReport(throwable, "Exception ticking world entities");
    ...
    public CrashReport addServerInfoToCrashReport(CrashReport report) {
        ...
        if (this.playerList != null) {
            report.getCategory()
                .addDetail("Player Count", new ICrashReportDetail<String>() {
    ...
    public void addServerStatsToSnooper(Snooper playerSnooper) {
        ...
        if (this.playerList != null) {
            ...
            playerSnooper
                .addClientStat("players_seen", Integer.valueOf(this.playerList.getAvailablePlayerDat().length));
        }
        ...
        playerSnooper
            .addClientStat("avg_tick_ms", Integer.valueOf((int) (MathHelper.average(this.tickTimeArray) * 1.0E-6D)));
        int l = 0;
            ...
            for (WorldServer worldserver1 : this.worlds) {
                if (worldserver1 != null) {
                    ...
                    playerSnooper.addClientStat(
                        "world[" + l + "][dimension]",
                        Integer.valueOf(
                            worldserver1.provider.getDimensionType()
                                .getId()));
    ...
    public boolean sendCommandFeedback() {
        return this.worlds[0].getGameRules()
    ...
    public int getSpawnRadius(@Nullable WorldServer worldIn) {
        return worldIn != null ? worldIn.getGameRules()
            .getInt("spawnRadius") : 10;
    }
    ...
    public void reload() {
        if (this.isCallingFromMinecraftThread()) {
            this.getPlayerList()
                .saveAllPlayerData();
            this.worlds[0].getLootTableManager()
                .reloadLootTables();
            this.getAdvancementManager()
                .reload();
            this.getFunctionManager()
                .reload();
            this.getPlayerList()
    ...
    public static void main(String[] p_main_0_) {
        ...
        try {
            ...
            Runtime.getRuntime()
                .addShutdownHook(new Thread("Server Shutdown Thread") {

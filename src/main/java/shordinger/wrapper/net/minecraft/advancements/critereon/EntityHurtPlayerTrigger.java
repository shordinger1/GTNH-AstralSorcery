...
public class EntityHurtPlayerTrigger implements ICriterionTrigger<EntityHurtPlayerTrigger.Instance> {
    ...
    public void addListener(PlayerAdvancements playerAdvancementsIn,
                            ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> listener) {
    ...
    public void trigger(EntityPlayerMP player, DamageSource source, float amountDealt, float amountTaken,
                        boolean wasBlocked) {
        EntityHurtPlayerTrigger.Listeners entityhurtplayertrigger$listeners = this.listeners
    ...
    public static class Instance extends AbstractCriterionInstance {
        ...
        public boolean test(EntityPlayerMP player, DamageSource source, float amountDealt, float amountTaken,
                            boolean wasBlocked) {
    ...
    static class Listeners {
        ...
        public void trigger(EntityPlayerMP player, DamageSource source, float amountDealt, float amountTaken,
            ...
            for (ICriterionTrigger.Listener<EntityHurtPlayerTrigger.Instance> listener : this.listeners) {
                if (((EntityHurtPlayerTrigger.Instance) listener.getCriterionInstance())
                    .test(player, source, amountDealt, amountTaken, wasBlocked)) {
                    if (list == null) {

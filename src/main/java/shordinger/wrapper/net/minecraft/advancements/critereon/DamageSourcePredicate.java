...
public class DamageSourcePredicate {
    ...
    public DamageSourcePredicate(@Nullable Boolean isProjectile, @Nullable Boolean isExplosion,
                                 @Nullable Boolean bypassesArmor, @Nullable Boolean bypassesInvulnerability, @Nullable Boolean bypassesMagic,
                                 @Nullable Boolean isFire, @Nullable Boolean isMagic, EntityPredicate directEntity,
    ...
    public boolean test(EntityPlayerMP player, DamageSource source) {
        if (this == ANY) {
            ...
            return false;
        } else if (this.bypassesInvulnerability != null

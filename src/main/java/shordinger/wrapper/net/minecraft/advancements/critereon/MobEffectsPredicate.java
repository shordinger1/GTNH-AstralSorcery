...
public class MobEffectsPredicate {
    ...
    public static MobEffectsPredicate deserialize(@Nullable JsonElement element) {
        if (element != null && !element.isJsonNull()) {
            ...
            for (Entry<String, JsonElement> entry : jsonobject.entrySet()) {
                ...
                MobEffectsPredicate.InstancePredicate mobeffectspredicate$instancepredicate = MobEffectsPredicate.InstancePredicate
                    .deserialize(JsonUtils.getJsonObject(entry.getValue(), entry.getKey()));
    ...
    public static class InstancePredicate {
        ...
        public InstancePredicate(MinMaxBounds amplifier, MinMaxBounds duration, @Nullable Boolean ambient,

...
public class DisplayInfo {
    ...
    public DisplayInfo(ItemStack icon, ITextComponent title, ITextComponent description,
                       @Nullable ResourceLocation background, FrameType frame, boolean showToast, boolean announceToChat,
                       boolean hidden) {
        this.title = title;
    ...
    public static DisplayInfo deserialize(JsonObject object, JsonDeserializationContext context) {
        ITextComponent itextcomponent = (ITextComponent) JsonUtils
            .deserializeClass(object, "title", context, ITextComponent.class);
        ITextComponent itextcomponent1 = (ITextComponent) JsonUtils
            .deserializeClass(object, "description", context, ITextComponent.class);
        ...
        if (itextcomponent != null && itextcomponent1 != null) {
            ...
            ResourceLocation resourcelocation = object.has("background")
                ...
                : null;
            FrameType frametype = object.has("frame") ? FrameType.byName(JsonUtils.getString(object, "frame"))
                : FrameType.TASK;

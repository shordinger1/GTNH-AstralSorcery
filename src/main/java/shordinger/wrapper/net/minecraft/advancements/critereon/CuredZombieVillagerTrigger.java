...
public class CuredZombieVillagerTrigger implements ICriterionTrigger<CuredZombieVillagerTrigger.Instance> {
    ...
    public void addListener(PlayerAdvancements playerAdvancementsIn,
                            ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> listener) {
        CuredZombieVillagerTrigger.Listeners curedzombievillagertrigger$listeners = this.listeners
     ...
     */
    public CuredZombieVillagerTrigger.Instance deserializeInstance(JsonObject json,
    ...
    static class Listeners {
        ...
        public void trigger(EntityPlayerMP player, EntityZombie zombie, EntityVillager villager) {
            ...
            for (ICriterionTrigger.Listener<CuredZombieVillagerTrigger.Instance> listener : this.listeners) {
                if (((CuredZombieVillagerTrigger.Instance) listener.getCriterionInstance())
                    .test(player, zombie, villager)) {
                    if (list == null) {

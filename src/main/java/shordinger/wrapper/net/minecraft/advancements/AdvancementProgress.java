...
public class AdvancementProgress implements Comparable<AdvancementProgress> {
    ...
    public void update(Map<String, Criterion> criteriaIn, String[][] requirements) {
        ...
        Iterator<Entry<String, CriterionProgress>> iterator = this.criteria.entrySet()
            .iterator();
    ...
    public String toString() {
        return "AdvancementProgress{criteria=" + this.criteria
            + ", requirements="
    ...
    public static AdvancementProgress fromNetwork(PacketBuffer p_192100_0_) {
        ...
        for (int j = 0; j < i; ++j) {
            advancementprogress.criteria
                .put(p_192100_0_.readString(32767), CriterionProgress.read(p_192100_0_, advancementprogress));
        }
    ...
    public Date getFirstProgressDate() {
        ...
        for (CriterionProgress criterionprogress : this.criteria.values()) {
            if (criterionprogress.isObtained() && (date == null || criterionprogress.getObtained()
                .before(date))) {
    ...
    public static class Serializer
        ...
        public JsonElement serialize(AdvancementProgress p_serialize_1_, Type p_serialize_2_,
        ...
        public AdvancementProgress deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
            ...
            for (Entry<String, JsonElement> entry : jsonobject1.entrySet()) {
                ...
                advancementprogress.criteria.put(
                    s,
                    CriterionProgress.fromDateTime(advancementprogress, JsonUtils.getString(entry.getValue(), s)));
            }

...
public class EnchantmentProtection extends Enchantment {
    ...
    public EnchantmentProtection(Enchantment.Rarity rarityIn, EnchantmentProtection.Type protectionTypeIn,
    ...
    public int calcModifierDamage(int level, DamageSource source) {
        if (source.canHarmInCreative()) {
            ...
            return this.protectionType == EnchantmentProtection.Type.PROJECTILE && source.isProjectile() ? level * 2
                : 0;
        }
    }
    ...
    public boolean canApplyTogether(Enchantment ench) {
        if (ench instanceof EnchantmentProtection) {
            ...
            if (this.protectionType == enchantmentprotection.protectionType) {
                ...
                return this.protectionType == EnchantmentProtection.Type.FALL

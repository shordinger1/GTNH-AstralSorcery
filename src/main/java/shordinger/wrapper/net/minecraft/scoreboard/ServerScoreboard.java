...
public class ServerScoreboard extends Scoreboard {
    ...
    public void onScoreUpdated(Score scoreIn) {
        ...
        if (this.addedObjectives.contains(scoreIn.getObjective())) {
            this.scoreboardMCServer.getPlayerList()
                .sendPacketToAllPlayers(new SPacketUpdateScore(scoreIn));
        }
    ...
    public void broadcastScoreUpdate(String scoreName) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketUpdateScore(scoreName));
        this.markSaveDataDirty();
    }
    ...
    public void broadcastScoreUpdate(String scoreName, ScoreObjective objective) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketUpdateScore(scoreName, objective));
        this.markSaveDataDirty();
    }
    ...
    public boolean addPlayerToTeam(String player, String newTeam) {
        if (super.addPlayerToTeam(player, newTeam)) {
            ...
            this.scoreboardMCServer.getPlayerList()
                .sendPacketToAllPlayers(new SPacketTeams(scoreplayerteam, Arrays.asList(player), 3));
            this.markSaveDataDirty();
            return true;
        } else {
            return false;
    ...
    public void removePlayerFromTeam(String username, ScorePlayerTeam playerTeam) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketTeams(playerTeam, Arrays.asList(username), 4));
        this.markSaveDataDirty();
    }
    ...
    public void onObjectiveDisplayNameChanged(ScoreObjective objective) {
        ...
        if (this.addedObjectives.contains(objective)) {
            this.scoreboardMCServer.getPlayerList()
                .sendPacketToAllPlayers(new SPacketScoreboardObjective(objective, 2));
        }
    ...
    public void broadcastTeamCreated(ScorePlayerTeam playerTeam) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketTeams(playerTeam, 0));
        this.markSaveDataDirty();
    }
    ...
    public void broadcastTeamInfoUpdate(ScorePlayerTeam playerTeam) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketTeams(playerTeam, 2));
        this.markSaveDataDirty();
    }
    ...
    public void broadcastTeamRemove(ScorePlayerTeam playerTeam) {
        ...
        this.scoreboardMCServer.getPlayerList()
            .sendPacketToAllPlayers(new SPacketTeams(playerTeam, 1));
        this.markSaveDataDirty();
    }
    ...
    public void addObjective(ScoreObjective objective) {
        ...
        for (EntityPlayerMP entityplayermp : this.scoreboardMCServer.getPlayerList()
            .getPlayers()) {

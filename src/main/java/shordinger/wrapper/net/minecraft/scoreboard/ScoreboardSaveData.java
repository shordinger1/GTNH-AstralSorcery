...
public class ScoreboardSaveData extends WorldSavedData {
        ...
        for (int i = 0; i < tagList.tagCount(); ++i) {
            ...
            if (nbttagcompound.hasKey("NameTagVisibility", 8)) {
                Team.EnumVisible team$enumvisible = Team.EnumVisible
                    .getByName(nbttagcompound.getString("NameTagVisibility"));
            ...
            if (nbttagcompound.hasKey("DeathMessageVisibility", 8)) {
                Team.EnumVisible team$enumvisible1 = Team.EnumVisible
                    .getByName(nbttagcompound.getString("DeathMessageVisibility"));
            ...
            if (nbttagcompound.hasKey("CollisionRule", 8)) {
                Team.CollisionRule team$collisionrule = Team.CollisionRule
                    .getByName(nbttagcompound.getString("CollisionRule"));
    ...
    protected void readObjectives(NBTTagList nbt) {
        for (int i = 0; i < nbt.tagCount(); ++i) {
            ...
            if (iscorecriteria != null) {
                ...
                scoreobjective
                    .setRenderType(IScoreCriteria.EnumRenderType.getByName(nbttagcompound.getString("RenderType")));
            }
        }
    }
    ...
    protected NBTTagList teamsToNbt() {
        ...
        for (ScorePlayerTeam scoreplayerteam : this.scoreboard.getTeams()) {
            ...
            nbttagcompound
                .setString("DeathMessageVisibility", scoreplayerteam.getDeathMessageVisibility().internalName);

...
import shordinger.wrapper.net.minecraft.block.BlockFurnace;
...
import shordinger.wrapper.net.minecraft.inventory.ContainerFurnace;
...
import shordinger.wrapper.net.minecraft.inventory.SlotFurnaceFuel;
import shordinger.wrapper.net.minecraft.item.Item;
import shordinger.wrapper.net.minecraft.item.ItemBoat;
import shordinger.wrapper.net.minecraft.item.ItemDoor;
import shordinger.wrapper.net.minecraft.item.ItemHoe;
...
public class TileEntityFurnace extends TileEntityLockable implements ITickable, ISidedInventory {
        ...
        if (((ItemStack) this.furnaceItemStacks.get(0)).isEmpty()) {
            ...
            if (itemstack.isEmpty()) {
                ...
                if (itemstack1.isEmpty()) {
                    ...
                    && itemstack1.getCount() + itemstack.getCount() <= itemstack1.getMaxStackSize()) // Forge fix: make
                // furnace respect
                // stack sizes in
                // furnace recipes
                {
    ...
    public void smeltItem() {
        if (this.canSmelt()) {
            ...
            ItemStack itemstack1 = FurnaceRecipes.instance()

...
import shordinger.wrapper.net.minecraft.inventory.InventoryLargeChest;
...
public class TileEntityChest extends TileEntityLockableLoot implements ITickable {
    ...
    private boolean isChestAt(BlockPos posIn) {
        if (this.world == null) {
            ...
            Block block = this.world.getBlockState(posIn)
                .getBlock();
    ...
    public void update() {
        ...
        if (!this.world.isRemote && this.numPlayersUsing != 0 && (this.ticksSinceSync + i + j + k) % 200 == 0) {
            ...
            for (EntityPlayer entityplayer : this.world.getEntitiesWithinAABB(
                EntityPlayer.class,
                new AxisAlignedBB(
                    (double) ((float) i - 5.0F),
                    (double) ((float) j - 5.0F),
    ...
    public <T> T getCapability(net.minecraftforge.common.capabilities.Capability<T> capability,
        ...
        if (capability == net.minecraftforge.items.CapabilityItemHandler.ITEM_HANDLER_CAPABILITY) {
            ...
            if (doubleChestHandler != null && doubleChestHandler
                != net.minecraftforge.items.VanillaDoubleChestItemHandler.NO_ADJACENT_CHESTS_INSTANCE)

...
public abstract class TileEntity extends net.minecraft.tileentity.TileEntity
    ...
    public static TileEntity create(World worldIn, NBTTagCompound compound) {
        ...
        try {
            ...
            net.minecraftforge.fml.common.FMLLog.log.error(
                ...
                s,
                oclass == null ? null : oclass.getName(),
                throwable1);
        }
    ...
    public int getBlockMetadata() {
        if (this.blockMetadata == -1) {
            ...
            this.blockMetadata = iblockstate.getBlock()
    ...
    public Block getBlockType() {
        if (this.blockType == null && this.world != null) {
            this.blockType = this.world.getBlockState(this.pos)
                .getBlock();
        }
    ...
    public void addInfoToCrashReport(CrashReportCategory reportCategory) {
        ...
        if (this.world != null) {
            ...
            reportCategory.addDetail("Actual block type", new ICrashReportDetail<String>() {
                ...
                public String call() throws Exception {
                    int i = Block.getIdFromBlock(
                        TileEntity.this.world.getBlockState(TileEntity.this.pos)
                            .getBlock());
            ...
            reportCategory.addDetail("Actual block data value", new ICrashReportDetail<String>() {
                ...
                public String call() throws Exception {
                    ...
                    if (i < 0) {
                        ...
                        String s = String.format("%4s", Integer.toBinaryString(i))
                            .replace(" ", "0");
     ...
     * when the ID, or Metadata changes.
     * Use with caution as this will leave straggler TileEntities, or create conflicts with other TileEntities if not
     * used properly.
     *
    ...
    public boolean canRenderBreaking() {
        ...
        return (block instanceof net.minecraft.block.BlockChest || block instanceof net.minecraft.block.BlockEnderChest
    ...
    public boolean restrictNBTCopy() {
        return this instanceof TileEntityCommandBlock || this instanceof TileEntityMobSpawner
    ...
    /**
     * If the TileEntitySpecialRenderer associated with this TileEntity can be batched in with another renderers, and
     * won't access the GL state.
     * If TileEntity returns true, then TESR should have the same functionality as (and probably extend) the FastTESR
     * class.
     */

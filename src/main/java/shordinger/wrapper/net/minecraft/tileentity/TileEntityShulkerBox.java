...
public class TileEntityShulkerBox extends TileEntityLockableLoot implements ITickable, ISidedInventory {
    ...
    public void update() {
        ...
        if (this.animationStatus == TileEntityShulkerBox.AnimationStatus.OPENING
    ...
    public AxisAlignedBB getBoundingBox(EnumFacing p_190587_1_) {
        return Block.FULL_BLOCK_AABB.expand(
            (double) (0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetX()),
            (double) (0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetY()),
            (double) (0.5F * this.getProgress(1.0F) * (float) p_190587_1_.getFrontOffsetZ()));
    }
    ...
    private void moveCollidedEntities() {
        ...
        if (iblockstate.getBlock() instanceof BlockShulkerBox) {
            ...
            AxisAlignedBB axisalignedbb = this.getTopBoundingBox(enumfacing)
                .offset(this.pos);
                ...
                for (int i = 0; i < list.size(); ++i) {
                    ...
                    if (entity.getPushReaction() != EnumPushReaction.IGNORE) {
                        ...
                        entity.move(
                            ...
                            d2 * (double) enumfacing.getFrontOffsetZ());
                    }
                }
            }
        }
    ...
    public static void registerFixesShulkerBox(DataFixer fixer) {
        fixer.registerWalker(
            ...
            new ItemStackDataLists(TileEntityShulkerBox.class, new String[]{"Items"}));
    }

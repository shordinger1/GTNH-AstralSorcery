...
public class Teleporter implements net.minecraftforge.common.util.ITeleporter {
        ...
        if (this.destinationCoordinateCache.containsKey(l)) {
            ...
            for (int i1 = -128; i1 <= 128; ++i1) {
                ...
                for (int j1 = -128; j1 <= 128; ++j1) {
                    for (BlockPos blockpos1 = blockpos3
                        .add(i1, this.world.getActualHeight() - 1 - blockpos3.getY(), j1); blockpos1.getY()
                             >= 0; blockpos1 = blockpos2) {
        ...
        if (d0 >= 0.0D) {
            if (flag) {
                this.destinationCoordinateCache
                    .put(l, new Teleporter.PortalPosition(blockpos, this.world.getTotalWorldTime()));
            }
            ...
            double d2 = blockpattern$patternhelper.getForwards()
                ...
                : (double) blockpattern$patternhelper.getFrontTopLeft()
                .getX();
            double d6 = (double) (blockpattern$patternhelper.getFrontTopLeft()
                .getY() + 1) - entityIn.getLastPortalVec().y * (double) blockpattern$patternhelper.getHeight();

            if (flag1) {
                ++d2;
            }

            if (blockpattern$patternhelper.getForwards()
                .getAxis() == EnumFacing.Axis.X) {
                d7 = d2 + (1.0D - entityIn.getLastPortalVec().x) * (double) blockpattern$patternhelper.getWidth()
                    * (double) blockpattern$patternhelper.getForwards()
                    .rotateY()
                    .getAxisDirection()
                    .getOffset();
            } else {
            ...
            if (blockpattern$patternhelper.getForwards()
                .getOpposite() == entityIn.getTeleportDirection()) {
                f = 1.0F;
                f1 = 1.0F;
                            ...
                            for (int j4 = 0; j4 < 3; ++j4) {
                                for (int k4 = 0; k4 < 4; ++k4) {
                                    for (int l4 = -1; l4 < 4; ++l4) {
                                        ...
                                        if (l4 < 0 && !this.world.getBlockState(blockpos$mutableblockpos)
                                            .getMaterial()
                            ...
                            for (int k7 = i2; k7 < i2 + 2; ++k7) {
                                ...
                                for (int j10 = 0; j10 < 4; ++j10) {
                                    for (int j11 = -1; j11 < 4; ++j11) {
                                        ...
                                        if (j11 < 0 && !this.world.getBlockState(blockpos$mutableblockpos)
                                            .getMaterial()
                                            .isSolid()
        ...
        for (int i8 = 0; i8 < 4; ++i8) {
            for (int l8 = 0; l8 < 4; ++l8) {
                for (int l9 = -1; l9 < 4; ++l9) {
                    ...
                    this.world.setBlockState(
                        ...
                        flag1 ? Blocks.OBSIDIAN.getDefaultState() : iblockstate,
                        2);
                }
            }
            ...
            for (int i9 = 0; i9 < 4; ++i9) {
                for (int i10 = -1; i10 < 4; ++i10) {
                    ...
                    this.world.notifyNeighborsOfStateChange(
                        blockpos,
    ...
    public void removeStalePortalLocations(long worldTime) {
        if (worldTime % 100L == 0L) {
            ...
            ObjectIterator<Teleporter.PortalPosition> objectiterator = this.destinationCoordinateCache.values()
                .iterator();

...
public class StructureEndCityPieces {
    ...
    private static final StructureEndCityPieces.IGenerator HOUSE_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
        ...
        public boolean generate(TemplateManager p_191086_1_, int p_191086_2_,
                                StructureEndCityPieces.CityTemplate p_191086_3_, BlockPos p_191086_4_, List<StructureComponent> p_191086_5_,
                                Random p_191086_6_) {
            if (p_191086_2_ > 8) {
                return false;
            } else {
                Rotation rotation = p_191086_3_.placeSettings.getRotation();
                StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces
                    .addHelper(
                        p_191086_5_,
                        StructureEndCityPieces
                            .addPiece(p_191086_1_, p_191086_3_, p_191086_4_, "base_floor", rotation, true));
                int i = p_191086_6_.nextInt(3);

                if (i == 0) {
                    StructureEndCityPieces.addHelper(
                        p_191086_5_,
                        StructureEndCityPieces.addPiece(
                            p_191086_1_,
                    ...
                    structureendcitypieces$citytemplate = StructureEndCityPieces.addHelper(
                        p_191086_5_,
                        StructureEndCityPieces.addPiece(
                            p_191086_1_,
                            structureendcitypieces$citytemplate,
                    ...
                    structureendcitypieces$citytemplate = StructureEndCityPieces.addHelper(
                        ...
                        StructureEndCityPieces.addPiece(
                            ...
                            rotation,
                            false));
                    StructureEndCityPieces.recursiveChildren(
                        p_191086_1_,
                        StructureEndCityPieces.TOWER_GENERATOR,
                        p_191086_2_ + 1,
                        structureendcitypieces$citytemplate,
                        (BlockPos) null,
                        p_191086_5_,
    ...
    private static final StructureEndCityPieces.IGenerator TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
        ...
        public boolean generate(TemplateManager p_191086_1_, int p_191086_2_,
                                ...
                                Random p_191086_6_) {
            Rotation rotation = p_191086_3_.placeSettings.getRotation();
            StructureEndCityPieces.CityTemplate lvt_8_1_ = StructureEndCityPieces.addHelper(
                p_191086_5_,
                StructureEndCityPieces.addPiece(
                    p_191086_1_,
                    p_191086_3_,
                    new BlockPos(3 + p_191086_6_.nextInt(2), -3, 3 + p_191086_6_.nextInt(2)),
                    "tower_base",
                    rotation,
                    true));
            lvt_8_1_ = StructureEndCityPieces.addHelper(
                p_191086_5_,
                StructureEndCityPieces
                    .addPiece(p_191086_1_, lvt_8_1_, new BlockPos(0, 7, 0), "tower_piece", rotation, true));
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate1 = p_191086_6_.nextInt(3) == 0
                ? lvt_8_1_
                : null;
            ...
            for (int j = 0; j < i; ++j) {
                lvt_8_1_ = StructureEndCityPieces.addHelper(
                    p_191086_5_,
                    StructureEndCityPieces
                        .addPiece(p_191086_1_, lvt_8_1_, new BlockPos(0, 4, 0), "tower_piece", rotation, true));
            ...
            if (structureendcitypieces$citytemplate1 != null) {
                for (Tuple<Rotation, BlockPos> tuple : StructureEndCityPieces.TOWER_BRIDGES) {
                    if (p_191086_6_.nextBoolean()) {
                        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate2 = StructureEndCityPieces
                            .addHelper(
                                p_191086_5_,
                                StructureEndCityPieces.addPiece(
                                    p_191086_1_,
                                    structureendcitypieces$citytemplate1,
                                    tuple.getSecond(),
                                    "bridge_end",
                                    rotation.add(tuple.getFirst()),
                                    true));
                        StructureEndCityPieces.recursiveChildren(
                            p_191086_1_,
                            StructureEndCityPieces.TOWER_BRIDGE_GENERATOR,
                            p_191086_2_ + 1,
                            structureendcitypieces$citytemplate2,
                            (BlockPos) null,
                            p_191086_5_,
                            p_191086_6_);
                    }
                ...
                StructureEndCityPieces.addHelper(
                    p_191086_5_,
                    StructureEndCityPieces
                        .addPiece(p_191086_1_, lvt_8_1_, new BlockPos(-1, 4, -1), "tower_top", rotation, true));
            } else {
                if (p_191086_2_ != 7) {
                    return StructureEndCityPieces.recursiveChildren(
                        p_191086_1_,
                        StructureEndCityPieces.FAT_TOWER_GENERATOR,
                        p_191086_2_ + 1,
                        lvt_8_1_,
                        (BlockPos) null,
                        p_191086_5_,
    ...
    private static final StructureEndCityPieces.IGenerator TOWER_BRIDGE_GENERATOR = new StructureEndCityPieces.IGenerator() {
        ...
        public boolean generate(TemplateManager p_191086_1_, int p_191086_2_,
            ...
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces.addHelper(
                p_191086_5_,
                StructureEndCityPieces
                    .addPiece(p_191086_1_, p_191086_3_, new BlockPos(0, 0, -4), "bridge_piece", rotation, true));
            ...
            if (!this.shipCreated && p_191086_6_.nextInt(10 - p_191086_2_) == 0) {
                StructureEndCityPieces.addHelper(
                    ...
                    StructureEndCityPieces.addPiece(
                        p_191086_1_,
                        structureendcitypieces$citytemplate,
                        new BlockPos(-8 + p_191086_6_.nextInt(8), j, -70 + p_191086_6_.nextInt(10)),
                        "ship",
                        rotation,
                        true));
                ...
                p_191086_1_,
                StructureEndCityPieces.HOUSE_TOWER_GENERATOR,
                p_191086_2_ + 1,
                structureendcitypieces$citytemplate,
    ...
    private static final StructureEndCityPieces.IGenerator FAT_TOWER_GENERATOR = new StructureEndCityPieces.IGenerator() {
        ...
        public boolean generate(TemplateManager p_191086_1_, int p_191086_2_,
            ...
            StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = StructureEndCityPieces.addHelper(
                p_191086_5_,
                StructureEndCityPieces
                    .addPiece(p_191086_1_, p_191086_3_, new BlockPos(-3, 4, -3), "fat_tower_base", rotation, true));
            structureendcitypieces$citytemplate = StructureEndCityPieces.addHelper(
                p_191086_5_,
                StructureEndCityPieces.addPiece(
                    p_191086_1_,
    ...
    private static StructureEndCityPieces.CityTemplate addPiece(TemplateManager p_191090_0_,
                                                                StructureEndCityPieces.CityTemplate p_191090_1_, BlockPos p_191090_2_, String p_191090_3_, Rotation p_191090_4_,
                                                                boolean owerwrite) {
        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = new StructureEndCityPieces.CityTemplate(
            p_191090_0_,
            p_191090_3_,
            p_191090_1_.templatePosition,
            p_191090_4_,
            owerwrite);
        BlockPos blockpos = p_191090_1_.template.calculateConnectedPos(
            p_191090_1_.placeSettings,
            p_191090_2_,
    ...
    public static void startHouseTower(TemplateManager p_191087_0_, BlockPos p_191087_1_, Rotation p_191087_2_,
                                       List<StructureComponent> p_191087_3_, Random p_191087_4_) {
        FAT_TOWER_GENERATOR.init();
        HOUSE_TOWER_GENERATOR.init();
        TOWER_BRIDGE_GENERATOR.init();
        TOWER_GENERATOR.init();
        StructureEndCityPieces.CityTemplate structureendcitypieces$citytemplate = addHelper(
            p_191087_3_,
            new StructureEndCityPieces.CityTemplate(p_191087_0_, "base_floor", p_191087_1_, p_191087_2_, true));
        structureendcitypieces$citytemplate = addHelper(
            p_191087_3_,
            addPiece(
                p_191087_0_,
                structureendcitypieces$citytemplate,
    ...
    private static StructureEndCityPieces.CityTemplate addHelper(List<StructureComponent> p_189935_0_,
                                                                 StructureEndCityPieces.CityTemplate p_189935_1_) {
        p_189935_0_.add(p_189935_1_);
        return p_189935_1_;
    }

    private static boolean recursiveChildren(TemplateManager p_191088_0_, StructureEndCityPieces.IGenerator p_191088_1_,
                                             int p_191088_2_, StructureEndCityPieces.CityTemplate p_191088_3_, BlockPos p_191088_4_,
                                             List<StructureComponent> p_191088_5_, Random p_191088_6_) {
        if (p_191088_2_ > 8) {
            return false;
        } else {
            ...
            if (p_191088_1_.generate(p_191088_0_, p_191088_2_, p_191088_3_, p_191088_4_, list, p_191088_6_)) {
                ...
                for (StructureComponent structurecomponent : list) {
                    ...
                    StructureComponent structurecomponent1 = StructureComponent
                        .findIntersecting(p_191088_5_, structurecomponent.getBoundingBox());
    ...
    public static class CityTemplate extends StructureComponentTemplate {
        ...
        public CityTemplate(TemplateManager p_i47214_1_, String p_i47214_2_, BlockPos p_i47214_3_, Rotation p_i47214_4_,
                            boolean overwriteIn) {
            super(0);
        ...
        private void loadTemplate(TemplateManager p_191085_1_) {
            Template template = p_191085_1_
                .getTemplate((MinecraftServer) null, new ResourceLocation("endcity/" + this.pieceName));
            PlacementSettings placementsettings = (this.overwrite ? StructureEndCityPieces.OVERWRITE
                : StructureEndCityPieces.INSERT).copy()
        ...
        protected void handleDataMarker(String function, BlockPos pos, World worldIn, Random rand,
            ...
            if (function.startsWith("Chest")) {
                ...
                if (sbb.isVecInside(blockpos)) {
                    ...
                    if (tileentity instanceof TileEntityChest) {
                        ((TileEntityChest) tileentity)
                            .setLootTable(LootTableList.CHESTS_END_CITY_TREASURE, rand.nextLong());
                    }
                }
                ...
                EntityItemFrame entityitemframe = new EntityItemFrame(
                    worldIn,
                    pos,
                    this.rotation.rotate(EnumFacing.SOUTH));
    ...
    interface IGenerator {
        ...
        boolean generate(TemplateManager p_191086_1_, int p_191086_2_, StructureEndCityPieces.CityTemplate p_191086_3_,
                         BlockPos p_191086_4_, List<StructureComponent> p_191086_5_, Random p_191086_6_);
    }
}

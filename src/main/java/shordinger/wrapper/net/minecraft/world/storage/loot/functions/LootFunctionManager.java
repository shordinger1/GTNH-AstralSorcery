...
public class LootFunctionManager {
    ...
    public static class Serializer implements JsonDeserializer<LootFunction>, JsonSerializer<LootFunction> {
        ...
        public LootFunction deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
            ...
            return serializer.deserialize(
                jsonobject,
                p_deserialize_3_,
                (LootCondition[]) JsonUtils.deserializeClass(
                    jsonobject,
                    "conditions",
                    new LootCondition[0],
                    p_deserialize_3_,
        ...
        public JsonElement serialize(LootFunction p_serialize_1_, Type p_serialize_2_,

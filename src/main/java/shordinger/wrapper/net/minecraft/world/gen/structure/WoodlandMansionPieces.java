...
import shordinger.wrapper.net.minecraft.world.gen.structure.template.PlacementSettings;
...
public class WoodlandMansionPieces {
    ...
    public static void generateMansion(TemplateManager p_191152_0_, BlockPos p_191152_1_, Rotation p_191152_2_,
                                       List<WoodlandMansionPieces.MansionTemplate> p_191152_3_, Random p_191152_4_) {
        WoodlandMansionPieces.Grid woodlandmansionpieces$grid = new WoodlandMansionPieces.Grid(p_191152_4_);
        WoodlandMansionPieces.Placer woodlandmansionpieces$placer = new WoodlandMansionPieces.Placer(
            p_191152_0_,
            p_191152_4_);
    ...
    static class Grid {
        ...
        public boolean isRoomId(WoodlandMansionPieces.SimpleGrid p_191114_1_, int p_191114_2_, int p_191114_3_,
                                int p_191114_4_, int p_191114_5_) {
            return (this.floorRooms[p_191114_4_].get(p_191114_2_, p_191114_3_) & 65535) == p_191114_5_;
        }

        @Nullable
        public EnumFacing get1x2RoomDirection(WoodlandMansionPieces.SimpleGrid p_191113_1_, int p_191113_2_,
                                              int p_191113_3_, int p_191113_4_, int p_191113_5_) {
            for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                if (this.isRoomId(
                    p_191113_1_,
                    p_191113_2_ + enumfacing.getFrontOffsetX(),
                    p_191113_3_ + enumfacing.getFrontOffsetZ(),
                    p_191113_4_,
                    p_191113_5_)) {
                    return enumfacing;
                }
        ...
        private void recursiveCorridor(WoodlandMansionPieces.SimpleGrid p_191110_1_, int p_191110_2_, int p_191110_3_,
                                       EnumFacing p_191110_4_, int p_191110_5_) {
            if (p_191110_5_ > 0) {
                p_191110_1_.set(p_191110_2_, p_191110_3_, 1);
                p_191110_1_.setIf(
                    p_191110_2_ + p_191110_4_.getFrontOffsetX(),
                    p_191110_3_ + p_191110_4_.getFrontOffsetZ(),
                    0,
                    1);
                ...
                for (int i = 0; i < 8; ++i) {
                    ...
                    if (enumfacing != p_191110_4_.getOpposite()
                        && (enumfacing != EnumFacing.EAST || !this.random.nextBoolean())) {
                        int j = p_191110_2_ + p_191110_4_.getFrontOffsetX();
                        int k = p_191110_3_ + p_191110_4_.getFrontOffsetZ();

                        if (p_191110_1_.get(j + enumfacing.getFrontOffsetX(), k + enumfacing.getFrontOffsetZ()) == 0
                            && p_191110_1_
                            .get(j + enumfacing.getFrontOffsetX() * 2, k + enumfacing.getFrontOffsetZ() * 2) == 0) {
                            this.recursiveCorridor(
                                p_191110_1_,
                                p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing.getFrontOffsetX(),
                                p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing.getFrontOffsetZ(),
                                enumfacing,
                                p_191110_5_ - 1);
                            break;
                        }
                ...
                p_191110_1_.setIf(
                    p_191110_2_ + enumfacing1.getFrontOffsetX(),
                    p_191110_3_ + enumfacing1.getFrontOffsetZ(),
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + enumfacing2.getFrontOffsetX(),
                    p_191110_3_ + enumfacing2.getFrontOffsetZ(),
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing1.getFrontOffsetX(),
                    p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing1.getFrontOffsetZ(),
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + p_191110_4_.getFrontOffsetX() + enumfacing2.getFrontOffsetX(),
                    p_191110_3_ + p_191110_4_.getFrontOffsetZ() + enumfacing2.getFrontOffsetZ(),
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + p_191110_4_.getFrontOffsetX() * 2,
                    p_191110_3_ + p_191110_4_.getFrontOffsetZ() * 2,
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + enumfacing1.getFrontOffsetX() * 2,
                    p_191110_3_ + enumfacing1.getFrontOffsetZ() * 2,
                    0,
                    2);
                p_191110_1_.setIf(
                    p_191110_2_ + enumfacing2.getFrontOffsetX() * 2,
                    p_191110_3_ + enumfacing2.getFrontOffsetZ() * 2,
                    0,
                    2);
            }
        }
        ...
        private void setupThirdFloor() {
            ...
            if (list.isEmpty()) {
                ...
                int l1 = woodlandmansionpieces$simplegrid
                    .get(((Integer) tuple.getFirst()).intValue(), ((Integer) tuple.getSecond()).intValue());
                woodlandmansionpieces$simplegrid.set(
                    ((Integer) tuple.getFirst()).intValue(),
                    ((Integer) tuple.getSecond()).intValue(),
                    l1 | 4194304);
                EnumFacing enumfacing1 = this.get1x2RoomDirection(
                    this.baseGrid,
                    ((Integer) tuple.getFirst()).intValue(),
                    ((Integer) tuple.getSecond()).intValue(),
                    1,
                ...
                for (int j1 = 0; j1 < this.thirdFloorGrid.height; ++j1) {
                    for (int k1 = 0; k1 < this.thirdFloorGrid.width; ++k1) {
                        ...
                        } else if (k1 == ((Integer) tuple.getFirst()).intValue()
                            && j1 == ((Integer) tuple.getSecond()).intValue()) {
                ...
                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                    if (this.thirdFloorGrid.get(i2 + enumfacing.getFrontOffsetX(), i1 + enumfacing.getFrontOffsetZ())
                        == 0) {
                ...
                if (list1.isEmpty()) {
                    ...
                    woodlandmansionpieces$simplegrid
                        .set(((Integer) tuple.getFirst()).intValue(), ((Integer) tuple.getSecond()).intValue(), l1);
                } else {
                    EnumFacing enumfacing2 = list1.get(this.random.nextInt(list1.size()));
                    this.recursiveCorridor(
                        this.thirdFloorGrid,
                        i2 + enumfacing2.getFrontOffsetX(),
                        i1 + enumfacing2.getFrontOffsetZ(),
                        enumfacing2,
                        4);
        ...
        private void identifyRooms(WoodlandMansionPieces.SimpleGrid p_191116_1_,
            ...
            for (Tuple<Integer, Integer> tuple : list) {
                ...
                if (p_191116_2_.get(k, l) == 0) {
                    ...
                    if (p_191116_2_.get(k + 1, l) == 0 && p_191116_2_.get(k, l + 1) == 0
                        && p_191116_2_.get(k + 1, l + 1) == 0
                        && p_191116_1_.get(k + 1, l) == 2
                        && p_191116_1_.get(k, l + 1) == 2
                        && p_191116_1_.get(k + 1, l + 1) == 2) {
                        j1 = k + 1;
                        l1 = l + 1;
                        i2 = 262144;
                    } else if (p_191116_2_.get(k - 1, l) == 0 && p_191116_2_.get(k, l + 1) == 0
                        && p_191116_2_.get(k - 1, l + 1) == 0
                        && p_191116_1_.get(k - 1, l) == 2
                        && p_191116_1_.get(k, l + 1) == 2
                        && p_191116_1_.get(k - 1, l + 1) == 2) {
    ...
    public static class MansionTemplate extends StructureComponentTemplate {
        ...
        public MansionTemplate(TemplateManager p_i47355_1_, String p_i47355_2_, BlockPos p_i47355_3_,
                               Rotation p_i47355_4_) {
            this(p_i47355_1_, p_i47355_2_, p_i47355_3_, p_i47355_4_, Mirror.NONE);
        }

        public MansionTemplate(TemplateManager p_i47356_1_, String p_i47356_2_, BlockPos p_i47356_3_,
                               Rotation p_i47356_4_, Mirror p_i47356_5_) {
            super(0);
        ...
        private void loadTemplate(TemplateManager p_191081_1_) {
            Template template = p_191081_1_
                .getTemplate((MinecraftServer) null, new ResourceLocation("mansion/" + this.templateName));
        ...
        protected void handleDataMarker(String function, BlockPos pos, World worldIn, Random rand,
            ...
            if (function.startsWith("Chest")) {
                ...
                entityvindicator.onInitialSpawn(
                    worldIn.getDifficultyForLocation(new BlockPos(entityvindicator)),
    ...
    static class Placer {
        ...
        public void createMansion(BlockPos p_191125_1_, Rotation p_191125_2_,
                                  List<WoodlandMansionPieces.MansionTemplate> p_191125_3_, WoodlandMansionPieces.Grid p_191125_4_) {
            ...
            this.traverseOuterWalls(
                p_191125_3_,
                woodlandmansionpieces$placementdata1,
                woodlandmansionpieces$simplegrid,
                EnumFacing.SOUTH,
                this.startX,
                this.startY,
                ...
                for (int l = woodlandmansionpieces$simplegrid1.width - 1; l >= 0 && !flag; --l) {
                    if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid1, l, k)) {
                        woodlandmansionpieces$placementdata2.position = woodlandmansionpieces$placementdata2.position
                            .offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k - this.startY) * 8);
                        woodlandmansionpieces$placementdata2.position = woodlandmansionpieces$placementdata2.position
                            .offset(p_191125_2_.rotate(EnumFacing.EAST), (l - this.startX) * 8);
                        this.traverseWallPiece(p_191125_3_, woodlandmansionpieces$placementdata2);
                        this.traverseOuterWalls(
                            p_191125_3_,
                            woodlandmansionpieces$placementdata2,
            ...
            this.createRoof(
                ...
                p_191125_2_,
                woodlandmansionpieces$simplegrid1,
                (WoodlandMansionPieces.SimpleGrid) null);
                    ...
                    for (int j1 = 0; j1 < woodlandmansionpieces$simplegrid3.width; ++j1) {
                        if (woodlandmansionpieces$simplegrid3.get(j1, i1) == 1) {
                            BlockPos blockpos1 = blockpos
                                .offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (i1 - this.startY) * 8);
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 - 1) == 1
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        "carpet_north",
                                        blockpos1.offset(p_191125_2_.rotate(EnumFacing.EAST), 1)
                                            .up(),
                                        p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(j1 + 1, i1) == 1
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        "carpet_east",
                                        blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 1)
                                            .offset(p_191125_2_.rotate(EnumFacing.EAST), 5)
                                            .up(),
                                        p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(j1, i1 + 1) == 1
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        s,
                                        blockpos1.offset(p_191125_2_.rotate(EnumFacing.SOUTH), 5)
                                            .offset(p_191125_2_.rotate(EnumFacing.WEST), 1),
                                        p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(j1 - 1, i1) == 1
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        s1,
                                        blockpos1.offset(p_191125_2_.rotate(EnumFacing.WEST), 1)
                                            .offset(p_191125_2_.rotate(EnumFacing.NORTH), 1),
                                        p_191125_2_));
                            }
                        }
                    }
                    ...
                    for (int l1 = 0; l1 < woodlandmansionpieces$simplegrid3.width; ++l1) {
                        ...
                        if (woodlandmansionpieces$simplegrid3.get(l1, k1) == 2 || flag1) {
                            ...
                            if ((i2 & 2097152) == 2097152) {
                                for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL.facings()) {
                                    if (woodlandmansionpieces$simplegrid3
                                        .get(l1 + enumfacing.getFrontOffsetX(), k1 + enumfacing.getFrontOffsetZ())
                                        == 1) {
                                        list.add(enumfacing);
                                    }
                                }
                            ...
                            BlockPos blockpos2 = blockpos
                                .offset(p_191125_2_.rotate(EnumFacing.SOUTH), 8 + (k1 - this.startY) * 8);
                            blockpos2 = blockpos2
                                .offset(p_191125_2_.rotate(EnumFacing.EAST), -1 + (l1 - this.startX) * 8);

                            if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1 - 1, k1)
                                && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1 - 1, k1, l2, k2)) {
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        enumfacing1 == EnumFacing.WEST ? s3 : s2,
                                        blockpos2,
                                        p_191125_2_));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1 + 1, k1) == 1 && !flag1) {
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        enumfacing1 == EnumFacing.EAST ? s3 : s2,
                                        blockpos3,
                                        p_191125_2_));
                            }

                            if (WoodlandMansionPieces.Grid.isHouse(woodlandmansionpieces$simplegrid3, l1, k1 + 1)
                                && !p_191125_4_.isRoomId(woodlandmansionpieces$simplegrid3, l1, k1 + 1, l2, k2)) {
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        enumfacing1 == EnumFacing.SOUTH ? s3 : s2,
                                        blockpos4,
                                        p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (woodlandmansionpieces$simplegrid3.get(l1, k1 - 1) == 1 && !flag1) {
                                ...
                                p_191125_3_.add(
                                    new WoodlandMansionPieces.MansionTemplate(
                                        this.templateManager,
                                        enumfacing1 == EnumFacing.NORTH ? s3 : s2,
                                        blockpos5,
                                        p_191125_2_.add(Rotation.CLOCKWISE_90)));
                            }
                            ...
                            if (j2 == 65536) {
                                this.addRoom1x1(
                                    ...
                                    p_191125_2_,
                                    enumfacing1,
                                    awoodlandmansionpieces$roomcollection[l2]);
                            } else if (j2 == 131072 && enumfacing1 != null) {
                                EnumFacing enumfacing3 = p_191125_4_
                                    .get1x2RoomDirection(woodlandmansionpieces$simplegrid3, l1, k1, l2, k2);
                                ...
                                if (!p_191125_4_.isRoomId(
                                    woodlandmansionpieces$simplegrid3,
                                    l1 + enumfacing2.getFrontOffsetX(),
                                    k1 + enumfacing2.getFrontOffsetZ(),
                                    l2,
                                    k2)) {
        ...
        private void traverseOuterWalls(List<WoodlandMansionPieces.MansionTemplate> p_191130_1_,
                                        WoodlandMansionPieces.PlacementData p_191130_2_, WoodlandMansionPieces.SimpleGrid p_191130_3_,
                                        EnumFacing p_191130_4_, int p_191130_5_, int p_191130_6_, int p_191130_7_, int p_191130_8_) {
            int i = p_191130_5_;
            int j = p_191130_6_;
            EnumFacing enumfacing = p_191130_4_;

            while (true) {
                if (!WoodlandMansionPieces.Grid
                    .isHouse(p_191130_3_, i + p_191130_4_.getFrontOffsetX(), j + p_191130_4_.getFrontOffsetZ())) {
                ...
                } else if (WoodlandMansionPieces.Grid
                    .isHouse(p_191130_3_, i + p_191130_4_.getFrontOffsetX(), j + p_191130_4_.getFrontOffsetZ())
                    && WoodlandMansionPieces.Grid.isHouse(
                    p_191130_3_,
                    i + p_191130_4_.getFrontOffsetX()
                        + p_191130_4_.rotateYCCW()
                        .getFrontOffsetX(),
        ...
        private void createRoof(List<WoodlandMansionPieces.MansionTemplate> p_191123_1_, BlockPos p_191123_2_,
                                Rotation p_191123_3_, WoodlandMansionPieces.SimpleGrid p_191123_4_,
                                @Nullable WoodlandMansionPieces.SimpleGrid p_191123_5_) {
            for (int i = 0; i < p_191123_4_.height; ++i) {
                for (int j = 0; j < p_191123_4_.width; ++j) {
                    BlockPos lvt_8_3_ = p_191123_2_
                        .offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (i - this.startY) * 8);
                        ...
                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, j - 1, i)) {
                            ...
                            p_191123_1_.add(
                                new WoodlandMansionPieces.MansionTemplate(
                                    ...
                                    "roof_front",
                                    blockpos5,
                                    p_191123_3_.add(Rotation.CLOCKWISE_180)));
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, j, i - 1)) {
                            ...
                            p_191123_1_.add(
                                new WoodlandMansionPieces.MansionTemplate(
                                    ...
                                    "roof_front",
                                    blockpos6,
                                    p_191123_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                        }
                        ...
                        if (!WoodlandMansionPieces.Grid.isHouse(p_191123_4_, j, i + 1)) {
                            ...
                            p_191123_1_.add(
                                new WoodlandMansionPieces.MansionTemplate(
                                    ...
                                    "roof_front",
                                    blockpos7,
                                    p_191123_3_.add(Rotation.CLOCKWISE_90)));
                        }
                    }
                }
            }
            ...
            if (p_191123_5_ != null) {
                for (int k = 0; k < p_191123_4_.height; ++k) {
                    for (int i1 = 0; i1 < p_191123_4_.width; ++i1) {
                        BlockPos blockpos3 = p_191123_2_
                            .offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (k - this.startY) * 8);
            ...
            for (int l = 0; l < p_191123_4_.height; ++l) {
                for (int j1 = 0; j1 < p_191123_4_.width; ++j1) {
                    BlockPos blockpos4 = p_191123_2_
                        .offset(p_191123_3_.rotate(EnumFacing.SOUTH), 8 + (l - this.startY) * 8);
        ...
        private void entrance(List<WoodlandMansionPieces.MansionTemplate> p_191133_1_,
                              WoodlandMansionPieces.PlacementData p_191133_2_) {
            EnumFacing enumfacing = p_191133_2_.rotation.rotate(EnumFacing.WEST);
            p_191133_1_.add(
                new WoodlandMansionPieces.MansionTemplate(
                    this.templateManager,
                    "entrance",
                    p_191133_2_.position.offset(enumfacing, 9),
                    p_191133_2_.rotation));
            p_191133_2_.position = p_191133_2_.position.offset(p_191133_2_.rotation.rotate(EnumFacing.SOUTH), 16);
        }

        private void traverseWallPiece(List<WoodlandMansionPieces.MansionTemplate> p_191131_1_,
                                       WoodlandMansionPieces.PlacementData p_191131_2_) {
            p_191131_1_.add(
                new WoodlandMansionPieces.MansionTemplate(
                    this.templateManager,
                    p_191131_2_.wallType,
                    p_191131_2_.position.offset(p_191131_2_.rotation.rotate(EnumFacing.EAST), 7),
                    p_191131_2_.rotation));
            p_191131_2_.position = p_191131_2_.position.offset(p_191131_2_.rotation.rotate(EnumFacing.SOUTH), 8);
        }

        private void traverseTurn(List<WoodlandMansionPieces.MansionTemplate> p_191124_1_,
                                  WoodlandMansionPieces.PlacementData p_191124_2_) {
            p_191124_2_.position = p_191124_2_.position.offset(p_191124_2_.rotation.rotate(EnumFacing.SOUTH), -1);
            p_191124_1_.add(
                new WoodlandMansionPieces.MansionTemplate(
                    this.templateManager,
                    "wall_corner",
                    p_191124_2_.position,
                    p_191124_2_.rotation));
        ...
        private void traverseInnerTurn(List<WoodlandMansionPieces.MansionTemplate> p_191126_1_,
                                       WoodlandMansionPieces.PlacementData p_191126_2_) {
        ...
        private void addRoom1x1(List<WoodlandMansionPieces.MansionTemplate> p_191129_1_, BlockPos p_191129_2_,
                                Rotation p_191129_3_, EnumFacing p_191129_4_, WoodlandMansionPieces.RoomCollection p_191129_5_) {
            ...
            BlockPos blockpos = Template
                .getZeroPositionWithTransform(new BlockPos(1, 0, 0), Mirror.NONE, rotation, 7, 7);
        ...
        private void addRoom1x2(List<WoodlandMansionPieces.MansionTemplate> p_191132_1_, BlockPos p_191132_2_,
                                Rotation p_191132_3_, EnumFacing p_191132_4_, EnumFacing p_191132_5_,
                                WoodlandMansionPieces.RoomCollection p_191132_6_, boolean p_191132_7_) {
            if (p_191132_5_ == EnumFacing.EAST && p_191132_4_ == EnumFacing.SOUTH) {
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        this.templateManager,
                        p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_),
                        blockpos13,
                        p_191132_3_));
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        ...
                        p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_),
                        blockpos11,
                        p_191132_3_.add(Rotation.CLOCKWISE_180)));
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        ...
                        p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_),
                        blockpos9,
                        p_191132_3_.add(Rotation.CLOCKWISE_90),
                        Mirror.LEFT_RIGHT));
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        ...
                        p_191132_6_.get1x2SideEntrance(this.random, p_191132_7_),
                        blockpos6,
                        p_191132_3_.add(Rotation.COUNTERCLOCKWISE_90)));
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        this.templateManager,
                        p_191132_6_.get1x2FrontEntrance(this.random, p_191132_7_),
                        blockpos5,
                        p_191132_3_));
                ...
                p_191132_1_.add(
                    new WoodlandMansionPieces.MansionTemplate(
                        this.templateManager,
                        p_191132_6_.get1x2Secret(this.random),
                        blockpos1,
                        p_191132_3_.add(Rotation.CLOCKWISE_90)));
        ...
        private void addRoom2x2(List<WoodlandMansionPieces.MansionTemplate> p_191127_1_, BlockPos p_191127_2_,
                                Rotation p_191127_3_, EnumFacing p_191127_4_, EnumFacing p_191127_5_,
            ...
            p_191127_1_.add(
                new WoodlandMansionPieces.MansionTemplate(
                    this.templateManager,
                    p_191127_6_.get2x2(this.random),
                    blockpos,
                    rotation,
                    mirror));
        }

        private void addRoom2x2Secret(List<WoodlandMansionPieces.MansionTemplate> p_191128_1_, BlockPos p_191128_2_,
                                      Rotation p_191128_3_, WoodlandMansionPieces.RoomCollection p_191128_4_) {
            BlockPos blockpos = p_191128_2_.offset(p_191128_3_.rotate(EnumFacing.EAST), 1);
            p_191128_1_.add(
                new WoodlandMansionPieces.MansionTemplate(
                    this.templateManager,
                    p_191128_4_.get2x2Secret(this.random),
                    blockpos,
                    p_191128_3_,
                    Mirror.NONE));
        }
    ...
    static class SimpleGrid {
        ...
        public int get(int p_191145_1_, int p_191145_2_) {
            return p_191145_1_ >= 0 && p_191145_1_ < this.width && p_191145_2_ >= 0 && p_191145_2_ < this.height
                ? this.grid[p_191145_1_][p_191145_2_]
                : this.valueIfOutside;
        }
        ...
        public boolean edgesTo(int p_191147_1_, int p_191147_2_, int p_191147_3_) {
            return this.get(p_191147_1_ - 1, p_191147_2_) == p_191147_3_
                || this.get(p_191147_1_ + 1, p_191147_2_) == p_191147_3_
                || this.get(p_191147_1_, p_191147_2_ + 1) == p_191147_3_
                || this.get(p_191147_1_, p_191147_2_ - 1) == p_191147_3_;
        }
    }

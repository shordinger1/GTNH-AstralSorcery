...
public class RandomValueRange {
    ...
    public static class Serializer implements JsonDeserializer<RandomValueRange>, JsonSerializer<RandomValueRange> {
        ...
        public RandomValueRange deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
        ...
        public JsonElement serialize(RandomValueRange p_serialize_1_, Type p_serialize_2_,

...
import shordinger.wrapper.net.minecraft.entity.EntitySpawnPlacementRegistry;
...
public final class WorldEntitySpawner {
                    ...
                    for (int i1 = -8; i1 <= 8; ++i1) {
                        for (int j1 = -8; j1 <= 8; ++j1) {
                            ...
                            if (!this.eligibleChunksForSpawning.contains(chunkpos)) {
                                ...
                                if (!flag && worldServerIn.getWorldBorder()
                                    .contains(chunkpos)) {
                            ...
                            if (!iblockstate.isNormalCube()) {
                                ...
                                for (int k2 = 0; k2 < 3; ++k2) {
                                    ...
                                    for (int i4 = 0; i4 < l3; ++i4) {
                                        ...
                                        if (!worldServerIn
                                            .isAnyPlayerWithinRangeAt((double) f, (double) i3, (double) f1, 24.0D)
                                            ...
                                            if (worldServerIn.canCreatureTypeSpawnHere(
                                                enumcreaturetype,
                                                biome$spawnlistentry,
                                                blockpos$mutableblockpos)
                                                && canCreatureTypeSpawnAtLocation(
                                                EntitySpawnPlacementRegistry
                                                    .getPlacementForEntity(biome$spawnlistentry.entityClass),
                                                worldServerIn,
                                                blockpos$mutableblockpos)) {
                                                ...
                                                entityliving.setLocationAndAngles(
                                                    ...
                                                    (double) i3,
                                                    (double) f1,
                                                    worldServerIn.rand.nextFloat() * 360.0F,
                                                    0.0F);
                                                ...
                                                if (canSpawn
                                                    ...
                                                    if (!net.minecraftforge.event.ForgeEventFactory
                                                        .doSpecialSpawn(entityliving, worldServerIn, f, i3, f1))
                                                    ...
                                                    if (j2 >= net.minecraftforge.event.ForgeEventFactory
    ...
    public static boolean canCreatureTypeSpawnBody(EntityLiving.SpawnPlacementType spawnPlacementTypeIn, World worldIn,
                                                   BlockPos pos) {
        {
     ...
     */
    public static void performWorldGenSpawning(World worldIn, Biome biomeIn, int centerX, int centerZ, int diameterX,
                                               int diameterZ, Random randomIn) {
                    ...
                    for (int k1 = 0; !flag && k1 < 4; ++k1) {
                        ...
                        if (canCreatureTypeSpawnAtLocation(
                            ...
                            if (net.minecraftforge.event.ForgeEventFactory.canEntitySpawn(
                                ...
                                (float) blockpos.getY(),
                                k + 0.5f,
                                false) == net.minecraftforge.fml.common.eventhandler.Event.Result.DENY) continue;
                            entityliving.setLocationAndAngles(
                                (double) ((float) j + 0.5F),
                        ...
                        for (k += randomIn.nextInt(5) - randomIn.nextInt(5); j < centerX || j >= centerX + diameterX
                            || k < centerZ
                            || k >= centerZ + diameterX; k = i1 + randomIn.nextInt(5) - randomIn.nextInt(5)) {

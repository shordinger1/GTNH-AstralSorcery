...
public class WorldGenMegaJungle extends WorldGenHugeTrees {
    ...
    public WorldGenMegaJungle(boolean notify, int baseHeightIn, int extraRandomHeightIn, IBlockState woodMetadataIn,
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        ...
        if (!this.ensureGrowable(worldIn, rand, position, i)) {
            ...
            for (int j = position.getY() + i - 2 - rand.nextInt(4); j
                > position.getY() + i / 2; j -= 2 + rand.nextInt(4)) {
        ...
        if (p_181632_2_.nextInt(3) > 0 && p_181632_1_.isAirBlock(p_181632_3_)) {
            this.setBlockAndNotifyAdequately(
                ...
                Blocks.VINE.getDefaultState()
                    .withProperty(p_181632_4_, Boolean.valueOf(true)));
        }
    }

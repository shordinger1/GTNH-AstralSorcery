package shordinger.wrapper.net.minecraft.world.storage.loot.conditions;
...
import shordinger.wrapper.net.minecraft.world.storage.loot.properties.EntityProperty;
import shordinger.wrapper.net.minecraft.world.storage.loot.properties.EntityPropertyManager;
...
public class EntityHasProperty implements LootCondition {
    ...
    public static class Serializer extends LootCondition.Serializer<EntityHasProperty> {
        ...
        public void serialize(JsonObject json, EntityHasProperty value, JsonSerializationContext context) {
            ...
            for (EntityProperty entityproperty : value.properties) {
                ...
                jsonobject.add(
                    serializer.getName()
                        .toString(),
                    serializer.serialize(entityproperty, context));
            }
        ...
        public EntityHasProperty deserialize(JsonObject json, JsonDeserializationContext context) {
            Set<Entry<String, JsonElement>> set = JsonUtils.getJsonObject(json, "properties")
                .entrySet();
            ...
            return new EntityHasProperty(
                aentityproperty,
                (LootContext.EntityTarget) JsonUtils
                    .deserializeClass(json, "entity", context, LootContext.EntityTarget.class));
        }
    }
}

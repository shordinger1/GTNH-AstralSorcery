...
public class WorldInfo {
        ...
        fixer.registerWalker(FixTypes.LEVEL, new IDataWalker() {
            ...
            public NBTTagCompound process(IDataFixer fixer, NBTTagCompound compound, int versionIn) {
                if (compound.hasKey("Player", 10)) {
                    compound
                        .setTag("Player", fixer.process(FixTypes.PLAYER, compound.getCompoundTag("Player"), versionIn));
                }
        ...
        category.addDetail("Level spawn location", new ICrashReportDetail<String>() {
            ...
            public String call() throws Exception {
                return CrashReportCategory
                    .getCoordinateInfo(WorldInfo.this.spawnX, WorldInfo.this.spawnY, WorldInfo.this.spawnZ);
            }
        });
    ...
    // Dimension numerical ID version of setter, as two dimensions could in theory have the same DimensionType. ID
    // should be grabbed from the world NOT the Type

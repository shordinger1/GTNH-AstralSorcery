...
public abstract class StructureComponentTemplate extends StructureComponent {
    ...
    public StructureComponentTemplate() {
        this.placeSettings = DEFAULT_PLACE_SETTINGS.setIgnoreEntities(true)
    ...
    protected void readStructureFromNBT(NBTTagCompound tagCompound, TemplateManager p_143011_2_) {
        this.templatePosition = new BlockPos(
            tagCompound.getInteger("TPX"),
            tagCompound.getInteger("TPY"),
    ...
    protected abstract void handleDataMarker(String function, BlockPos pos, World worldIn, Random rand,
    ...
    private void setBoundingBoxFromTemplate() {
        ...
        this.boundingBox
            .offset(this.templatePosition.getX(), this.templatePosition.getY(), this.templatePosition.getZ());
    }

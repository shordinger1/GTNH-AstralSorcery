    ...
    public static class Serializer implements JsonDeserializer<LootEntry>, JsonSerializer<LootEntry> {
        ...
        public LootEntry deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
            ...
            if (jsonobject.has("conditions")) {
                alootcondition = (LootCondition[]) JsonUtils
                    .deserializeClass(jsonobject, "conditions", p_deserialize_3_, LootCondition[].class);
            } else {
                alootcondition = new LootCondition[0];
            }

            LootEntry ret = net.minecraftforge.common.ForgeHooks
                .deserializeJsonLootEntry(s, jsonobject, i, j, alootcondition);
        ...
        public JsonElement serialize(LootEntry p_serialize_1_, Type p_serialize_2_,

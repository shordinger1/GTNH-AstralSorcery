...
import shordinger.wrapper.net.minecraft.block.BlockChorusFlower;
...
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenEndIsland;
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenEndCity;
...
public class ChunkGeneratorEnd implements IChunkGenerator {
    ...
    public ChunkGeneratorEnd(World p_i47241_1_, boolean p_i47241_2_, long p_i47241_3_, BlockPos p_i47241_5_) {
        ...
        this.endCityGen = (MapGenEndCity) net.minecraftforge.event.terraingen.TerrainGen
            .getModdedMapGen(this.endCityGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.END_CITY);
    }
    ...
    public void buildSurfaces(ChunkPrimer primer) {
        if (!net.minecraftforge.event.ForgeEventFactory
            .onReplaceBiomeBlocks(this, this.chunkX, this.chunkZ, primer, this.world)) return;
        for (int i = 0; i < 16; ++i) {
            for (int j = 0; j < 16; ++j) {
                int k = 1;
                int l = -1;
    ...
    public void populate(int x, int z) {
        ...
        this.world.getBiome(blockpos.add(16, 0, 16))
            .decorate(this.world, this.world.rand, blockpos);
        ...
        if (i > 4096L) {
            ...
            if (this.getIslandHeightValue(x, z, 1, 1) > 40.0F) {
                ...
                for (int k = 0; k < j; ++k) {
                    ...
                    int j1 = this.world.getHeight(blockpos.add(l, 0, i1))
                        .getY();
                    ...
                    if (j1 > 0) {
                        ...
                        if (this.world.isAirBlock(blockpos.add(l, k1 + 1, i1))
                            && this.world.getBlockState(blockpos.add(l, k1, i1))
                ...
                if (this.rand.nextInt(700) == 0) {
                    ...
                    int j2 = this.world.getHeight(blockpos.add(l1, 0, i2))
                        .getY();

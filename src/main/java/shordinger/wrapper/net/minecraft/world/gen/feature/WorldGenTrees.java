...
import shordinger.wrapper.net.minecraft.block.BlockCocoa;
...
public class WorldGenTrees extends WorldGenAbstractTree {
    ...
    public WorldGenTrees(boolean notify, int minTreeHeightIn, IBlockState woodMeta, IBlockState p_i46446_4_,
                         boolean growVines) {
        super(notify);
        ...
        if (position.getY() >= 1 && position.getY() + i + 1 <= worldIn.getHeight()) {
            ...
            if (!flag) {
                ...
                if (state.getBlock()
                    ...
                    state.getBlock()
                        .onPlantGrow(state, worldIn, position.down(), position);
                    int k2 = 3;
                    int l2 = 0;
                        ...
                        for (int k1 = position.getX() - j1; k1 <= position.getX() + j1; ++k1) {
                            ...
                            for (int i2 = position.getZ() - j1; i2 <= position.getZ() + j1; ++i2) {
                                ...
                                if (Math.abs(l1) != j1 || Math.abs(j2) != j1 || rand.nextInt(2) != 0 && i4 != 0) {
                                    ...
                                    if (state.getBlock()
                                        .isAir(state, worldIn, blockpos)
                                        || state.getBlock()
                                        .isLeaves(state, worldIn, blockpos)
                    ...
                    for (int j3 = 0; j3 < i; ++j3) {
                        ...
                        if (state.getBlock()
                            .isAir(state, worldIn, upN)
                            || state.getBlock()
                            .isLeaves(state, worldIn, upN)
                            || state.getMaterial() == Material.VINE) {
                        ...
                        for (int k3 = position.getY() - 3 + i; k3 <= position.getY() + i; ++k3) {
                            ...
                            for (int l4 = position.getX() - k4; l4 <= position.getX() + k4; ++l4) {
                                for (int i5 = position.getZ() - k4; i5 <= position.getZ() + k4; ++i5) {
                                    ...
                                    if (state.getBlock()
                                        .isLeaves(state, worldIn, blockpos$mutableblockpos1)) {

...
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenFire;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenGlowStone1;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenGlowStone2;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenHellLava;
...
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenNetherBridge;
...
public class ChunkGeneratorHell implements IChunkGenerator {
    ...
    public ChunkGeneratorHell(World worldIn, boolean p_i45637_2_, long seed) {
        ...
        this.genNetherBridge = (MapGenNetherBridge) net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(
            genNetherBridge,
        ...
        this.genNetherCaves = net.minecraftforge.event.terraingen.TerrainGen
            .getModdedMapGen(genNetherCaves, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.NETHER_CAVE);
    }
    ...
    public void buildSurfaces(int p_185937_1_, int p_185937_2_, ChunkPrimer primer) {
        if (!net.minecraftforge.event.ForgeEventFactory
            .onReplaceBiomeBlocks(this, p_185937_1_, p_185937_2_, primer, this.world)) return;
        ...
        this.gravelNoise = this.slowsandGravelNoiseGen.generateNoiseOctaves(
            ...
            1.0D,
            0.03125D);
        this.depthBuffer = this.netherrackExculsivityNoiseGen.generateNoiseOctaves(
            this.depthBuffer,
            p_185937_1_ * 16,
            p_185937_2_ * 16,
            0,
    ...
    public Chunk generateChunk(int x, int z) {
        ...
        Biome[] abiome = this.world.getBiomeProvider()
            .getBiomes((Biome[]) null, x * 16, z * 16, 16, 16);
    ...
    private double[] getHeights(double[] p_185938_1_, int p_185938_2_, int p_185938_3_, int p_185938_4_,
        ...
        this.noiseData4 = this.scaleNoise.generateNoiseOctaves(
            ...
            0.0D,
            1.0D);
        this.dr = this.depthNoise.generateNoiseOctaves(
            this.dr,
            p_185938_2_,
            p_185938_3_,
            p_185938_4_,
        ...
        this.pnr = this.perlinNoise1.generateNoiseOctaves(
            ...
            34.2206D,
            8.555150000000001D);
        this.ar = this.lperlinNoise1.generateNoiseOctaves(
            this.ar,
            p_185938_2_,
            p_185938_3_,
            p_185938_4_,
            ...
            2053.236D,
            684.412D);
        this.br = this.lperlinNoise2.generateNoiseOctaves(
            this.br,
            p_185938_2_,
            p_185938_3_,
            p_185938_4_,
    ...
    public void populate(int x, int z) {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS
            .post(new net.minecraftforge.event.terraingen.DecorateBiomeEvent.Pre(this.world, this.rand, chunkpos));
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            if (this.rand.nextBoolean()) {
                this.redMushroomFeature.generate(
                    this.world,
                    this.rand,
                    blockpos.add(this.rand.nextInt(16) + 8, this.rand.nextInt(128), this.rand.nextInt(16) + 8));
            }
    ...
    public List<Biome.SpawnListEntry> getPossibleCreatures(EnumCreatureType creatureType, BlockPos pos) {
        if (creatureType == EnumCreatureType.MONSTER) {
            ...
            if (this.genNetherBridge.isPositionInStructure(this.world, pos) && this.world.getBlockState(pos.down())
    ...
    public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position,
        ...
        return "Fortress".equals(structureName) && this.genNetherBridge != null
            ? this.genNetherBridge.getNearestStructurePos(worldIn, position, findUnexplored)
            : null;
    }

    public boolean isInsideStructure(World worldIn, String structureName, BlockPos pos) {
        return "Fortress".equals(structureName) && this.genNetherBridge != null
            ? this.genNetherBridge.isInsideStructure(pos)
            : false;
    }

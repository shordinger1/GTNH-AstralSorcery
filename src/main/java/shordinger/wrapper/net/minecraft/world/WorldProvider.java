...
public abstract class WorldProvider {
    ...
    public final void setWorld(World worldIn) {
        ...
        this.terrainType = worldIn.getWorldInfo()
            .getTerrainType();
        this.generatorSettings = worldIn.getWorldInfo()
            .getGeneratorOptions();
        this.init();
    ...
    public boolean canCoordinateBeSpawn(int x, int z) {
        ...
        if (this.world.getBiome(blockpos)
            .ignorePlayerSpawnSuitability()) {
            return true;
        } else {
            return this.world.getGroundAboveSeaLevel(blockpos)
    ...
    public BlockPos getRandomizedSpawnPoint() {
        ...
        int spawnFuzz = this.world instanceof WorldServer
            ? terrainType.getSpawnFuzz((WorldServer) this.world, this.world.getMinecraftServer())
            : 1;
        ...
        if (!isNether() && !isAdventure && spawnFuzz != 0) {
            ...
            ret = world.getTopSolidOrLiquidBlock(
                ret.add(
                    spawnFuzzHalf - world.rand.nextInt(spawnFuzz),
                    0,
                    spawnFuzzHalf - world.rand.nextInt(spawnFuzz)));
        }
    ...
    public WorldSleepResult canSleepAt(net.minecraft.entity.player.EntityPlayer player, BlockPos pos) {
        return (this.canRespawnHere() && this.world.getBiome(pos) != net.minecraft.init.Biomes.HELL)
    ...
    public double getHorizon() {
        return world.worldInfo.getTerrainType()
            .getHorizon(world);
    }

...
public class BiomeHills extends Biome {
    ...
    private final WorldGenerator silverfishSpawner = new WorldGenMinable(
        Blocks.MONSTER_EGG.getDefaultState()
            .withProperty(BlockSilverfish.VARIANT, BlockSilverfish.EnumType.STONE),
        9);
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos) {
        ...
        net.minecraftforge.common.MinecraftForge.ORE_GEN_BUS
            .post(new net.minecraftforge.event.terraingen.OreGenEvent.Pre(worldIn, rand, pos));
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
            ...
            emeralds,
            pos,
            net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.EMERALD))
        ...
        for (int j1 = 0; j1 < 7; ++j1) {
            ...
            if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
                ...
                silverfishSpawner,
                pos.add(j1, k1, l1),
                net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.SILVERFISH))
                this.silverfishSpawner.generate(worldIn, rand, pos.add(k1, l1, i2));
        }
        net.minecraftforge.common.MinecraftForge.ORE_GEN_BUS
            .post(new net.minecraftforge.event.terraingen.OreGenEvent.Post(worldIn, rand, pos));
    }
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (state.getBlock()
                    .isReplaceableOreGen(
                        ...
                        worldIn,
                        blockpos,
                        net.minecraft.block.state.pattern.BlockMatcher.forBlock(Blocks.STONE))) {

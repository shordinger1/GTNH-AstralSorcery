...
import shordinger.wrapper.net.minecraft.block.BlockRail;
...
public class StructureMineshaftPieces {
    ...
    private static StructureMineshaftPieces.Peice createRandomShaftPiece(List<StructureComponent> p_189940_0_,
                                                                         Random p_189940_1_, int p_189940_2_, int p_189940_3_, int p_189940_4_, @Nullable EnumFacing p_189940_5_,
                                                                         int p_189940_6_, MapGenMineshaft.Type p_189940_7_) {
        int i = p_189940_1_.nextInt(100);

        if (i >= 80) {
            StructureBoundingBox structureboundingbox = StructureMineshaftPieces.Cross
                .findCrossing(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);
            ...
            StructureBoundingBox structureboundingbox1 = StructureMineshaftPieces.Stairs
                .findStairs(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

            if (structureboundingbox1 != null) {
                return new StructureMineshaftPieces.Stairs(
                    p_189940_6_,
                    p_189940_1_,
            ...
            StructureBoundingBox structureboundingbox2 = StructureMineshaftPieces.Corridor
                .findCorridorSize(p_189940_0_, p_189940_1_, p_189940_2_, p_189940_3_, p_189940_4_, p_189940_5_);

            if (structureboundingbox2 != null) {
                return new StructureMineshaftPieces.Corridor(
                    p_189940_6_,
                    p_189940_1_,
    ...
    private static StructureMineshaftPieces.Peice generateAndAddPiece(StructureComponent p_189938_0_,
                                                                      List<StructureComponent> p_189938_1_, Random p_189938_2_, int p_189938_3_, int p_189938_4_, int p_189938_5_,
                                                                      EnumFacing p_189938_6_, int p_189938_7_) {
        if (p_189938_7_ > 8) {
            return null;
            ...
            StructureMineshaftPieces.Peice structuremineshaftpieces$peice = createRandomShaftPiece(
                p_189938_1_,
                p_189938_2_,
                p_189938_3_,
                p_189938_4_,
    ...
    public static class Corridor extends StructureMineshaftPieces.Peice {
            ...
            if (this.isLiquidInStructureBoundingBox(worldIn, structureBoundingBoxIn)) {
                ...
                for (int j1 = 0; j1 < this.sectionCount; ++j1) {
                    ...
                    if (this.hasSpiders && !this.spawnerPlaced) {
                        ...
                        if (structureBoundingBoxIn.isVecInside(blockpos)
                            && this.getSkyBrightness(worldIn, 1, 0, i2, structureBoundingBoxIn) < 8) {
                ...
                for (int l2 = 0; l2 <= 2; ++l2) {
                    for (int i3 = 0; i3 <= i1; ++i3) {
                        int k3 = -1;
                        IBlockState iblockstate3 = this
                            .getBlockStateFromPos(worldIn, l2, -1, i3, structureBoundingBoxIn);

                        if (iblockstate3.getMaterial() == Material.AIR
                            && this.getSkyBrightness(worldIn, l2, -1, i3, structureBoundingBoxIn) < 8) {
                            int l3 = -1;
                ...
                if (this.hasRails) {
                    ...
                    for (int j3 = 0; j3 <= i1; ++j3) {
                        IBlockState iblockstate2 = this
                            .getBlockStateFromPos(worldIn, 1, -1, j3, structureBoundingBoxIn);

                        if (iblockstate2.getMaterial() != Material.AIR && iblockstate2.isFullBlock()) {
                            float f = this.getSkyBrightness(worldIn, 1, 0, j3, structureBoundingBoxIn) > 8 ? 0.9F
                                : 0.7F;
        ...
        private void placeSupport(World p_189921_1_, StructureBoundingBox p_189921_2_, int p_189921_3_, int p_189921_4_,
                                  int p_189921_5_, int p_189921_6_, int p_189921_7_, Random p_189921_8_) {
        ...
        private void placeCobWeb(World p_189922_1_, StructureBoundingBox p_189922_2_, Random p_189922_3_,
                                 float p_189922_4_, int p_189922_5_, int p_189922_6_, int p_189922_7_) {
    ...
    public static class Cross extends StructureMineshaftPieces.Peice {
        ...
        public Cross(int p_i47139_1_, Random p_i47139_2_, StructureBoundingBox p_i47139_3_,
                     @Nullable EnumFacing p_i47139_4_, MapGenMineshaft.Type p_i47139_5_) {
                ...
                for (int i = this.boundingBox.minX; i <= this.boundingBox.maxX; ++i) {
                    for (int j = this.boundingBox.minZ; j <= this.boundingBox.maxZ; ++j) {
                        if (this.getBlockStateFromPos(worldIn, i, this.boundingBox.minY - 1, j, structureBoundingBoxIn)
                            .getMaterial() == Material.AIR
                            && this.getSkyBrightness(worldIn, i, this.boundingBox.minY - 1, j, structureBoundingBoxIn)
                            < 8) {
                            this.setBlockState(
                                worldIn,
                                iblockstate,
    ...
    public static class Room extends StructureMineshaftPieces.Peice {
        ...
        public Room(int p_i47137_1_, Random p_i47137_2_, int p_i47137_3_, int p_i47137_4_,
            ...
            this.boundingBox = new StructureBoundingBox(
                ...
                50,
                p_i47137_4_,
                p_i47137_3_ + 7 + p_i47137_2_.nextInt(6),
                54 + p_i47137_2_.nextInt(6),
                p_i47137_4_ + 7 + p_i47137_2_.nextInt(6));
        }
        ...
        public void buildComponent(StructureComponent componentIn, List<StructureComponent> listIn, Random rand) {
            ...
            for (k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice = StructureMineshaftPieces
                    .generateAndAddPiece(
                        componentIn,
                        listIn,
                        rand,
            ...
            for (k = 0; k < this.boundingBox.getXSize(); k = k + 4) {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice1 = StructureMineshaftPieces
                    .generateAndAddPiece(
                        componentIn,
                        listIn,
                        rand,
            ...
            for (k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                StructureMineshaftPieces.Peice structuremineshaftpieces$peice2 = StructureMineshaftPieces
                    .generateAndAddPiece(
                        componentIn,
                        listIn,
                        rand,
            ...
            for (k = 0; k < this.boundingBox.getZSize(); k = k + 4) {
                ...
                StructureComponent structurecomponent = StructureMineshaftPieces.generateAndAddPiece(
                    componentIn,
                    listIn,
                    rand,
                    this.boundingBox.maxX + 1,

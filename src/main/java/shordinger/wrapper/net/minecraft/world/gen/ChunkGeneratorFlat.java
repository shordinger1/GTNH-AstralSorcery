...
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenStructure;
...
public class ChunkGeneratorFlat implements IChunkGenerator {
    ...
    public ChunkGeneratorFlat(World worldIn, long seed, boolean generateStructures, String flatGeneratorSettings) {
        ...
        if (this.flatWorldGenInfo.getWorldFeatures()
            .containsKey("lake")) {
        ...
        this.hasDungeons = this.flatWorldGenInfo.getWorldFeatures()
            .containsKey("dungeon");
        int j = 0;
        int k = 0;
        boolean flag = true;
        ...
        for (FlatLayerInfo flatlayerinfo : this.flatWorldGenInfo.getFlatLayers()) {
            ...
            if (flatlayerinfo.getLayerMaterial()
                .getBlock() == Blocks.AIR) {
        ...
        this.hasDecoration = flag && this.flatWorldGenInfo.getBiome() != Biome.getIdForBiome(Biomes.VOID) ? false
            : this.flatWorldGenInfo.getWorldFeatures()
    ...
    public void populate(int x, int z) {
        ...
        if (this.waterLakeGenerator != null && !flag && this.random.nextInt(4) == 0) {
            this.waterLakeGenerator.generate(
                this.world,
                this.random,
    ...
    public BlockPos getNearestStructurePos(World worldIn, String structureName, BlockPos position,
        ...
        return mapgenstructure != null ? mapgenstructure.getNearestStructurePos(worldIn, position, findUnexplored)
            : null;
    }

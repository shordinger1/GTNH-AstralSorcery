...
import shordinger.wrapper.net.minecraft.world.biome.BiomeJungle;
...
public class GenLayerShore extends GenLayer {
        ...
        for (int i = 0; i < areaHeight; ++i) {
            for (int j = 0; j < areaWidth; ++j) {
                ...
                if (k == Biome.getIdForBiome(Biomes.MUSHROOM_ISLAND)) {
                    ...
                    if (this.isJungleCompatible(i2) && this.isJungleCompatible(l2)
                        && this.isJungleCompatible(k3)
                        && this.isJungleCompatible(j4)) {
    ...
    private void replaceIfNeighborOcean(int[] p_151632_1_, int[] p_151632_2_, int p_151632_3_, int p_151632_4_,
                                        int p_151632_5_, int p_151632_6_, int p_151632_7_) {
    ...
    private boolean isJungleCompatible(int p_151631_1_) {
        if (Biome.getBiome(p_151631_1_) != null && Biome.getBiome(p_151631_1_)
            .getBiomeClass() == BiomeJungle.class) {
            return true;
        } else {

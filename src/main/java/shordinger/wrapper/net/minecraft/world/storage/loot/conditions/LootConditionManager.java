...
public class LootConditionManager {
    ...
    public static boolean testAllConditions(Iterable<LootCondition> conditions, Random rand, LootContext context) {
        ...
        for (LootCondition cond : conditions) if (!cond.testCondition(rand, context)) return false;
        return true;
    }
    ...
    public static class Serializer implements JsonDeserializer<LootCondition>, JsonSerializer<LootCondition> {
        ...
        public LootCondition deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
        ...
        public JsonElement serialize(LootCondition p_serialize_1_, Type p_serialize_2_,
            ...
            jsonobject.addProperty(
                "condition",
                serializer.getLootTableLocation()
                    .toString());
            return jsonobject;
        }
    }

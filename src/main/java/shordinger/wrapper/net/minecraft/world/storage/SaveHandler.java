...
public class SaveHandler implements ISaveHandler, IPlayerFileData {
    ...
    public SaveHandler(File p_i46648_1_, String saveDirectoryNameIn, boolean p_i46648_3_, DataFixer dataFixerIn) {
        ...
        if (p_i46648_3_) {
            ...
            this.structureTemplateManager = new TemplateManager(
                (new File(this.worldDirectory, "structures")).toString(),
                dataFixerIn);
        } else {
    ...
    public void saveWorldInfoWithPlayer(WorldInfo worldInformation, @Nullable NBTTagCompound tagCompound) {
        ...
        net.minecraftforge.fml.common.FMLCommonHandler.instance()
            .handleWorldDataSave(this, worldInformation, nbttagcompound1);
    ...
    public void writePlayerData(EntityPlayer player) {
        try {
            ...
            net.minecraftforge.event.ForgeEventFactory.firePlayerSavingEvent(
                player,

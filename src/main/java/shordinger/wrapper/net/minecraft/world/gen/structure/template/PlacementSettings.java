...
public class PlacementSettings {
    ...
    public Random getRandom(@Nullable BlockPos seed) {
        if (this.random != null) {
            ...
            return this.setSeed.longValue() == 0L ? new Random(System.currentTimeMillis())
                : new Random(this.setSeed.longValue());
        } else if (seed == null) {
            ...
            int j = seed.getZ();
            return new Random(
                (long) (i * i * 4987142 + i * 5947611) + (long) (j * j) * 4392871L + (long) (j * 389711) ^ 987234911L);
        }
    }

...
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenDungeons;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenLakes;
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenMineshaft;
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenScatteredFeature;
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenStronghold;
import shordinger.wrapper.net.minecraft.world.gen.structure.MapGenVillage;
import shordinger.wrapper.net.minecraft.world.gen.structure.StructureOceanMonument;
import shordinger.wrapper.net.minecraft.world.gen.structure.WoodlandMansion;
...
public class ChunkGeneratorOverworld implements IChunkGenerator {
    ...
    public ChunkGeneratorOverworld(World worldIn, long seed, boolean mapFeaturesEnabledIn, String generatorOptions) {
        {
            caveGenerator = net.minecraftforge.event.terraingen.TerrainGen
            ...
            ravineGenerator = net.minecraftforge.event.terraingen.TerrainGen
        ...
        this.terrainType = worldIn.getWorldInfo()
            .getTerrainType();
        ...
        if (generatorOptions != null) {
            this.settings = ChunkGeneratorSettings.Factory.jsonToFactory(generatorOptions)
                .build();
    ...
    public void setBlocksInChunk(int x, int z, ChunkPrimer primer) {
        this.biomesForGeneration = this.world.getBiomeProvider()
            .getBiomesForGeneration(this.biomesForGeneration, x * 4 - 2, z * 4 - 2, 10, 10);
    ...
    public void populate(int x, int z) {
        ...
        if (this.settings.useDungeons) if (net.minecraftforge.event.terraingen.TerrainGen.populate(
            this,
            this.world,
            this.rand,
            x,

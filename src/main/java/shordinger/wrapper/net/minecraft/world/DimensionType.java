...
public enum DimensionType {
    ...
    public static DimensionType register(String name, String suffix, int id, Class<? extends WorldProvider> provider,
        ...
        String enum_name = name.replace(" ", "_")
            .toLowerCase();
        DimensionType ret = net.minecraftforge.common.util.EnumHelper
            .addEnum(DimensionType.class, enum_name, ENUM_ARGS, id, name, suffix, provider);

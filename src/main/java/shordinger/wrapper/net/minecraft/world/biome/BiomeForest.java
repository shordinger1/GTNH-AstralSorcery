...
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenBirchTree;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenCanopyTree;
...
public class BiomeForest extends Biome {
    ...
    public BiomeForest(BiomeForest.Type typeIn, Biome.BiomeProperties properties) {
        ...
        if (this.type == BiomeForest.Type.FLOWER) // Needs to be done here so we have access to this.type
        {
            ...
            for (BlockFlower.EnumFlowerType type : BlockFlower.EnumFlowerType.values()) {
                ...
                addFlower(
                    net.minecraft.init.Blocks.RED_FLOWER.getDefaultState()
                        .withProperty(net.minecraft.init.Blocks.RED_FLOWER.getTypeProperty(), type),
                    10);
            }
        }
    }
    ...
    public BlockFlower.EnumFlowerType pickRandomFlower(Random rand, BlockPos pos) {
        if (this.type == BiomeForest.Type.FLOWER) {
            double d0 = MathHelper.clamp(
                (1.0D + GRASS_COLOR_NOISE.getValue((double) pos.getX() / 48.0D, (double) pos.getZ() / 48.0D)) / 2.0D,
                0.0D,
                0.9999D);
    ...
    public void decorate(World worldIn, Random rand, BlockPos pos) {
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.FLOWERS)) { // no tab for patch
    ...
    public void addMushrooms(World p_185379_1_, Random p_185379_2_, BlockPos p_185379_3_) {
        ...
        for (int i = 0; i < 4; ++i) {
            for (int j = 0; j < 4; ++j) {
                ...
                if (p_185379_2_.nextInt(20) == 0 && net.minecraftforge.event.terraingen.TerrainGen.decorate(
                    p_185379_1_,
                    p_185379_2_,
                    new net.minecraft.util.math.ChunkPos(p_185379_3_),
                    blockpos,
                ...
                } else if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
                    p_185379_1_,
                    p_185379_2_,
                    new net.minecraft.util.math.ChunkPos(p_185379_3_),
                    blockpos,
    ...
    public void addDoublePlants(World p_185378_1_, Random p_185378_2_, BlockPos p_185378_3_, int p_185378_4_) {
        for (int i = 0; i < p_185378_4_; ++i) {
            ...
            for (int k = 0; k < 5; ++k) {
                ...
                int j1 = p_185378_2_.nextInt(
                    p_185378_1_.getHeight(p_185378_3_.add(l, 0, i1))
                        .getY() + 32);

                if (DOUBLE_PLANT_GENERATOR.generate(
                    p_185378_1_,
                    p_185378_2_,
                    new BlockPos(p_185378_3_.getX() + l, j1, p_185378_3_.getZ() + i1))) {
                    break;
                }
            }
        }

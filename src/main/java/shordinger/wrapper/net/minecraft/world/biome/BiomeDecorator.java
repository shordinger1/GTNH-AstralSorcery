...
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenBigMushroom;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenBush;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenCactus;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenClay;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenDeadBush;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenFlowers;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenLiquids;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenMinable;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenPumpkin;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenReed;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenSand;
import shordinger.wrapper.net.minecraft.world.gen.feature.WorldGenWaterlily;
...
public class BiomeDecorator {
    ...
    public void decorate(World worldIn, Random random, Biome biome, BlockPos pos) {
        if (this.decorating) {
            ...
            this.chunkProviderSettings = ChunkGeneratorSettings.Factory.jsonToFactory(
                    worldIn.getWorldInfo()
                        .getGeneratorOptions())
                .build();
            this.chunkPos = pos;
            this.dirtGen = new WorldGenMinable(Blocks.DIRT.getDefaultState(), this.chunkProviderSettings.dirtSize);
            this.gravelOreGen = new WorldGenMinable(
            ...
            this.redstoneGen = new WorldGenMinable(
                Blocks.REDSTONE_ORE.getDefaultState(),
                this.chunkProviderSettings.redstoneSize);
            this.diamondGen = new WorldGenMinable(
                Blocks.DIAMOND_ORE.getDefaultState(),
                this.chunkProviderSettings.diamondSize);
            this.lapisGen = new WorldGenMinable(
    ...
    protected void genDecorations(Biome biomeIn, World worldIn, Random random) {
        net.minecraft.util.math.ChunkPos forgeChunkPos = new net.minecraft.util.math.ChunkPos(chunkPos); // actual
        // ChunkPos
        // instead of
        // BlockPos,
        // used for
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS
            .post(new net.minecraftforge.event.terraingen.DecorateBiomeEvent.Pre(worldIn, random, forgeChunkPos));
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            random,
            forgeChunkPos,
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.SAND))
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            for (int j1 = 0; j1 < this.gravelPatchesPerChunk; ++j1) {
                ...
                this.gravelGen
                    .generate(worldIn, random, worldIn.getTopSolidOrLiquidBlock(this.chunkPos.add(i2, 0, j6)));
            }
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            for (int l2 = 0; l2 < this.flowersPerChunk; ++l2) {
                ...
                int j14 = worldIn.getHeight(this.chunkPos.add(i7, 0, l10))
                    .getY() + 32;
                ...
                if (j14 > 0) {
                    ...
                    BlockFlower blockflower = blockflower$enumflowertype.getBlockType()
                        .getBlock();

                    if (blockflower.getDefaultState()
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            for (int i3 = 0; i3 < this.grassPerChunk; ++i3) {
                ...
                int k14 = worldIn.getHeight(this.chunkPos.add(j7, 0, i11))
                    .getY() * 2;

                if (k14 > 0) {
                    int l17 = random.nextInt(k14);
                    biomeIn.getRandomWorldGenForGrass(random)
                        .generate(worldIn, random, this.chunkPos.add(j7, l17, i11));
                }
            }
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            random,
            forgeChunkPos,
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.DEAD_BUSH))
            for (int j3 = 0; j3 < this.deadBushPerChunk; ++j3) {
                int k7 = random.nextInt(16) + 8;
                int j11 = random.nextInt(16) + 8;
                int l14 = worldIn.getHeight(this.chunkPos.add(k7, 0, j11))
                    .getY() * 2;
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            random,
            forgeChunkPos,
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.LILYPAD))
            for (int k3 = 0; k3 < this.waterlilyPerChunk; ++k3) {
                int l7 = random.nextInt(16) + 8;
                int k11 = random.nextInt(16) + 8;
                int i15 = worldIn.getHeight(this.chunkPos.add(l7, 0, k11))
                    .getY() * 2;
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            for (int l3 = 0; l3 < this.mushroomsPerChunk; ++l3) {
                ...
                if (random.nextInt(8) == 0) {
                    ...
                    int j15 = worldIn.getHeight(this.chunkPos.add(j8, 0, i12))
                        .getY() * 2;
            ...
            if (random.nextInt(4) == 0) {
                ...
                int j12 = worldIn.getHeight(this.chunkPos.add(i4, 0, k8))
                    .getY() * 2;
            ...
            if (random.nextInt(8) == 0) {
                ...
                int k12 = worldIn.getHeight(this.chunkPos.add(j4, 0, l8))
                    .getY() * 2;
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            random,
            forgeChunkPos,
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.REED)) {
            for (int k4 = 0; k4 < this.reedsPerChunk; ++k4) {
                int i9 = random.nextInt(16) + 8;
                int l12 = random.nextInt(16) + 8;
                int i16 = worldIn.getHeight(this.chunkPos.add(i9, 0, l12))
                    .getY() * 2;
            ...
            for (int l4 = 0; l4 < 10; ++l4) {
                ...
                int j16 = worldIn.getHeight(this.chunkPos.add(j9, 0, i13))
                    .getY() * 2;
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            if (random.nextInt(32) == 0) {
                ...
                int j13 = worldIn.getHeight(this.chunkPos.add(i5, 0, k9))
                    .getY() * 2;
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
            ...
            random,
            forgeChunkPos,
            net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.CACTUS))
            for (int j5 = 0; j5 < this.cactiPerChunk; ++j5) {
                int l9 = random.nextInt(16) + 8;
                int k13 = random.nextInt(16) + 8;
                int l16 = worldIn.getHeight(this.chunkPos.add(l9, 0, k13))
                    .getY() * 2;
        ...
        if (this.generateFalls) {
            if (net.minecraftforge.event.terraingen.TerrainGen.decorate(
                ...
                random,
                forgeChunkPos,
                net.minecraftforge.event.terraingen.DecorateBiomeEvent.Decorate.EventType.LAKE_WATER))
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS
            .post(new net.minecraftforge.event.terraingen.DecorateBiomeEvent.Post(worldIn, random, forgeChunkPos));
    }
    ...
    protected void generateOres(World worldIn, Random random) {
        net.minecraftforge.common.MinecraftForge.ORE_GEN_BUS
            .post(new net.minecraftforge.event.terraingen.OreGenEvent.Pre(worldIn, random, chunkPos));
        if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
            worldIn,
            random,
            dirtGen,
            chunkPos,
            ...
            this.genStandardOre1(
                worldIn,
                random,
                this.chunkProviderSettings.dirtCount,
                this.dirtGen,
                this.chunkProviderSettings.dirtMinHeight,
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
            ...
            dioriteGen,
            chunkPos,
            net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.DIORITE))
            this.genStandardOre1(
                worldIn,
                random,
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
            ...
            graniteGen,
            chunkPos,
            net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.GRANITE))
            this.genStandardOre1(
                worldIn,
                random,
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.generateOre(
            ...
            andesiteGen,
            chunkPos,
            net.minecraftforge.event.terraingen.OreGenEvent.GenerateMinable.EventType.ANDESITE))
            this.genStandardOre1(
                worldIn,
                random,
        ...
        net.minecraftforge.common.MinecraftForge.ORE_GEN_BUS
            .post(new net.minecraftforge.event.terraingen.OreGenEvent.Post(worldIn, random, chunkPos));
    }
     ...
     */
    protected void genStandardOre1(World worldIn, Random random, int blockCount, WorldGenerator generator,
     ...
     */
    protected void genStandardOre2(World worldIn, Random random, int blockCount, WorldGenerator generator,

...
public class PotionUtils {
    ...
    public static int getColor(ItemStack p_190932_0_) {
        ...
        if (nbttagcompound != null && nbttagcompound.hasKey("CustomPotionColor", 99)) {
            ...
            return getPotionFromItem(p_190932_0_) == PotionTypes.EMPTY ? 16253176
    ...
    public static ItemStack appendEffects(ItemStack itemIn, Collection<PotionEffect> effects) {
        if (effects.isEmpty()) {
            ...
            NBTTagCompound nbttagcompound = (NBTTagCompound) MoreObjects
    ...
    public static void addPotionTooltip(ItemStack itemIn, List<String> lores, float durationFactor) {
        ...
        if (list.isEmpty()) {
            String s = I18n.translateToLocal("effect.none")
                .trim();
            ...
            for (PotionEffect potioneffect : list) {
                ...
                if (potioneffect.getAmplifier() > 0) {
                    s1 = s1 + " "
                        + I18n.translateToLocal("potion.potency." + potioneffect.getAmplifier())
                        .trim();
                }
        ...
        if (!list1.isEmpty()) {
            ...
            for (Tuple<String, AttributeModifier> tuple : list1) {
                ...
                if (d0 > 0.0D) {
                    lores.add(
                        TextFormatting.BLUE + I18n.translateToLocalFormatted(
                    ...
                    d1 = d1 * -1.0D;
                    lores.add(
                        TextFormatting.RED + I18n.translateToLocalFormatted(

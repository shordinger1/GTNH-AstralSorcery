...
public class PotionEffect implements Comparable<PotionEffect> {
    ...
    public PotionEffect(PotionEffect other) {
        ...
        this.curativeItems = other.curativeItems == null ? null
            : new java.util.ArrayList<net.minecraft.item.ItemStack>(other.curativeItems);
    }
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            return this.duration == potioneffect.duration && this.amplifier == potioneffect.amplifier
    ...
    public int compareTo(PotionEffect p_compareTo_1_) {
        int i = 32147;
        return (this.getDuration() <= 32147 || p_compareTo_1_.getDuration() <= 32147)
            && (!this.getIsAmbient() || !p_compareTo_1_.getIsAmbient())
            ? ComparisonChain.start()
            .compare(Boolean.valueOf(this.getIsAmbient()), Boolean.valueOf(p_compareTo_1_.getIsAmbient()))
            .compare(this.getDuration(), p_compareTo_1_.getDuration())
            .compare(
                this.getPotion()
                    .getGuiSortColor(this),
                p_compareTo_1_.getPotion()
                    .getGuiSortColor(p_compareTo_1_))
            .result()
            : ComparisonChain.start()
            .compare(Boolean.valueOf(this.getIsAmbient()), Boolean.valueOf(p_compareTo_1_.getIsAmbient()))
            .compare(
    ...
    private static PotionEffect readCurativeItems(PotionEffect effect, NBTTagCompound nbt) {
        if (nbt.hasKey("CurativeItems", net.minecraftforge.common.util.Constants.NBT.TAG_LIST)) {
            ...
            net.minecraft.nbt.NBTTagList list = nbt
                .getTagList("CurativeItems", net.minecraftforge.common.util.Constants.NBT.TAG_COMPOUND);

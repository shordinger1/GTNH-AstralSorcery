...
import shordinger.wrapper.net.minecraft.nbt.NBTSizeTracker;
...
public class PacketBuffer extends ByteBuf {
    ...
    public PacketBuffer writeItemStack(ItemStack stack) {
        if (stack.isEmpty()) {
            ...
            if (stack.getItem()
                ...
                || stack.getItem()
                .getShareTag()) {
                nbttagcompound = stack.getItem()
                    .getNBTShareTag(stack);
            }
    ...
    public ItemStack readItemStack() throws IOException {
        ...
        if (i < 0) {
            ...
            itemstack.getItem()
                .readNBTShareTag(itemstack, this.readCompoundTag());
            return itemstack;
        }
    }

...
public class SPacketTitle implements Packet<INetHandlerPlayClient> {
    ...
    public SPacketTitle(SPacketTitle.Type typeIn, @Nullable ITextComponent messageIn, int fadeInTimeIn,
                        int displayTimeIn, int fadeOutTimeIn) {
        this.type = typeIn;
    ...
    public void readPacketData(PacketBuffer buf) throws IOException {
        ...
        if (this.type == SPacketTitle.Type.TITLE || this.type == SPacketTitle.Type.SUBTITLE
            || this.type == SPacketTitle.Type.ACTIONBAR) {
    ...
    public static enum Type {
        ...
        public static String[] getNames() {
            ...
            for (SPacketTitle.Type spackettitle$type : values()) {
                astring[i++] = spackettitle$type.name()

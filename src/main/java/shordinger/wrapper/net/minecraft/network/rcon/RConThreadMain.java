...
public class RConThreadMain extends RConThreadBase {
    ...
    private void cleanClientThreadsMap() {
        Iterator<Entry<SocketAddress, RConThreadClient>> iterator = this.clientThreads.entrySet()
            .iterator();
        ...
        if (this.rconPassword.isEmpty()) {
            ...
            if (!this.running) {
                try {
                    ...
                    this.logWarning(
                        "Unable to initialise rcon on " + this.hostname
                            + ":"
                            + this.rconPort
                            + " : "
            ...
            this.logWarning(
                "Invalid rcon port " + this.rconPort
                    + " found in '"

...
public class Snooper {
    ...
    private final String uniqueID = UUID.randomUUID()
        .toString();
    /**
            ...
            this.threadTrigger.schedule(new TimerTask() {
                ...
                public void run() {
                    if (Snooper.this.playerStatsCollector.isSnooperEnabled()) {
                        ...
                        MinecraftServer minecraftserver = Snooper.this.playerStatsCollector instanceof MinecraftServer
                            ? (MinecraftServer) Snooper.this.playerStatsCollector
                            : null;
                        HttpUtil.postMap(
                            Snooper.this.serverUrl,
                            map,
                            true,
                            minecraftserver == null ? null : minecraftserver.getServerProxy());
                    }
                }
            }, 0L, 900000L);
        }

package shordinger.wrapper.net.minecraft.profiler;
...
public class Profiler {
        ...
        if (this.profilingEnabled) {
            ...
            if (k > 100000000L) {
                LOGGER.warn(
                    ...
                    this.profilingSection,
                    Double.valueOf((double) k / 1000000.0D));
            }
        ...
        if (!this.profilingEnabled) {
            ...
            if ((float) k > f) {
                list.add(
                    new Profiler.Result(
                        "unspecified",
                        (double) ((float) k - f) * 100.0D / (double) k,
    ...
    public static final class Result implements Comparable<Profiler.Result> {
        ...
        public int compareTo(Profiler.Result p_compareTo_1_) {
            if (p_compareTo_1_.usePercentage < this.usePercentage) {
                ...
                return p_compareTo_1_.usePercentage > this.usePercentage ? 1
                    : p_compareTo_1_.profilerName.compareTo(this.profilerName);
            }
        }
    ...
    /**
     * Forge: Fix for MC-117087, World.updateEntities is wasting time calling Class.getSimpleName() when the profiler is
     * not active
     */

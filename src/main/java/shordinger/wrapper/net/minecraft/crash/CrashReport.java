package shordinger.wrapper.net.minecraft.crash;
...
import shordinger.wrapper.net.minecraft.world.gen.layer.IntCache;
...
public class CrashReport {
    ...
    private void populateEnvironment() {
        ...
        net.minecraftforge.fml.common.FMLCommonHandler.instance()
            .enhanceCrashReport(this, this.systemDetailsCategory);
    }
    ...
    public void getSectionsInStringBuilder(StringBuilder builder) {
        if ((this.stacktrace == null || this.stacktrace.length <= 0) && !this.crashReportSections.isEmpty()) {
            this.stacktrace = (StackTraceElement[]) ArrayUtils
    ...
    public CrashReportCategory makeCategoryDepth(String categoryName, int stacktraceLength) {
        ...
        if (this.firstCategoryInCrashReport) {
            ...
            if (j < 0) {
                System.out
                    .println("Negative index in crash report handler (" + astacktraceelement.length + "/" + i + ")");
            }
            ...
            this.firstCategoryInCrashReport = crashreportcategory
                .firstTwoElementsOfStackTraceMatch(stacktraceelement, stacktraceelement1);
            ...
            } else if (astacktraceelement != null && astacktraceelement.length >= i
                && 0 <= j

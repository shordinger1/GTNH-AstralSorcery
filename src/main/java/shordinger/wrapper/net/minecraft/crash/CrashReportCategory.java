    ...
    public boolean firstTwoElementsOfStackTraceMatch(StackTraceElement s1, StackTraceElement s2) {
        if (this.stackTrace.length != 0 && s1 != null) {
            ...
            if (stacktraceelement.isNativeMethod() == s1.isNativeMethod() && stacktraceelement.getClassName()
                .equals(s1.getClassName())
                && stacktraceelement.getFileName()
                .equals(s1.getFileName())
        ...
        category.addDetail("Block data value", new ICrashReportDetail<String>() {
            ...
            public String call() throws Exception {
                if (blockData < 0) {
                    ...
                    String s = String.format("%4s", Integer.toBinaryString(blockData))
                        .replace(" ", "0");
    ...
    static class Entry {
        ...
        public Entry(String key, Object value) {
            ...
            if (value == null) {
                ...
                this.value = "~~ERROR~~ " + throwable.getClass()

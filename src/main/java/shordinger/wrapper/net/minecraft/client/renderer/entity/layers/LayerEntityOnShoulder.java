...
import shordinger.wrapper.net.minecraft.client.model.ModelParrot;
...
import shordinger.wrapper.net.minecraft.client.renderer.entity.RenderParrot;
...
public class LayerEntityOnShoulder implements LayerRenderer<EntityPlayer> {
    ...
    private LayerEntityOnShoulder.DataHolder renderEntityOnShoulder(EntityPlayer p_192864_1_,
                                                                    @Nullable UUID p_192864_2_, NBTTagCompound p_192864_3_,
                                                                    RenderLivingBase<? extends EntityLivingBase> p_192864_4_, ModelBase p_192864_5_, ResourceLocation p_192864_6_,
                                                                    Class<?> p_192864_7_, float p_192864_8_, float p_192864_9_, float p_192864_10_, float p_192864_11_,
                                                                    float p_192864_12_, float p_192864_13_, float p_192864_14_, boolean p_192864_15_) {
        ...
        p_192864_5_.setRotationAngles(
            ...
            p_192864_1_);
        p_192864_5_
            .render(p_192864_1_, p_192864_8_, p_192864_9_, p_192864_11_, p_192864_12_, p_192864_13_, p_192864_14_);

...
public class BlockPart {
    ...
    static class Deserializer implements JsonDeserializer<BlockPart> {
        ...
        private Map<EnumFacing, BlockPartFace> parseFacesCheck(JsonDeserializationContext deserializationContext,
                                                               JsonObject object) {
        ...
        private Map<EnumFacing, BlockPartFace> parseFaces(JsonDeserializationContext deserializationContext,
                                                          JsonObject object) {
            ...
            for (Entry<String, JsonElement> entry : jsonobject.entrySet()) {
                ...
                map.put(
                    enumfacing,
                    (BlockPartFace) deserializationContext.deserialize(entry.getValue(), BlockPartFace.class));
            }
        ...
        private Vector3f parsePositionTo(JsonObject object) {
            ...
            if (vector3f.x >= -16.0F && vector3f.y >= -16.0F
                && vector3f.z >= -16.0F
                && vector3f.x <= 32.0F
                && vector3f.y <= 32.0F
                && vector3f.z <= 32.0F) {

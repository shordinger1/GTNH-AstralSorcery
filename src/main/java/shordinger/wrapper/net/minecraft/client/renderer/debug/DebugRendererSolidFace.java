...
public class DebugRendererSolidFace implements DebugRenderer.IDebugRenderer {
    ...
    public void render(float partialTicks, long finishTimeNano) {
        ...
        Iterable<BlockPos> iterable = BlockPos.getAllInBox(
            MathHelper.floor(entityplayer.posX - 6.0D),
            MathHelper.floor(entityplayer.posY - 6.0D),
            MathHelper.floor(entityplayer.posZ - 6.0D),
            MathHelper.floor(entityplayer.posX + 6.0D),
            MathHelper.floor(entityplayer.posY + 6.0D),
            MathHelper.floor(entityplayer.posZ + 6.0D));
        ...
        for (BlockPos blockpos : iterable) {
            ...
            if (iblockstate.getBlock() != Blocks.AIR) {
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.WEST) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder.pos(d3, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder.pos(d3, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder.pos(d3, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder.pos(d3, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator.draw();
                }
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.SOUTH) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder1.pos(d3, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder1.pos(d3, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder1.pos(d6, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder1.pos(d6, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator1.draw();
                }
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.EAST) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder2.pos(d6, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder2.pos(d6, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder2.pos(d6, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder2.pos(d6, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator2.draw();
                }
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.NORTH) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder3.pos(d6, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder3.pos(d6, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder3.pos(d3, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder3.pos(d3, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator3.draw();
                }
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.DOWN) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder4.pos(d3, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder4.pos(d6, d4, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder4.pos(d3, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder4.pos(d6, d4, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator4.draw();
                }
                ...
                if (iblockstate.getBlockFaceShape(world, blockpos, EnumFacing.UP) == BlockFaceShape.SOLID) {
                    ...
                    bufferbuilder5.pos(d3, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder5.pos(d3, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder5.pos(d6, d7, d5)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    bufferbuilder5.pos(d6, d7, d8)
                        .color(1.0F, 0.0F, 0.0F, 0.5F)
                        .endVertex();
                    tessellator5.draw();
                }

...
public class GuiScreenBook extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (this.bookIsUnsigned) {
            this.buttonSign = this
                .addButton(new GuiButton(3, this.width / 2 - 100, 196, 98, 20, I18n.format("book.signButton")));
            this.buttonDone = this
                .addButton(new GuiButton(0, this.width / 2 + 2, 196, 98, 20, I18n.format("gui.done")));
            this.buttonFinalize = this
                .addButton(new GuiButton(5, this.width / 2 - 100, 196, 98, 20, I18n.format("book.finalizeButton")));
            this.buttonCancel = this
                .addButton(new GuiButton(4, this.width / 2 + 2, 196, 98, 20, I18n.format("gui.cancel")));
        } else {
            this.buttonDone = this
        ...
        int j = 2;
        this.buttonNextPage = (GuiScreenBook.NextPageButton) this
            .addButton(new GuiScreenBook.NextPageButton(1, i + 120, 156, true));
        this.buttonPreviousPage = (GuiScreenBook.NextPageButton) this
            .addButton(new GuiScreenBook.NextPageButton(2, i + 38, 156, false));
        this.updateButtons();
    }
    ...
    private void updateButtons() {
        ...
        if (this.bookIsUnsigned) {
            ...
            this.buttonFinalize.enabled = !this.bookTitle.trim()
                .isEmpty();
        }
    }
        ...
        if (this.bookIsUnsigned && this.bookIsModified) {
            if (this.bookPages != null) {
                ...
                this.mc.getConnection()
                    .sendPacket(new CPacketCustomPayload(s1, packetbuffer));
            }
        }
    }
            ...
            if (this.bookIsUnsigned) {
                ...
                if (ItemWrittenBook.validBookTagContents(this.book.getTagCompound())) {
                    ...
                    TextComponentString textcomponentstring = new TextComponentString(
                        TextFormatting.DARK_RED + "* Invalid book tag *");
            ...
            if (this.cachedComponents == null) {
                ...
                for (int l1 = 0; l1 < k1; ++l1) {
                    ...
                    this.fontRenderer.drawString(
                        itextcomponent2.getUnformattedText(),
                        i + 36,
                        34 + l1 * this.fontRenderer.FONT_HEIGHT,
                        0);
                }
    ...
    public boolean handleComponentClick(ITextComponent component) {
        ClickEvent clickevent = component.getStyle()
            .getClickEvent();
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
            if (this.visible) {
                ...
                mc.getTextureManager()
                    .bindTexture(GuiScreenBook.BOOK_GUI_TEXTURES);
                int i = 0;
                int j = 192;

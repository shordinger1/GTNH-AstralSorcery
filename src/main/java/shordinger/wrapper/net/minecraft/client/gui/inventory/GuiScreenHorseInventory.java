...
public class GuiScreenHorseInventory extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        this.fontRenderer.drawString(
            this.horseInventory.getDisplayName()
                .getUnformattedText(),
            8,
            6,
            4210752);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager()
            .bindTexture(HORSE_GUI_TEXTURES);
        ...
        if (this.horseEntity instanceof AbstractChestHorse) {
            ...
            if (abstractchesthorse.hasChest()) {
                this.drawTexturedModalRect(
                    ...
                    0,
                    this.ySize,
                    abstractchesthorse.getInventoryColumns() * 18,
                    54);
            }
        }
        ...
        GuiInventory.drawEntityOnScreen(
            ...
            j + 60,
            17,
            (float) (i + 51) - this.mousePosx,
            (float) (j + 75 - 50) - this.mousePosY,
            this.horseEntity);
    }

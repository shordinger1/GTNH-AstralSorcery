...
import shordinger.wrapper.net.minecraft.client.model.ModelEvokerFangs;
...
public class RenderEvokerFangs extends Render<EntityEvokerFangs> {
    ...
    private static final ResourceLocation EVOKER_ILLAGER_FANGS = new ResourceLocation(
        "textures/entity/illager/fangs.png");

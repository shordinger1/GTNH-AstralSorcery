...
//import shordinger.wrapper.net.minecraft.client.gui.GuiControls;
//import shordinger.wrapper.net.minecraft.client.gui.GuiGameOver;
//import shordinger.wrapper.net.minecraft.client.gui.GuiIngame;
...
//import shordinger.wrapper.net.minecraft.client.gui.GuiMemoryErrorScreen;
//import shordinger.wrapper.net.minecraft.client.gui.GuiMultiplayer;
...
//import shordinger.wrapper.net.minecraft.client.gui.GuiSleepMP;
//import shordinger.wrapper.net.minecraft.client.gui.GuiWinGame;
//import shordinger.wrapper.net.minecraft.client.gui.ScaledResolution;
//import shordinger.wrapper.net.minecraft.client.gui.ScreenChatOptions;
//import shordinger.wrapper.net.minecraft.client.gui.advancements.GuiScreenAdvancements;
//import shordinger.wrapper.net.minecraft.client.gui.chat.NarratorChatListener;
//import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiContainerCreative;
//import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiInventory;
...
//import shordinger.wrapper.net.minecraft.client.main.GameConfiguration;
...
//import shordinger.wrapper.net.minecraft.client.renderer.ItemRenderer;
...
//import shordinger.wrapper.net.minecraft.client.renderer.debug.DebugRenderer;
...
//import shordinger.wrapper.net.minecraft.client.resources.DefaultResourcePack;
//import shordinger.wrapper.net.minecraft.client.resources.FoliageColorReloadListener;
//import shordinger.wrapper.net.minecraft.client.resources.GrassColorReloadListener;
...
//import shordinger.wrapper.net.minecraft.client.resources.IResourcePack;
//import shordinger.wrapper.net.minecraft.client.resources.LanguageManager;
//import shordinger.wrapper.net.minecraft.client.resources.ResourcePackRepository;
//import shordinger.wrapper.net.minecraft.client.resources.SimpleReloadableResourceManager;
//import shordinger.wrapper.net.minecraft.client.resources.SkinManager;
//import shordinger.wrapper.net.minecraft.client.resources.data.AnimationMetadataSection;
//import shordinger.wrapper.net.minecraft.client.resources.data.AnimationMetadataSectionSerializer;
//import shordinger.wrapper.net.minecraft.client.resources.data.FontMetadataSection;
//import shordinger.wrapper.net.minecraft.client.resources.data.FontMetadataSectionSerializer;
//import shordinger.wrapper.net.minecraft.client.resources.data.LanguageMetadataSection;
//import shordinger.wrapper.net.minecraft.client.resources.data.LanguageMetadataSectionSerializer;
...
//import shordinger.wrapper.net.minecraft.client.resources.data.PackMetadataSectionSerializer;
//import shordinger.wrapper.net.minecraft.client.resources.data.TextureMetadataSection;
//import shordinger.wrapper.net.minecraft.client.resources.data.TextureMetadataSectionSerializer;
//import shordinger.wrapper.net.minecraft.client.settings.CreativeSettings;
...
//import shordinger.wrapper.net.minecraft.client.shader.Framebuffer;
//import shordinger.wrapper.net.minecraft.client.tutorial.Tutorial;
//import shordinger.wrapper.net.minecraft.client.util.ISearchTree;
//import shordinger.wrapper.net.minecraft.client.util.ITooltipFlag;
//import shordinger.wrapper.net.minecraft.client.util.RecipeBookClient;
//import shordinger.wrapper.net.minecraft.client.util.SearchTree;
//import shordinger.wrapper.net.minecraft.client.util.SearchTreeManager;
...
//import shordinger.wrapper.net.minecraft.profiler.ISnooperInfo;
//import shordinger.wrapper.net.minecraft.profiler.Profiler;
//import shordinger.wrapper.net.minecraft.profiler.Snooper;
...
//import shordinger.wrapper.net.minecraft.util.FrameTimer;
//import shordinger.wrapper.net.minecraft.util.IThreadListener;
//import shordinger.wrapper.net.minecraft.util.MinecraftError;
//import shordinger.wrapper.net.minecraft.util.MouseHelper;
//import shordinger.wrapper.net.minecraft.util.MovementInputFromOptions;
//import shordinger.wrapper.net.minecraft.util.NonNullList;
//import shordinger.wrapper.net.minecraft.util.ReportedException;
//import shordinger.wrapper.net.minecraft.util.ResourceLocation;
//import shordinger.wrapper.net.minecraft.util.ScreenShotHelper;
//import shordinger.wrapper.net.minecraft.util.Session;
//import shordinger.wrapper.net.minecraft.util.Timer;
...
//import shordinger.wrapper.net.minecraft.util.text.TextComponentKeybind;
...
//import shordinger.wrapper.net.minecraft.world.WorldProviderHell;
//import shordinger.wrapper.net.minecraft.world.WorldSettings;
//import shordinger.wrapper.net.minecraft.world.chunk.storage.AnvilSaveConverter;
//import shordinger.wrapper.net.minecraft.world.storage.ISaveFormat;
...
//public class Minecraft extends net.minecraft.client.Minecraft implements IThreadListener, ISnooperInfo {
////
...
////    private static final List<DisplayMode> MAC_DISPLAY_MODES = Lists
...
//            .beginMinecraftLoading(this, this.defaultResourcePacks, this.mcResourceManager, this.metadataSerializer_);
...
//            this.modelManager.getBlockModelShapes(),
//            this.blockColors);
...
//            return (List) p_193988_0_.getTooltip((EntityPlayer) null, ITooltipFlag.TooltipFlags.NORMAL)
//                .stream()
...
//            return (List) p_193990_0_.getRecipes()
//                .stream()
//                .flatMap(
//                    (p_193993_0_) -> {
//                        return p_193993_0_.getRecipeOutput()
//                            .getTooltip((EntityPlayer) null, ITooltipFlag.TooltipFlags.NORMAL)
//                            .stream();
//                    })
//                .map(TextFormatting::getTextWithoutFormattingCodes)
//                .map(String::trim)
...
//                .collect(Collectors.toList());
//        }, (p_193991_0_) -> {
//            return (List) p_193991_0_.getRecipes()
//                .stream()
//                .map(
//                    (p_193992_0_) -> {
//                        return Item.REGISTRY.getNameForObject(
//                            p_193992_0_.getRecipeOutput()
//                                .getItem());
//                    })
//                .collect(Collectors.toList());
//        });
...
//                    Display.setIcon(
//                        new ByteBuffer[]{this.readImageToBuffer(inputstream), this.readImageToBuffer(inputstream1)});
//                }
...
//            scaledresolution.getScaledWidth() * i,
...
//            (double) scaledresolution.getScaledHeight(),
//            0.0D,
//            1000.0D,
//            3000.0D);
//        GlStateManager.matrixMode(5888);
...
//                .getDynamicTextureLocation("logo", new DynamicTexture(ImageIO.read(inputstream)));
...
//        bufferbuilder.pos(0.0D, (double) this.displayHeight, 0.0D)
//            .tex(0.0D, 0.0D)
//            .color(255, 255, 255, 255)
//            .endVertex();
//        bufferbuilder.pos((double) this.displayWidth, (double) this.displayHeight, 0.0D)
//            .tex(0.0D, 0.0D)
//            .color(255, 255, 255, 255)
//            .endVertex();
//        bufferbuilder.pos((double) this.displayWidth, 0.0D, 0.0D)
//            .tex(0.0D, 0.0D)
//            .color(255, 255, 255, 255)
//            .endVertex();
...
//        int k = 256;
//        this.draw(
//            (scaledresolution.getScaledWidth() - 256) / 2,
//            (scaledresolution.getScaledHeight() - 256) / 2,
//            0,
//            0,
//            256,
//            256,
...
//     *
//     * <p>
//     * <strong>WARNING</strong>: This method is not thread-safe. Opening GUIs from a thread other than the main
...
//        this.mcSoundHandler.setListener(this.getRenderViewEntity(), this.timer.renderPartialTicks); // Forge: MC-46445
//        // Spectator mode
//        // particles and
//        // sounds computed
//        // from where you
...
//                this.isGamePaused ? this.renderPartialTicksPaused : this.timer.renderPartialTicks,
//                i);
...
//        ++this.fpsCounter;
//        boolean flag = this.isSingleplayer() && this.currentScreen != null
...
//                .color(200, 0, 0, 0)
//                .endVertex();
//            bufferbuilder.pos((double) ((float) j - 176.0F), (double) (k + 320), 0.0D)
//                .color(200, 0, 0, 0)
//                .endVertex();
//            bufferbuilder.pos((double) ((float) j + 176.0F), (double) (k + 320), 0.0D)
//                .color(200, 0, 0, 0)
...
//                int l1 = j1 >> 8 & 255;
//                int i2 = j1 & 255;
//                bufferbuilder.pos((double) j, (double) k, 0.0D)
//                    .color(k1, l1, i2, 255)
//                    .endVertex();
//
...
//                    bufferbuilder.pos((double) ((float) j + f1), (double) ((float) k - f2), 0.0D)
//                        .color(k1, l1, i2, 255)
//                        .endVertex();
//                }
//
...
//                s,
//                (float) (j + 160 - this.fontRenderer.getStringWidth(s)),
//                (float) (k - 80 - 16),
//                16777215);
//
...
//                }
//
//                String s1 = stringbuilder.append(profiler$result2.profilerName)
//                    .toString();
//                this.fontRenderer.drawStringWithShadow(
//                    s1,
//                    (float) (j - 160),
...
//                this.fontRenderer.drawStringWithShadow(
//                    s1,
//                    (float) (j + 160 - 50 - this.fontRenderer.getStringWidth(s1)),
//                    (float) (k + 80 + k2 * 8 + 20),
//                    profiler$result2.getColor());
//                s1 = decimalformat.format(profiler$result2.totalUsePercentage) + "%";
//                this.fontRenderer.drawStringWithShadow(
//                    s1,
//                    (float) (j + 160 - this.fontRenderer.getStringWidth(s1)),
//                    (float) (k + 80 + k2 * 8 + 20),
//                    profiler$result2.getColor());
//            }
//        }
...
//                                    .interactWithEntity(this.player, this.objectMouseOver.entityHit, enumhand)
...
//                        && (this.objectMouseOver == null || this.objectMouseOver.typeOfHit == RayTraceResult.Type.MISS))
//                        net.minecraftforge.common.ForgeHooks.onEmptyClick(this.player, enumhand);
//                    if (!itemstack.isEmpty()
//                        && this.playerController.processRightClick(this.player, this.world, enumhand)
//                        == EnumActionResult.SUCCESS) {
//                        this.entityRenderer.itemRenderer.resetEquippedProgress(enumhand);
//                        return;
//                    }
...
//            if (!this.fullscreen) // Forge: Fix MC-68754, Screen is not resizeable after exiting fullscreen due to LWJGL
//            // bug https://github.com/LWJGL/lwjgl/issues/142 which is fixed, but not in the
//            // version MC ships
//            {
...
//                        return Minecraft.this.currentScreen.getClass()
//                            .getCanonicalName();
//                    }
//                });
...
//                this.gameSettings.advancedItemTooltips ? "debug.advanced_tooltips.on" : "debug.advanced_tooltips.off");
//            this.gameSettings.saveOptions();
//            return true;
//        } else if (auxKey == 49) {
...
//            this.gameSettings.saveOptions();
//            this.debugFeedbackTranslated(
//                this.gameSettings.pauseOnLostFocus ? "debug.pause_focus.on" : "debug.pause_focus.off");
//            return true;
//        } else if (auxKey == 16) {
...
//                    this.ingameGUI.getSpectatorGui()
//                        .onHotbarSelected(i);
...
//                        k = k < 0 ? -1 : 1;
//
//                        if (this.ingameGUI.getSpectatorGui()
//                            .isMenuActive()) {
//                            this.ingameGUI.getSpectatorGui()
//                                .onMouseScroll(-k);
//                        } else {
//                            float f = MathHelper
//                                .clamp(this.player.capabilities.getFlySpeed() + (float) k * 0.005F, 0.0F, 0.2F);
...
//                    .appendSibling(
//                        (new TextComponentTranslation("debug.prefix", new Object[0])).setStyle(
...
//        SocketAddress socketaddress = this.integratedServer.getNetworkSystem()
//            .addLocalEndpoint();
...
//        com.mojang.authlib.GameProfile gameProfile = this.getSession()
//            .getProfile();
//        if (!this.getSession()
//            .hasCachedProperties()) {
//            gameProfile = sessionService.fillProfileProperties(gameProfile, true); // Forge: Fill profile properties
//            // upon game load. Fixes MC-52974.
//            this.getSession()
...
//        if (world != null) net.minecraftforge.common.MinecraftForge.EVENT_BUS
//            .post(new net.minecraftforge.event.world.WorldEvent.Unload(world));
//
...
//            net.minecraftforge.fml.client.FMLClientHandler.instance()
//                .handleClientWorldClosing(this.world);
//        }
//
...
//                    .createPlayer(worldClientIn, new StatisticsManager(), new RecipeBookClient());
...
//            .addDetail("Launched Version", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            });
//        theCrash.getCategory()
//            .addDetail("LWJGL", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            });
//        theCrash.getCategory()
//            .addDetail("OpenGL", new ICrashReportDetail<String>() {
//
//                public String call() {
//                    return GlStateManager.glGetString(7937) + " GL version "
...
//            });
//        theCrash.getCategory()
//            .addDetail("GL Caps", new ICrashReportDetail<String>() {
//
//                public String call() {
...
//            });
//        theCrash.getCategory()
//            .addDetail("Using VBOs", new ICrashReportDetail<String>() {
//
//                public String call() {
...
//            });
//        theCrash.getCategory()
//            .addDetail("Is Modded", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            });
//        theCrash.getCategory()
//            .addDetail("Type", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            });
//        theCrash.getCategory()
//            .addDetail("Resource Packs", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
//                    StringBuilder stringbuilder = new StringBuilder();
//
...
//            });
//        theCrash.getCategory()
//            .addDetail("Current Language", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
//                    return Minecraft.this.mcLanguageManager.getCurrentLanguage()
//                        .toString();
//                }
//            });
//        theCrash.getCategory()
//            .addDetail("Profiler Position", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            });
//        theCrash.getCategory()
//            .addDetail("CPU", new ICrashReportDetail<String>() {
//
//                public String call() throws Exception {
...
//            .getRepositoryEntries()) {
//            playerSnooper
//                .addClientStat("resource_pack[" + i++ + "]", resourcepackrepository$entry.getResourcePackName());
//        }
//
//        if (this.integratedServer != null && this.integratedServer.getPlayerUsageSnooper() != null) {
//            playerSnooper.addClientStat(
//                "snooper_partner",
//                this.integratedServer.getPlayerUsageSnooper()
//                    .getUniqueID());
//        }
//    }
//
...
//            "gl_caps[ARB_arrays_of_arrays]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_arrays_of_arrays));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_base_instance]", Boolean.valueOf(contextcapabilities.GL_ARB_base_instance));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_blend_func_extended]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_blend_func_extended));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_clear_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_clear_buffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_color_buffer_float]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_color_buffer_float));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_compatibility]", Boolean.valueOf(contextcapabilities.GL_ARB_compatibility));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_compressed_texture_pixel_storage]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_compressed_texture_pixel_storage));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_compute_shader]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_compute_shader));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_copy_buffer]", Boolean.valueOf(contextcapabilities.GL_ARB_copy_buffer));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_copy_image]", Boolean.valueOf(contextcapabilities.GL_ARB_copy_image));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_depth_buffer_float]",
...
//            Boolean.valueOf(contextcapabilities.GL_ARB_depth_buffer_float));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_depth_clamp]", Boolean.valueOf(contextcapabilities.GL_ARB_depth_clamp));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_depth_texture]", Boolean.valueOf(contextcapabilities.GL_ARB_depth_texture));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_draw_buffers]", Boolean.valueOf(contextcapabilities.GL_ARB_draw_buffers));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_draw_buffers_blend]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_draw_buffers_blend));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_draw_elements_base_vertex]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_draw_elements_base_vertex));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_draw_indirect]", Boolean.valueOf(contextcapabilities.GL_ARB_draw_indirect));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_draw_instanced]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_draw_instanced));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_explicit_attrib_location]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_explicit_attrib_location));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_explicit_uniform_location]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_explicit_uniform_location));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_fragment_layer_viewport]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_fragment_layer_viewport));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_fragment_program]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_fragment_program));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_fragment_shader]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_fragment_shader));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_fragment_program_shadow]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_fragment_program_shadow));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_framebuffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_framebuffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_framebuffer_sRGB]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_framebuffer_sRGB));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_geometry_shader4]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_geometry_shader4));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_gpu_shader5]", Boolean.valueOf(contextcapabilities.GL_ARB_gpu_shader5));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_half_float_pixel]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_half_float_pixel));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_half_float_vertex]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_half_float_vertex));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_instanced_arrays]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_instanced_arrays));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_map_buffer_alignment]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_map_buffer_alignment));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_map_buffer_range]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_map_buffer_range));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_multisample]", Boolean.valueOf(contextcapabilities.GL_ARB_multisample));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_multitexture]", Boolean.valueOf(contextcapabilities.GL_ARB_multitexture));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_occlusion_query2]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_occlusion_query2));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_pixel_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_pixel_buffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_seamless_cube_map]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_seamless_cube_map));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_shader_objects]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_shader_objects));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_shader_stencil_export]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_shader_stencil_export));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_shader_texture_lod]",
...
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_tessellation_shader]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_tessellation_shader));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_texture_border_clamp]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_texture_border_clamp));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_texture_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_texture_buffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_texture_cube_map]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_texture_cube_map));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_texture_cube_map_array]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_texture_cube_map_array));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_texture_non_power_of_two]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_texture_non_power_of_two));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_uniform_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_uniform_buffer_object));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_vertex_blend]", Boolean.valueOf(contextcapabilities.GL_ARB_vertex_blend));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_vertex_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_vertex_buffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[ARB_vertex_program]",
//            Boolean.valueOf(contextcapabilities.GL_ARB_vertex_program));
//        playerSnooper
//            .addStatToSnooper("gl_caps[ARB_vertex_shader]", Boolean.valueOf(contextcapabilities.GL_ARB_vertex_shader));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_bindable_uniform]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_bindable_uniform));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_blend_equation_separate]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_blend_equation_separate));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_blend_func_separate]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_blend_func_separate));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_blend_minmax]", Boolean.valueOf(contextcapabilities.GL_EXT_blend_minmax));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_blend_subtract]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_blend_subtract));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_draw_instanced]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_draw_instanced));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_framebuffer_multisample]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_framebuffer_multisample));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_framebuffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_framebuffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_framebuffer_sRGB]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_framebuffer_sRGB));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_geometry_shader4]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_geometry_shader4));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_gpu_program_parameters]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_gpu_program_parameters));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_gpu_shader4]", Boolean.valueOf(contextcapabilities.GL_EXT_gpu_shader4));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_multi_draw_arrays]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_multi_draw_arrays));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_packed_depth_stencil]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_packed_depth_stencil));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_paletted_texture]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_paletted_texture));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_rescale_normal]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_rescale_normal));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_separate_shader_objects]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_separate_shader_objects));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_shader_image_load_store]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_shader_image_load_store));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_shadow_funcs]", Boolean.valueOf(contextcapabilities.GL_EXT_shadow_funcs));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_shared_texture_palette]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_shared_texture_palette));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_stencil_clear_tag]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_stencil_clear_tag));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_stencil_two_side]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_stencil_two_side));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_stencil_wrap]", Boolean.valueOf(contextcapabilities.GL_EXT_stencil_wrap));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_texture_3d]", Boolean.valueOf(contextcapabilities.GL_EXT_texture_3d));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_texture_array]", Boolean.valueOf(contextcapabilities.GL_EXT_texture_array));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_texture_buffer_object]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_texture_buffer_object));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_texture_integer]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_texture_integer));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_texture_lod_bias]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_texture_lod_bias));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_texture_sRGB]", Boolean.valueOf(contextcapabilities.GL_EXT_texture_sRGB));
//        playerSnooper
//            .addStatToSnooper("gl_caps[EXT_vertex_shader]", Boolean.valueOf(contextcapabilities.GL_EXT_vertex_shader));
//        playerSnooper.addStatToSnooper(
//            "gl_caps[EXT_vertex_weighting]",
//            Boolean.valueOf(contextcapabilities.GL_EXT_vertex_weighting));
//        playerSnooper
//            .addStatToSnooper("gl_caps[gl_max_vertex_uniforms]", Integer.valueOf(GlStateManager.glGetInteger(35658)));
//        GlStateManager.glGetError();
//        playerSnooper
//            .addStatToSnooper("gl_caps[gl_max_fragment_uniforms]", Integer.valueOf(GlStateManager.glGetInteger(35657)));
//        GlStateManager.glGetError();
//        playerSnooper
//            .addStatToSnooper("gl_caps[gl_max_vertex_attribs]", Integer.valueOf(GlStateManager.glGetInteger(34921)));
//        GlStateManager.glGetError();
//        playerSnooper.addStatToSnooper(
//            "gl_caps[gl_max_vertex_texture_image_units]",
//            Integer.valueOf(GlStateManager.glGetInteger(35660)));
//        GlStateManager.glGetError();
//        playerSnooper.addStatToSnooper(
//            "gl_caps[gl_max_texture_image_units]",
//            Integer.valueOf(GlStateManager.glGetInteger(34930)));
//        GlStateManager.glGetError();
//        playerSnooper.addStatToSnooper(
//            "gl_caps[gl_max_array_texture_layers]",
...
//                return this.ingameGUI.getBossOverlay()
...
//                        || this.currentScreen != null && !this.currentScreen.isFocused())) {

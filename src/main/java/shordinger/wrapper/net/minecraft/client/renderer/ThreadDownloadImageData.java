...
public class ThreadDownloadImageData extends SimpleTexture {
    ...
    public ThreadDownloadImageData(@Nullable File cacheFileIn, String imageUrlIn,
                                   ResourceLocation textureResourceLocation, @Nullable IImageBuffer imageBufferIn) {

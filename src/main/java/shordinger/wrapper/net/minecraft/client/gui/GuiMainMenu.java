...
import shordinger.wrapper.net.minecraft.realms.RealmsBridge;
...
public class GuiMainMenu extends GuiScreen {
    ...
    public static final String MORE_INFO_TEXT = "Please click " + TextFormatting.UNDERLINE
        + "here"
    ...
    private void addSingleplayerMultiplayerButtons(int p_73969_1_, int p_73969_2_) {
        ...
        this.buttonList
            .add(new GuiButton(2, this.width / 2 - 100, p_73969_1_ + p_73969_2_ * 1, I18n.format("menu.multiplayer")));
        ...
        for (int j = 0; j < 64; ++j) {
            ...
            for (int k = 0; k < 6; ++k) {
                ...
                this.mc.getTextureManager()
                    .bindTexture(TITLE_PANORAMA_PATHS[k]);
    ...
    private void rotateAndBlurSkybox() {
        ...
        for (int j = 0; j < 3; ++j) {
            ...
            bufferbuilder.pos((double) k, (double) l, (double) this.zLevel)
                .tex((double) (0.0F + f1), 1.0D)
                .color(1.0F, 1.0F, 1.0F, f)
                .endVertex();
            bufferbuilder.pos((double) k, 0.0D, (double) this.zLevel)
                .tex((double) (1.0F + f1), 1.0D)
                .color(1.0F, 1.0F, 1.0F, f)
                .endVertex();
            bufferbuilder.pos(0.0D, 0.0D, (double) this.zLevel)
                .tex((double) (1.0F + f1), 0.0D)
                .color(1.0F, 1.0F, 1.0F, f)
                .endVertex();
            bufferbuilder.pos(0.0D, (double) l, (double) this.zLevel)
                .tex((double) (0.0F + f1), 0.0D)
                .color(1.0F, 1.0F, 1.0F, f)
                .endVertex();
        }
    ...
    private void renderSkybox(int mouseX, int mouseY, float partialTicks) {
        ...
        BufferBuilder bufferbuilder = tessellator.getBuffer();
        bufferbuilder.begin(7, DefaultVertexFormats.POSITION_TEX_COLOR);
        bufferbuilder.pos(0.0D, (double) j, (double) this.zLevel)
        ...
        bufferbuilder.pos((double) i, (double) j, (double) this.zLevel)
            ...
            .color(1.0F, 1.0F, 1.0F, 1.0F)
            .endVertex();
        bufferbuilder.pos((double) i, 0.0D, (double) this.zLevel)
            .tex((double) (0.5F + f1), (double) (0.5F - f2))
            .color(1.0F, 1.0F, 1.0F, 1.0F)
            .endVertex();
        bufferbuilder.pos(0.0D, 0.0D, (double) this.zLevel)
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.mc.getTextureManager()
            .bindTexture(MINECRAFT_TITLE_TEXTURES);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        ...
        this.mc.getTextureManager()
            .bindTexture(field_194400_H);
        drawModalRectWithCustomSizedTexture(j + 88, 67, 0.0F, 0.0F, 98, 14, 128.0F, 16.0F);

        this.splashText = net.minecraftforge.client.ForgeHooksClient
            .renderMainMenu(this, this.fontRenderer, this.width, this.height, this.splashText);

        GlStateManager.pushMatrix();
        GlStateManager.translate((float) (this.width / 2 + 90), 70.0F, 0.0F);
        GlStateManager.rotate(-20.0F, 0.0F, 0.0F, 1.0F);
        float f = 1.8F - MathHelper
            .abs(MathHelper.sin((float) (Minecraft.getSystemTime() % 1000L) / 1000.0F * ((float) Math.PI * 2F)) * 0.1F);
        ...
        java.util.List<String> brandings = com.google.common.collect.Lists.reverse(
        ...
        for (int brdline = 0; brdline < brandings.size(); brdline++) {
            ...
            if (!com.google.common.base.Strings.isNullOrEmpty(brd)) {
                this.drawString(
                    ...
                    brd,
                    2,
                    this.height - (10 + brdline * (this.fontRenderer.FONT_HEIGHT + 1)),
                    16777215);
            }
        }
        ...
        if (mouseX > this.widthCopyrightRest && mouseX < this.widthCopyrightRest + this.widthCopyright
            ...
            drawRect(
                this.widthCopyrightRest,
                this.height - 1,
                this.widthCopyrightRest + this.widthCopyright,
                this.height,
                -1);
        }
        ...
        if (this.openGLWarning1 != null && !this.openGLWarning1.isEmpty()) {
            drawRect(
                ...
                this.openGLWarningY1 - 2,
                this.openGLWarningX2 + 2,
                this.openGLWarningY2 - 1,
                1428160512);

...
public class GuiTextField extends Gui {
    ...
    private void drawSelectionBox(int startX, int startY, int endX, int endY) {
        ...
        bufferbuilder.pos((double) startX, (double) endY, 0.0D)
            .endVertex();
        bufferbuilder.pos((double) endX, (double) endY, 0.0D)
            .endVertex();
        bufferbuilder.pos((double) endX, (double) startY, 0.0D)
            .endVertex();
        bufferbuilder.pos((double) startX, (double) startY, 0.0D)
            .endVertex();
        tessellator.draw();
    ...
    public void setSelectionPos(int position) {
        ...
        if (this.fontRenderer != null) {
            ...
            if (position == this.lineScrollOffset) {
                this.lineScrollOffset -= this.fontRenderer.trimStringToWidth(this.text, j, true)
                    .length();
            }

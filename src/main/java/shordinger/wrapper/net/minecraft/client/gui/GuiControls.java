...
public class GuiControls extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList
            .add(new GuiButton(200, this.width / 2 - 155 + 160, this.height - 29, 150, 20, I18n.format("gui.done")));
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (this.buttonId != null) {
            this.buttonId.setKeyModifierAndCode(
    ...
    protected void keyTyped(char typedChar, int keyCode) throws IOException {
        if (this.buttonId != null) {
            if (keyCode == 1) {
                ...
                this.buttonId
                    .setKeyModifierAndCode(net.minecraftforge.client.settings.KeyModifier.getActiveModifier(), keyCode);
            ...
            if (!net.minecraftforge.client.settings.KeyModifier.isKeyCodeModifier(keyCode)) this.buttonId = null;

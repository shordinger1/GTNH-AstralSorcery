...
public class GuiListWorldSelection extends GuiListExtended {
    ...
    public GuiListWorldSelection(GuiWorldSelection p_i46590_1_, Minecraft clientIn, int widthIn, int heightIn,
    ...
    public void refreshList() {
        ...
        try {
            ...
            this.mc.displayGuiScreen(
                new GuiErrorScreen(I18n.format("selectWorld.unable_to_load"), anvilconverterexception.getMessage()));
            return;
        }

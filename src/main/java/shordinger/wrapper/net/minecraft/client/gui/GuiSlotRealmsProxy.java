...
import shordinger.wrapper.net.minecraft.realms.RealmsScrolledSelectionList;
...
public class GuiSlotRealmsProxy extends GuiSlot {
    ...
    public GuiSlotRealmsProxy(RealmsScrolledSelectionList selectionListIn, int widthIn, int heightIn, int topIn,

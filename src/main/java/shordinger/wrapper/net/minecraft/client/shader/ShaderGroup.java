...
public class ShaderGroup {
    ...
    public ShaderGroup(TextureManager p_i1050_1_, IResourceManager resourceManagerIn, Framebuffer mainFramebufferIn,
                    ...
                    try {
                        ...
                        if (framebuffer2 == null) {
                            ...
                            shader.addAuxFramebuffer(
                                s4,
                                Integer.valueOf(lvt_20_2_.getGlTextureId()),
                                lvt_21_1_,
                                lvt_22_1_);
                        } else {
                            shader.addAuxFramebuffer(
    ...
    public Shader addShader(String programName, Framebuffer framebufferIn, Framebuffer framebufferOut)
    ...
    private Framebuffer getFramebuffer(String p_148017_1_) {
        if (p_148017_1_ == null) {
            ...
            return p_148017_1_.equals("minecraft:main") ? this.mainFramebuffer

...
public class TutorialToast implements IToast {
    ...
    public TutorialToast(TutorialToast.Icons iconIn, ITextComponent titleComponent,
    ...
    public IToast.Visibility draw(GuiToast toastGui, long delta) {
        ...
        if (this.hasProgressBar) {
            ...
            float f = (float) MathHelper.clampedLerp(
                (double) this.displayedProgress,
                (double) this.currentProgress,
                (double) ((float) (delta - this.lastDelta) / 100.0F));
            int i;

...
/*
 * @deprecated use {@link net.minecraftforge.client.model.IModelState} and {@link
...
public class ItemTransformVec3f implements net.minecraftforge.common.model.IModelState {
    ...
    public static final ItemTransformVec3f DEFAULT = new ItemTransformVec3f(
        new Vector3f(),
        new Vector3f(),
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            return this.rotation.equals(itemtransformvec3f.rotation) && this.scale.equals(itemtransformvec3f.scale)

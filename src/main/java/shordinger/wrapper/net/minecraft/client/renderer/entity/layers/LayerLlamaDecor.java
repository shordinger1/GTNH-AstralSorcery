...
import shordinger.wrapper.net.minecraft.client.renderer.entity.RenderLlama;
...
public class LayerLlamaDecor implements LayerRenderer<EntityLlama> {
    ...
    public void doRenderLayer(EntityLlama entitylivingbaseIn, float limbSwing, float limbSwingAmount,
                              float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (entitylivingbaseIn.hasColor()) {
            this.renderer.bindTexture(
                LLAMA_DECOR_TEXTURES[entitylivingbaseIn.getColor()
                    .getMetadata()]);

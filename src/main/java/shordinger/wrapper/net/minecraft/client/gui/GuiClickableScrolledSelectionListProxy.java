...
import shordinger.wrapper.net.minecraft.realms.RealmsClickableScrolledSelectionList;
import shordinger.wrapper.net.minecraft.realms.Tezzelator;
...
public class GuiClickableScrolledSelectionListProxy extends GuiSlot {
    ...
    public GuiClickableScrolledSelectionListProxy(RealmsClickableScrolledSelectionList selectionList, int widthIn,
                                                  int heightIn, int topIn, int bottomIn, int slotHeightIn) {
    ...
    public void handleMouseInput() {
        ...
        if (this.scrollMultiplier > 0.0F && Mouse.getEventButtonState()) {
            this.proxy
                .customMouseEvent(this.top, this.bottom, this.headerPadding, this.amountScrolled, this.slotHeight);
        }
    }

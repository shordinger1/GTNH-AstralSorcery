...
import shordinger.wrapper.net.minecraft.realms.RealmsButton;
...
public class GuiButtonRealmsProxy extends GuiButton {
    ...
    public GuiButtonRealmsProxy(RealmsButton realmsButtonIn, int buttonId, int x, int y, String text, int widthIn,
                                int heightIn) {

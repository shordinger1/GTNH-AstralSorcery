...
import shordinger.wrapper.net.minecraft.client.particle.ParticleFirework;
...
import shordinger.wrapper.net.minecraft.world.storage.SaveDataMemoryStorage;
import shordinger.wrapper.net.minecraft.world.storage.SaveHandlerMP;
...
public class WorldClient extends World {
    ...
    public WorldClient(NetHandlerPlayClient netHandler, WorldSettings settings, int dimension,
        ...
        super(
            new SaveHandlerMP(),
            new WorldInfo(settings, "MpServer"),
            net.minecraftforge.common.DimensionManager.createProviderFor(dimension),
            profilerIn,
            true);
    ...
    public void tick() {
        ...
        for (int i = 0; i < 10 && !this.entitySpawnQueue.isEmpty(); ++i) {
            Entity entity = this.entitySpawnQueue.iterator()
                .next();
    ...
    protected boolean isChunkLoaded(int x, int z, boolean allowEmpty) {
        return allowEmpty || !this.getChunkProvider()
            .provideChunk(x, z)
            .isEmpty();
    }
        ...
        if (flag) {
            if (entityIn instanceof EntityMinecart) {
                this.mc.getSoundHandler()
                    .playSound(new MovingSoundMinecart((EntityMinecart) entityIn));
            }
        } else {
    ...
    public void sendQuittingDisconnectingPacket() {
        this.connection.getNetworkManager()
            .closeChannel(new TextComponentString("Quitting"));
    }
    ...
    public void doVoidFogParticles(int posX, int posY, int posZ) {
        ...
        boolean flag = this.mc.playerController.getCurrentGameType() == GameType.CREATIVE && !itemstack.isEmpty()
    ...
    public void showBarrierParticles(int x, int y, int z, int offset, Random random, boolean holdingBarrier,
        ...
        for (int j1 = 0; j1 < this.loadedEntityList.size(); ++j1) {
            ...
            if (entity1.isDead) {
                ...
                if (entity1.addedToChunk && this.isChunkLoaded(k1, l, true)) {
                    this.getChunkFromChunkCoords(k1, l)
    ...
    public void playSound(double x, double y, double z, SoundEvent soundIn, SoundCategory category, float volume,
        ...
        double d0 = this.mc.getRenderViewEntity()
            .getDistanceSq(x, y, z);
        ...
        if (distanceDelay && d0 > 100.0D) {
            ...
            this.mc.getSoundHandler()
                .playDelayedSound(positionedsoundrecord, (int) (d1 * 20.0D));
        } else {
            this.mc.getSoundHandler()
    ...
    public void makeFireworks(double x, double y, double z, double motionX, double motionY, double motionZ,
        ...
        this.mc.effectRenderer.addEffect(
            new ParticleFirework.Starter(this, x, y, z, motionX, motionY, motionZ, this.mc.effectRenderer, compound));
    }

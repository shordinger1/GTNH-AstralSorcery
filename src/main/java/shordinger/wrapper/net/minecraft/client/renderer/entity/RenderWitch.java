...
import shordinger.wrapper.net.minecraft.client.model.ModelWitch;
import shordinger.wrapper.net.minecraft.client.renderer.GlStateManager;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerHeldItemWitch;
...
public class RenderWitch extends RenderLiving<EntityWitch> {
    ...
    public void doRender(EntityWitch entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ((ModelWitch) this.mainModel).holdingItem = !entity.getHeldItemMainhand()
            .isEmpty();

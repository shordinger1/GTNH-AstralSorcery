...
public class SoundHandler implements IResourceManagerReloadListener, ITickable {
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        ...
        net.minecraftforge.fml.common.ProgressManager.ProgressBar resourcesBar = net.minecraftforge.fml.common.ProgressManager
            .push("Loading sounds", resources.size());
    ...
    private boolean validateSoundResource(Sound p_184401_1_, ResourceLocation p_184401_2_) {
        ...
        try {
            ...
            LOGGER.warn(
                "Could not load sound file {}, cannot add it to event {}",
                resourcelocation,
                p_184401_2_,
                ioexception);
            flag = false;

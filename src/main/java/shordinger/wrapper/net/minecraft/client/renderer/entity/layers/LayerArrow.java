...
import shordinger.wrapper.net.minecraft.client.model.ModelBox;
...
public class LayerArrow implements LayerRenderer<EntityLivingBase> {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount,
        ...
        if (i > 0) {
            Entity entity = new EntityTippedArrow(
                entitylivingbaseIn.world,
            ...
            for (int j = 0; j < i; ++j) {
                ...
                ModelRenderer modelrenderer = this.renderer.getMainModel()
                    .getRandomModelBox(random);
                ...
                double d1 = 0.0D;
                double d2 = 0.0D;
                this.renderer.getRenderManager()
                    .renderEntity(entity, 0.0D, 0.0D, 0.0D, 0.0F, partialTicks, false);

...
import shordinger.wrapper.net.minecraft.client.entity.EntityOtherPlayerMP;
import shordinger.wrapper.net.minecraft.client.entity.EntityPlayerSP;
import shordinger.wrapper.net.minecraft.client.gui.GuiCommandBlock;
import shordinger.wrapper.net.minecraft.client.gui.GuiDisconnected;
import shordinger.wrapper.net.minecraft.client.gui.GuiDownloadTerrain;
...
import shordinger.wrapper.net.minecraft.client.gui.GuiMerchant;
...
import shordinger.wrapper.net.minecraft.client.gui.GuiScreenBook;
import shordinger.wrapper.net.minecraft.client.gui.GuiScreenDemo;
...
import shordinger.wrapper.net.minecraft.client.gui.GuiYesNo;
import shordinger.wrapper.net.minecraft.client.gui.GuiYesNoCallback;
import shordinger.wrapper.net.minecraft.client.gui.IProgressMeter;
import shordinger.wrapper.net.minecraft.client.gui.MapItemRenderer;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiContainerCreative;
import shordinger.wrapper.net.minecraft.client.gui.recipebook.GuiRecipeBook;
import shordinger.wrapper.net.minecraft.client.gui.recipebook.IRecipeShownListener;
import shordinger.wrapper.net.minecraft.client.gui.toasts.RecipeToast;
...
import shordinger.wrapper.net.minecraft.client.particle.ParticleItemPickup;
import shordinger.wrapper.net.minecraft.client.player.inventory.ContainerLocalMenu;
import shordinger.wrapper.net.minecraft.client.player.inventory.LocalBlockIntercommunication;
import shordinger.wrapper.net.minecraft.client.renderer.debug.DebugRendererNeighborsUpdate;
import shordinger.wrapper.net.minecraft.client.renderer.debug.DebugRendererPathfinding;
...
import shordinger.wrapper.net.minecraft.entity.EntityTracker;
import shordinger.wrapper.net.minecraft.entity.IMerchant;
import shordinger.wrapper.net.minecraft.entity.NpcMerchant;
...
import shordinger.wrapper.net.minecraft.inventory.ContainerHorseChest;
...
import shordinger.wrapper.net.minecraft.network.PacketThreadUtil;
...
import shordinger.wrapper.net.minecraft.network.play.server.SPacketAdvancementInfo;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketAnimation;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketBlockAction;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketBlockBreakAnim;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketBlockChange;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCamera;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketChangeGameState;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketChat;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketChunkData;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCloseWindow;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCollectItem;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCombatEvent;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketConfirmTransaction;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCooldown;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCustomPayload;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketCustomSound;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketDestroyEntities;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketDisconnect;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketDisplayObjective;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEffect;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntity;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityAttach;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityEffect;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityEquipment;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityHeadLook;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityMetadata;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityProperties;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityStatus;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityTeleport;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketEntityVelocity;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketExplosion;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketHeldItemChange;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketJoinGame;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketKeepAlive;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketMaps;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketMoveVehicle;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketMultiBlockChange;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketOpenWindow;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketParticles;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketPlaceGhostRecipe;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketPlayerAbilities;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketPlayerListHeaderFooter;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketPlayerListItem;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketPlayerPosLook;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketRecipeBook;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketRemoveEntityEffect;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketResourcePackSend;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketRespawn;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketScoreboardObjective;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSelectAdvancementsTab;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketServerDifficulty;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSetExperience;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSetPassengers;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSetSlot;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSignEditorOpen;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSoundEffect;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnExperienceOrb;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnGlobalEntity;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnMob;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnObject;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnPainting;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnPlayer;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketSpawnPosition;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketStatistics;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketTabComplete;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketTeams;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketTimeUpdate;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketTitle;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUnloadChunk;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUpdateBossInfo;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUpdateHealth;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUpdateScore;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUpdateTileEntity;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketUseBed;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketWindowItems;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketWindowProperty;
import shordinger.wrapper.net.minecraft.network.play.server.SPacketWorldBorder;
...
import shordinger.wrapper.net.minecraft.scoreboard.IScoreCriteria;
...
import shordinger.wrapper.net.minecraft.scoreboard.ScorePlayerTeam;
import shordinger.wrapper.net.minecraft.scoreboard.Scoreboard;
import shordinger.wrapper.net.minecraft.scoreboard.Team;
...
import shordinger.wrapper.net.minecraft.tileentity.TileEntityStructure;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
    ...
    public void handleJoinGame(SPacketJoinGame packetIn) {
        ...
        this.world = new WorldClient(
            ...
            net.minecraftforge.fml.common.network.handshake.NetworkDispatcher.get(getNetworkManager())
                .getOverrideDimension(packetIn),
    ...
    public void handleSpawnObject(SPacketSpawnObject packetIn) {
        ...
        if (packetIn.getType() == 10) {
            ...
            entity = new EntityLlamaSpit(
                ...
                d1,
                d2,
                (double) packetIn.getSpeedX() / 8000.0D,
            ...
            entity = new EntityItemFrame(
                ...
                EnumFacing.getHorizontal(packetIn.getData()));
            packetIn.setData(0);
        } else if (packetIn.getType() == 77) {
            entity = new EntityLeashKnot(
                this.world,
                new BlockPos(MathHelper.floor(d0), MathHelper.floor(d1), MathHelper.floor(d2)));
            packetIn.setData(0);
    ...
    public void handleEntityMetadata(SPacketEntityMetadata packetIn) {
        ...
        if (entity != null && packetIn.getDataManagerEntries() != null) {
            entity.getDataManager()
                .setEntryValues(packetIn.getDataManagerEntries());
        }
    }
    ...
    public void handleSpawnPlayer(SPacketSpawnPlayer packetIn) {
        ...
        EntityOtherPlayerMP entityotherplayermp = new EntityOtherPlayerMP(
            this.client.world,
            this.getPlayerInfo(packetIn.getUniqueId())
                .getGameProfile());
        ...
        if (list != null) {
            entityotherplayermp.getDataManager()
                .setEntryValues(list);
        }
    }
    ...
    public void handleMultiBlockChange(SPacketMultiBlockChange packetIn) {
        ...
        for (SPacketMultiBlockChange.BlockUpdateData spacketmultiblockchange$blockupdatedata : packetIn
            .getChangedBlocks()) {
            this.world.invalidateRegionAndSetBlock(
    ...
    public void handleChunkData(SPacketChunkData packetIn) {
        ...
        this.world.invalidateBlockReceiveRegion(
            ...
            if (this.guiScreenServer instanceof GuiScreenRealmsProxy) {
                this.client.displayGuiScreen(
                    (new DisconnectedRealmsScreen(
                        ((GuiScreenRealmsProxy) this.guiScreenServer).getProxy(),
                        "disconnect.lost",
                        reason)).getProxy());
            } else {
    ...
    public void handleChat(SPacketChat packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        net.minecraft.util.text.ITextComponent message = net.minecraftforge.event.ForgeEventFactory
            .onClientChat(packetIn.getType(), packetIn.getChatComponent());
    ...
    public void handleUseBed(SPacketUseBed packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        packetIn.getPlayer(this.world)
            .trySleep(packetIn.getBedPosition());
    }
    ...
    public void handleSpawnMob(SPacketSpawnMob packetIn) {
        ...
        EntityLivingBase entitylivingbase = (EntityLivingBase) EntityList
            .createEntityByID(packetIn.getEntityType(), this.client.world);
        ...
        if (entitylivingbase != null) {
            ...
            if (list != null) {
                entitylivingbase.getDataManager()
                    .setEntryValues(list);
            }
        } else {
    ...
    public void handleSpawnPosition(SPacketSpawnPosition packetIn) {
        ...
        this.client.world.getWorldInfo()
            .setSpawn(packetIn.getSpawnPos());
    }
            ...
            for (int i : packetIn.getPassengerIds()) {
                ...
                if (entity1 != null) {
                    ...
                    if (entity1 == this.client.player && !flag) {
                        this.client.ingameGUI.setOverlayMessage(
                            I18n.format("mount.onboard", this.client.gameSettings.keyBindSneak.getDisplayName()),
                            false);
                    }
                }
            }
        ...
        if (entity != null) {
            if (packetIn.getOpCode() == 21) {
                this.client.getSoundHandler()
                    .playSound(new GuardianSound((EntityGuardian) entity));
    ...
    public void handleUpdateHealth(SPacketUpdateHealth packetIn) {
        ...
        this.client.player.getFoodStats()
            .setFoodLevel(packetIn.getFoodLevel());
        this.client.player.getFoodStats()
            .setFoodSaturationLevel(packetIn.getSaturationLevel());
    }
    ...
    public void handleOpenWindow(SPacketOpenWindow packetIn) {
        ...
        if ("minecraft:container".equals(packetIn.getGuiId())) {
            ...
            if (entity instanceof AbstractHorse) {
                entityplayersp.openGuiHorseInventory(
                    (AbstractHorse) entity,
                    new ContainerHorseChest(packetIn.getWindowTitle(), packetIn.getSlotCount()));
                entityplayersp.openContainer.windowId = packetIn.getWindowId();
            }
            ...
            IInventory iinventory = new ContainerLocalMenu(
                packetIn.getGuiId(),
    ...
    public void handleSetSlot(SPacketSetSlot packetIn) {
        ...
        this.client.getTutorial()
            .handleSetSlot(itemstack);
        ...
        if (packetIn.getWindowId() == -1) {
            ...
            if (packetIn.getWindowId() == 0 && packetIn.getSlot() >= 36 && i < 45) {
                if (!itemstack.isEmpty()) {
                    ItemStack itemstack1 = entityplayer.inventoryContainer.getSlot(i)
                        .getStack();
    ...
    public void handleUpdateTileEntity(SPacketUpdateTileEntity packetIn) {
        ...
        if (this.client.world.isBlockLoaded(packetIn.getPos())) {
            ...
            if (i == 1 && tileentity instanceof TileEntityMobSpawner || flag
                ...
                if (tileentity == null) {
                    LOGGER.error(
                        "Received invalid update packet for null tile entity at {} with data: {}",
                        packetIn.getPos(),
                        packetIn.getNbtCompound());
                    return;
                }
    ...
    public void handleBlockAction(SPacketBlockAction packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        this.client.world.addBlockEvent(
            packetIn.getBlockPosition(),
            packetIn.getBlockType(),
            packetIn.getData1(),
            packetIn.getData2());
    }
    ...
    public void handleBlockBreakAnim(SPacketBlockBreakAnim packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        this.client.world
            .sendBlockBreakProgress(packetIn.getBreakerId(), packetIn.getPosition(), packetIn.getProgress());
    }
    ...
    public void handleChangeGameState(SPacketChangeGameState packetIn) {
        ...
        if (i >= 0 && i < SPacketChangeGameState.MESSAGE_NAMES.length
            ...
            entityplayer.sendStatusMessage(
                new TextComponentTranslation(SPacketChangeGameState.MESSAGE_NAMES[i], new Object[0]),
                false);
        }
            ...
            if (f == 0.0F) {
                ...
                this.client.ingameGUI.getChatGUI()
                    .printChatMessage(
                        new TextComponentTranslation(
                            "demo.help.movement",
                            new Object[]{gamesettings.keyBindForward.getDisplayName(),
                                gamesettings.keyBindLeft.getDisplayName(), gamesettings.keyBindBack.getDisplayName(),
                ...
                this.client.ingameGUI.getChatGUI()
                    .printChatMessage(
                        new TextComponentTranslation(
                            "demo.help.jump",
                            new Object[]{gamesettings.keyBindJump.getDisplayName()}));
            } else if (f == 103.0F) {
                this.client.ingameGUI.getChatGUI()
                    .printChatMessage(
                        new TextComponentTranslation(
                            "demo.help.inventory",
                            new Object[]{gamesettings.keyBindInventory.getDisplayName()}));
            }
        } else if (i == 6) {
            this.world.playSound(
                entityplayer,
    ...
    public void handleSelectAdvancementsTab(SPacketSelectAdvancementsTab packetIn) {
        ...
        if (resourcelocation == null) {
            ...
            Advancement advancement = this.advancementManager.getAdvancementList()
    ...
    public void handleStatistics(SPacketStatistics packetIn) {
        ...
        for (Entry<StatBase, Integer> entry : packetIn.getStatisticMap()
            ...
            this.client.player.getStatFileWriter()
                .unlockAchievement(this.client.player, statbase, k);
        }
    ...
    public void handleRecipeBook(SPacketRecipeBook packetIn) {
        ...
        switch (spacketrecipebook$state) {
            case REMOVE:
                Iterator iterator = packetIn.getRecipes()
                    .iterator();
            ...
            case INIT:
                packetIn.getRecipes()
                    .forEach(recipebook::unlock);
                packetIn.getDisplayedRecipes()
                    .forEach(recipebook::markNew);
                break;
            case ADD:
                packetIn.getRecipes()
                    .forEach((p_194025_2_) -> {
        ...
        if (entity instanceof EntityLivingBase) {
            ...
            if (potion != null) {
                PotionEffect potioneffect = new PotionEffect(
                    potion,
                    packetIn.getDuration(),
                    packetIn.getAmplifier(),
                    packetIn.getIsAmbient(),
                    packetIn.doesShowParticles());
    ...
    public void handleServerDifficulty(SPacketServerDifficulty packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        this.client.world.getWorldInfo()
            .setDifficulty(packetIn.getDifficulty());
        this.client.world.getWorldInfo()
            .setDifficultyLocked(packetIn.isDifficultyLocked());
    }
    ...
    public void handleTitle(SPacketTitle packetIn) {
        ...
        this.client.ingameGUI
            .displayTitle(s, s1, packetIn.getFadeInTime(), packetIn.getDisplayTime(), packetIn.getFadeOutTime());
    }
    ...
    public void handlePlayerListItem(SPacketPlayerListItem packetIn) {
        ...
        for (SPacketPlayerListItem.AddPlayerData spacketplayerlistitem$addplayerdata : packetIn.getEntries()) {
            if (packetIn.getAction() == SPacketPlayerListItem.Action.REMOVE_PLAYER) {
                this.playerInfoMap.remove(
                    spacketplayerlistitem$addplayerdata.getProfile()
                        .getId());
            } else {
                NetworkPlayerInfo networkplayerinfo = this.playerInfoMap.get(
                    spacketplayerlistitem$addplayerdata.getProfile()
                        .getId());
    ...
    public void handleResourcePack(SPacketResourcePackSend packetIn) {
        ...
        if (this.validateResourcePackUrl(s)) {
            if (s.startsWith("level://")) {
                    ...
                    if (file2.isFile()) {
                        ...
                        Futures.addCallback(
                            this.client.getResourcePackRepository()
                                .setServerResourcePack(file2),
                            this.createDownloadCallback());
                        return;
                    }
                ...
                this.netManager
                    .sendPacket(new CPacketResourcePackStatus(CPacketResourcePackStatus.Action.FAILED_DOWNLOAD));
            } else {
                                ...
                                public void confirmClicked(boolean result, int id) {
                                    ...
                                    if (result) {
                                        ...
                                        NetHandlerPlayClient.this.netManager.sendPacket(
                                            new CPacketResourcePackStatus(CPacketResourcePackStatus.Action.ACCEPTED));
                                        Futures.addCallback(
                                            NetHandlerPlayClient.this.client.getResourcePackRepository()
                                                .downloadResourcePack(s, s1),
                                        ...
                                        NetHandlerPlayClient.this.netManager.sendPacket(
                                            new CPacketResourcePackStatus(CPacketResourcePackStatus.Action.DECLINED));
                                    }
    ...
    public void handleUpdateBossInfo(SPacketUpdateBossInfo packetIn) {
        PacketThreadUtil.checkThreadAndEnqueue(packetIn, this, this.client);
        this.client.ingameGUI.getBossOverlay()
            .read(packetIn);
    }
    ...
    public void handleCooldown(SPacketCooldown packetIn) {
        ...
        if (packetIn.getTicks() == 0) {
            this.client.player.getCooldownTracker()
                .removeCooldown(packetIn.getItem());
        } else {
            this.client.player.getCooldownTracker()
                .setCooldown(packetIn.getItem(), packetIn.getTicks());
        }
    }
        ...
        if ("MC|TrList".equals(packetIn.getChannelName())) {
            ...
            try {
                ...
                if (guiscreen != null && guiscreen instanceof GuiMerchant
                    && k == this.client.player.openContainer.windowId) {
            ...
            this.client.player.setServerBrand(
                packetIn.getBufferData()
                    .readString(32767));
        } else if ("MC|BOpen".equals(packetIn.getChannelName())) {
            EnumHand enumhand = (EnumHand) packetIn.getBufferData()
                .readEnumValue(EnumHand.class);
            ItemStack itemstack = enumhand == EnumHand.OFF_HAND ? this.client.player.getHeldItemOffhand()
            ...
            this.client.getSoundHandler()
                .stop(s1, SoundCategory.getByName(s));
        }
    }
    ...
    public void handleScoreboardObjective(SPacketScoreboardObjective packetIn) {
        ...
        if (packetIn.getAction() == 0) {
            ScoreObjective scoreobjective = scoreboard
                .addScoreObjective(packetIn.getObjectiveName(), IScoreCriteria.DUMMY);
            ...
            if (!(entity instanceof EntityLivingBase)) {
                ...
                for (SPacketEntityProperties.Snapshot spacketentityproperties$snapshot : packetIn.getSnapshots()) {
                    IAttributeInstance iattributeinstance = abstractattributemap
                        .getAttributeInstanceByName(spacketentityproperties$snapshot.getName());

                    if (iattributeinstance == null) {
                        iattributeinstance = abstractattributemap.registerAttribute(
                            new RangedAttribute(
                                (IAttribute) null,
                                spacketentityproperties$snapshot.getName(),
                                0.0D,
                                -Double.MAX_VALUE,
                                Double.MAX_VALUE)); // Forge: fix invalid value range (MC-150405)
                    }
    ...
    public NetworkPlayerInfo getPlayerInfo(String name) {
        for (NetworkPlayerInfo networkplayerinfo : this.playerInfoMap.values()) {
            if (networkplayerinfo.getGameProfile()
                .getName()
                .equals(name)) {

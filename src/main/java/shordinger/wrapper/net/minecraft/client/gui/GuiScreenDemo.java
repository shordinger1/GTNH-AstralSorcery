...
public class GuiScreenDemo extends GuiScreen {
    ...
    private static final ResourceLocation DEMO_BACKGROUND_LOCATION = new ResourceLocation(
    ...
    public void initGui() {
        ...
        int i = -16;
        this.buttonList.add(
            new GuiButton(1, this.width / 2 - 116, this.height / 2 + 62 + -16, 114, 20, I18n.format("demo.help.buy")));
        this.buttonList.add(
            new GuiButton(2, this.width / 2 + 2, this.height / 2 + 62 + -16, 114, 20, I18n.format("demo.help.later")));
    }
            ...
            case 1:
                ...
                try {
                    ...
                    oclass.getMethod("browse", URI.class)
                        .invoke(object, new URI("http://www.minecraft.net/store?source=demo"));
    ...
    public void drawDefaultBackground() {
        ...
        this.mc.getTextureManager()
            .bindTexture(DEMO_BACKGROUND_LOCATION);
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.fontRenderer
            .drawString(I18n.format("demo.help.jump", gamesettings.keyBindJump.getDisplayName()), i, j + 24, 5197647);
        this.fontRenderer.drawString(
            I18n.format("demo.help.inventory", gamesettings.keyBindInventory.getDisplayName()),
            i,
            j + 36,
            5197647);

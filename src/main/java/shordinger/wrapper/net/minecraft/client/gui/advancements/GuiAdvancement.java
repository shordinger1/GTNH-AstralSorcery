...
import shordinger.wrapper.net.minecraft.advancements.DisplayInfo;
...
public class GuiAdvancement extends Gui {
    ...
    public GuiAdvancement(GuiAdvancementTab p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_,
        ...
        this.title = p_i47385_2_.fontRenderer.trimStringToWidth(
            p_i47385_4_.getTitle()
                .getFormattedText(),
            163);
        ...
        int j = String.valueOf(i)
            .length();
        int k = i > 1
            ? p_i47385_2_.fontRenderer.getStringWidth("  ") + p_i47385_2_.fontRenderer.getStringWidth("0") * j * 2
            + p_i47385_2_.fontRenderer.getStringWidth("/")
            : 0;
        int l = 29 + p_i47385_2_.fontRenderer.getStringWidth(this.title) + k;
        String s = p_i47385_4_.getDescription()
            .getFormattedText();
    ...
    public void draw(int p_191817_1_, int p_191817_2_) {
        if (!this.displayInfo.isHidden() || this.advancementProgress != null && this.advancementProgress.isDone()) {
            ...
            this.drawTexturedModalRect(
                p_191817_1_ + this.x + 3,
                p_191817_2_ + this.y,
                this.displayInfo.getFrame()
                    .getIcon(),
                128 + advancementstate.getId() * 26,
                26,
                26);
            RenderHelper.enableGUIStandardItemLighting();
            this.minecraft.getRenderItem()
                .renderItemAndEffectIntoGUI(
                    (EntityLivingBase) null,
                    this.displayInfo.getIcon(),
                    p_191817_1_ + this.x + 8,
                    p_191817_2_ + this.y + 5);
        }
    ...
    public void drawHover(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
        ...
        boolean flag1 = 113 - p_191821_2_ - this.y - 26
            <= 6 + this.description.size() * this.minecraft.fontRenderer.FONT_HEIGHT;
        float f = this.advancementProgress == null ? 0.0F : this.advancementProgress.getPercent();
        ...
        this.drawTexturedModalRect(
            p_191821_1_ + this.x + 3,
            p_191821_2_ + this.y,
            this.displayInfo.getFrame()
                .getIcon(),
            128 + advancementstate2.getId() * 26,
            26,
            26);

        if (flag) {
            this.minecraft.fontRenderer
                .drawString(this.title, (float) (i1 + 5), (float) (p_191821_2_ + this.y + 9), -1, true);

            if (s != null) {
                this.minecraft.fontRenderer
                    .drawString(s, (float) (p_191821_1_ + this.x - i), (float) (p_191821_2_ + this.y + 9), -1, true);
            }
        } else {
            this.minecraft.fontRenderer.drawString(
                this.title,
                (float) (p_191821_1_ + this.x + 32),
                (float) (p_191821_2_ + this.y + 9),
                -1,
                true);
            ...
            if (s != null) {
                this.minecraft.fontRenderer.drawString(
                    s,
                    (float) (p_191821_1_ + this.x + this.width - i - 5),
                    (float) (p_191821_2_ + this.y + 9),
                    -1,
                    true);
            }
        ...
        if (flag1) {
            for (int k1 = 0; k1 < this.description.size(); ++k1) {
                this.minecraft.fontRenderer.drawString(
                    this.description.get(k1),
                    (float) (i1 + 5),
                    (float) (l + 26 - j1 + 7 + k1 * this.minecraft.fontRenderer.FONT_HEIGHT),
                    -5592406,
                    false);
            }
        } else {
        ...
        this.minecraft.getRenderItem()
            .renderItemAndEffectIntoGUI(
                (EntityLivingBase) null,
                this.displayInfo.getIcon(),
                p_191821_1_ + this.x + 8,
                p_191821_2_ + this.y + 5);
    }
    ...
    protected void render9Sprite(int p_192994_1_, int p_192994_2_, int p_192994_3_, int p_192994_4_, int p_192994_5_,
        ...
        this.renderRepeating(
            p_192994_1_ + p_192994_5_,
            p_192994_2_,
            p_192994_3_ - p_192994_5_ - p_192994_5_,
            p_192994_5_,
            p_192994_8_ + p_192994_5_,
            p_192994_9_,
            p_192994_6_ - p_192994_5_ - p_192994_5_,
            p_192994_7_);
        this.drawTexturedModalRect(
            p_192994_1_ + p_192994_3_ - p_192994_5_,
            p_192994_2_,
            p_192994_8_ + p_192994_6_ - p_192994_5_,
            p_192994_9_,
            p_192994_5_,
            p_192994_5_);
        this.drawTexturedModalRect(
            p_192994_1_,
            p_192994_2_ + p_192994_4_ - p_192994_5_,
            p_192994_8_,
            p_192994_9_ + p_192994_7_ - p_192994_5_,
            p_192994_5_,
            p_192994_5_);
        this.renderRepeating(
            p_192994_1_ + p_192994_5_,
        ...
        this.renderRepeating(
            p_192994_1_,
            p_192994_2_ + p_192994_5_,
            p_192994_5_,
            p_192994_4_ - p_192994_5_ - p_192994_5_,
            p_192994_8_,
            p_192994_9_ + p_192994_5_,
            p_192994_6_,

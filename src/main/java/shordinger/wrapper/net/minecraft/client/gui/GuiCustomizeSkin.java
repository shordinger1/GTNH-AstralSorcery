...
public class GuiCustomizeSkin extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.buttonList
            .add(new GuiButton(200, this.width / 2 - 100, this.height / 6 + 24 * (i >> 1), I18n.format("gui.done")));
    }
    ...
    private String getMessage(EnumPlayerModelParts playerModelParts) {
        ...
        if (this.mc.gameSettings.getModelParts()
            .contains(playerModelParts)) {
            s = I18n.format("options.on");
        } else {
            s = I18n.format("options.off");
        }

        return playerModelParts.getName()
            .getFormattedText() + ": "
            + s;
    }
    ...
    class ButtonPart extends GuiButton {
        ...
        private ButtonPart(int p_i45514_2_, int p_i45514_3_, int p_i45514_4_, int p_i45514_5_, int p_i45514_6_,
            ...
            super(
                ...
                p_i45514_5_,
                p_i45514_6_,
                GuiCustomizeSkin.this.getMessage(playerModelParts));

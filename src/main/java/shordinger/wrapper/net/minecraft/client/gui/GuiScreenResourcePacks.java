...
import shordinger.wrapper.net.minecraft.client.resources.ResourcePackListEntryDefault;
import shordinger.wrapper.net.minecraft.client.resources.ResourcePackListEntryFound;
import shordinger.wrapper.net.minecraft.client.resources.ResourcePackListEntryServer;
...
public class GuiScreenResourcePacks extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.availableResourcePacksList = new GuiResourcePackAvailable(
            this.mc,
            200,
            this.height,
        ...
        this.selectedResourcePacksList = new GuiResourcePackSelected(
            this.mc,
            200,
            this.height,
            this.selectedResourcePacks);
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.enabled) {
            if (button.id == 2) {
                File file1 = this.mc.getResourcePackRepository()
                    .getDirResourcepacks();

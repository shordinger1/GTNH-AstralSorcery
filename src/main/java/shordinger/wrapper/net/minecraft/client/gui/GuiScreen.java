...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    protected boolean keyHandled, mouseHandled; // Forge: allow canceling key and mouse Post events from
    // handleMouseInput and handleKeyboardInput
        ...
        if (!StringUtils.isEmpty(copyText)) {
            try {
                ...
                Toolkit.getDefaultToolkit()
                    .getSystemClipboard()
                    .setContents(stringselection, (ClipboardOwner) null);
    ...
    protected void handleComponentHover(ITextComponent component, int x, int y) {
        if (component != null && component.getStyle()
            .getHoverEvent() != null) {
            HoverEvent hoverevent = component.getStyle()
                .getHoverEvent();
            ...
            if (hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
                ...
                try {
                    NBTBase nbtbase = JsonToNBT.getTagFromJson(
                        hoverevent.getValue()
                            .getUnformattedText());
                ...
                if (this.mc.gameSettings.advancedItemTooltips) {
                    try {
                        NBTTagCompound nbttagcompound = JsonToNBT.getTagFromJson(
                            hoverevent.getValue()
                                .getUnformattedText());
                ...
                if (clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
                    ...
                    try {
                        ...
                        if (this.mc.gameSettings.chatLinksPrompt) {
                            ...
                            this.mc
                                .displayGuiScreen(new GuiConfirmOpenLink(this, clickevent.getValue(), 31102009, false));
                        } else {
        ...
        if (mouseButton == 0) {
            for (int i = 0; i < this.buttonList.size(); ++i) {
                ...
                if (guibutton.mousePressed(this.mc, mouseX, mouseY)) {
                    ...
                    if (this.equals(this.mc.currentScreen)) net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(
    ...
    public void handleInput() throws IOException {
        if (Mouse.isCreated()) {
            while (Mouse.next()) {
                ...
                if (net.minecraftforge.common.MinecraftForge.EVENT_BUS
                    .post(new net.minecraftforge.client.event.GuiScreenEvent.MouseInputEvent.Pre(this))) continue;
        ...
        if (Keyboard.isCreated()) {
            while (Keyboard.next()) {
                ...
                if (net.minecraftforge.common.MinecraftForge.EVENT_BUS
                    .post(new net.minecraftforge.client.event.GuiScreenEvent.KeyboardInputEvent.Pre(this))) continue;

...
public class GuiRepair extends GuiContainer implements IContainerListener {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        ...
        if (this.anvil.maximumCost > 0) {
            ...
            if (this.anvil.maximumCost >= 40 && !this.mc.player.capabilities.isCreativeMode) {
                ...
                i = 16736352;
            } else if (!this.anvil.getSlot(2)
                .getHasStack()) {
                flag = false;
            } else if (!this.anvil.getSlot(2)
                .canTakeStack(this.playerInventory.player)) {
                i = 16736352;
            }
    ...
    private void renameItem() {
        ...
        this.mc.player.connection
            .sendPacket(new CPacketCustomPayload("MC|ItemName", (new PacketBuffer(Unpooled.buffer())).writeString(s)));
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.drawTexturedModalRect(
            ...
            j + 20,
            0,
            this.ySize + (this.anvil.getSlot(0)
                .getHasStack() ? 0 : 16),
            110,
            16);

        if ((this.anvil.getSlot(0)
            .getHasStack()
            || this.anvil.getSlot(1)
            .getHasStack())
            && !this.anvil.getSlot(2)
            .getHasStack()) {

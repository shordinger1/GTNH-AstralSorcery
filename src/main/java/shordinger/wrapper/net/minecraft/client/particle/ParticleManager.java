...
public class ParticleManager {
    ...
    private void registerVanillaParticles() {
        ...
        this.registerParticle(
            EnumParticleTypes.ENCHANTMENT_TABLE.getParticleID(),
    ...
    public Particle spawnEffectParticle(int particleId, double xCoord, double yCoord, double zCoord, double xSpeed,
        ...
        if (iparticlefactory != null) {
            Particle particle = iparticlefactory
                .createParticle(particleId, this.world, xCoord, yCoord, zCoord, xSpeed, ySpeed, zSpeed, parameters);
    ...
    public void addBlockDestroyEffects(BlockPos pos, IBlockState state) {
        if (!state.getBlock()
            .isAir(state, this.world, pos)
            && !state.getBlock()
            .addDestroyEffects(world, pos, this)) {
    ...
    public void addBlockHitEffects(BlockPos pos, EnumFacing side) {
        ...
        if (iblockstate.getRenderType() != EnumBlockRenderType.INVISIBLE) {
            ...
            this.addEffect(
                (new ParticleDigging(this.world, d0, d1, d2, 0.0D, 0.0D, 0.0D, iblockstate)).setBlockPos(pos)
    ...
    public void addBlockHitEffects(BlockPos pos, net.minecraft.util.math.RayTraceResult target) {
        ...
        if (state != null && !state.getBlock()
            .addHitEffects(state, world, target, this)) {

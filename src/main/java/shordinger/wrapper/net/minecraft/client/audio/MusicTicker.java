...
public class MusicTicker implements ITickable {
    ...
    public void update() {
        ...
        if (this.currentMusic != null) {
            if (!musicticker$musictype.getMusicLocation()
                .getSoundName()
                .equals(this.currentMusic.getSoundLocation())) {
            ...
            if (!this.mc.getSoundHandler()
                ...
                this.timeUntilNextMusic = Math.min(
                    MathHelper
                        .getInt(this.rand, musicticker$musictype.getMinDelay(), musicticker$musictype.getMaxDelay()),

...
public class FallbackResourceManager implements IResourceManager {
        ...
        for (int i = this.resourcePacks.size() - 1; i >= 0; --i) {
            ...
            if (iresourcepack1.resourceExists(location)) {
                ...
                return new SimpleResource(
                    ...
                    location,
                    this.getInputStream(location, iresourcepack1),
                    inputstream,
    ...
    private void checkResourcePath(ResourceLocation p_188552_1_) throws IOException {
        if (p_188552_1_.getResourcePath()
            .contains("..")) {
            ...
            if (iresourcepack.resourceExists(location)) {
                ...
                list.add(
                    new SimpleResource(
                        ...
                        location,
                        this.getInputStream(location, iresourcepack),
                        inputstream,
                        this.frmMetadataSerializer));
            }
        }
    ...
    static class InputStreamLeakedResourceLogger extends InputStream {
        ...
        public InputStreamLeakedResourceLogger(InputStream p_i46093_1_, ResourceLocation location,
                                               String resourcePack) {
            this.inputStream = p_i46093_1_;
            ByteArrayOutputStream bytearrayoutputstream = new ByteArrayOutputStream();
            (new Exception()).printStackTrace(new PrintStream(bytearrayoutputstream));
            this.message = "Leaked resource: '" + location
                + "' loaded from pack: '"
                + resourcePack
                + "'\n"

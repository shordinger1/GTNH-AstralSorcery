...
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerWitherAura;
...
public class RenderWither extends RenderLiving<EntityWither> {
    ...
    private static final ResourceLocation INVULNERABLE_WITHER_TEXTURES = new ResourceLocation(

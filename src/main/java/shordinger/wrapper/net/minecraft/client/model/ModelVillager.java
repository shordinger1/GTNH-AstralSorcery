...
public class ModelVillager extends ModelBase {
    ...
    public ModelVillager(float scale, float p_i1164_2_, int width, int height) {
        ...
        this.villagerHead.setTextureOffset(0, 0)
            .addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, scale);
        ...
        this.villagerNose.setTextureOffset(24, 0)
            .addBox(-1.0F, -1.0F, -6.0F, 2, 4, 2, scale);
        ...
        this.villagerBody.setTextureOffset(16, 20)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, scale);
        this.villagerBody.setTextureOffset(0, 38)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, scale + 0.5F);
        ...
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(-8.0F, -2.0F, -2.0F, 4, 8, 4, scale);
        this.villagerArms.setTextureOffset(44, 22)
            .addBox(4.0F, -2.0F, -2.0F, 4, 8, 4, scale);
        this.villagerArms.setTextureOffset(40, 38)
            .addBox(-4.0F, 2.0F, -2.0F, 8, 4, 4, scale);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        this.leftVillagerLeg.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F
            * limbSwingAmount
            * 0.5F;

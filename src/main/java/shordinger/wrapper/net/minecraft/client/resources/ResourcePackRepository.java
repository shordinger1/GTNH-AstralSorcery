...
public class ResourcePackRepository {
    ...
    private static final FileFilter RESOURCE_PACK_FILTER = new FileFilter() {
        ...
        public boolean accept(File p_accept_1_) {
            boolean flag = p_accept_1_.isFile() && p_accept_1_.getName()
                .endsWith(".zip");
    ...
    public ResourcePackRepository(File dirResourcepacksIn, File dirServerResourcepacksIn,
                                  IResourcePack rprDefaultResourcePackIn, MetadataSerializer rprMetadataSerializerIn, GameSettings settings) {
        ...
        while (iterator.hasNext()) {
            ...
            for (ResourcePackRepository.Entry resourcepackrepository$entry : this.repositoryEntriesAll) {
                if (resourcepackrepository$entry.getResourcePackName()
                    .equals(s)) {
    ...
    private List<File> getResourcePackFiles() {
        return this.dirResourcepacks.isDirectory()
            ? Arrays.asList(this.dirResourcepacks.listFiles(RESOURCE_PACK_FILTER))
    ...
    private IResourcePack getResourcePack(File p_191399_1_) {
        ...
        try {
            PackMetadataSection packmetadatasection = (PackMetadataSection) iresourcepack
    ...
    public ResourcePackRepository.Entry getResourcePackEntry() {
        if (this.serverResourcePack != null) {
            ResourcePackRepository.Entry resourcepackrepository$entry = new ResourcePackRepository.Entry(
                this.serverResourcePack);
    ...
    public ListenableFuture<Object> downloadResourcePack(String url, String hash) {
        ...
        final String s1 = SHA1.matcher(hash)
            .matches() ? hash : "";
        ...
        try {
            ...
            this.downloadingPacks = HttpUtil
                .downloadResourcePack(file1, url, map, 52428800, guiscreenworking, minecraft.getProxy());
    ...
    private boolean checkHash(String p_190113_1_, File p_190113_2_) {
        ...
        try {
            ...
            if (s.toLowerCase(java.util.Locale.ROOT)
                .equals(p_190113_1_.toLowerCase(java.util.Locale.ROOT))) {
    ...
    private void deleteOldServerResourcesPacks() {
        try {
            ...
            LOGGER.error(
                "Error while deleting old server resource pack : {}",
    ...
    public class Entry {
        ...
        public void bindTexturePackIcon(TextureManager textureManagerIn) {
            ...
            if (this.locationTexturePackIcon == null) {
                this.locationTexturePackIcon = textureManagerIn
                    .getDynamicTextureLocation("texturepackicon", new DynamicTexture(bufferedimage));
            }
        ...
        public String getTexturePackDescription() {
            return this.rePackMetadataSection == null
                ...
                : this.rePackMetadataSection.getPackDescription()
                .getFormattedText();
        }
        ...
        public boolean equals(Object p_equals_1_) {
            if (this == p_equals_1_) {
                ...
                return p_equals_1_ instanceof ResourcePackRepository.Entry ? this.toString()
        ...
        public String toString() {
            return String.format(
                "%s:%s",
                this.reResourcePack.getPackName(),
                this.reResourcePack instanceof FolderResourcePack ? "folder" : "zip");
        }
    }
}

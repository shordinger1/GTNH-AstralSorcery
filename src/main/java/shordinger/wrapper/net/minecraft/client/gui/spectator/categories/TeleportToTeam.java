...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject {
    ...
    public TeleportToTeam() {
        ...
        for (ScorePlayerTeam scoreplayerteam : minecraft.world.getScoreboard()
            .getTeams()) {
    ...
    class TeamSelectionObject implements ISpectatorMenuObject {
        ...
        public TeamSelectionObject(ScorePlayerTeam teamIn) {
            ...
            if (this.players.isEmpty()) {
                ...
                String s1 = ((NetworkPlayerInfo) this.players.get((new Random()).nextInt(this.players.size())))
                    .getGameProfile()
                    .getName();
        ...
        public void renderIcon(float brightness, int alpha) {
            ...
            if (i >= 0) {
                ...
                Gui.drawRect(
                    ...
                    15,
                    15,
                    MathHelper.rgb(f * brightness, f1 * brightness, f2 * brightness) | alpha << 24);
            }

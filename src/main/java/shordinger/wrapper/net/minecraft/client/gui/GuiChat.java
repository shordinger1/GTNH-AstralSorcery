...
public class GuiChat extends GuiScreen implements ITabCompleter {
    ...
    protected void mouseClicked(int mouseX, int mouseY, int mouseButton) throws IOException {
        if (mouseButton == 0) {
            ITextComponent itextcomponent = this.mc.ingameGUI.getChatGUI()
    ...
    public void getSentHistory(int msgPos) {
        ...
        int j = this.mc.ingameGUI.getChatGUI()
            .getSentMessages()
            .size();
        ...
        if (i != this.sentHistoryCursor) {
            if (i == j) {
                ...
                this.inputField.setText(
                    (String) this.mc.ingameGUI.getChatGUI()
                        .getSentMessages()
                        .get(i));
    ...
    public static class ChatTabCompleter extends TabCompleter {
        ...
        public BlockPos getTargetBlockPos() {
            ...
            if (this.client.objectMouseOver != null
                && this.client.objectMouseOver.typeOfHit == RayTraceResult.Type.BLOCK) {

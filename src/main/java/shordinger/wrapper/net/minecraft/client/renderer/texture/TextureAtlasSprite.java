...
import shordinger.wrapper.net.minecraft.client.resources.data.AnimationFrame;
...
public class TextureAtlasSprite {
    ...
    public void loadSpriteFrames(IResource resource, int mipmaplevels) throws IOException {
        ...
        AnimationMetadataSection animationmetadatasection = (AnimationMetadataSection) resource
            .getMetadata("animation");
        int[][] aint = new int[mipmaplevels][];
        aint[0] = new int[bufferedimage.getWidth() * bufferedimage.getHeight()];
        bufferedimage
            .getRGB(0, 0, bufferedimage.getWidth(), bufferedimage.getHeight(), aint[0], 0, bufferedimage.getWidth());
        ...
        if (animationmetadatasection == null) {
            ...
            if (animationmetadatasection.getFrameCount() > 0) {
                Iterator lvt_7_1_ = animationmetadatasection.getFrameIndexSet()
                    .iterator();
    ...
    public String toString() {
        return "TextureAtlasSprite{name='" + this.iconName
            + '\''
            + ", frameCount="
     ...
     */
    public boolean load(net.minecraft.client.resources.IResourceManager manager,
                        net.minecraft.util.ResourceLocation location,

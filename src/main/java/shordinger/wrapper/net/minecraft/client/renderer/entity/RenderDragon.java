...
import shordinger.wrapper.net.minecraft.client.model.ModelDragon;
...
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerEnderDragonDeath;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerEnderDragonEyes;
...
public class RenderDragon extends RenderLiving<EntityDragon> {
     ...
     */
    protected void renderModel(EntityDragon entitylivingbaseIn, float limbSwing, float limbSwingAmount,
    ...
    public void doRender(EntityDragon entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        if (entity.healingEnderCrystal != null) {
            ...
            renderCrystalBeams(
                ...
                entity.ticksExisted,
                entity.healingEnderCrystal.posX,
                (double) f + entity.healingEnderCrystal.posY,
    ...
    public static void renderCrystalBeams(double p_188325_0_, double p_188325_2_, double p_188325_4_, float p_188325_6_,
        ...
        GlStateManager.rotate(
            (float) (-Math.atan2((double) f2, (double) f)) * (180F / (float) Math.PI) - 90.0F,
            0.0F,
            1.0F,
            0.0F);
        GlStateManager.rotate(
            (float) (-Math.atan2((double) f3, (double) f1)) * (180F / (float) Math.PI) - 90.0F,
            1.0F,
            0.0F,
            0.0F);
        ...
        for (int j = 0; j <= 8; ++j) {
            ...
            bufferbuilder.pos((double) (f7 * 0.2F), (double) (f8 * 0.2F), 0.0D)
                .tex((double) f9, (double) f5)
                .color(0, 0, 0, 255)
                .endVertex();
            bufferbuilder.pos((double) f7, (double) f8, (double) f4)
                .tex((double) f9, (double) f6)

...
public class GuiPageButtonList extends GuiListExtended {
    ...
    private void populateComponents() {
        for (GuiPageButtonList.GuiListEntry[] aguipagebuttonlist$guilistentry : this.pages) {
            for (int i = 0; i < aguipagebuttonlist$guilistentry.length; i += 2) {
                ...
                GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 = i
                    < aguipagebuttonlist$guilistentry.length - 1 ? aguipagebuttonlist$guilistentry[i + 1] : null;
                Gui gui = this.createEntry(guipagebuttonlist$guilistentry, 0, guipagebuttonlist$guilistentry1 == null);
                Gui gui1 = this
                    .createEntry(guipagebuttonlist$guilistentry1, 160, guipagebuttonlist$guilistentry == null);
    ...
    private void populateEntries() {
        ...
        for (int i = 0; i < this.pages[this.page].length; i += 2) {
            ...
            GuiPageButtonList.GuiListEntry guipagebuttonlist$guilistentry1 = i < this.pages[this.page].length - 1
                ? this.pages[this.page][i + 1]
                : null;
            Gui gui = this.componentMap.lookup(guipagebuttonlist$guilistentry.getId());
            Gui gui1 = guipagebuttonlist$guilistentry1 != null
                ? (Gui) this.componentMap.lookup(guipagebuttonlist$guilistentry1.getId())
                : null;
            GuiPageButtonList.GuiEntry guipagebuttonlist$guientry = new GuiPageButtonList.GuiEntry(gui, gui1);
            this.entries.add(guipagebuttonlist$guientry);
        }
    ...
    @Nullable
    private Gui createEntry(@Nullable GuiPageButtonList.GuiListEntry p_178058_1_, int p_178058_2_,
                            boolean p_178058_3_) {
        if (p_178058_1_ instanceof GuiPageButtonList.GuiSlideEntry) {
            return this
                .createSlider(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiSlideEntry) p_178058_1_);
        } else if (p_178058_1_ instanceof GuiPageButtonList.GuiButtonEntry) {
            return this
                .createButton(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.GuiButtonEntry) p_178058_1_);
        } else if (p_178058_1_ instanceof GuiPageButtonList.EditBoxEntry) {
            return this
                .createTextField(this.width / 2 - 155 + p_178058_2_, 0, (GuiPageButtonList.EditBoxEntry) p_178058_1_);
        } else {
            return p_178058_1_ instanceof GuiPageButtonList.GuiLabelEntry ? this.createLabel(
                this.width / 2 - 155 + p_178058_2_,
                0,
                (GuiPageButtonList.GuiLabelEntry) p_178058_1_,
                p_178058_3_) : null;
        }
    }
    ...
    public boolean mouseClicked(int mouseX, int mouseY, int mouseEvent) {
        ...
        if (i >= 0) {
            ...
            if (this.focusedControl != guipagebuttonlist$guientry.focusedControl && this.focusedControl != null
                && this.focusedControl instanceof GuiTextField) {
    ...
    private GuiSlider createSlider(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_) {
        GuiSlider guislider = new GuiSlider(
            ...
            p_178067_1_,
            p_178067_2_,
            p_178067_3_.getCaption(),
            p_178067_3_.getMinValue(),
            p_178067_3_.getMaxValue(),
            p_178067_3_.getInitalValue(),
            p_178067_3_.getFormatter());
    ...
    private GuiListButton createButton(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_) {
        GuiListButton guilistbutton = new GuiListButton(
            ...
            p_178065_1_,
            p_178065_2_,
            p_178065_3_.getCaption(),
            p_178065_3_.getInitialValue());
    ...
    private GuiLabel createLabel(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_,
                                 boolean p_178063_4_) {
        GuiLabel guilabel;
    ...
    public static class GuiEntry implements GuiListExtended.IGuiListEntry {
        ...
        private void renderComponent(Gui p_192636_1_, int p_192636_2_, int p_192636_3_, int p_192636_4_,
                                     boolean p_192636_5_, float p_192636_6_) {
            if (p_192636_1_ != null) {
                if (p_192636_1_ instanceof GuiButton) {
                    this.renderButton(
                        (GuiButton) p_192636_1_,
                        p_192636_2_,
                        p_192636_3_,
                        p_192636_4_,
                        p_192636_5_,
        ...
        private void renderButton(GuiButton p_192635_1_, int p_192635_2_, int p_192635_3_, int p_192635_4_,
                                  boolean p_192635_5_, float p_192635_6_) {
        ...
        private void renderLabel(GuiLabel p_178025_1_, int p_178025_2_, int p_178025_3_, int p_178025_4_,
                                 boolean p_178025_5_) {

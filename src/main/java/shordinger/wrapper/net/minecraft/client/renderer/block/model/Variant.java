...
public class Variant implements net.minecraftforge.client.model.ISmartVariant {
    ...
    public String toString() {
        return "Variant{modelLocation=" + this.modelLocation
            + ", rotation="
            + this.rotation
            + ", uvLock="
            + this.uvLock
    ...
    public int hashCode() {
        ...
        i = 31 * i + Boolean.valueOf(this.uvLock)
            .hashCode();
        i = 31 * i + this.weight;
        return i;
    }
    ...
    public static class Deserializer implements JsonDeserializer<Variant> {
        ...
        public Variant deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,

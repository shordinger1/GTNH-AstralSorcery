...
import shordinger.wrapper.net.minecraft.client.gui.GuiButtonImage;
...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener {
    ...
    public void initGui() {
        ...
        this.recipeBookGui.func_194303_a(
            this.width,
            this.height,
            this.mc,
            this.widthTooNarrow,
        ...
        this.recipeButton = new GuiButtonImage(
            10,
            this.guiLeft + 104,
            this.height / 2 - 22,
            20,
    ...
    public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY,
        ...
        RenderManager rendermanager = Minecraft.getMinecraft()
            .getRenderManager();
    ...
    protected boolean hasClickedOutside(int p_193983_1_, int p_193983_2_, int p_193983_3_, int p_193983_4_) {
        ...
        return this.recipeBookGui
            .hasClickedOutside(p_193983_1_, p_193983_2_, this.guiLeft, this.guiTop, this.xSize, this.ySize) && flag;
    }

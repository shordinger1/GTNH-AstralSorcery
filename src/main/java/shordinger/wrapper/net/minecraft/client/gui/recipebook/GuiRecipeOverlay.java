...
public class GuiRecipeOverlay extends Gui {
    ...
    public void init(Minecraft mcIn, RecipeList recipeListIn, int p_191845_3_, int p_191845_4_, int p_191845_5_,
                     int p_191845_6_, float p_191845_7_, RecipeBook p_191845_8_) {
        this.mc = mcIn;
        ...
        for (int j1 = 0; j1 < j; ++j1) {
            ...
            this.buttonList.add(
                new GuiRecipeOverlay.Button(
                    this.x + 4 + 25 * (j1 % k),
                    this.y + 5 + 25 * (j1 / k),
                    flag1 ? (IRecipe) list.get(j1) : (IRecipe) list1.get(j1 - i),
                    flag1));
        }
    ...
    public void render(int p_191842_1_, int p_191842_2_, float p_191842_3_) {
        if (this.visible) {
            ...
            this.mc.getTextureManager()
                .bindTexture(RECIPE_BOOK_TEXTURE);
    ...
    private void nineInchSprite(int p_191846_1_, int p_191846_2_, int p_191846_3_, int p_191846_4_, int p_191846_5_,
                                int p_191846_6_) {
        this.drawTexturedModalRect(this.x, this.y, p_191846_5_, p_191846_6_, p_191846_4_, p_191846_4_);
        this.drawTexturedModalRect(
            this.x + p_191846_4_ * 2 + p_191846_1_ * p_191846_3_,
            this.y,
        ...
        this.drawTexturedModalRect(
            this.x,
            this.y + p_191846_4_ * 2 + p_191846_2_ * p_191846_3_,
            p_191846_5_,
        ...
        for (int i = 0; i < p_191846_1_; ++i) {
            this.drawTexturedModalRect(
                this.x + p_191846_4_ + i * p_191846_3_,
                this.y,
                ...
                p_191846_4_);
            this.drawTexturedModalRect(
                this.x + p_191846_4_ + (i + 1) * p_191846_3_,
                this.y,
                p_191846_5_ + p_191846_4_,
                p_191846_6_,
                p_191846_4_,
            ...
            for (int j = 0; j < p_191846_2_; ++j) {
                if (i == 0) {
                    this.drawTexturedModalRect(
                        this.x,
                        this.y + p_191846_4_ + j * p_191846_3_,
                        p_191846_5_,
                    ...
                    this.drawTexturedModalRect(
                        this.x,
                        this.y + p_191846_4_ + (j + 1) * p_191846_3_,
                        p_191846_5_,
                        p_191846_6_ + p_191846_4_,
                        p_191846_4_,
                        p_191846_4_);
                ...
                this.drawTexturedModalRect(
                    ...
                    p_191846_4_);
                this.drawTexturedModalRect(
                    this.x + p_191846_4_ + (i + 1) * p_191846_3_ - 1,
                    this.y + p_191846_4_ + (j + 1) * p_191846_3_ - 1,
                    p_191846_5_ + p_191846_4_,
                    p_191846_6_ + p_191846_4_,
                    p_191846_4_ + 1,
                    p_191846_4_ + 1);
    ...
    class Button extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
            ...
            mc.getTextureManager()
                .bindTexture(GuiRecipeOverlay.RECIPE_BOOK_TEXTURE);
            ...
            Iterator<Ingredient> iterator = this.recipe.getIngredients()
                .iterator();
                        ...
                        if (aitemstack.length != 0) {
                            ...
                            mc.getRenderItem()
                                .renderItemAndEffectIntoGUI(
                                    aitemstack[MathHelper.floor(GuiRecipeOverlay.this.time / 30.0F)
                                        % aitemstack.length],
                                    i2,
                                    j2);

...
import shordinger.wrapper.net.minecraft.client.gui.spectator.ISpectatorMenuRecipient;
import shordinger.wrapper.net.minecraft.client.gui.spectator.SpectatorMenu;
import shordinger.wrapper.net.minecraft.client.gui.spectator.categories.SpectatorDetails;
...
public class GuiSpectator extends Gui implements ISpectatorMenuRecipient {
    ...
    protected void renderPage(ScaledResolution p_175258_1_, float p_175258_2_, int p_175258_3_, float p_175258_4_,
        ...
        if (p_175258_5_.getSelectedSlot() >= 0) {
            this.drawTexturedModalRect(
                (float) (p_175258_3_ - 91 - 1 + p_175258_5_.getSelectedSlot() * 20),
                p_175258_4_ - 1.0F,
                0,
                22,
                24,
        ...
        for (int i = 0; i < 9; ++i) {
            this.renderSlot(
                i,
                p_175258_1_.getScaledWidth() / 2 - 90 + i * 20 + 2,
                p_175258_4_ + 3.0F,
                p_175258_2_,
                p_175258_5_.getObject(i));
        }
    ...
    private void renderSlot(int p_175266_1_, int p_175266_2_, float p_175266_3_, float p_175266_4_,
                            ISpectatorMenuObject p_175266_5_) {
        this.mc.getTextureManager()
            .bindTexture(SPECTATOR_WIDGETS);
        ...
        if (p_175266_5_ != SpectatorMenu.EMPTY_SLOT) {
            ...
            if (i > 3 && p_175266_5_.isEnabled()) {
                this.mc.fontRenderer.drawStringWithShadow(
                    s,
                    (float) (p_175266_2_ + 19 - 2 - this.mc.fontRenderer.getStringWidth(s)),
                    p_175266_3_ + 6.0F + 3.0F,
                    16777215 + (i << 24));
            }
        }
    }
    ...
    public void renderSelectedItem(ScaledResolution p_175263_1_) {
        ...
        if (i > 3 && this.menu != null) {
            ...
            String s = ispectatormenuobject == SpectatorMenu.EMPTY_SLOT ? this.menu.getSelectedCategory()
                .getPrompt()
                .getFormattedText()
    ...
    public void onMouseScroll(int p_175259_1_) {
        ...
        for (i = this.menu.getSelectedSlot() + p_175259_1_; i >= 0 && i <= 8
            && (this.menu.getItem(i) == SpectatorMenu.EMPTY_SLOT || !this.menu.getItem(i)

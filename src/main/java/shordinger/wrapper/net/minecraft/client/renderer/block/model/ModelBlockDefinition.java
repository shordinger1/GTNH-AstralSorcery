...
public class ModelBlockDefinition {
    ...
    public static class Deserializer implements JsonDeserializer<ModelBlockDefinition> {
        ...
        public ModelBlockDefinition deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_,
            ...
            if (!map.isEmpty() || multipart != null && !multipart.getVariants()
                .isEmpty()) {
        ...
        protected Map<String, VariantList> parseMapVariants(JsonDeserializationContext deserializationContext,
                                                            JsonObject object) {
            ...
            if (object.has("variants")) {
                ...
                for (Entry<String, JsonElement> entry : jsonobject.entrySet()) {
                    map.put(
                        entry.getKey(),
                        (VariantList) deserializationContext.deserialize(entry.getValue(), VariantList.class));
                }
            }

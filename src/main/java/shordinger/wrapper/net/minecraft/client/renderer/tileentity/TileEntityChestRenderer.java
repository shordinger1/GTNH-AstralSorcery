...
import shordinger.wrapper.net.minecraft.client.model.ModelChest;
import shordinger.wrapper.net.minecraft.client.model.ModelLargeChest;
...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer<TileEntityChest> {
    ...
    private static final ResourceLocation TEXTURE_TRAPPED_DOUBLE = new ResourceLocation(
    ...
    public void render(TileEntityChest te, double x, double y, double z, float partialTicks, int destroyStage,
        ...
        if (te.hasWorld()) {
            ...
            if (block instanceof BlockChest && i == 0) {
                ((BlockChest) block).checkForSurroundingChests(
                    te.getWorld(),
                    te.getPos(),
                    te.getWorld()

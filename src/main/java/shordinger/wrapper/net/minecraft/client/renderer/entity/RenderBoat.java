...
import shordinger.wrapper.net.minecraft.client.model.IMultipassModel;
import shordinger.wrapper.net.minecraft.client.model.ModelBase;
import shordinger.wrapper.net.minecraft.client.model.ModelBoat;
...
public class RenderBoat extends Render<EntityBoat> {
    ...
    public void setupRotation(EntityBoat p_188311_1_, float p_188311_2_, float p_188311_3_) {
        ...
        if (f > 0.0F) {
            GlStateManager.rotate(
                MathHelper.sin(f) * f * f1 / 10.0F * (float) p_188311_1_.getForwardDirection(),
                1.0F,
                0.0F,
                0.0F);
        }
    ...
    protected ResourceLocation getEntityTexture(EntityBoat entity) {
        return BOAT_TEXTURES[entity.getBoatType()
            .ordinal()];
    }
    ...
    public void renderMultipass(EntityBoat p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_,

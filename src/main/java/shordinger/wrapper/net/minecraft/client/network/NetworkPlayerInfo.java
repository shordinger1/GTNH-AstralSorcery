...
public class NetworkPlayerInfo {
    ...
    public ResourceLocation getLocationSkin() {
        ...
        return (ResourceLocation) MoreObjects.firstNonNull(
            this.playerTextures.get(Type.SKIN),
    ...
    public ScorePlayerTeam getPlayerTeam() {
        return Minecraft.getMinecraft().world.getScoreboard()
            .getPlayersTeam(
                this.getGameProfile()
                    .getName());
    }
        ...
        synchronized (this) {
            if (!this.playerTexturesLoaded) {
                ...
                Minecraft.getMinecraft()
                    .getSkinManager()
                    .loadProfileTextures(this.gameProfile, new SkinManager.SkinAvailableCallback() {

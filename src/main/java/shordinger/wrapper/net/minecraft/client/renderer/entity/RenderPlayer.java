...
import shordinger.wrapper.net.minecraft.client.model.ModelPlayer;
import shordinger.wrapper.net.minecraft.client.renderer.GlStateManager;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerArrow;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerBipedArmor;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerCape;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerCustomHead;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerDeadmau5Head;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerElytra;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerEntityOnShoulder;
...
public class RenderPlayer extends RenderLivingBase<AbstractClientPlayer> {
    ...
    public void doRender(AbstractClientPlayer entity, double x, double y, double z, float entityYaw,
        ...
        if (net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(
            new net.minecraftforge.client.event.RenderPlayerEvent.Pre(entity, this, partialTicks, x, y, z))) return;
    ...
    protected void applyRotations(AbstractClientPlayer entityLiving, float p_77043_2_, float rotationYaw,
        ...
        if (entityLiving.isEntityAlive() && entityLiving.isPlayerSleeping()) {
            ...
            if (d0 > 0.0D && d1 > 0.0D) {
                ...
                GlStateManager
                    .rotate((float) (Math.signum(d3) * Math.acos(d2)) * 180.0F / (float) Math.PI, 0.0F, 1.0F, 0.0F);
            }
        } else {
            super.applyRotations(entityLiving, p_77043_2_, rotationYaw, partialTicks);
        }

...
import shordinger.wrapper.net.minecraft.client.resources.ResourceIndex;
import shordinger.wrapper.net.minecraft.client.resources.ResourceIndexFolder;
...
public class GameConfiguration {
    ...
    public static class FolderInformation {
        ...
        public ResourceIndex getAssetsIndex() {
            return (ResourceIndex) (this.assetIndex == null ? new ResourceIndexFolder(this.assetsDir)
                : new ResourceIndex(this.assetsDir, this.assetIndex));
        }
    }
    ...
    public static class UserInformation {
        ...
        public UserInformation(Session sessionIn, PropertyMap userPropertiesIn, PropertyMap profilePropertiesIn,
                               Proxy proxyIn) {

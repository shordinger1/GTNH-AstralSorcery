package shordinger.wrapper.net.minecraft.client.gui.achievement;
...
import shordinger.wrapper.net.minecraft.client.gui.GuiSlot;
...
import shordinger.wrapper.net.minecraft.stats.StatCrafting;
...
public class GuiStats extends GuiScreen implements IProgressMeter {
    ...
    public void initButtons() {
        ...
        this.buttonList
            .add(new GuiButton(1, this.width / 2 - 160, this.height - 52, 80, 20, I18n.format("stat.generalButton")));
        GuiButton guibutton = this.addButton(
            new GuiButton(2, this.width / 2 - 80, this.height - 52, 80, 20, I18n.format("stat.blocksButton")));
        GuiButton guibutton1 = this
            .addButton(new GuiButton(3, this.width / 2, this.height - 52, 80, 20, I18n.format("stat.itemsButton")));
        GuiButton guibutton2 = this
            .addButton(new GuiButton(4, this.width / 2 + 80, this.height - 52, 80, 20, I18n.format("stat.mobsButton")));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        if (this.doesGuiPauseGame) {
            ...
            this.drawCenteredString(
                this.fontRenderer,
                LOADING_STRINGS[(int) (Minecraft.getSystemTime() / 150L % (long) LOADING_STRINGS.length)],
                this.width / 2,
    ...
    private void drawSprite(int x, int y, int u, int v) {
        ...
        bufferbuilder.pos((double) (x + 0), (double) (y + 18), (double) this.zLevel)
            .tex((double) ((float) (u + 0) * 0.0078125F), (double) ((float) (v + 18) * 0.0078125F))
            .endVertex();
        bufferbuilder.pos((double) (x + 18), (double) (y + 18), (double) this.zLevel)
            .tex((double) ((float) (u + 18) * 0.0078125F), (double) ((float) (v + 18) * 0.0078125F))
            .endVertex();
        bufferbuilder.pos((double) (x + 18), (double) (y + 0), (double) this.zLevel)
            .tex((double) ((float) (u + 18) * 0.0078125F), (double) ((float) (v + 0) * 0.0078125F))
            .endVertex();
        bufferbuilder.pos((double) (x + 0), (double) (y + 0), (double) this.zLevel)
            .tex((double) ((float) (u + 0) * 0.0078125F), (double) ((float) (v + 0) * 0.0078125F))
            .endVertex();
        tessellator.draw();
    }
        ...
        protected void renderStat(StatBase p_148209_1_, int p_148209_2_, int p_148209_3_, boolean p_148209_4_) {
            if (p_148209_1_ != null) {
                ...
                GuiStats.this.drawString(
                    ...
                    s,
                    p_148209_2_ - GuiStats.this.fontRenderer.getStringWidth(s),
                    p_148209_3_ + 5,
                ...
                GuiStats.this.drawString(
                    GuiStats.this.fontRenderer,
                    "-",
                    p_148209_2_ - GuiStats.this.fontRenderer.getStringWidth("-"),
                    p_148209_3_ + 5,
                    p_148209_4_ ? 16777215 : 9474192);
            }
        }
        ...
        public StatsBlock(Minecraft p_i47554_2_) {
            ...
            for (StatCrafting statcrafting : StatList.MINE_BLOCK_STATS) {
                ...
                if (GuiStats.this.stats.readStat(statcrafting) > 0) {
                    flag = true;
                } else if (StatList.getObjectUseStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getObjectUseStats(item)) > 0) {
                    flag = true;
                } else if (StatList.getCraftStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getCraftStats(item)) > 0) {
                    flag = true;
                } else if (StatList.getObjectsPickedUpStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getObjectsPickedUpStats(item)) > 0) {
                    flag = true;
                } else if (StatList.getDroppedObjectStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getDroppedObjectStats(item)) > 0) {
                    flag = true;
                }
    ...
    class StatsGeneral extends GuiSlot {
        ...
        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn,
            ...
            GuiStats.this.drawString(
                ...
                xPos + 2,
                yPos + 1,
                slotIndex % 2 == 0 ? 16777215 : 9474192);
            String s = statbase.format(GuiStats.this.stats.readStat(statbase));
            GuiStats.this.drawString(
                GuiStats.this.fontRenderer,
                s,
                xPos + 2 + 213 - GuiStats.this.fontRenderer.getStringWidth(s),
                yPos + 1,
                slotIndex % 2 == 0 ? 16777215 : 9474192);
        }
    }
    ...
    class StatsItem extends GuiStats.Stats {
        ...
        public StatsItem(Minecraft mcIn) {
            ...
            for (StatCrafting statcrafting : StatList.USE_ITEM_STATS) {
                ...
                if (GuiStats.this.stats.readStat(statcrafting) > 0) {
                    flag = true;
                } else if (StatList.getObjectBreakStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getObjectBreakStats(item)) > 0) {
                    flag = true;
                } else if (StatList.getCraftStats(item) != null
                    && GuiStats.this.stats.readStat(StatList.getCraftStats(item)) > 0) {
                    flag = true;
    ...
    class StatsMobsList extends GuiSlot {
        ...
        public StatsMobsList(Minecraft mcIn) {
            super(
                mcIn,
                GuiStats.this.width,
                GuiStats.this.height,
                32,
                GuiStats.this.height - 64,
                GuiStats.this.fontRenderer.FONT_HEIGHT * 4);
            this.setShowSelectionBox(false);

            for (EntityList.EntityEggInfo entitylist$entityegginfo : EntityList.ENTITY_EGGS.values()) {
                if (GuiStats.this.stats.readStat(entitylist$entityegginfo.killEntityStat) > 0
                    || GuiStats.this.stats.readStat(entitylist$entityegginfo.entityKilledByStat) > 0) {
        ...
        protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn,
            ...
            String s = I18n
                .format("entity." + EntityList.getTranslationName(entitylist$entityegginfo.spawnedID) + ".name");
            ...
            GuiStats.this.drawString(
                ...
                s1,
                xPos + 2,
                yPos + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT,
                i == 0 ? 6316128 : 9474192);
            GuiStats.this.drawString(
                GuiStats.this.fontRenderer,
                s2,
                xPos + 2,
                yPos + 1 + GuiStats.this.fontRenderer.FONT_HEIGHT * 2,
                j == 0 ? 6316128 : 9474192);
        }
    }
}

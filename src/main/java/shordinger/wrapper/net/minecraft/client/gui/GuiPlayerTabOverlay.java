...
public class GuiPlayerTabOverlay extends Gui {
    ...
    private static final Ordering<NetworkPlayerInfo> ENTRY_ORDERING = Ordering
    ...
    public String getPlayerName(NetworkPlayerInfo networkPlayerInfoIn) {
        return networkPlayerInfoIn.getDisplayName() != null ? networkPlayerInfoIn.getDisplayName()
            ...
            networkPlayerInfoIn.getGameProfile()
                .getName());
    }
    ...
    public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
        ...
        for (NetworkPlayerInfo networkplayerinfo : list) {
            ...
            if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreCriteria.EnumRenderType.HEARTS) {
                k = this.mc.fontRenderer.getStringWidth(
                    " " + scoreboardIn.getOrCreateScore(
        ...
        boolean flag = this.mc.isIntegratedServerRunning() || this.mc.getConnection()
            .getNetworkManager()
            .isEncrypted();
        int l;
        ...
        if (list1 != null) {
            drawRect(
                ...
                k1 - 1,
                width / 2 + l1 / 2 + 1,
                k1 + list1.size() * this.mc.fontRenderer.FONT_HEIGHT,
                Integer.MIN_VALUE);
            ...
            if (k4 < list.size()) {
                ...
                if (flag) {
                    ...
                    this.mc.getTextureManager()
                        .bindTexture(networkplayerinfo1.getLocationSkin());
                    int l2 = 8 + (flag1 ? 8 : 0);
                    int i3 = 8 * (flag1 ? -1 : 1);
                ...
                if (networkplayerinfo1.getGameType() == GameType.SPECTATOR) {
                    this.mc.fontRenderer
                        .drawStringWithShadow(TextFormatting.ITALIC + s4, (float) j2, (float) k2, -1862270977);
                } else {
        ...
        if (list2 != null) {
            ...
            drawRect(
                ...
                k1 - 1,
                width / 2 + l1 / 2 + 1,
                k1 + list2.size() * this.mc.fontRenderer.FONT_HEIGHT,
                Integer.MIN_VALUE);
    ...
    private void drawScoreboardValues(ScoreObjective objective, int p_175247_2_, String name, int p_175247_4_,
                                      int p_175247_5_, NetworkPlayerInfo info) {
        int i = objective.getScoreboard()
        ...
        if (objective.getRenderType() == IScoreCriteria.EnumRenderType.HEARTS) {
            ...
            if (Minecraft.getSystemTime() - info.getLastHealthTime() > 1000L
                || this.lastTimeOpened != info.getRenderVisibilityId()) {
            ...
            int k = Math.max(
                MathHelper.ceil((float) (i / 2)),
                Math.max(MathHelper.ceil((float) (info.getDisplayHealth() / 2)), 10));
            ...
            if (j > 0) {
                ...
                if (f > 3.0F) {
                    ...
                    this.mc.fontRenderer.drawStringWithShadow(
                        s,
                        (float) ((p_175247_5_ + p_175247_4_) / 2 - this.mc.fontRenderer.getStringWidth(s) / 2),
                        (float) p_175247_2_,
                        i1);
                }
            }
            ...
            this.mc.fontRenderer.drawStringWithShadow(
                s1,
                (float) (p_175247_5_ - this.mc.fontRenderer.getStringWidth(s1)),
                (float) p_175247_2_,
                16777215);
        }
    }
    ...
    static class PlayerComparator implements Comparator<NetworkPlayerInfo> {
        ...
        public int compare(NetworkPlayerInfo p_compare_1_, NetworkPlayerInfo p_compare_2_) {
            ...
            return ComparisonChain.start()
                ...
                .compare(
                    scoreplayerteam != null ? scoreplayerteam.getName() : "",

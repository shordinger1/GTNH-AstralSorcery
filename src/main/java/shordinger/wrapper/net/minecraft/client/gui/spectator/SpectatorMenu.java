...
public class SpectatorMenu {
    ...
    public ISpectatorMenuObject getItem(int index) {
        ...
        if (this.page > 0 && index == 0) {
            ...
            return i < this.category.getItems()
                .size() ? SCROLL_RIGHT_ENABLED : SCROLL_RIGHT_DISABLED;
        } else if (index == 8) {
            return CLOSE_ITEM;
        } else {
            return i >= 0 && i < this.category.getItems()
                .size() ? (ISpectatorMenuObject) MoreObjects.firstNonNull(
    ...
    static class MoveMenuObject implements ISpectatorMenuObject {
        ...
        public ITextComponent getSpectatorName() {
            return this.direction < 0 ? new TextComponentTranslation("spectatorMenu.previous_page", new Object[0])
                : new TextComponentTranslation("spectatorMenu.next_page", new Object[0]);
        }

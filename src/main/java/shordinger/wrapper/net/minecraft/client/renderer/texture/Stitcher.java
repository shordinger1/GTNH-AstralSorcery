...
public class Stitcher {
    ...
    public void doStitch() {
        ...
        net.minecraftforge.fml.common.ProgressManager.ProgressBar bar = net.minecraftforge.fml.common.ProgressManager
            .push("Texture stitching", astitcher$holder.length);
        ...
        for (Stitcher.Holder stitcher$holder : astitcher$holder) {
            ...
            if (!this.allocateSlot(stitcher$holder)) {
                ...
                for (Stitcher.Holder h : astitcher$holder) net.minecraftforge.fml.common.FMLLog.log.info("  {}", h);
    ...
    public List<TextureAtlasSprite> getStichSlots() {
        ...
        for (Stitcher.Slot stitcher$slot1 : list) {
            ...
            textureatlassprite.initSprite(
                this.currentWidth,
                this.currentHeight,
                stitcher$slot1.getOriginX(),
                stitcher$slot1.getOriginY(),
                stitcher$holder.isRotated());
    ...
    private boolean expandAndAllocateSlot(Stitcher.Holder p_94311_1_) {
        ...
        if (!flag1 && !flag2) {
            ...
            if (flag3 ^ flag4) {
                flag = !flag3 && flag1; // Forge: Fix stitcher not expanding entire height before growing width, and
                // {potentially} growing larger then the max size.
            } else {
                flag = flag1 && k <= l;
            }
    ...
    public static class Holder implements Comparable<Stitcher.Holder> {
        ...
        public Holder(TextureAtlasSprite theTextureIn, int mipmapLevelHolderIn) {
            ...
            this.rotated = Stitcher.getMipmapDimension(this.height, mipmapLevelHolderIn)
                > Stitcher.getMipmapDimension(this.width, mipmapLevelHolderIn);
        }
        ...
        public String toString() {
            return "Holder{width=" + this.width
                + ", height="
                + this.height
                + ", name="
                + this.sprite.getIconName()
                + '}';
        }
            ...
            if (this.getHeight() == p_compareTo_1_.getHeight()) {
                if (this.getWidth() == p_compareTo_1_.getWidth()) {
                    ...
                    return this.sprite.getIconName()
                        .compareTo(p_compareTo_1_.sprite.getIconName());
                }

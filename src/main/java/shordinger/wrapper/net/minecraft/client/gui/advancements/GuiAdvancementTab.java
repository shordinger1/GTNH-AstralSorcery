...
public class GuiAdvancementTab extends Gui {
    ...
    public GuiAdvancementTab(Minecraft p_i47589_1_, GuiScreenAdvancements p_i47589_2_, AdvancementTabType p_i47589_3_,
                             int p_i47589_4_, Advancement p_i47589_5_, DisplayInfo p_i47589_6_) {
    ...
    public void drawContents() {
        ...
        if (resourcelocation != null) {
            ...
            this.minecraft.getTextureManager()
                .bindTexture(TextureManager.RESOURCE_LOCATION_EMPTY);
        }
    ...
    @Nullable
    public static GuiAdvancementTab create(Minecraft p_193936_0_, GuiScreenAdvancements p_193936_1_, int p_193936_2_,
        ...
        if (p_193936_3_.getDisplay() == null) {
            ...
            for (AdvancementTabType advancementtabtype : AdvancementTabType.values()) {
                if ((p_193936_2_ % AdvancementTabType.MAX_TABS) < advancementtabtype.getMax()) {
                    return new GuiAdvancementTab(
                        p_193936_0_,
                        p_193936_1_,
                        advancementtabtype,
                        p_193936_2_ % AdvancementTabType.MAX_TABS,
                        p_193936_2_ / AdvancementTabType.MAX_TABS,
                        p_193936_3_,
    ...
    public void addAdvancement(Advancement p_191800_1_) {
        if (p_191800_1_.getDisplay() != null) {
            GuiAdvancement guiadvancement = new GuiAdvancement(
                this,
                this.minecraft,
                p_191800_1_,
    ...
    public GuiAdvancementTab(Minecraft p_i47589_1_, GuiScreenAdvancements p_i47589_2_, AdvancementTabType p_i47589_3_,
                             int p_i47589_4_, int page, Advancement p_i47589_5_, DisplayInfo p_i47589_6_) {

...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
    ...
    public final Map<ResourceLocation, ITextureObject> mapTextureObjects = Maps
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        net.minecraftforge.fml.common.ProgressManager.ProgressBar bar = net.minecraftforge.fml.common.ProgressManager
            .push(
                ...
                this.mapTextureObjects.keySet()
                    .size(),
                true);
        Iterator<Entry<ResourceLocation, ITextureObject>> iterator = this.mapTextureObjects.entrySet()
            .iterator();

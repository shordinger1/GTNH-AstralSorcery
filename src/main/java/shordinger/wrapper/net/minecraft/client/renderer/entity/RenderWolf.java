...
import shordinger.wrapper.net.minecraft.client.model.ModelWolf;
import shordinger.wrapper.net.minecraft.client.renderer.GlStateManager;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerWolfCollar;
...
public class RenderWolf extends RenderLiving<EntityWolf> {
    ...
    private static final ResourceLocation TAMED_WOLF_TEXTURES = new ResourceLocation(
        "textures/entity/wolf/wolf_tame.png");
    private static final ResourceLocation ANRGY_WOLF_TEXTURES = new ResourceLocation(

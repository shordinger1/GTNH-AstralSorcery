package shordinger.wrapper.net.minecraft.client.entity;
...
import shordinger.wrapper.net.minecraft.client.audio.ElytraSound;
import shordinger.wrapper.net.minecraft.client.audio.MovingSoundMinecartRiding;
...
import shordinger.wrapper.net.minecraft.client.gui.GuiEnchantment;
import shordinger.wrapper.net.minecraft.client.gui.GuiHopper;
import shordinger.wrapper.net.minecraft.client.gui.GuiMerchant;
import shordinger.wrapper.net.minecraft.client.gui.GuiRepair;
...
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiBeacon;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiBrewingStand;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiChest;
...
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiDispenser;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiEditCommandBlockMinecart;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiEditSign;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiEditStructure;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiFurnace;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiScreenHorseInventory;
import shordinger.wrapper.net.minecraft.client.gui.inventory.GuiShulkerBox;
...
public class EntityPlayerSP extends AbstractClientPlayer {
    ...
    public EntityPlayerSP(Minecraft p_i47378_1_, World p_i47378_2_, NetHandlerPlayClient p_i47378_3_,
        ...
        if (!super.startRiding(entityIn, force)) {
            ...
            if (entityIn instanceof EntityMinecart) {
                this.mc.getSoundHandler()
                    .playSound(new MovingSoundMinecartRiding(this, (EntityMinecart) entityIn));
            }
    ...
    public void onUpdate() {
        if (this.world.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ))) {
            ...
            if (this.isRiding()) {
                this.connection
                    .sendPacket(new CPacketPlayer.Rotation(this.rotationYaw, this.rotationPitch, this.onGround));
    ...
    public EntityItem dropItem(boolean dropAll) {
        CPacketPlayerDigging.Action cpacketplayerdigging$action = dropAll ? CPacketPlayerDigging.Action.DROP_ALL_ITEMS
            : CPacketPlayerDigging.Action.DROP_ITEM;
        this.connection
            .sendPacket(new CPacketPlayerDigging(cpacketplayerdigging$action, BlockPos.ORIGIN, EnumFacing.DOWN));
        return null;
    }
    ...
    private boolean isOpenBlockSpace(BlockPos pos) {
        ...
        return !iblockstate.getBlock()
            .isNormalCube(iblockstate, world, pos);
    }
    ...
    public void playSound(SoundEvent soundIn, float volume, float pitch) {
        net.minecraftforge.event.entity.PlaySoundAtEntityEvent event = net.minecraftforge.event.ForgeEventFactory
            .onPlaySoundAtEntity(this, soundIn, this.getSoundCategory(), volume, pitch);
    ...
    public void notifyDataManagerChange(DataParameter<?> key) {
        ...
        if (HAND_STATES.equals(key)) {
            ...
            EnumHand enumhand = (((Byte) this.dataManager.get(HAND_STATES)).byteValue() & 2) > 0 ? EnumHand.OFF_HAND
                : EnumHand.MAIN_HAND;
        ...
        if (FLAGS.equals(key) && this.isElytraFlying() && !this.wasFallFlying) {
            this.mc.getSoundHandler()
                .playSound(new ElytraSound(this));
        }
    }
    ...
    public void onLivingUpdate() {
        ...
        if (this.inPortal) {
                ...
                this.mc.getSoundHandler()
                    .playSound(
                        PositionedSoundRecord
                            .getMasterRecord(SoundEvents.BLOCK_PORTAL_TRIGGER, this.rand.nextFloat() * 0.4F + 0.8F));
            }
            ...
            this.inPortal = false;
        } else if (this.isPotionActive(MobEffects.NAUSEA) && this.getActivePotionEffect(MobEffects.NAUSEA)
            .getDuration() > 60) {
        ...
        this.mc.getTutorial()
            .handleMovement(this.movementInput);
        ...
        AxisAlignedBB axisalignedbb = this.getEntityBoundingBox();
        net.minecraftforge.client.event.PlayerSPPushOutOfBlocksEvent event = new net.minecraftforge.client.event.PlayerSPPushOutOfBlocksEvent(
            this,
            axisalignedbb);
        ...
        boolean flag4 = (float) this.getFoodStats()
        ...
        if (this.movementInput.jump && !flag
            && !this.onGround
            && this.motionY < 0.0D
            && !this.isElytraFlying()
    ...
    public void updateRidden() {
        ...
        if (this.getRidingEntity() instanceof EntityBoat) {
            ...
            entityboat.updateInputs(
                this.movementInput.leftKeyDown,
                this.movementInput.rightKeyDown,
                this.movementInput.forwardKeyDown,
                        ...
                        if (iblockstate.getCollisionBoundingBox(this.world, blockpos) == null) {
                            ...
                            if (iblockstate1.getCollisionBoundingBox(this.world, blockpos) == null) {
                                ...
                                if (this.isPotionActive(MobEffects.JUMP_BOOST)) {
                                    f7 += (float) (this.getActivePotionEffect(MobEffects.JUMP_BOOST)
                                ...
                                AxisAlignedBB axisalignedbb = (new AxisAlignedBB(
                                    vec3d,
                                    vec3d4.addVector(0.0D, (double) f10, 0.0D))).grow((double) f9, 0.0D, (double) f9);
                                ...
                                for (AxisAlignedBB axisalignedbb2 : list) {
                                    if (axisalignedbb2.intersects(vec3d7, vec3d8)
                                        || axisalignedbb2.intersects(vec3d9, vec3d10)) {
                                        ...
                                        while (true) {
                                            ...
                                            if ((axisalignedbb1 = iblockstate2
                                                .getCollisionBoundingBox(this.world, blockpos2)) != null) {
                                            ...
                                            if (i > 1) {
                                                ...
                                                if (iblockstate3.getCollisionBoundingBox(this.world, blockpos)
                                                    != null) {
                                                    return;
                                                }
                                            }

...
public abstract class GuiListExtended extends GuiSlot {
    ...
    protected void drawSlot(int slotIndex, int xPos, int yPos, int heightIn, int mouseXIn, int mouseYIn,
        ...
        this.getListEntry(slotIndex)
            .drawEntry(
                ...
                mouseXIn,
                mouseYIn,
                this.isMouseYWithinSlotBounds(mouseYIn)
                    && this.getSlotIndexFromScreenCoords(mouseXIn, mouseYIn) == slotIndex,
                partialTicks);
    }

    protected void updateItemPos(int entryID, int insideLeft, int yPos, float partialTicks) {
        this.getListEntry(entryID)
            .updatePosition(entryID, insideLeft, yPos, partialTicks);
    }
        ...
        if (this.isMouseYWithinSlotBounds(mouseY)) {
            ...
            if (i >= 0) {
                ...
                if (this.getListEntry(i)
                    .mousePressed(i, mouseX, mouseY, mouseEvent, l, i1)) {
    ...
    public boolean mouseReleased(int x, int y, int mouseEvent) {
        for (int i = 0; i < this.getSize(); ++i) {
            ...
            int i1 = y - k;
            this.getListEntry(i)
                .mouseReleased(i, x, y, mouseEvent, l, i1);
        }

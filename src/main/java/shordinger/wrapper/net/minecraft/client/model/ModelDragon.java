...
public class ModelDragon extends ModelBase {
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
        ...
        float f6 = this.updateRotations(
            entitydragon.getMovementOffsets(5, this.partialTicks)[0]
        ...
        for (int i = 0; i < 5; ++i) {
            ...
            this.spine.rotateAngleX = f9
                + entitydragon.getHeadPartYOffset(i, adouble, adouble1) * 0.017453292F * 1.5F * 5.0F;
        ...
        this.head.rotateAngleX = this.updateRotations((double) entitydragon.getHeadPartYOffset(6, adouble, adouble2))
            * 0.017453292F
            * 1.5F
            * 5.0F;

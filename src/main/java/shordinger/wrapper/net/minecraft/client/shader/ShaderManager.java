...
import shordinger.wrapper.net.minecraft.client.util.JsonBlendingMode;
...
public class ShaderManager {
    ...
    public ShaderManager(IResourceManager resourceManager, String programName) throws JsonException, IOException {
        ...
        try {
            ...
            JsonObject jsonobject = jsonparser
                .parse(IOUtils.toString(iresource.getInputStream(), StandardCharsets.UTF_8))
                .getAsJsonObject();
            ...
            this.blendingMode = JsonBlendingMode
                .parseBlendNode(JsonUtils.getJsonObject(jsonobject, "blend", (JsonObject) null));
            ...
            this.program = ShaderLinkHelper.getStaticShaderLinkHelper()
                .createProgram();
        ...
        for (int i = 0; i < this.shaderSamplerLocations.size(); ++i) {
            if (this.shaderSamplers.get(this.samplerNames.get(i)) != null) {
                ...
                if (j != -1) {
                    ...
                    OpenGlHelper
                        .glUniform1i(OpenGlHelper.glGetUniformLocation(this.program, this.samplerNames.get(i)), i);
                }
            }
        }
    ...
    private void setupUniforms() {
        ...
        for (int j = 0; i < this.samplerNames.size(); ++j) {
            ...
            if (k == -1) {
                LOGGER.warn(
                    "Shader {}could not find sampler named {} in the specified shader program.",

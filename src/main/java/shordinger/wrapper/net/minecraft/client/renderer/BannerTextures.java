...
import shordinger.wrapper.net.minecraft.client.renderer.texture.LayeredColorMaskTexture;
...
public class BannerTextures {
    ...
    public static final BannerTextures.Cache BANNER_DESIGNS = new BannerTextures.Cache(
        "B",
        new ResourceLocation("textures/entity/banner_base.png"),
    ...
    public static final ResourceLocation SHIELD_BASE_TEXTURE = new ResourceLocation(
    ...
    public static class Cache {
            ...
            if (id.isEmpty()) {
                ...
                if (bannertextures$cacheentry == null) {
                    ...
                    Minecraft.getMinecraft()
                        .getTextureManager()
                        .loadTexture(
                            bannertextures$cacheentry.textureLocation,
        ...
        private boolean freeCacheSlot() {
            ...
            Iterator<String> iterator = this.cacheMap.keySet()
                .iterator();

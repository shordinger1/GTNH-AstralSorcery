...
import shordinger.wrapper.net.minecraft.block.BlockHugeMushroom;
...
import shordinger.wrapper.net.minecraft.item.ItemFishFood;
...
public class RenderItem implements IResourceManagerReloadListener {
    ...
    public IBakedModel getItemModelWithOverrides(ItemStack stack, @Nullable World worldIn,
        ...
        return ibakedmodel.getOverrides()
            .handleItemState(ibakedmodel, stack, worldIn, entitylivingbaseIn);
    }
    ...
    public void renderItem(ItemStack stack, EntityLivingBase entitylivingbaseIn,
        ...
        if (!stack.isEmpty() && entitylivingbaseIn != null) {
            IBakedModel ibakedmodel = this
                .getItemModelWithOverrides(stack, entitylivingbaseIn.world, entitylivingbaseIn);
    ...
    protected void renderItemModel(ItemStack stack, IBakedModel bakedmodel,
        ...
        if (!stack.isEmpty()) {
            this.textureManager.bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
            this.textureManager.getTexture(TextureMap.LOCATION_BLOCKS_TEXTURE)
            ...
            bakedmodel = net.minecraftforge.client.ForgeHooksClient
                .handleCameraTransforms(bakedmodel, transform, leftHanded);
    ...
    protected void renderItemModelIntoGUI(ItemStack stack, int x, int y, IBakedModel bakedmodel) {
        ...
        bakedmodel = net.minecraftforge.client.ForgeHooksClient
            .handleCameraTransforms(bakedmodel, ItemCameraTransforms.TransformType.GUI, false);
        this.renderItem(stack, bakedmodel);
        ...
        if (!p_184391_2_.isEmpty()) {
            ...
            try {
                this.renderItemModelIntoGUI(
                    ...
                    p_184391_3_,
                    p_184391_4_,
                    this.getItemModelWithOverrides(p_184391_2_, (World) null, p_184391_1_));
    ...
    public void renderItemOverlayIntoGUI(FontRenderer fr, ItemStack stack, int xPosition, int yPosition,
        ...
        if (!stack.isEmpty()) {
            ...
            if (stack.getItem()
                ...
                int rgbfordisplay = stack.getItem()
    ...
    private void draw(BufferBuilder renderer, int x, int y, int width, int height, int red, int green, int blue,
        ...
        renderer.pos((double) (x + 0), (double) (y + 0), 0.0D)
            .color(red, green, blue, alpha)
            .endVertex();
        renderer.pos((double) (x + 0), (double) (y + height), 0.0D)
            .color(red, green, blue, alpha)
            .endVertex();
        renderer.pos((double) (x + width), (double) (y + height), 0.0D)
            .color(red, green, blue, alpha)
            .endVertex();
        renderer.pos((double) (x + width), (double) (y + 0), 0.0D)
            .color(red, green, blue, alpha)
            .endVertex();
    ...
    private void registerItems() {
        ...
        this.registerBlock(
            Blocks.MONSTER_EGG,
            BlockSilverfish.EnumType.CHISELED_STONEBRICK.getMetadata(),
            "chiseled_brick_monster_egg");
        this.registerBlock(
            Blocks.MONSTER_EGG,
            BlockSilverfish.EnumType.COBBLESTONE.getMetadata(),
            "cobblestone_monster_egg");
        this.registerBlock(
            Blocks.MONSTER_EGG,
            BlockSilverfish.EnumType.CRACKED_STONEBRICK.getMetadata(),
            "cracked_brick_monster_egg");
        this.registerBlock(
            Blocks.MONSTER_EGG,
            BlockSilverfish.EnumType.MOSSY_STONEBRICK.getMetadata(),
        ...
        this.registerBlock(
            Blocks.MONSTER_EGG,
            BlockSilverfish.EnumType.STONEBRICK.getMetadata(),
        ...
        this.registerBlock(
            ...
            EnumDyeColor.LIGHT_BLUE.getMetadata(),
        ...
        this.registerBlock(
            ...
            EnumDyeColor.BLACK.getMetadata(),
        ...
        this.registerBlock(
            Blocks.STAINED_HARDENED_CLAY,
            EnumDyeColor.MAGENTA.getMetadata(),
            "magenta_stained_hardened_clay");
        this.registerBlock(
            Blocks.STAINED_HARDENED_CLAY,
            EnumDyeColor.ORANGE.getMetadata(),
        ...
        this.registerBlock(
            Blocks.STAINED_HARDENED_CLAY,
            EnumDyeColor.YELLOW.getMetadata(),
        ...
        for (EnumDyeColor enumdyecolor : EnumDyeColor.values()) {
            this.registerBlock(
                Blocks.CONCRETE,
                enumdyecolor.getMetadata(),
                enumdyecolor.getDyeColorName() + "_concrete");
            this.registerBlock(
                Blocks.CONCRETE_POWDER,
                enumdyecolor.getMetadata(),
                enumdyecolor.getDyeColorName() + "_concrete_powder");
        }
        ...
        this.registerBlock(
            ...
            BlockHugeMushroom.EnumType.ALL_INSIDE.getMetadata(),

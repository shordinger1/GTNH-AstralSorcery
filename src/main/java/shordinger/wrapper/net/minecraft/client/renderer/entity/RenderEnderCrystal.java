...
import shordinger.wrapper.net.minecraft.client.model.ModelEnderCrystal;
...
public class RenderEnderCrystal extends Render<EntityEnderCrystal> {
    ...
    private static final ResourceLocation ENDER_CRYSTAL_TEXTURES = new ResourceLocation(
    ...
    public boolean shouldRender(EntityEnderCrystal livingEntity, ICamera camera, double camX, double camY,
                                double camZ) {

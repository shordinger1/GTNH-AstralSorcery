...
public class SoundManager {
    ...
    public SoundManager(SoundHandler p_i45119_1_, GameSettings p_i45119_2_) {
        ...
        try {
            ...
            net.minecraftforge.common.MinecraftForge.EVENT_BUS
                .post(new net.minecraftforge.client.event.sound.SoundSetupEvent(this));
        } catch (SoundSystemException soundsystemexception) {
            LOGGER
                .error(LOG_MARKER, "Error linking with the LibraryJavaSound plug-in", (Throwable) soundsystemexception);
        }
    }
    ...
    public void reloadSoundSystem() {
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS
            .post(new net.minecraftforge.client.event.sound.SoundLoadEvent(this));
    }
    ...
    public void updateAllSounds() {
        ...
        for (ITickableSound itickablesound : this.tickableSounds) {
            ...
            if (itickablesound.isDonePlaying()) {
                ...
                this.sndSystem
                    .setPosition(s, itickablesound.getXPosF(), itickablesound.getYPosF(), itickablesound.getZPosF());
            }
        }

        Iterator<Entry<String, ISound>> iterator = this.playingSounds.entrySet()
            .iterator();
        ...
        Iterator<Entry<ISound, Integer>> iterator1 = this.delayedSounds.entrySet()
            .iterator();
                ...
                if (this.sndSystem.getMasterVolume() <= 0.0F) {
                    ...
                    if (sound == SoundHandler.MISSING_SOUND) {
                        ...
                        if (f1 == 0.0F) {
                            ...
                            String s = MathHelper.getRandomUUID(ThreadLocalRandom.current())
                                .toString();
                            ResourceLocation resourcelocation1 = sound.getSoundAsOggLocation();

                            if (sound.isStreaming()) {
                                this.sndSystem.newStreamingSource(
                                    false,
                                    s,
                                    ...
                                    p_sound.getYPosF(),
                                    p_sound.getZPosF(),
                                    p_sound.getAttenuationType()
                                        .getTypeInt(),
                                    f);
                                net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(
                                    new net.minecraftforge.client.event.sound.PlayStreamingSourceEvent(
                                        this,
                                        p_sound,
                                        s));
                            } else {
                                this.sndSystem.newSource(
                                    ...
                                    f);
                                net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(
                                    new net.minecraftforge.client.event.sound.PlaySoundSourceEvent(this, p_sound, s));
                            }
    ...
    private static URL getURLForSoundResource(final ResourceLocation p_148612_0_) {
        String s = String
            .format("%s:%s:%s", "mcsounddomain", p_148612_0_.getResourceDomain(), p_148612_0_.getResourcePath());
        ...
        if (p_189567_2_ != null) {
            for (String s : this.categorySounds.get(p_189567_2_)) {
                ...
                if (p_189567_1_.isEmpty()) {
                    this.stopSound(isound);
                } else if (isound.getSoundLocation()
                    .equals(new ResourceLocation(p_189567_1_))) {
                    this.stopSound(isound);
                }
            }
        ...
        public boolean playing(String p_playing_1_) {
            synchronized (SoundSystemConfig.THREAD_SYNC) {
                if (this.soundLibrary == null) {
                    ...
                    Source source = (Source) this.soundLibrary.getSources()
                        .get(p_playing_1_);

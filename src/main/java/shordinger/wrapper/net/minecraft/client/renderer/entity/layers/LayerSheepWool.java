...
import shordinger.wrapper.net.minecraft.client.model.ModelSheep1;
import shordinger.wrapper.net.minecraft.client.renderer.GlStateManager;
import shordinger.wrapper.net.minecraft.client.renderer.entity.RenderSheep;
...
public class LayerSheepWool implements LayerRenderer<EntitySheep> {
    ...
    public void doRenderLayer(EntitySheep entitylivingbaseIn, float limbSwing, float limbSwingAmount,

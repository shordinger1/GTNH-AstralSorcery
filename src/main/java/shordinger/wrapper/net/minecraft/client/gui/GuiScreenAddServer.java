...
public class GuiScreenAddServer extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.serverResourcePacks = this.addButton(
            new GuiButton(
                ...
                I18n.format("addServer.resourcePack") + ": "
                    + this.serverData.getResourceMode()
                    .getMotd()
                    .getFormattedText()));
        ...
        (this.buttonList.get(0)).enabled = !this.serverIPField.getText()
            .isEmpty()
        ...
        if (button.enabled) {
            if (button.id == 2) {
                this.serverData.setResourceMode(
                    ServerData.ServerResourceMode.values()[(this.serverData.getResourceMode()

...
public class GuiBeacon extends GuiContainer {
    ...
    public void updateScreen() {
        ...
        this.beaconConfirmButton.enabled = !this.tileBeacon.getStackInSlot(0)
            .isEmpty() && potion != null;
    }
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        if (button.id == -2) {
            ...
            this.mc.getConnection()
                .sendPacket(new CPacketCustomPayload("MC|Beacon", packetbuffer));
            this.mc.player.connection.sendPacket(new CPacketCloseWindow(this.mc.player.openContainer.windowId));
            this.mc.displayGuiScreen((GuiScreen) null);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        this.mc.getTextureManager()
            .bindTexture(BEACON_GUI_TEXTURES);
        ...
        public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks) {
            if (this.visible) {
                mc.getTextureManager()
                    .bindTexture(GuiBeacon.BEACON_GUI_TEXTURES);
                GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
    ...
    class PowerButton extends GuiBeacon.Button {
        ...
        public PowerButton(int buttonId, int x, int y, Potion effectIn, int tierIn) {
            super(
                ...
                effectIn.getStatusIconIndex() % 8 * 18,
                198 + effectIn.getStatusIconIndex() / 8 * 18);

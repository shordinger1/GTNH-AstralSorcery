...
public class ScreenChatOptions extends GuiScreen {
    ...
    private static final GameSettings.Options[] CHAT_OPTIONS = new GameSettings.Options[]{
        ...
        GameSettings.Options.CHAT_WIDTH, GameSettings.Options.REDUCED_DEBUG_INFO, GameSettings.Options.NARRATOR};
    ...
    public void updateNarratorButton() {
        this.narratorButton.displayString = this.game_settings
            .getKeyBinding(GameSettings.Options.byOrdinal(this.narratorButton.id));
    }
}

...
public class RecipeBookPage {
    ...
    public void init(Minecraft p_194194_1_, int p_194194_2_, int p_194194_3_) {
        ...
        for (int i = 0; i < this.buttons.size(); ++i) {
            ((GuiButtonRecipe) this.buttons.get(i))
                .setPosition(p_194194_2_ + 11 + 25 * (i % 5), p_194194_3_ + 31 + 25 * (i / 5));
        }
    ...
    public void renderTooltip(int p_193721_1_, int p_193721_2_) {
        if (this.minecraft.currentScreen != null && this.hoveredButton != null && !this.overlay.isVisible()) {
            this.minecraft.currentScreen.drawHoveringText(
                this.hoveredButton.getToolTipText(this.minecraft.currentScreen),
                p_193721_1_,
                p_193721_2_);
        }
    }
    ...
    public boolean mouseClicked(int p_194196_1_, int p_194196_2_, int p_194196_3_, int p_194196_4_, int p_194196_5_,
            ...
            for (GuiButtonRecipe guibuttonrecipe : this.buttons) {
                if (guibuttonrecipe.mousePressed(this.minecraft, p_194196_1_, p_194196_2_)) {
                    ...
                    if (p_194196_3_ == 0) {
                        ...
                        this.overlay.init(
                            this.minecraft,
                            guibuttonrecipe.getList(),
                            guibuttonrecipe.x,
                            guibuttonrecipe.y,
                            p_194196_4_ + p_194196_6_ / 2,
                            p_194196_5_ + 13 + p_194196_7_ / 2,
                            (float) guibuttonrecipe.getButtonWidth(),
                            this.recipeBook);
                    }

...
import shordinger.wrapper.net.minecraft.client.model.ModelEnderman;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerEndermanEyes;
import shordinger.wrapper.net.minecraft.client.renderer.entity.layers.LayerHeldBlock;
...
public class RenderEnderman extends RenderLiving<EntityEnderman> {
    ...
    private static final ResourceLocation ENDERMAN_TEXTURES = new ResourceLocation(

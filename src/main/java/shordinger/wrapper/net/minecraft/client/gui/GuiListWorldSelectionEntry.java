...
public class GuiListWorldSelectionEntry implements GuiListExtended.IGuiListEntry {
    ...
    public GuiListWorldSelectionEntry(GuiListWorldSelection listWorldSelIn, WorldSummary worldSummaryIn,
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY,
        ...
        String s1 = this.worldSummary.getFileName() + " ("
            + DATE_FORMAT.format(new Date(this.worldSummary.getLastTimePlayed()))
            + ")";
        String s2 = "";
        ...
        if (this.worldSummary.requiresConversion()) {
            ...
            s2 = I18n.format(
                "gameMode." + this.worldSummary.getEnumGameType()
                    .getName());
            ...
            if (this.worldSummary.markVersionInList()) {
                if (this.worldSummary.askToOpenWorld()) {
                    s2 = s2 + ", "
                        + I18n.format("selectWorld.version")
                        + " "
                        + TextFormatting.RED
                        + s3
        ...
        this.client.fontRenderer.drawString(
            s2,
            x + 32 + 3,
            y + this.client.fontRenderer.FONT_HEIGHT + this.client.fontRenderer.FONT_HEIGHT + 3,
            8421504);
        GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
        this.client.getTextureManager()
            .bindTexture(this.icon != null ? this.iconLocation : ICON_MISSING);
        ...
        if (this.client.gameSettings.touchscreen || isSelected) {
            this.client.getTextureManager()
                .bindTexture(ICON_OVERLAY_LOCATION);
            ...
            if (this.worldSummary.markVersionInList()) {
                ...
                if (this.worldSummary.askToOpenWorld()) {
                    ...
                    if (j < 32) {
                        this.worldSelScreen.setVersionTooltip(
                            TextFormatting.GOLD + I18n.format("selectWorld.tooltip.snapshot1")
                                + "\n"
                                + TextFormatting.GOLD
            ...
            this.client.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback() {
                ...
                public void confirmClicked(boolean result, int id) {
                    if (result) {
                        ...
                        GuiListWorldSelectionEntry.this.client
                            .displayGuiScreen(GuiListWorldSelectionEntry.this.worldSelScreen);
                    }
                }
            },
    ...
    public void recreateWorld() {
        ...
        ISaveHandler isavehandler = this.client.getSaveLoader()
            .getSaveLoader(this.worldSummary.getFileName(), false);
    ...
    private void loadServerIcon() {
        ...
        if (flag) {
            ...
            if (this.icon == null) {
                ...
                this.client.getTextureManager()
                    .loadTexture(this.iconLocation, this.icon);
            }
            ...
            bufferedimage.getRGB(
                ...
                this.icon.getTextureData(),
                0,
                bufferedimage.getWidth());
            this.icon.updateDynamicTexture();
        } else if (!flag) {
            this.client.getTextureManager()
                .deleteTexture(this.iconLocation);
            this.icon = null;
        }
    }

...
public class FontRenderer implements IResourceManagerReloadListener {
    ...
    private void renderStringAtPos(String text, boolean shadow) {
        for (int i = 0; i < text.length(); ++i) {
            ...
            if (c0 == 167 && i + 1 < text.length()) {
                int i1 = "0123456789abcdefklmnor".indexOf(
        ...
        {
            {
                ...
                if (this.underlineStyle) {
                    ...
                    bufferbuilder1
                        .pos((double) (this.posX + (float) l), (double) (this.posY + (float) this.FONT_HEIGHT), 0.0D)
                        .endVertex();
     ...
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 1, false)</code></td>
     * <td><samp>""</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 6, false)</code></td>
     * <td><samp>"0"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 29, false)</code></td>
     * <td><samp>"0123"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 30, false)</code></td>
     * <td><samp>"01234"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 9001, false)</code></td>
     * <td><samp>"0123456789"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 1, true)</code></td>
     * <td><samp>""</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 6, true)</code></td>
     * <td><samp>"9"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 29, true)</code></td>
     * <td><samp>"6789"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 30, true)</code></td>
     * <td><samp>"56789"</samp></td>
     * </tr>
     * <tr>
     * <td><code>trimStringToWidth("0123456789", 9001, true)</code></td>
     * <td><samp>"0123456789"</samp></td>
     * </tr>
     * </table>
     */
    ...
    public int getWordWrappedHeight(String str, int maxLength) {
        return this.FONT_HEIGHT * this.listFormattedStringToWidth(str, maxLength)
            .size();
    }

...
public class ClientAdvancementManager {
    ...
    private final Map<Advancement, AdvancementProgress> advancementToProgress = Maps
        .<Advancement, AdvancementProgress>newHashMap();
    @Nullable
    ...
    public void read(SPacketAdvancementInfo p_192799_1_) {
        ...
        for (Entry<ResourceLocation, AdvancementProgress> entry : p_192799_1_.getProgressUpdates()
            .entrySet()) {
            ...
            if (advancement != null) {
                ...
                if (!p_192799_1_.isFirstSync() && advancementprogress.isDone()
                    && advancement.getDisplay() != null
                    && advancement.getDisplay()
                    .shouldShowToast()) {
                    this.mc.getToastGui()
                        .add(new AdvancementToast(advancement));
                }
            } else {

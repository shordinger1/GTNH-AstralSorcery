...
import shordinger.wrapper.net.minecraft.entity.monster.AbstractIllager;
...
public class ModelIllager extends ModelBase {
    ...
    public ModelIllager(float scaleFactor, float p_i47227_2_, int textureWidthIn, int textureHeightIn) {
        ...
        this.head.setTextureOffset(0, 0)
            .addBox(-4.0F, -10.0F, -4.0F, 8, 10, 8, scaleFactor);
        ...
        this.nose.setTextureOffset(24, 0)
            .addBox(-1.0F, -1.0F, -6.0F, 2, 4, 2, scaleFactor);
        ...
        this.body.setTextureOffset(16, 20)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 12, 6, scaleFactor);
        this.body.setTextureOffset(0, 38)
            .addBox(-4.0F, 0.0F, -3.0F, 8, 18, 6, scaleFactor + 0.5F);
        ...
        this.arms.setTextureOffset(44, 22)
            .addBox(-8.0F, -2.0F, -2.0F, 4, 8, 4, scaleFactor);
        ...
        this.arms.setTextureOffset(40, 38)
            .addBox(-4.0F, 2.0F, -2.0F, 8, 4, 4, scaleFactor);

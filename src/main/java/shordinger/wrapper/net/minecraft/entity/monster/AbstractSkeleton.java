...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIFleeSun;
...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIRestrictSun;
...
public abstract class AbstractSkeleton extends EntityMob implements IRangedAttackMob {
    ...
    private final EntityAIAttackRangedBow<AbstractSkeleton> aiArrowAttack = new EntityAIAttackRangedBow<AbstractSkeleton>(
        this,
        1.0D,
        20,
        15.0F);

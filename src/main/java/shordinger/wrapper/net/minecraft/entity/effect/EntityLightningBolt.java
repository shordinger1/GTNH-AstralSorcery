package shordinger.wrapper.net.minecraft.entity.effect;
...
public class EntityLightningBolt extends EntityWeatherEffect {
    ...
    public EntityLightningBolt(World worldIn, double x, double y, double z, boolean effectOnlyIn) {
        ...
        if (!effectOnlyIn && !worldIn.isRemote
            ...
            for (int i = 0; i < 4; ++i) {
                BlockPos blockpos1 = blockpos
                    .add(this.rand.nextInt(3) - 1, this.rand.nextInt(3) - 1, this.rand.nextInt(3) - 1);

...
import shordinger.wrapper.net.minecraft.enchantment.EnchantmentData;
...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIFollowGolem;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIHarvestFarmland;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAILookAtTradePlayer;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIMoveIndoors;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIMoveTowardsRestriction;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIOpenDoor;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIPlay;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIRestrictOpenDoor;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAISwimming;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAITradePlayer;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIVillagerInteract;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIVillagerMate;
...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIWatchClosest2;
...
import shordinger.wrapper.net.minecraft.world.storage.MapDecoration;
...
public class EntityVillager extends EntityAgeable implements INpc, IMerchant {
    ...
    private static final DataParameter<Integer> PROFESSION = EntityDataManager
        .<Integer>createKey(EntityVillager.class, DataSerializers.VARINT);
    ...
    private static final EntityVillager.ITradeList[][][][] DEFAULT_TRADE_LIST_MAP = new EntityVillager.ITradeList[][][][]{
        ...
        {{{new EntityVillager.EmeraldForItems(Items.PAPER, new EntityVillager.PriceInfo(24, 36)),
            ...
            {{new EntityVillager.EmeraldForItems(Items.PAPER, new EntityVillager.PriceInfo(24, 36))},
                ...
                {new EntityVillager.TreasureMapForEmeralds(
                    new EntityVillager.PriceInfo(12, 20),
                    "Monument",
                    MapDecoration.Type.MONUMENT),
                    new EntityVillager.TreasureMapForEmeralds(
                        new EntityVillager.PriceInfo(16, 28),
                        "Mansion",
    ...
    protected void updateAITasks() {
        if (--this.randomTickDivider <= 0) {
            ...
            this.world.getVillageCollection()
                .addToVillagerPositionList(blockpos);
            this.randomTickDivider = 70 + this.rand.nextInt(50);
            this.village = this.world.getVillageCollection()
    ...
    public boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        if (flag) {
            ...
            return true;
        } else if (!this.holdingSpawnEggOfClass(itemstack, this.getClass()) && this.isEntityAlive()
            && !this.isTrading()
            && !this.isChild()
            && !player.isSneaking()) {
    ...
    public static void registerFixesVillager(DataFixer fixer) {
        ...
        fixer.registerWalker(
            FixTypes.ENTITY,
            new ItemStackDataLists(EntityVillager.class, new String[]{"Inventory"}));
    ...
    public void readEntityFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("ProfessionName")) {
            ...
            if (p == null) p = net.minecraftforge.fml.common.registry.ForgeRegistries.VILLAGER_PROFESSIONS
    ...
    public net.minecraftforge.fml.common.registry.VillagerRegistry.VillagerProfession getProfessionForge() {
        if (this.prof == null) {
            ...
            if (this.prof == null) return net.minecraftforge.fml.common.registry.VillagerRegistry.getById(0); // Farmer
        }
        return this.prof;
    }
    ...
    public void useRecipe(MerchantRecipe recipe) {
        ...
        if (recipe.getItemToBuy()
            ...
            this.wealth += recipe.getItemToBuy()
                .getCount();
        }
    ...
    private void populateBuyingList() {
        if (this.careerId != 0 && this.careerLevel != 0) {
            ...
            this.careerId = this.getProfessionForge()
                .getRandomCareer(this.rand) + 1;
            this.careerLevel = 1;
        }
        ...
        java.util.List<EntityVillager.ITradeList> trades = this.getProfessionForge()
            .getCareer(i)
            .getTrades(j);
    ...
    public ITextComponent getDisplayName() {
        ...
        if (s != null && !s.isEmpty()) {
            ...
            s1 = this.getProfessionForge()
                .getCareer(this.careerId - 1)
                .getName();
            {
    ...
    public IEntityLivingData finalizeMobSpawn(DifficultyInstance p_190672_1_, @Nullable IEntityLivingData p_190672_2_,
                                              boolean p_190672_3_) {
    ...
    public void onStruckByLightning(EntityLightningBolt lightningBolt) {
        if (!this.world.isRemote && !this.isDead) {
            ...
            entitywitch.onInitialSpawn(
                this.world.getDifficultyForLocation(new BlockPos(entitywitch)),
                (IEntityLivingData) null);
    ...
    private boolean canVillagerPickupItem(Item itemIn) {
        return itemIn == Items.BREAD || itemIn == Items.POTATO
            || itemIn == Items.CARROT
            || itemIn == Items.WHEAT
    ...
    public boolean isFarmItemInInventory() {
        for (int i = 0; i < this.villagerInventory.getSizeInventory(); ++i) {
            ...
            if (!itemstack.isEmpty() && (itemstack.getItem() == Items.WHEAT_SEEDS || itemstack.getItem() == Items.POTATO
    ...
    public static class ListEnchantedItemForEmeralds implements EntityVillager.ITradeList {
        ...
        public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random) {
            ...
            ItemStack itemstack1 = EnchantmentHelper.addRandomEnchantment(
                random,
                new ItemStack(this.enchantedItemStack.getItem(), 1, this.enchantedItemStack.getMetadata()),
                5 + random.nextInt(15),
                false);
    ...
    // MODDERS DO NOT USE OR EDIT THIS IN ANY WAY IT WILL HAVE NO EFFECT, THIS IS JUST IN HERE TO ALLOW FORGE TO ACCESS
    // IT
    @Deprecated
    ...
    public static class PriceInfo extends Tuple<Integer, Integer> {
        ...
        public PriceInfo(int p_i45810_1_, int p_i45810_2_) {
            ...
            if (p_i45810_2_ < p_i45810_1_) {
                EntityVillager.LOGGER.warn(
                    "PriceRange({}, {}) invalid, {} smaller than {}",
                    Integer.valueOf(p_i45810_1_),
                    Integer.valueOf(p_i45810_2_),
                    Integer.valueOf(p_i45810_2_),
                    Integer.valueOf(p_i45810_1_));
            }
        }
        ...
        public int getPrice(Random rand) {
            return ((Integer) this.getFirst()).intValue() >= ((Integer) this.getSecond()).intValue()
                ...
                : ((Integer) this.getFirst()).intValue() + rand
                .nextInt(((Integer) this.getSecond()).intValue() - ((Integer) this.getFirst()).intValue() + 1);
        }
    }
    ...
    static class TreasureMapForEmeralds implements EntityVillager.ITradeList {
        ...
        public TreasureMapForEmeralds(EntityVillager.PriceInfo p_i47340_1_, String p_i47340_2_,
        ...
        public void addMerchantRecipe(IMerchant merchant, MerchantRecipeList recipeList, Random random) {
            ...
            if (blockpos != null) {
                ItemStack itemstack = ItemMap
                    .setupNewMap(world, (double) blockpos.getX(), (double) blockpos.getZ(), (byte) 2, true, true);
                ...
                recipeList
                    .add(new MerchantRecipe(new ItemStack(Items.EMERALD, i), new ItemStack(Items.COMPASS), itemstack));
            }
        }
    }
}

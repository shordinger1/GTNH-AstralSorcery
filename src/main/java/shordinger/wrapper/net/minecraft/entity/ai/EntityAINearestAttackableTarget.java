...
public class EntityAINearestAttackableTarget<T extends EntityLivingBase> extends EntityAITarget {
    ...
    public EntityAINearestAttackableTarget(EntityCreature creature, Class<T> classTarget, int chance,
                                           boolean checkSight, boolean onlyNearby, @Nullable final Predicate<? super T> targetSelector) {
        ...
        this.targetEntitySelector = new Predicate<T>() {
            ...
            public boolean apply(@Nullable T p_apply_1_) {
                if (p_apply_1_ == null) {
                    ...
                    return !EntitySelectors.NOT_SPECTATING.apply(p_apply_1_) ? false
                        : EntityAINearestAttackableTarget.this.isSuitableTarget(p_apply_1_, false);
                }
            }
        };
    }
    ...
    public boolean shouldExecute() {
        if (this.targetChance > 0 && this.taskOwner.getRNG()
            ...
            List<T> list = this.taskOwner.world.<T>getEntitiesWithinAABB(
                this.targetClass,
                    ...
                    public Double apply(@Nullable EntityPlayer p_apply_1_) {
                        ...
                        if (itemstack.getItem() == Items.SKULL) {
                            ...
                            boolean flag = EntityAINearestAttackableTarget.this.taskOwner instanceof EntitySkeleton
                                && i == 0;
                            boolean flag1 = EntityAINearestAttackableTarget.this.taskOwner instanceof EntityZombie
                                && i == 2;
                            boolean flag2 = EntityAINearestAttackableTarget.this.taskOwner instanceof EntityCreeper
                                && i == 4;

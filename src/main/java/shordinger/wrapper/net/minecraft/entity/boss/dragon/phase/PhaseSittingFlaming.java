            ...
            for (int i = 0; i < 8; ++i) {
                ...
                for (int j = 0; j < 6; ++j) {
                    this.dragon.world.spawnParticle(
                        ...
                        d4,
                        d5,
                        -vec3d.x * 0.07999999821186066D * (double) j,
                        -vec3d.y * 0.6000000238418579D,
                        -vec3d.z * 0.07999999821186066D * (double) j);
                }
    ...
    public void doLocalUpdate() {
        ...
        if (this.flameTicks >= 200) {
            ...
            Vec3d vec3d = (new Vec3d(
                ...
                0.0D,
                this.dragon.dragonPartHead.posZ - this.dragon.posZ)).normalize();
            float f = 5.0F;
            ...
            while (this.dragon.world.isAirBlock(blockpos$mutableblockpos) && d2 >= 0) // Forge: Fix infinite loop if
            // ground is missing.
            {
                --d2;

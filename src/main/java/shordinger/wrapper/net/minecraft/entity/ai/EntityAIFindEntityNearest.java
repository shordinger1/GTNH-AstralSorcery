...
public class EntityAIFindEntityNearest extends EntityAIBase {
        ...
        this.predicate = new Predicate<EntityLivingBase>() {
            ...
            public boolean apply(@Nullable EntityLivingBase p_apply_1_) {
                ...
                if (p_apply_1_.isInvisible()) {
                    ...
                    return (double) p_apply_1_.getDistance(EntityAIFindEntityNearest.this.mob) > d0 ? false
    ...
    public boolean shouldExecute() {
        ...
        List<EntityLivingBase> list = this.mob.world.<EntityLivingBase>getEntitiesWithinAABB(
            this.classToCheck,
            this.mob.getEntityBoundingBox()
                .grow(d0, 4.0D, d0),
            this.predicate);

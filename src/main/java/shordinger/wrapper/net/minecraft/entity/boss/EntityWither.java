...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIAttackRanged;
...
public class EntityWither extends EntityMob implements IRangedAttackMob {
    ...
    private static final DataParameter<Integer> FIRST_HEAD_TARGET = EntityDataManager
        .<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> SECOND_HEAD_TARGET = EntityDataManager
        .<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> THIRD_HEAD_TARGET = EntityDataManager
        .<Integer>createKey(EntityWither.class, DataSerializers.VARINT);
    ...
    protected void initEntityAI() {
        ...
        this.targetTasks
            .addTask(2, new EntityAINearestAttackableTarget(this, EntityLiving.class, 0, false, false, NOT_UNDEAD));
    }
                ...
                if (this.ticksExisted >= this.nextHeadUpdate[i - 1]) {
                    ...
                    if (k1 > 0) {
                        ...
                        if (entity != null && entity.isEntityAlive()
                            && this.getDistanceSq(entity) <= 900.0D
    ...
    public static boolean canDestroyBlock(Block blockIn) {
        return blockIn != Blocks.BEDROCK && blockIn != Blocks.END_PORTAL
    ...
    private void launchWitherSkullToEntity(int p_82216_1_, EntityLivingBase p_82216_2_) {
        this.launchWitherSkullToCoords(
            p_82216_1_,
            p_82216_2_.posX,
            p_82216_2_.posY + (double) p_82216_2_.getEyeHeight() * 0.5D,
            p_82216_2_.posZ,

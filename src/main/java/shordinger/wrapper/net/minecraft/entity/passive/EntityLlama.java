...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAILlamaFollowCaravan;
...
public class EntityLlama extends AbstractChestHorse implements IRangedAttackMob {
    ...
    private static final DataParameter<Integer> DATA_STRENGTH_ID = EntityDataManager
        .<Integer>createKey(EntityLlama.class, DataSerializers.VARINT);
    private static final DataParameter<Integer> DATA_COLOR_ID = EntityDataManager
        .<Integer>createKey(EntityLlama.class, DataSerializers.VARINT);
    ...
    public boolean canMateWith(EntityAnimal otherAnimal) {
        return otherAnimal != this && otherAnimal instanceof EntityLlama
            && this.canMate()
            && ((EntityLlama) otherAnimal).canMate();
    }

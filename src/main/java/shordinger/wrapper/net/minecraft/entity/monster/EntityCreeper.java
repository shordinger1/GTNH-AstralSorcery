...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAICreeperSwell;
...
public class EntityCreeper extends EntityMob {
    ...
    private static final DataParameter<Integer> STATE = EntityDataManager
        .<Integer>createKey(EntityCreeper.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> POWERED = EntityDataManager
        .<Boolean>createKey(EntityCreeper.class, DataSerializers.BOOLEAN);
    ...
    public void onDeath(DamageSource cause) {
        ...
        if (this.world.getGameRules()
            ...
            } else if (cause.getTrueSource() instanceof EntityCreeper && cause.getTrueSource() != this
    ...
    public boolean ableToCauseSkullDrop() {
        return this.droppedSkulls < 1 && this.world.getGameRules()
            .getBoolean("doMobLoot");
    }

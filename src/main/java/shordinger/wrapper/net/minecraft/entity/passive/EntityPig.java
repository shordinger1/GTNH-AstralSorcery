...
public class EntityPig extends EntityAnimal {
    ...
    private static final DataParameter<Boolean> SADDLED = EntityDataManager
        .<Boolean>createKey(EntityPig.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> BOOST_TIME = EntityDataManager
        .<Integer>createKey(EntityPig.class, DataSerializers.VARINT);
    ...
    public boolean canBeSteered() {
        ...
        if (!(entity instanceof EntityPlayer)) {
            ...
            return entityplayer.getHeldItemMainhand()
                ...
                || entityplayer.getHeldItemOffhand()
                .getItem() == Items.CARROT_ON_A_STICK;
        }
    }
    ...
    public void travel(float strafe, float vertical, float forward) {
        ...
        if (this.isBeingRidden() && this.canBeSteered()) {
            ...
            if (this.canPassengerSteer()) {
                float f = (float) this.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED)
    ...
    public boolean boost() {
        if (this.boosting) {
            ...
            this.boosting = true;
            this.boostTime = 0;
            this.totalBoostTime = this.getRNG()
                .nextInt(841) + 140;
            this.getDataManager()
                .set(BOOST_TIME, Integer.valueOf(this.totalBoostTime));
            return true;
        }
    }

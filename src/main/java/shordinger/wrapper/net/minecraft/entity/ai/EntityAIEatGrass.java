...
public class EntityAIEatGrass extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.grassEaterEntity.getRNG()
            .nextInt(this.grassEaterEntity.isChild() ? 50 : 1000) != 0) {
            return false;
        } else {
            BlockPos blockpos = new BlockPos(
                this.grassEaterEntity.posX,
                this.grassEaterEntity.posY,
                this.grassEaterEntity.posZ);

            if (IS_TALL_GRASS.apply(this.entityWorld.getBlockState(blockpos))) {
                return true;
            } else {
                return this.entityWorld.getBlockState(blockpos.down())
    ...
    public void startExecuting() {
        ...
        this.grassEaterEntity.getNavigator()
            .clearPath();
    }
        ...
        if (this.eatingGrassTimer == 4) {
            ...
            if (IS_TALL_GRASS.apply(this.entityWorld.getBlockState(blockpos))) {
                if (net.minecraftforge.event.ForgeEventFactory
                    .getMobGriefingEvent(this.entityWorld, this.grassEaterEntity)) {
                ...
                if (this.entityWorld.getBlockState(blockpos1)
                    .getBlock() == Blocks.GRASS) {
                    if (net.minecraftforge.event.ForgeEventFactory
                        .getMobGriefingEvent(this.entityWorld, this.grassEaterEntity)) {

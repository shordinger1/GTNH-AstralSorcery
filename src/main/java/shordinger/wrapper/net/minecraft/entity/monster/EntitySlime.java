...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIFindEntityNearest;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIFindEntityNearestPlayer;
...
public class EntitySlime extends EntityLiving implements IMob {
    ...
    private static final DataParameter<Integer> SLIME_SIZE = EntityDataManager
        .<Integer>createKey(EntitySlime.class, DataSerializers.VARINT);
    ...
    public boolean getCanSpawnHere() {
        ...
        if (this.world.getWorldInfo()
            .getTerrainType()
            .handleSlimeSpawnReduction(rand, world)) {
            return false;
        } else {
            if (this.world.getDifficulty() != EnumDifficulty.PEACEFUL) {
                Biome biome = this.world.getBiome(blockpos);

                if (biome == Biomes.SWAMPLAND && this.posY > 50.0D
                    && this.posY < 70.0D
                ...
                if (this.rand.nextInt(10) == 0 && chunk.getRandomWithSeed(987234911L)
                    .nextInt(10) == 0 && this.posY < 40.0D) {
                    return super.getCanSpawnHere();
                }
            }
    ...
    static class AISlimeFaceRandom extends EntityAIBase {
        ...
        public void updateTask() {
            if (--this.nextRandomizeTime <= 0) {
                this.nextRandomizeTime = 40 + this.slime.getRNG()
                    .nextInt(60);
                this.chosenDegrees = (float) this.slime.getRNG()
                    .nextInt(360);
            }
    ...
    static class AISlimeFloat extends EntityAIBase {
         ...
         */
        public void updateTask() {
            if (this.slime.getRNG()
                .nextFloat() < 0.8F) {
                this.slime.getJumpHelper()
                    .setJumping();
            }
            ...
            if (this.action != EntityMoveHelper.Action.MOVE_TO) {
                ...
                if (this.entity.onGround) {
                    this.entity.setAIMoveSpeed(
                        (float) (this.speed * this.entity.getEntityAttribute(SharedMonsterAttributes.MOVEMENT_SPEED)
                            .getAttributeValue()));

...
public class EntityAIAttackRangedBow<T extends EntityMob & IRangedAttackMob> extends EntityAIBase {
    ...
    protected boolean isBowInMainhand() {
        return !this.entity.getHeldItemMainhand()
            .isEmpty()
            && this.entity.getHeldItemMainhand()
    ...
    public void updateTask() {
        ...
        if (entitylivingbase != null) {
            double d0 = this.entity.getDistanceSq(
            ...
            if (d0 <= (double) this.maxAttackDistance && this.seeTime >= 20) {
                ...
                this.entity.getNavigator()
                    .tryMoveToEntityLiving(entitylivingbase, this.moveSpeedAmp);
                this.strafingTime = -1;
            }

...
public class EntityBat extends EntityAmbientCreature {
    ...
    private static final DataParameter<Byte> HANGING = EntityDataManager
        .<Byte>createKey(EntityBat.class, DataSerializers.BYTE);
    /**
    ...
    protected void updateAITasks() {
        ...
        if (this.getIsBatHanging()) {
            ...
            if (this.spawnPosition == null || this.rand.nextInt(30) == 0
                || this.spawnPosition
                .distanceSq((double) ((int) this.posX), (double) ((int) this.posY), (double) ((int) this.posZ))
                < 4.0D) {
            ...
            if (this.rand.nextInt(100) == 0 && this.world.getBlockState(blockpos1)
                .isNormalCube()) {
                this.setIsBatHanging(true);
            }
        }

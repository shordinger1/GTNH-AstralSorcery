...
import shordinger.wrapper.net.minecraft.entity.passive.EntityShoulderRiding;
...
public class EntityAILandOnOwnersShoulder extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        boolean flag = entitylivingbase != null && !((EntityPlayer) entitylivingbase).isSpectator()
            && !((EntityPlayer) entitylivingbase).capabilities.isFlying
    ...
    public void updateTask() {
        if (!this.isSittingOnShoulder && !this.entity.isSitting() && !this.entity.getLeashed()) {
            if (this.entity.getEntityBoundingBox()
                .intersects(this.owner.getEntityBoundingBox())) {

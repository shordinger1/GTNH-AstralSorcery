...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIDefendVillage;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIHurtByTarget;
import shordinger.wrapper.net.minecraft.entity.ai.EntityAILookAtVillager;
...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIMoveTowardsTarget;
...
public class EntityIronGolem extends EntityGolem {
    ...
    protected static final DataParameter<Byte> PLAYER_CREATED = EntityDataManager
        .<Byte>createKey(EntityIronGolem.class, DataSerializers.BYTE);
    /**

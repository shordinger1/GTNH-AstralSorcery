...
public class EntitySnowman extends EntityGolem implements IRangedAttackMob, net.minecraftforge.common.IShearable {
    ...
    private static final DataParameter<Byte> PUMPKIN_EQUIPPED = EntityDataManager
        .<Byte>createKey(EntitySnowman.class, DataSerializers.BYTE);
    ...
    public void onLivingUpdate() {
        ...
        if (!this.world.isRemote) {
            ...
            if (this.world.getBiome(new BlockPos(i, 0, k))
                .getTemperature(new BlockPos(i, j, k)) > 1.0F) {
            ...
            for (int l = 0; l < 4; ++l) {
                ...
                if (this.world.getBlockState(blockpos)
                    ...
                    && this.world.getBiome(blockpos)
                    .getTemperature(blockpos) < 0.8F
    ...
    protected boolean processInteract(EntityPlayer player, EnumHand hand) {
        ...
        if (false && itemstack.getItem() == Items.SHEARS && this.isPumpkinEquipped() && !this.world.isRemote) // Forge:
        // Moved
        // to
        // onSheared
        {

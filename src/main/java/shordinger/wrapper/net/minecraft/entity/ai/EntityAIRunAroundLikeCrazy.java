...
public class EntityAIRunAroundLikeCrazy extends EntityAIBase {
    ...
    public void startExecuting() {
        this.horseHost.getNavigator()
            .tryMoveToXYZ(this.targetX, this.targetY, this.targetZ, this.speed);
    }
    ...
    public boolean shouldContinueExecuting() {
        return !this.horseHost.isTame() && !this.horseHost.getNavigator()
            .noPath() && this.horseHost.isBeingRidden();
    }
    ...
    public void updateTask() {
        if (!this.horseHost.isTame() && this.horseHost.getRNG()
            .nextInt(50) == 0) {
            Entity entity = (Entity) this.horseHost.getPassengers()
                .get(0);
            ...
            if (entity instanceof EntityPlayer) {
                ...
                if (j > 0 && this.horseHost.getRNG()
                    .nextInt(j) < i
                    && !net.minecraftforge.event.ForgeEventFactory.onAnimalTame(horseHost, (EntityPlayer) entity)) {

...
import shordinger.wrapper.net.minecraft.entity.IEntityOwnable;
...
public abstract class EntityTameable extends EntityAnimal implements IEntityOwnable {
    ...
    public void onDeath(DamageSource cause) {
        if (!this.world.isRemote && this.world.getGameRules()
            .getBoolean("showDeathMessages") && this.getOwner() instanceof EntityPlayerMP) {
            this.getOwner()
                .sendMessage(

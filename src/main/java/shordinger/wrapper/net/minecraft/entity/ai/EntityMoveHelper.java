...
import shordinger.wrapper.net.minecraft.pathfinding.NodeProcessor;
    ...
    public void onUpdateMoveHelper() {
        if (this.action == EntityMoveHelper.Action.STRAFE) {
            ...
            if (pathnavigate != null) {
                ...
                if (nodeprocessor != null && nodeprocessor.getPathNodeType(
                    this.entity.world,
                    MathHelper.floor(this.entity.posX + (double) f7),
            ...
            if (d2 > (double) this.entity.stepHeight
                && d0 * d0 + d1 * d1 < (double) Math.max(1.0F, this.entity.width)) {

...
public class EntityAIHurtByTarget extends EntityAITarget {
    ...
    public EntityAIHurtByTarget(EntityCreature creatureIn, boolean entityCallsForHelpIn,
    ...
    protected void alertOthers() {
        ...
        for (EntityCreature entitycreature : this.taskOwner.world.getEntitiesWithinAABB(

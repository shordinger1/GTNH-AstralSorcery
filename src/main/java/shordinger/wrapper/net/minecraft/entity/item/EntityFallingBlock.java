...
import shordinger.wrapper.net.minecraft.block.BlockAnvil;
...
public class EntityFallingBlock extends Entity {
    ...
    protected static final DataParameter<BlockPos> ORIGIN = EntityDataManager
        .<BlockPos>createKey(EntityFallingBlock.class, DataSerializers.BLOCK_POS);
    ...
    public void onUpdate() {
        ...
        if (this.fallTile.getMaterial() == Material.AIR) {
            ...
            if (!this.world.isRemote) {
                ...
                boolean flag1 = flag && this.world.getBlockState(blockpos1)
                ...
                if (flag && d0 > 1.0D) {
                    ...
                    if (raytraceresult != null && this.world.getBlockState(raytraceresult.getBlockPos())
                        .getMaterial() == Material.WATER) {
                ...
                if (!this.onGround && !flag1) {
                    ...
                    if (this.world.isAirBlock(new BlockPos(this.posX, this.posY - 0.009999999776482582D, this.posZ))) // Forge:
                        // Don't
                        // indent
                        // below.
                    ...
                    if (iblockstate.getBlock() != Blocks.PISTON_EXTENSION) {
                        ...
                        if (!this.dontSetBlock) {
                            if (this.world.mayPlace(block, blockpos1, true, EnumFacing.UP, this)
                                ...
                                if (block instanceof BlockFalling) {
                                    ((BlockFalling) block)
                                        .onEndFalling(this.world, blockpos1, this.fallTile, iblockstate);
                                }
        ...
        if (this.hurtEntities) {
            ...
            if (i > 0) {
                List<Entity> list = Lists
                    .newArrayList(this.world.getEntitiesWithinAABBExcludingEntity(this, this.getEntityBoundingBox()));
    ...
    protected void readEntityFromNBT(NBTTagCompound compound) {
        ...
        if (compound.hasKey("Block", 8)) {
            this.fallTile = Block.getBlockFromName(compound.getString("Block"))
                .getStateFromMeta(i);
        } else if (compound.hasKey("TileID", 99)) {
            this.fallTile = Block.getBlockById(compound.getInteger("TileID"))
                .getStateFromMeta(i);
        } else {
            this.fallTile = Block.getBlockById(compound.getByte("Tile") & 255)
                .getStateFromMeta(i);
        }
        ...
        if (block == null || block.getDefaultState()

...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAITasks;
import shordinger.wrapper.net.minecraft.entity.ai.EntityJumpHelper;
import shordinger.wrapper.net.minecraft.entity.ai.EntityLookHelper;
import shordinger.wrapper.net.minecraft.entity.ai.EntityMoveHelper;
import shordinger.wrapper.net.minecraft.entity.ai.EntitySenses;
...
public abstract class EntityLiving extends EntityLivingBase {
     ...
     */
    private static final DataParameter<Byte> AI_FLAGS = EntityDataManager
        .<Byte>createKey(EntityLiving.class, DataSerializers.BYTE);
    /**
    ...
    public void onLivingUpdate() {
        ...
        if (!this.world.isRemote && this.canPickUpLoot()
            && !this.dead
            && net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.world, this)) {
            for (EntityItem entityitem : this.world.getEntitiesWithinAABB(
                EntityItem.class,
                this.getEntityBoundingBox()
                    .grow(1.0D, 0.0D, 1.0D))) {
                if (!entityitem.isDead && !entityitem.getItem()
                    .isEmpty() && !entityitem.cannotPickup()) {
    ...
    protected void despawnEntity() {
        ...
        if (this.persistenceRequired) {
            ...
            && (result = net.minecraftforge.event.ForgeEventFactory.canEntityDespawn(this))
            != net.minecraftforge.fml.common.eventhandler.Event.Result.DEFAULT) {
            ...
            entityliving.getNavigator()
                .setPath(
                    this.getNavigator()
                        .getPath(),
                    1.5D);
            entityliving.getMoveHelper()
                .read(this.getMoveHelper());
        }
    ...
    public int getMaxFallHeight() {
        if (this.getAttackTarget() == null) {
            ...
            i = i - (3 - this.world.getDifficulty()
                .getDifficultyId()) * 4;
    ...
    public static EntityEquipmentSlot getSlotForItemStack(ItemStack stack) {
        final EntityEquipmentSlot slot = stack.getItem()
            .getEquipmentSlot(stack);
        if (slot != null) return slot; // FORGE: Allow modders to set a non-default equipment slot for a stack; e.g. a
        // non-armor chestplate-slot item
        if (stack.getItem() != Item.getItemFromBlock(Blocks.PUMPKIN) && stack.getItem() != Items.SKULL) {
            if (stack.getItem() instanceof ItemArmor) {
                ...
                return stack.getItem()
                    .isShield(stack, null) ? EntityEquipmentSlot.OFFHAND : EntityEquipmentSlot.MAINHAND;
            }
        } else {
    ...
    protected void setEnchantmentBasedOnDifficulty(DifficultyInstance difficulty) {
        ...
        if (!this.getHeldItemMainhand()
            .isEmpty() && this.rand.nextFloat() < 0.25F * f) {
        ...
        if (this.isLeashed) {
            ...
            if (!this.world.isRemote && sendPacket && this.world instanceof WorldServer) {
                ((WorldServer) this.world).getEntityTracker()
                    .sendToTracking(this, new SPacketEntityAttach(this, (Entity) null));
            }
        }
    }
    ...
    public void setLeashHolder(Entity entityIn, boolean sendAttachNotification) {
        ...
        if (!this.world.isRemote && sendAttachNotification && this.world instanceof WorldServer) {
            ((WorldServer) this.world).getEntityTracker()
                .sendToTracking(this, new SPacketEntityAttach(this, this.leashHolder));
        }
        ...
        if (this.isLeashed && this.leashNBTTag != null) {
            if (this.leashNBTTag.hasUniqueId("UUID")) {
                ...
                BlockPos blockpos = new BlockPos(
                    this.leashNBTTag.getInteger("X"),
                    this.leashNBTTag.getInteger("Y"),
    ...
    public boolean replaceItemInInventory(int inventorySlot, ItemStack itemStackIn) {
        ...
        if (!itemStackIn.isEmpty() && !isItemStackInSlot(entityequipmentslot, itemStackIn)
            && entityequipmentslot != EntityEquipmentSlot.HEAD) {
            return false;
        } else {
    ...
    public static enum SpawnPlacementType {
        ...
        public boolean canSpawnAt(World world, BlockPos pos) {
            return this.spawnPredicate != null ? this.spawnPredicate.test(world, pos)
                : net.minecraft.world.WorldEntitySpawner.canCreatureTypeSpawnBody(this, world, pos);
        }
    }
}

...
public class EntityAIOcelotAttack extends EntityAIBase {
    ...
    public void updateTask() {
        ...
        double d1 = this.entity
            .getDistanceSq(this.target.posX, this.target.getEntityBoundingBox().minY, this.target.posZ);
        double d2 = 0.8D;
        ...
        this.entity.getNavigator()
            .tryMoveToEntityLiving(this.target, d2);

...
public class EntityTracker {
    ...
    public EntityTracker(WorldServer theWorldIn) {
        ...
        this.maxTrackingDistanceThreshold = theWorldIn.getMinecraftServer()
            .getPlayerList()
    ...
    public void track(Entity entityIn) {
        if (net.minecraftforge.fml.common.registry.EntityRegistry.instance()
            .tryTrackingEntity(this, entityIn)) return;
    ...
    public void sendLeashedEntitiesInChunk(EntityPlayerMP player, Chunk chunkIn) {
        ...
        if (!list.isEmpty()) {
            for (Entity entity1 : list) {
                player.connection
                    .sendPacket(new SPacketEntityAttach(entity1, ((EntityLiving) entity1).getLeashHolder()));
            }
        }

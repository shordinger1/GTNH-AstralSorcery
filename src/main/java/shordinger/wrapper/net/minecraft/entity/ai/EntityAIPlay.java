...
public class EntityAIPlay extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        if (this.villager.getGrowingAge() >= 0) {
            ...
            List<EntityVillager> list = this.villager.world.<EntityVillager>getEntitiesWithinAABB(
        ...
        if (this.targetVillager != null) {
            if (this.villager.getDistanceSq(this.targetVillager) > 4.0D) {
                this.villager.getNavigator()
                    .tryMoveToEntityLiving(this.targetVillager, this.speed);
            }
        } else if (this.villager.getNavigator()
            .noPath()) {
            Vec3d vec3d = RandomPositionGenerator.findRandomTarget(this.villager, 16, 3);
            ...
            this.villager.getNavigator()
                .tryMoveToXYZ(vec3d.x, vec3d.y, vec3d.z, this.speed);
        }
    }
}

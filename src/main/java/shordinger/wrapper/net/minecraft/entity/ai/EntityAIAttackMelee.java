...
public class EntityAIAttackMelee extends EntityAIBase {
        ...
        if (entitylivingbase == null) {
            ...
            if (canPenalize) {
                if (--this.delayCounter <= 0) {
                    this.path = this.attacker.getNavigator()
                        .getPathToEntityLiving(entitylivingbase);
                    this.delayCounter = 4 + this.attacker.getRNG()
                        .nextInt(7);
            ...
            if (this.path != null) {
                ...
                return this.getAttackReachSqr(entitylivingbase) >= this.attacker.getDistanceSq(
    ...
    public void startExecuting() {
        this.attacker.getNavigator()
            .setPath(this.path, this.speedTowardsTarget);
        this.delayCounter = 0;
    }
        ...
        if ((this.longMemory || this.attacker.getEntitySenses()
            ...
            if (this.canPenalize) {
                ...
                if (this.attacker.getNavigator()
                    .getPath() != null) {
                    net.minecraft.pathfinding.PathPoint finalPathPoint = this.attacker.getNavigator()
                        .getPath()
                        .getFinalPathPoint();

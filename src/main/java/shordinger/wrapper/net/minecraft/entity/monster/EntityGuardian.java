...
import shordinger.wrapper.net.minecraft.pathfinding.PathNavigateSwimmer;
...
public class EntityGuardian extends EntityMob {
    ...
    private static final DataParameter<Boolean> MOVING = EntityDataManager
        .<Boolean>createKey(EntityGuardian.class, DataSerializers.BOOLEAN);
    private static final DataParameter<Integer> TARGET_ENTITY = EntityDataManager
        .<Integer>createKey(EntityGuardian.class, DataSerializers.VARINT);
    ...
    public float getBlockPathWeight(BlockPos pos) {
        return this.world.getBlockState(pos)
            .getMaterial() == Material.WATER ? 10.0F + this.world.getLightBrightness(pos) - 0.5F
        ...
        if (this.world.isRemote) {
            ...
            if (this.isMoving() && this.isInWater()) {
                ...
                for (int i = 0; i < 2; ++i) {
                    this.world.spawnParticle(
                        ...
                        this.posZ + (this.rand.nextDouble() - 0.5D) * (double) this.width - vec3d.z * 1.5D,
                        0.0D,
                        0.0D,
                        0.0D);
                }
            ...
            if (this.hasTargetedEntity()) {
                ...
                if (entitylivingbase != null) {
                    this.getLookHelper()
                        .setLookPositionWithEntity(entitylivingbase, 90.0F, 90.0F);
                    this.getLookHelper()
                        .onUpdateLook();
    ...
    static class AIGuardianAttack extends EntityAIBase {
        ...
        public void startExecuting() {
            this.tickCounter = -10;
            this.guardian.getNavigator()
                .clearPath();
            this.guardian.getLookHelper()
                .setLookPositionWithEntity(this.guardian.getAttackTarget(), 90.0F, 90.0F);
        ...
        public void updateTask() {
            ...
            if (!this.guardian.canEntityBeSeen(entitylivingbase)) {
                ...
                if (this.tickCounter == 0) {
                    this.guardian.setTargetedEntity(
                        this.guardian.getAttackTarget()
                            .getEntityId());
    ...
    static class GuardianMoveHelper extends EntityMoveHelper {
        ...
        public void onUpdateMoveHelper() {
            if (this.action == EntityMoveHelper.Action.MOVE_TO && !this.entityGuardian.getNavigator()
                .noPath()) {

...
import shordinger.wrapper.net.minecraft.block.BlockCarrot;
...
import shordinger.wrapper.net.minecraft.entity.ai.EntityAIMoveToBlock;
...
public class EntityRabbit extends EntityAnimal {
    ...
    private static final DataParameter<Integer> RABBIT_TYPE = EntityDataManager
        .<Integer>createKey(EntityRabbit.class, DataSerializers.VARINT);
    ...
    static class AIAvoidEntity<T extends Entity> extends EntityAIAvoidEntity<T> {
        ...
        public AIAvoidEntity(EntityRabbit rabbit, Class<T> p_i46403_2_, float p_i46403_3_, double p_i46403_4_,
                             double p_i46403_6_) {
            ...
            if (this.getIsAboveDestination()) {
                ...
                if (this.canRaid && block instanceof BlockCarrot) {
                    ...
                    if (integer.intValue() == 0) {
                        ...
                        world.setBlockState(
                            blockpos,
                            iblockstate.withProperty(BlockCarrot.AGE, Integer.valueOf(integer.intValue() - 1)),
                            2);

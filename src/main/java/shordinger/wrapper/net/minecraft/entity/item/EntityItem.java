...
public class EntityItem extends Entity {
    ...
    private static final DataParameter<ItemStack> ITEM = EntityDataManager
        .<ItemStack>createKey(EntityItem.class, DataSerializers.ITEM_STACK);
    /**
    ...
    public EntityItem(World worldIn, double x, double y, double z, ItemStack stack) {
        this(worldIn, x, y, z);
        this.setItem(stack);
        this.lifespan = (stack.getItem() == null ? 6000
            : stack.getItem()
            .getEntityLifespan(stack, worldIn));
    }
    ...
    public void onUpdate() {
        if (getItem().getItem()
            .onEntityItemUpdate(this)) return;
        if (this.getItem()
            .isEmpty()) {
            this.setDead();
        } else {
            ...
            if (this.world.isRemote) {
                ...
                this.noClip = this.pushOutOfBlocks(
                    this.posX,
                    (this.getEntityBoundingBox().minY + this.getEntityBoundingBox().maxY) / 2.0D,
                    this.posZ);
            }
            ...
            if (flag || this.ticksExisted % 25 == 0) {
                if (this.world.getBlockState(new BlockPos(this))
            ...
            if (this.onGround) {
                ...
                f = underState.getBlock()
                    .getSlipperiness(underState, this.world, underPos, this) * 0.98F;
            }
    ...
    public void onCollideWithPlayer(EntityPlayer entityIn) {
        if (!this.world.isRemote) {
            ...
            if (this.pickupDelay <= 0
                && (this.owner == null || lifespan - this.age <= 200 || this.owner.equals(entityIn.getName()))
                && (hook == 1 || i <= 0
                || entityIn.inventory.addItemStackToInventory(itemstack)
                || clone.getCount() > this.getItem()
                .getCount())) {
                clone.setCount(
                    clone.getCount() - this.getItem()
                        .getCount());
                net.minecraftforge.fml.common.FMLCommonHandler.instance()
                    .firePlayerItemPickupEvent(entityIn, this, clone);
    ...
    public ItemStack getItem() {
        return (ItemStack) this.getDataManager()
            .get(ITEM);
    }
    ...
    public void makeFakeItem() {
        ...
        this.age = getItem().getItem()
            .getEntityLifespan(getItem(), world) - 1;
    }
}

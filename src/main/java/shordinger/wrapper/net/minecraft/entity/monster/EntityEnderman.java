...
public class EntityEnderman extends EntityMob {
    ...
    private static final DataParameter<Optional<IBlockState>> CARRIED_BLOCK = EntityDataManager
        .<Optional<IBlockState>>createKey(EntityEnderman.class, DataSerializers.OPTIONAL_BLOCK_STATE);
    private static final DataParameter<Boolean> SCREAMING = EntityDataManager
        .<Boolean>createKey(EntityEnderman.class, DataSerializers.BOOLEAN);
    ...
    protected void dropEquipment(boolean wasRecentlyHit, int lootingModifier) {
        ...
        if (iblockstate != null) {
            ...
            int i = item.getHasSubtypes() ? iblockstate.getBlock()
                .getMetaFromState(iblockstate) : 0;
    ...
    static class AIFindPlayer extends EntityAINearestAttackableTarget<EntityPlayer> {
        ...
        public boolean shouldExecute() {
            ...
            this.player = this.enderman.world.getNearestAttackablePlayer(
                this.enderman.posX,
                this.enderman.posY,
                this.enderman.posZ,
                d0,
            ...
            if (this.player != null) {
                ...
                if (this.targetEntity != null) {
                    if (this.enderman.shouldAttackPlayer((EntityPlayer) this.targetEntity)) {
                        ...
                        this.teleportTime = 0;
                    } else if (((EntityPlayer) this.targetEntity).getDistanceSq(this.enderman) > 256.0D
    ...
    static class AIPlaceBlock extends EntityAIBase {
        ...
        public boolean shouldExecute() {
            if (this.enderman.getHeldBlockState() == null) {
                ...
                .getMobGriefingEvent(this.enderman.world, this.enderman)) {
                return false;
            } else {
                return this.enderman.getRNG()
                    .nextInt(2000) == 0;
            }
        }
        ...
        public void updateTask() {
            ...
            if (iblockstate2 != null
                ...
                .onBlockPlace(
                    enderman,
                    new net.minecraftforge.common.util.BlockSnapshot(world, blockpos, iblockstate2),
    ...
    static class AITakeBlock extends EntityAIBase {
        ...
        public void updateTask() {
            ...
            RayTraceResult raytraceresult = world.rayTraceBlocks(
                ...
                true,
                false);
            boolean flag = raytraceresult != null && raytraceresult.getBlockPos()
                .equals(blockpos);

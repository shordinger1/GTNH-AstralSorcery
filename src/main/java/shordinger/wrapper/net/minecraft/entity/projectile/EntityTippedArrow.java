...
public class EntityTippedArrow extends EntityArrow {
    ...
    private static final DataParameter<Integer> COLOR = EntityDataManager
        .<Integer>createKey(EntityTippedArrow.class, DataSerializers.VARINT);
    ...
    public void addEffect(PotionEffect effect) {
        ...
        this.getDataManager()
            .set(
                COLOR,
                Integer.valueOf(
                    PotionUtils.getPotionColorFromEffectList(
    ...
    public void onUpdate() {
        ...
        } else if (this.inGround && this.timeInGround != 0
            && !this.customPotionEffects.isEmpty()

...
public class EntityGhast extends EntityFlying implements IMob {
    ...
    private static final DataParameter<Boolean> ATTACKING = EntityDataManager
        .<Boolean>createKey(EntityGhast.class, DataSerializers.BOOLEAN);
    /**
    ...
    static class AILookAround extends EntityAIBase {
        ...
        public void updateTask() {
            if (this.parentEntity.getAttackTarget() == null) {
                this.parentEntity.rotationYaw = -((float) MathHelper
                    .atan2(this.parentEntity.motionX, this.parentEntity.motionZ)) * (180F / (float) Math.PI);
    ...
    static class GhastMoveHelper extends EntityMoveHelper {
        ...
        public void onUpdateMoveHelper() {
            if (this.action == EntityMoveHelper.Action.MOVE_TO) {
                ...
                if (this.courseChangeCooldown-- <= 0) {
                    this.courseChangeCooldown += this.parentEntity.getRNG()
                        .nextInt(5) + 2;
        ...
        private boolean isNotColliding(double x, double y, double z, double p_179926_7_) {
            ...
            for (int i = 1; (double) i < p_179926_7_; ++i) {
                ...
                if (!this.parentEntity.world.getCollisionBoxes(this.parentEntity, axisalignedbb)
                    .isEmpty()) {
                    return false;
                }
            }

                ...
                for (int i = 0; i < inventorybasic.getSizeInventory(); ++i) {
                    ...
                    if (!itemstack.isEmpty()) {
                        if (itemstack.getItem() == Items.WHEAT_SEEDS) {
                            ...
                            if (((net.minecraftforge.common.IPlantable) itemstack.getItem())
                                .getPlantType(world, blockpos) == net.minecraftforge.common.EnumPlantType.Crop) {
                                world.setBlockState(
                                    blockpos,
                                    ((net.minecraftforge.common.IPlantable) itemstack.getItem())
                                        .getPlant(world, blockpos),
                                    3);
                                flag = true;
                            }
                        }

...
public class EntityWitch extends EntityMob implements IRangedAttackMob {
    ...
    private static final AttributeModifier MODIFIER = (new AttributeModifier(
        ...
        -0.25D,
        0)).setSaved(false);
    private static final DataParameter<Boolean> IS_DRINKING = EntityDataManager
        .<Boolean>createKey(EntityWitch.class, DataSerializers.BOOLEAN);
    /**
    ...
    protected void entityInit() {
        super.entityInit();
        this.getDataManager()
            .register(IS_DRINKING, Boolean.valueOf(false));
    }
    ...
    public void setDrinkingPotion(boolean drinkingPotion) {
        this.getDataManager()
            .set(IS_DRINKING, Boolean.valueOf(drinkingPotion));
    }

    public boolean isDrinkingPotion() {
        return ((Boolean) this.getDataManager()
            .get(IS_DRINKING)).booleanValue();
    }
        ...
        if (!this.world.isRemote) {
            if (this.isDrinkingPotion()) {
                ...
                if (this.rand.nextFloat() < 0.15F && this.isInsideOfMaterial(Material.WATER)
                    ...
                    && (this.isBurning() || this.getLastDamageSource() != null && this.getLastDamageSource()
                    .isFireDamage())
                ...
                if (potiontype != null) {
                    ...
                    this.potionUseTimer = this.getHeldItemMainhand()
        ...
        if (id == 15) {
            for (int i = 0; i < this.rand.nextInt(35) + 10; ++i) {
                this.world.spawnParticle(
                    ...
                    this.posZ + this.rand.nextGaussian() * 0.12999999523162842D,
                    0.0D,
                    0.0D,
                    0.0D);
            }

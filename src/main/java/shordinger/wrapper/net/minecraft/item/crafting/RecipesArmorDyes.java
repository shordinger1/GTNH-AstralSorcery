...
public class RecipesArmorDyes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe>
    implements IRecipe {
        ...
        for (int k = 0; k < inv.getSizeInventory(); ++k) {
            ...
            if (!itemstack1.isEmpty()) {
                if (itemstack1.getItem() instanceof ItemArmor) {
                    ...
                    float[] afloat = net.minecraftforge.oredict.DyeUtils.colorFromStack(itemstack1)
                        .get()

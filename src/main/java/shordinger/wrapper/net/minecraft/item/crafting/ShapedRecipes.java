...
public class ShapedRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe>
    ...
    private static NonNullList<Ingredient> deserializeIngredients(String[] p_192402_0_,
        ...
        NonNullList<Ingredient> nonnulllist = NonNullList
            .<Ingredient>withSize(p_192402_2_ * p_192402_3_, Ingredient.EMPTY);
    ...
    private static Map<String, Ingredient> deserializeKey(JsonObject p_192408_0_) {
        ...
        for (Entry<String, JsonElement> entry : p_192408_0_.entrySet()) {
            if (((String) entry.getKey()).length() != 1) {
                throw new JsonSyntaxException(
                    "Invalid key entry: '" + (String) entry.getKey()

...
public class ItemShears extends Item {
    ...
    public boolean onBlockDestroyed(ItemStack stack, World worldIn, IBlockState state, BlockPos pos,
        ...
        return state.getMaterial() != Material.LEAVES && block != Blocks.WEB
            && block != Blocks.TALLGRASS
            && block != Blocks.VINE
            && block != Blocks.TRIPWIRE
            && block != Blocks.WOOL ? super.onBlockDestroyed(stack, worldIn, state, pos, entityLiving) : true;
    }
    ...
    public boolean onBlockStartBreak(ItemStack itemstack, BlockPos pos,
        ...
        Block block = player.world.getBlockState(pos)
            .getBlock();
        if (block instanceof net.minecraftforge.common.IShearable) {
            ...
            if (target.isShearable(itemstack, player.world, pos)) {
                ...
                player.world.setBlockState(pos, Blocks.AIR.getDefaultState(), 11); // TODO: Move to IShearable
                // implementors in 1.12+
                return true;
            }
        }
        return false;

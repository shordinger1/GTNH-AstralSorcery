...
public class ShapelessRecipes extends net.minecraftforge.registries.IForgeRegistryEntry.Impl<IRecipe>
    implements IRecipe {
    ...
    public ShapelessRecipes(String group, ItemStack output, NonNullList<Ingredient> ingredients) {
        ...
        boolean simple = true;
        for (Ingredient i : ingredients) simple &= i.isSimple();
    ...
    public boolean matches(InventoryCrafting inv, World worldIn) {
        ...
        if (ingredientCount != this.recipeItems.size()) return false;

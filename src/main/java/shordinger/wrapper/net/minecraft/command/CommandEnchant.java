...
public class CommandEnchant extends CommandBase {
                ...
                if (itemstack.isEmpty()) {
                    ...
                    if (itemstack.hasTagCompound()) {
                        ...
                        for (int j = 0; j < nbttaglist.tagCount(); ++j) {
                            int k = nbttaglist.getCompoundTagAt(j)
                                .getShort("id");
                            ...
                            if (Enchantment.getEnchantmentByID(k) != null) {
                                ...
                                if (!enchantment.isCompatibleWith(enchantment1)) {
                                    throw new CommandException(
                                        ...
                                        new Object[]{enchantment.getTranslatedName(i),
                                            enchantment1.getTranslatedName(
                                                nbttaglist.getCompoundTagAt(j)
                                                    .getShort("lvl"))});
                                }
                            }
                        }
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args,
        ...
        if (args.length == 1) {
            ...
            return args.length == 2 ? getListOfStringsMatchingLastWord(args, Enchantment.REGISTRY.getKeys())

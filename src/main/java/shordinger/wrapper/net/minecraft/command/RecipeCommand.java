...
public class RecipeCommand extends CommandBase {
            ...
            if (!flag && !flag1) {
                ...
                for (EntityPlayerMP entityplayermp : getPlayers(server, sender, args[1])) {
                    if ("*".equals(args[2])) {
                        ...
                        if (flag == entityplayermp.getRecipeBook()
                            .isUnlocked(irecipe)) {
                            String s = flag ? "commands.recipe.alreadyHave" : "commands.recipe.dontHave";
                            throw new CommandException(
                                s,
                                new Object[]{entityplayermp.getName(), irecipe.getRecipeOutput()
                                    .getDisplayName()});
                        }
                        ...
                        if (flag) {
                            ...
                            notifyCommandListener(
                                ...
                                new Object[]{irecipe.getRecipeOutput()
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args,
        ...
        if (args.length == 1) {
            ...
            return args.length == 3 ? getListOfStringsMatchingLastWord(args, CraftingManager.REGISTRY.getKeys())

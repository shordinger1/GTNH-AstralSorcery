...
import shordinger.wrapper.net.minecraft.command.server.CommandBanIp;
import shordinger.wrapper.net.minecraft.command.server.CommandBanPlayer;
import shordinger.wrapper.net.minecraft.command.server.CommandBroadcast;
import shordinger.wrapper.net.minecraft.command.server.CommandDeOp;
import shordinger.wrapper.net.minecraft.command.server.CommandEmote;
import shordinger.wrapper.net.minecraft.command.server.CommandListBans;
import shordinger.wrapper.net.minecraft.command.server.CommandListPlayers;
import shordinger.wrapper.net.minecraft.command.server.CommandMessage;
import shordinger.wrapper.net.minecraft.command.server.CommandMessageRaw;
import shordinger.wrapper.net.minecraft.command.server.CommandOp;
import shordinger.wrapper.net.minecraft.command.server.CommandPardonIp;
import shordinger.wrapper.net.minecraft.command.server.CommandPardonPlayer;
import shordinger.wrapper.net.minecraft.command.server.CommandPublishLocalServer;
import shordinger.wrapper.net.minecraft.command.server.CommandSaveAll;
import shordinger.wrapper.net.minecraft.command.server.CommandSaveOff;
import shordinger.wrapper.net.minecraft.command.server.CommandSaveOn;
import shordinger.wrapper.net.minecraft.command.server.CommandScoreboard;
import shordinger.wrapper.net.minecraft.command.server.CommandSetBlock;
import shordinger.wrapper.net.minecraft.command.server.CommandSetDefaultSpawnpoint;
import shordinger.wrapper.net.minecraft.command.server.CommandStop;
import shordinger.wrapper.net.minecraft.command.server.CommandSummon;
import shordinger.wrapper.net.minecraft.command.server.CommandTeleport;
import shordinger.wrapper.net.minecraft.command.server.CommandTestFor;
import shordinger.wrapper.net.minecraft.command.server.CommandTestForBlock;
import shordinger.wrapper.net.minecraft.command.server.CommandWhitelist;
import shordinger.wrapper.net.minecraft.entity.player.EntityPlayer;
import shordinger.wrapper.net.minecraft.network.rcon.RConConsoleSource;
...
public class ServerCommandManager extends CommandHandler implements ICommandListener {
    ...
    public void notifyListener(ICommandSender sender, ICommand command, int flags, String translationKey,
        ...
        ITextComponent itextcomponent = new TextComponentTranslation(
            "chat.type.admin",
            new Object[]{sender.getName(), new TextComponentTranslation(translationKey, translationArgs)});
        ...
        if (flag) {
            for (EntityPlayer entityplayer : minecraftserver.getPlayerList()
                .getPlayers()) {
                if (entityplayer != sender && minecraftserver.getPlayerList()
                    .canSendCommands(entityplayer.getGameProfile()) && command.checkPermission(this.server, sender)) {
        ...
        if (sender != minecraftserver && minecraftserver.worlds[0].getGameRules()
            .getBoolean("logAdminCommands")) {
            minecraftserver.sendMessage(itextcomponent);
        }

        boolean flag3 = minecraftserver.worlds[0].getGameRules()

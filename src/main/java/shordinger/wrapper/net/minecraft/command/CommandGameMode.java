...
public class CommandGameMode extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (args.length <= 0) {
            ...
            EntityPlayer entityplayer = args.length >= 2 ? getPlayer(server, sender, args[1])
            ...
            if (sender.getEntityWorld()
                ...
                entityplayer
                    .sendMessage(new TextComponentTranslation("gameMode.changed", new Object[]{itextcomponent}));
            }
            ...
            if (entityplayer == sender) {
                ...
                notifyCommandListener(
                    ...
                    new Object[]{entityplayer.getName(), itextcomponent});
            }
        }
    }
     ...
     */
    protected GameType getGameModeFromCommand(ICommandSender sender, String gameModeString)
        ...
        return gametype == GameType.NOT_SET
            ? WorldSettings.getGameTypeById(parseInt(gameModeString, 0, GameType.values().length - 2))
            : gametype;
    }

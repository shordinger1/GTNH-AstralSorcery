...
import shordinger.wrapper.net.minecraft.advancements.CriterionProgress;
...
public class AdvancementCommand extends CommandBase {
            ...
            if (p_193516_6_ == AdvancementCommand.Mode.ONLY && args.length == 5) {
                ...
                if (!advancement.getCriteria()
                    ...
                    throw new CommandException(
                        ...
                        new Object[]{advancement.getId(), args[4]});
                }

                if (!p_193516_5_.performCriterion(player, advancement, s)) {
                    throw new CommandException(
                        p_193516_5_.baseTranslationKey + ".criterion.failed",
                        new Object[]{advancement.getId(), player.getName(), s});
                }

                notifyCommandListener(
                    sender,
                    this,
                    p_193516_5_.baseTranslationKey + ".criterion.success",
                    new Object[]{advancement.getId(), player.getName(), s});
            } else {
                if (args.length != 4) {
                    throw p_193516_6_.usage(p_193516_5_);
    ...
    private List<Advancement> getAdvancements(Advancement p_193514_1_, AdvancementCommand.Mode p_193514_2_) {
        ...
        if (p_193514_2_.parents) {
            for (Advancement advancement = p_193514_1_.getParent(); advancement
                != null; advancement = advancement.getParent()) {
    ...
    private void testCriterion(ICommandSender p_192554_1_, EntityPlayerMP p_192554_2_, Advancement p_192554_3_,
        ...
        if (criterionprogress == null) {
            throw new CommandException(
                "commands.advancement.criterionNotFound",
                new Object[]{p_192554_3_.getId(), p_192554_4_});
        } else if (!criterionprogress.isObtained()) {
            throw new CommandException(
                "commands.advancement.test.criterion.notDone",
                new Object[]{p_192554_2_.getName(), p_192554_3_.getId(), p_192554_4_});
        } else {
            notifyCommandListener(
                p_192554_1_,
                this,
    ...
    private void testAdvancement(ICommandSender p_192552_1_, EntityPlayerMP p_192552_2_, Advancement p_192552_3_)
        ...
        if (!advancementprogress.isDone()) {
            throw new CommandException(
                "commands.advancement.test.advancement.notDone",
                new Object[]{p_192552_2_.getName(), p_192552_3_.getId()});
        } else {
            notifyCommandListener(
                p_192552_1_,
                this,
    ...
    private List<ResourceLocation> getAdvancementNames(MinecraftServer server) {
        ...
        for (Advancement advancement : server.getAdvancementManager()
            .getAdvancements()) {
    ...
    static enum ActionType {
        ...
        GRANT("grant") {
            protected boolean perform(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
                AdvancementProgress advancementprogress = p_193537_1_.getAdvancements()
                    .getProgress(p_193537_2_);

                if (advancementprogress.isDone()) {
                    return false;
                } else {
                    for (String s : advancementprogress.getRemaningCriteria()) {
                        p_193537_1_.getAdvancements()
                            .grantCriterion(p_193537_2_, s);
                    }
            ...
            protected boolean performCriterion(EntityPlayerMP p_193535_1_, Advancement p_193535_2_,
                                               String p_193535_3_) {
                return p_193535_1_.getAdvancements()
                    .grantCriterion(p_193535_2_, p_193535_3_);
            }
        },
        REVOKE("revoke") {
            protected boolean perform(EntityPlayerMP p_193537_1_, Advancement p_193537_2_) {
            ...
            protected boolean performCriterion(EntityPlayerMP p_193535_1_, Advancement p_193535_2_,
                                               String p_193535_3_) {
                return p_193535_1_.getAdvancements()
                    .revokeCriterion(p_193535_2_, p_193535_3_);
            }
        };
        ...
        protected abstract boolean performCriterion(EntityPlayerMP p_193535_1_, Advancement p_193535_2_,
                                                    String p_193535_3_);
    }
    ...
    static enum Mode {
        ...
        void success(ICommandSender sender, AdvancementCommand p_193546_2_, AdvancementCommand.ActionType type,
            ...
            CommandBase.notifyCommandListener(
                sender,
                p_193546_2_,
                type.baseTranslationKey + "." + this.name + ".success",
                args);
        }

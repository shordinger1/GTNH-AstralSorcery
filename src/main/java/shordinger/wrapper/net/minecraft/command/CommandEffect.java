...
public class CommandEffect extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 2) {
            ...
            EntityLivingBase entitylivingbase = (EntityLivingBase) getEntity(
                server,
                sender,
                args[0],
            ...
            if ("clear".equals(args[1])) {
                if (entitylivingbase.getActivePotionEffects()
                    .isEmpty()) {
                ...
                if (potion == null) {
                    ...
                    if (j > 0) {
                        ...
                        notifyCommandListener(
                            ...
                            new Object[]{new TextComponentTranslation(potioneffect.getEffectName(), new Object[0]),
                                Potion.getIdFromPotion(potion), k, entitylivingbase.getName(), j});
                        ...
                        notifyCommandListener(
                            ...
                            new Object[]{new TextComponentTranslation(potion.getName(), new Object[0]),
    ...
    public List<String> getTabCompletions(MinecraftServer server, ICommandSender sender, String[] args,
        ...
        if (args.length == 1) {
            ...
            return args.length == 5 ? getListOfStringsMatchingLastWord(args, new String[]{"true", "false"})

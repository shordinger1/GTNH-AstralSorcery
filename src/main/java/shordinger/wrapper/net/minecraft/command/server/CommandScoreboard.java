...
import shordinger.wrapper.net.minecraft.command.SyntaxErrorException;
...
public class CommandScoreboard extends CommandBase {
    ...
    private boolean handleUserWildcards(MinecraftServer server, ICommandSender sender, String[] args)
            ...
            for (String s1 : list1) {
                ...
                try {
                    ...
                    TextComponentTranslation textcomponenttranslation = new TextComponentTranslation(
                        ...
                        commandexception.getErrorObjects());
    ...
    protected ScoreObjective convertToObjective(String name, boolean forWrite, MinecraftServer server)
        throws CommandException {
        ...
        } else if (forWrite && scoreobjective.getCriteria()
            .isReadOnly()) {
    ...
    protected void addObjective(ICommandSender sender, String[] commandArgs, int argStartIndex, MinecraftServer server)
        throws CommandException {
    ...
    protected void addTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
    ...
    protected void setTeamOption(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        ...
        if (scoreplayerteam != null) {
            ...
            if (!"color".equalsIgnoreCase(s) && !"friendlyfire".equalsIgnoreCase(s)
                && !"seeFriendlyInvisibles".equalsIgnoreCase(s)
                && !"nametagVisibility".equalsIgnoreCase(s)
                && !"deathMessageVisibility".equalsIgnoreCase(s)
                && !"collisionRule".equalsIgnoreCase(s)) {
                throw new WrongUsageException("commands.scoreboard.teams.option.usage", new Object[0]);
                ...
                if ("color".equalsIgnoreCase(s)) {
                    ...
                    if (!"nametagVisibility".equalsIgnoreCase(s) && !"deathMessageVisibility".equalsIgnoreCase(s)) {
                        if ("collisionRule".equalsIgnoreCase(s)) {
                            throw new WrongUsageException(
                                "commands.scoreboard.teams.option.noValue",
                                new Object[]{s, joinNiceString(Team.CollisionRule.getNames())});
                        } else {
                            throw new WrongUsageException("commands.scoreboard.teams.option.usage", new Object[0]);
                        }
                    } else {
                        throw new WrongUsageException(
                            "commands.scoreboard.teams.option.noValue",
                            new Object[]{s, joinNiceString(Team.EnumVisible.getNames())});
                    }
                } else {
                    throw new WrongUsageException(
                        "commands.scoreboard.teams.option.noValue",
                        new Object[]{s, joinNiceStringFromCollection(Arrays.asList("true", "false"))});
                }
            } else {
                ...
                if ("color".equalsIgnoreCase(s)) {
                    ...
                    if (textformatting == null || textformatting.isFancyStyling()) {
                        throw new WrongUsageException(
                            "commands.scoreboard.teams.option.noValue",
                            new Object[]{s,
                                joinNiceStringFromCollection(TextFormatting.getValidValues(true, false))});
                    }
                ...
                notifyCommandListener(
                    ...
                    new Object[]{s, scoreplayerteam.getName(), s1});
            }
        }
    }

    protected void removeTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        ScorePlayerTeam scoreplayerteam = this.convertToTeam(args[startIndex], server);
        ...
        if (scoreplayerteam != null) {
            ...
            notifyCommandListener(
                ...
                new Object[]{scoreplayerteam.getName()});
        }
    }

    protected void listTeams(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        ...
        if (args.length > startIndex) {
            ...
            TextComponentTranslation textcomponenttranslation = new TextComponentTranslation(
                ...
                new Object[]{collection.size(), scoreplayerteam.getName()});
            textcomponenttranslation.getStyle()
            ...
            for (ScorePlayerTeam scoreplayerteam1 : collection1) {
                sender.sendMessage(
                    new TextComponentTranslation(
                        ...
                        new Object[]{scoreplayerteam1.getName(), scoreplayerteam1.getDisplayName(),
                            scoreplayerteam1.getMembershipCollection()
                                .size()}));
            }
        }
    }

    protected void joinTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        String s = args[startIndex++];
    ...
    protected void leaveTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        Set<String> set = Sets.<String>newHashSet();
        Set<String> set1 = Sets.<String>newHashSet();
    ...
    protected void emptyTeam(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        ScorePlayerTeam scoreplayerteam = this.convertToTeam(args[startIndex], server);
    ...
    protected void setDisplayObjective(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        String s = args[startIndex++];
    ...
    protected void listPlayers(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
            ...
            for (Score score : map.values()) {
                sender.sendMessage(
                    new TextComponentTranslation(
                        ...
                        new Object[]{score.getScorePoints(), score.getObjective()
                            .getDisplayName(),
                            score.getObjective()
                                .getName()}));
            }
    ...
    protected void addPlayerScore(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        ...
        if (s1.length() > 40) {
            throw new SyntaxErrorException(
                "commands.scoreboard.players.name.tooLong",
    ...
    protected void resetPlayerScore(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        String s = getEntityName(server, sender, args[startIndex++]);
    ...
    protected void enablePlayerTrigger(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
    ...
    protected void testPlayerScore(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        String s = getEntityName(server, sender, args[startIndex++]);
        ...
        if (s.length() > 40) {
            ...
            if (!scoreboard.entityHasObjective(s, scoreobjective)) {
                ...
                ++startIndex;
                int j = startIndex < args.length && !args[startIndex].equals("*") ? parseInt(args[startIndex], i)
                    : Integer.MAX_VALUE;
                Score score = scoreboard.getOrCreateScore(s, scoreobjective);
    ...
    protected void applyPlayerOperation(ICommandSender sender, String[] args, int startIndex, MinecraftServer server)
        throws CommandException {
        Scoreboard scoreboard = this.getScoreboard(server);
        String s = getEntityName(server, sender, args[startIndex++]);
        ScoreObjective scoreobjective = this.convertToObjective(args[startIndex++], true, server);
    ...
    protected void applyPlayerTag(MinecraftServer server, ICommandSender sender, String[] args, int startIndex)
        throws CommandException {
        String s = getEntityName(server, sender, args[startIndex]);
        ...
        if ("list".equals(s1)) {
            if (!set.isEmpty()) {
                TextComponentTranslation textcomponenttranslation = new TextComponentTranslation(
                    "commands.scoreboard.players.tag.list",
                    new Object[]{s});
                textcomponenttranslation.getStyle()
                    .setColor(TextFormatting.DARK_GREEN);
                sender.sendMessage(textcomponenttranslation);
            ...
            if (args.length > startIndex) {
                try {
                    ...
                    throw new CommandException(
                        "commands.scoreboard.players.tag.tagError",
                        new Object[]{nbtexception.getMessage()});
                }
            }
            ...
            if ("add".equals(s1)) {
                if (!entity.addTag(s2)) {
                    throw new CommandException(
                        "commands.scoreboard.players.tag.tooMany",
                        new Object[]{Integer.valueOf(1024)});
                }
        ...
        if (args.length == 1) {
            ...
            if ("objectives".equalsIgnoreCase(args[0])) {
                ...
                if (args.length == 2) {
                    return getListOfStringsMatchingLastWord(
                        args,
                        new String[]{"set", "add", "remove", "reset", "list", "enable", "test", "operation", "tag"});
                }
                ...
                if ("join".equalsIgnoreCase(args[1])) {
                    ...
                    if (!"empty".equalsIgnoreCase(args[1]) && !"list".equalsIgnoreCase(args[1])
                        && !"remove".equalsIgnoreCase(args[1])) {
                        if ("option".equalsIgnoreCase(args[1])) {
                            if (args.length == 3) {
                                return getListOfStringsMatchingLastWord(
                            ...
                            if (args.length == 5) {
                                if ("color".equalsIgnoreCase(args[3])) {
                                    return getListOfStringsMatchingLastWord(
                                        args,
                                        TextFormatting.getValidValues(true, false));
                                }

                                if ("nametagVisibility".equalsIgnoreCase(args[3])
                                    || "deathMessageVisibility".equalsIgnoreCase(args[3])) {
                                ...
                                if ("friendlyfire".equalsIgnoreCase(args[3])
                                    || "seeFriendlyInvisibles".equalsIgnoreCase(args[3])) {
    ...
    protected List<String> getObjectiveNames(boolean writableOnly, MinecraftServer server) {
        Collection<ScoreObjective> collection = this.getScoreboard(server)
            .getScoreObjectives();
        List<String> list = Lists.<String>newArrayList();

        for (ScoreObjective scoreobjective : collection) {
            if (!writableOnly || !scoreobjective.getCriteria()
                .isReadOnly()) {

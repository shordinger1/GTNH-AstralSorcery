            ...
            if ("on".equals(args[0])) {
                ...
                sender.sendMessage(
                    new TextComponentTranslation(
                        ...
                        new Object[]{server.getPlayerList()
                            .getWhitelistedPlayerNames().length,
                            server.getPlayerList()
                                .getAvailablePlayerDat().length}));
                String[] astring = server.getPlayerList()
                ...
                GameProfile gameprofile = server.getPlayerProfileCache()
                    .getGameProfileForUsername(args[1]);
                ...
                GameProfile gameprofile1 = server.getPlayerList()
                ...
                server.getPlayerList()
                    .removePlayerFromWhitelist(gameprofile1);

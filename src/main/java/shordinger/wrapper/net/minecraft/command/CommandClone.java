...
public class CommandClone extends CommandBase {
    ...
    public void execute(MinecraftServer server, ICommandSender sender, String[] args) throws CommandException {
        if (args.length < 9) {
            ...
            StructureBoundingBox structureboundingbox1 = new StructureBoundingBox(
                blockpos2,
                        ...
                        if (world.isAreaLoaded(structureboundingbox) && world.isAreaLoaded(structureboundingbox1)) {
                                    ...
                                    for (int l = structureboundingbox.minX; l <= structureboundingbox.maxX; ++l) {
                                        ...
                                        if ((!flag1 || iblockstate.getBlock() != Blocks.AIR)
                                            ...
                                            if (tileentity != null) {
                                                ...
                                                list1.add(
                                                    new CommandClone.StaticCloneData(
                                                        blockpos5,
                                                        iblockstate,
                                                        nbttagcompound));
                            ...
                            for (CommandClone.StaticCloneData commandclone$staticclonedata1 : list3) {
                                if (world.setBlockState(
                                    commandclone$staticclonedata1.pos,
                                    commandclone$staticclonedata1.blockState,
                                    2)) {
                                    ++i;
                                }
                            }
                            ...
                            for (CommandClone.StaticCloneData commandclone$staticclonedata2 : list1) {
                                ...
                                if (commandclone$staticclonedata2.nbt != null && tileentity3 != null) {
                                    commandclone$staticclonedata2.nbt
                                        .setInteger("x", commandclone$staticclonedata2.pos.getX());
                                    commandclone$staticclonedata2.nbt
                                        .setInteger("y", commandclone$staticclonedata2.pos.getY());
                                    commandclone$staticclonedata2.nbt
                                        .setInteger("z", commandclone$staticclonedata2.pos.getZ());
                                    tileentity3.readFromNBT(commandclone$staticclonedata2.nbt);
                                    tileentity3.markDirty();
                                }

                                world.setBlockState(
                                    commandclone$staticclonedata2.pos,
                                    commandclone$staticclonedata2.blockState,
                                    2);
                            }

                            for (CommandClone.StaticCloneData commandclone$staticclonedata3 : list4) {
                                world.notifyNeighborsRespectDebug(
                                    commandclone$staticclonedata3.pos,
                                ...
                                for (NextTickListEntry nextticklistentry : list5) {
                                    if (structureboundingbox.isVecInside(nextticklistentry.position)) {
                                        ...
                                        world.scheduleBlockUpdate(
                                            ...
                                            (int) (nextticklistentry.scheduledTime - world.getWorldInfo()
                                                .getWorldTotalTime()),

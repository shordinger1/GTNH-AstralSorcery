...
public class FunctionObject {
    ...
    public static FunctionObject create(FunctionManager functionManagerIn, List<String> commands) {
        ...
        for (String s : commands) {
            ...
            if (!s.startsWith("#") && !s.isEmpty()) {
                ...
                if (!functionManagerIn.getCommandManager()
                    .getCommands()
                    .containsKey(s1)) {
                    if (s1.startsWith("//")) {
    ...
    public static class CacheableFunction {
        ...
        public static final FunctionObject.CacheableFunction EMPTY = new FunctionObject.CacheableFunction(
            ...
            if (functionobject != null) {
                ...
                for (int k = j - 1; k >= 0; --k) {
                    commandQueue.addFirst(
                        new FunctionManager.QueuedCommand(functionManagerIn, sender, afunctionobject$entry[k]));
                }
            }
        }

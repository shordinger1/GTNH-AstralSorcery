...
public class NBTTagCompound extends NBTBase {
    ...
    public String toString() {
        ...
        for (String s : collection) {
            ...
            stringbuilder.append(handleEscape(s))
                .append(':')
                .append(this.tagMap.get(s));
        }
    ...
    protected static String handleEscape(String p_193582_0_) {
        return SIMPLE_VALUE.matcher(p_193582_0_)
            .matches() ? p_193582_0_ : NBTTagString.quoteAndEscape(p_193582_0_);
    }
}

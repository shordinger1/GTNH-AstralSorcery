...
public class PathNavigateGround extends PathNavigate {
    ...
    public Path getPathToPos(BlockPos pos) {
        if (this.world.getBlockState(pos)
            ...
            for (blockpos = pos.down(); blockpos.getY() > 0 && this.world.getBlockState(blockpos)
            ...
            while (blockpos.getY() < this.world.getHeight() && this.world.getBlockState(blockpos)
                .getMaterial() == Material.AIR) {
        ...
        if (!this.world.getBlockState(pos)
            ...
            for (blockpos1 = pos.up(); blockpos1.getY() < this.world.getHeight() && this.world.getBlockState(blockpos1)
                .getMaterial()
    ...
    private int getPathablePosY() {
        if (this.entity.isInWater() && this.getCanSwim()) {
            ...
            Block block = this.world
                .getBlockState(new BlockPos(MathHelper.floor(this.entity.posX), i, MathHelper.floor(this.entity.posZ)))
                .getBlock();
            int j = 0;
    ...
    protected void removeSunnyPath() {
        ...
        if (this.shouldAvoidSun) {
            if (this.world.canSeeSky(
                new BlockPos(
                    MathHelper.floor(this.entity.posX),
                    (int) (this.entity.getEntityBoundingBox().minY + 0.5D),
     ...
     */
    private boolean isSafeToStandAt(int x, int y, int z, int sizeX, int sizeY, int sizeZ, Vec3d vec31,
                                    double p_179683_8_, double p_179683_10_) {
        int i = x - sizeX / 2;
        int j = z - sizeZ / 2;
            ...
            for (int k = i; k < i + sizeX; ++k) {
                for (int l = j; l < j + sizeZ; ++l) {
                    ...
                    if (d0 * p_179683_8_ + d1 * p_179683_10_ >= 0.0D) {
                        ...
                        pathnodetype = this.nodeProcessor
                            .getPathNodeType(this.world, k, y, l, this.entity, sizeX, sizeY, sizeZ, true, true);
     ...
     */
    private boolean isPositionClear(int x, int y, int z, int sizeX, int sizeY, int sizeZ, Vec3d p_179692_7_,
                                    double p_179692_8_, double p_179692_10_) {
        for (BlockPos blockpos : BlockPos
            .getAllInBox(new BlockPos(x, y, z), new BlockPos(x + sizeX - 1, y + sizeY - 1, z + sizeZ - 1))) {

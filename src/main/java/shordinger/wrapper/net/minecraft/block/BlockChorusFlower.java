...
public class BlockChorusFlower extends Block {
    ...
    public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
        if (!this.canSurvive(worldIn, pos)) {
            ...
            if (worldIn.isAirBlock(blockpos) && blockpos.getY() < 256) {
                ...
                if (i < 5 && net.minecraftforge.common.ForgeHooks
                    .onCropsGrowPre(worldIn, blockpos, state, rand.nextInt(1) == 0)) {
                    boolean flag = false;
                    boolean flag1 = false;
                    ...
                    if (block == Blocks.END_STONE) {
                        ...
                        for (int k = 0; k < 4; ++k) {
                            Block block1 = worldIn.getBlockState(pos.down(j + 1))
                                .getBlock();
    ...
    private void placeGrownFlower(World worldIn, BlockPos pos, int age) {
        worldIn.setBlockState(
            ...
            this.getDefaultState()
                .withProperty(AGE, Integer.valueOf(age)),
            2);
    ...
    private void placeDeadFlower(World worldIn, BlockPos pos) {
        worldIn.setBlockState(
            pos,
            this.getDefaultState()
                .withProperty(AGE, Integer.valueOf(5)),
            2);
    ...
    private static void growTreeRecursive(World worldIn, BlockPos p_185601_1_, Random rand, BlockPos p_185601_3_,
        ...
        if (p_185601_5_ < 4) {
            ...
            for (int k = 0; k < l; ++k) {
                EnumFacing enumfacing = EnumFacing.Plane.HORIZONTAL.random(rand);
                BlockPos blockpos1 = p_185601_1_.up(i)
                    .offset(enumfacing);

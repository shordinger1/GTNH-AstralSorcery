...
public class BlockChorusPlant extends Block {
    ...
    public IBlockState getActualState(IBlockState state, IBlockAccess worldIn, BlockPos pos) {
        Block block = worldIn.getBlockState(pos.down())
            .getBlock();
        Block block1 = worldIn.getBlockState(pos.up())
            .getBlock();
        Block block2 = worldIn.getBlockState(pos.north())
            .getBlock();
        Block block3 = worldIn.getBlockState(pos.east())
            .getBlock();
        Block block4 = worldIn.getBlockState(pos.south())
            .getBlock();
        Block block5 = worldIn.getBlockState(pos.west())
            .getBlock();
        return state
            .withProperty(
                DOWN,
                Boolean.valueOf(block == this || block == Blocks.CHORUS_FLOWER || block == Blocks.END_STONE))
            .withProperty(UP, Boolean.valueOf(block1 == this || block1 == Blocks.CHORUS_FLOWER))
            .withProperty(NORTH, Boolean.valueOf(block2 == this || block2 == Blocks.CHORUS_FLOWER))
            .withProperty(EAST, Boolean.valueOf(block3 == this || block3 == Blocks.CHORUS_FLOWER))
            .withProperty(SOUTH, Boolean.valueOf(block4 == this || block4 == Blocks.CHORUS_FLOWER))
    ...
    public boolean canSurviveAt(World wordIn, BlockPos pos) {
        ...
        for (EnumFacing enumfacing : EnumFacing.Plane.HORIZONTAL) {
            ...
            Block block = wordIn.getBlockState(blockpos)
                .getBlock();
            ...
            if (block == this) {
                ...
                Block block1 = wordIn.getBlockState(blockpos.down())
                    .getBlock();
        ...
        Block block2 = wordIn.getBlockState(pos.down())
            .getBlock();
    ...
    public boolean shouldSideBeRendered(IBlockState blockState, IBlockAccess blockAccess, BlockPos pos,
                                        EnumFacing side) {
        Block block = blockAccess.getBlockState(pos.offset(side))
            .getBlock();

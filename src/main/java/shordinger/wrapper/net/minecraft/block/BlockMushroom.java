...
public class BlockMushroom extends BlockBush implements IGrowable {
    ...
    protected static final AxisAlignedBB MUSHROOM_AABB = new AxisAlignedBB(
    ...
    public boolean canBlockStay(World worldIn, BlockPos pos, IBlockState state) {
        if (pos.getY() >= 0 && pos.getY() < 256) {
            ...
            if (iblockstate.getBlock() == Blocks.MYCELIUM) {
                ...
                return worldIn.getLight(pos) < 13 && iblockstate.getBlock()
                    .canSustainPlant(iblockstate, worldIn, pos.down(), net.minecraft.util.EnumFacing.UP, this);
            }
        } else {
            return false;
        }

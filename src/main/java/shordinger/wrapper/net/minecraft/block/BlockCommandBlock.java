...
public class BlockCommandBlock extends BlockContainer {
    ...
    public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) {
        if (!worldIn.isRemote) {
            ...
            if (tileentity instanceof TileEntityCommandBlock) {
                ...
                if (!flag1 && !tileentitycommandblock.isAuto()
                    && tileentitycommandblock.getMode() != TileEntityCommandBlock.Mode.SEQUENCE) {
                    if (flag) {
    ...
    private void execute(IBlockState p_193387_1_, World p_193387_2_, BlockPos p_193387_3_,
                         CommandBlockBaseLogic p_193387_4_, boolean p_193387_5_) {
        if (p_193387_5_) {
    ...
    public int getComparatorInputOverride(IBlockState blockState, World worldIn, BlockPos pos) {
        ...
        return tileentity instanceof TileEntityCommandBlock
            ? ((TileEntityCommandBlock) tileentity).getCommandBlockLogic()
            .getSuccessCount()
            : 0;
    }
        ...
        if (tileentity instanceof TileEntityCommandBlock) {
            ...
            if (!worldIn.isRemote) {
                ...
                if (nbttagcompound == null || !nbttagcompound.hasKey("BlockEntityTag", 10)) {
                    commandblockbaselogic.setTrackOutput(
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            ...
            .withProperty(CONDITIONAL, Boolean.valueOf((meta & 8) != 0));
    }
    ...
    private static void executeChain(World p_193386_0_, BlockPos p_193386_1_, EnumFacing p_193386_2_) {
        ...
        for (i = gamerules.getInt("maxCommandChainLength"); i--
            > 0; p_193386_2_ = (EnumFacing) iblockstate.getValue(FACING)) {

...
public class BlockWall extends Block {
    ...
    public static final PropertyEnum<BlockWall.EnumType> VARIANT = PropertyEnum.<BlockWall.EnumType>create(
        "variant",
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            .withProperty(VARIANT, BlockWall.EnumType.byMetadata(meta));
    }
    ...
    private boolean canWallConnectTo(IBlockAccess world, BlockPos pos, EnumFacing facing) {
        ...
        Block block = world.getBlockState(other)
            .getBlock();

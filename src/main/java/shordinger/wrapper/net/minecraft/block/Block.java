...
public class Block extends net.minecraft.block.Block {
    ...
    public static final RegistryNamespaced REGISTRY = blockRegistry;
    ...
    protected static boolean isExceptionBlockForAttaching(Block attachBlock) {
        return attachBlock instanceof BlockShulkerBox || attachBlock instanceof BlockLeaves
            || attachBlock instanceof BlockTrapDoor
            || attachBlock == Blocks.BEACON
            || attachBlock == Blocks.CAULDRON
            || attachBlock == Blocks.GLASS
            || attachBlock == Blocks.GLOWSTONE
            || attachBlock == Blocks.ICE
            || attachBlock == Blocks.SEA_LANTERN
    ...
    protected static boolean isExceptBlockForAttachWithPiston(Block attachBlock) {
        return isExceptionBlockForAttaching(attachBlock) || attachBlock == Blocks.PISTON
            || attachBlock == Blocks.STICKY_PISTON
            || attachBlock == Blocks.PISTON_HEAD;
    }
    ...
    public boolean isBlockNormalCube(IBlockState state) {
        return state.getMaterial()
            .blocksMovement() && state.isFullCube();
    }
    ...
    public boolean causesSuffocation(IBlockState state) {
        return this.blockMaterial.blocksMovement() && this.getDefaultState()
            .isFullCube();
    }
    ...
    public float getPlayerRelativeBlockHardness(IBlockState state, EntityPlayer player, World worldIn, BlockPos pos) {
        return net.minecraftforge.common.ForgeHooks
            .blockStrength(this, player, worldIn, pos.getX(), pos.getY(), pos.getZ());
    }
    ...
    public EnumPushReaction getMobilityFlag(IBlockState state) {
        return ((Material) this.blockMaterial).getMobilityFlag();
    }
    ...
    public boolean isFireSource(World world, BlockPos pos, EnumFacing side) {
        ...
        if (this == Blocks.NETHERRACK || this == Blocks.MAGMA) return true;
    ...
    public BlockPos getBedSpawnPosition(IBlockState state, IBlockAccess world, BlockPos pos,
        ...
        if (world instanceof World) return BlockBed.getSafeExitLocation((World) world, pos, 0);
        return null;
    }
    ...
    public boolean isBedFoot(IBlockAccess world, BlockPos pos) {
        return getActualState(world.getBlockState(pos), world, pos).getValue(BlockBed.PART)
    ...
    public boolean canPlaceTorchOnTop(IBlockState state, IBlockAccess world, BlockPos pos) {
        if (this == Blocks.END_GATEWAY || this == Blocks.LIT_PUMPKIN) {
            return false;
        } else if (state.isTopSolid() || this instanceof BlockFence
            || this == Blocks.GLASS
            || this == Blocks.COBBLESTONE_WALL
    ...
    public boolean canSustainPlant(IBlockState state, IBlockAccess world, BlockPos pos, EnumFacing direction,
        ...
        IBlockState plant = plantable.getPlant(
            world,
    ...
    public void setHarvestLevel(String toolClass, int level) {
        java.util.Iterator<IBlockState> itr = getBlockState().getValidStates()
            .iterator();
        while (itr.hasNext()) {
    ...
    // 1,
    // "stone",
    // (new BlockStone()).setHardness(1.5F)
    // .setResistance(10.0F)
    ...
    // 2,
    // "grass",
    // (new BlockGrass()).setHardness(0.6F)
    // .setSoundType(SoundType.PLANT)
    // .setUnlocalizedName("grass"));
    // registerBlock(
    // 3,
    // "dirt",
    // (new BlockDirt()).setHardness(0.5F)
    // .setSoundType(SoundType.GROUND)
    // .setUnlocalizedName("dirt"));
    // Block block = (new Block(Material.ROCK)).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("stonebrick")
    // .setCreativeTab(CreativeTabs.BUILDING_BLOCKS);
    // registerBlock(4, "cobblestone", block);
    // Block block1 = (new BlockPlanks()).setHardness(2.0F)
    // .setResistance(5.0F)
    ...
    // 7,
    // "bedrock",
    // (new BlockEmptyDrops(Material.ROCK)).setBlockUnbreakable()
    ...
    // 12,
    // "sand",
    // (new BlockSand()).setHardness(0.5F)
    ...
    // 20,
    // "glass",
    // (new BlockGlass(Material.GLASS, false)).setHardness(0.3F)
    ...
    // 22,
    // "lapis_block",
    // (new Block(Material.IRON, MapColor.LAPIS)).setHardness(3.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // Block block2 = (new BlockSandStone()).setSoundType(SoundType.STONE)
    // .setHardness(0.8F)
    ...
    // 25,
    // "noteblock",
    // (new BlockNote()).setSoundType(SoundType.WOOD)
    // .setHardness(0.8F)
    // .setUnlocalizedName("musicBlock"));
    // registerBlock(
    // 26,
    // "bed",
    // (new BlockBed()).setSoundType(SoundType.WOOD)
    // .setHardness(0.2F)
    ...
    // 30,
    // "web",
    // (new BlockWeb()).setLightOpacity(1)
    // .setHardness(4.0F)
    ...
    // 37,
    // "yellow_flower",
    // (new BlockYellowFlower()).setHardness(0.0F)
    // .setSoundType(SoundType.PLANT)
    // .setUnlocalizedName("flower1"));
    // registerBlock(
    // 38,
    // "red_flower",
    // (new BlockRedFlower()).setHardness(0.0F)
    // .setSoundType(SoundType.PLANT)
    // .setUnlocalizedName("flower2"));
    // Block block3 = (new BlockMushroom()).setHardness(0.0F)
    // .setSoundType(SoundType.PLANT)
    // .setLightLevel(0.125F)
    // .setUnlocalizedName("mushroom");
    // registerBlock(39, "brown_mushroom", block3);
    // Block block4 = (new BlockMushroom()).setHardness(0.0F)
    // .setSoundType(SoundType.PLANT)
    // .setUnlocalizedName("mushroom");
    ...
    // 41,
    // "gold_block",
    // (new Block(Material.IRON, MapColor.GOLD)).setHardness(3.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 42,
    // "iron_block",
    // (new Block(Material.IRON, MapColor.IRON)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 43,
    // "double_stone_slab",
    // (new BlockDoubleStoneSlab()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 44,
    // "stone_slab",
    // (new BlockHalfStoneSlab()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("stoneSlab"));
    // Block block5 = (new Block(Material.ROCK, MapColor.RED)).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 48,
    // "mossy_cobblestone",
    // (new Block(Material.ROCK)).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 49,
    // "obsidian",
    // (new BlockObsidian()).setHardness(50.0F)
    ...
    // 50,
    // "torch",
    // (new BlockTorch()).setHardness(0.0F)
    ...
    // 51,
    // "fire",
    // (new BlockFire()).setHardness(0.0F)
    // .setLightLevel(1.0F)
    // .setSoundType(SoundType.CLOTH)
    ...
    // "oak_stairs",
    // (new BlockStairs(
    // block1.getDefaultState()
    // .withProperty(BlockPlanks.VARIANT, BlockPlanks.EnumType.OAK))).setUnlocalizedName("stairsWood"));
    // registerBlock(
    // 54,
    // "chest",
    // (new BlockChest(BlockChest.Type.BASIC)).setHardness(2.5F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 57,
    // "diamond_block",
    // (new Block(Material.IRON, MapColor.DIAMOND)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // Block block6 = (new BlockFarmland()).setHardness(0.6F)
    // .setSoundType(SoundType.GROUND)
    ...
    // 63,
    // "standing_sign",
    // (new BlockStandingSign()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 66,
    // "rail",
    // (new BlockRail()).setHardness(0.7F)
    // .setSoundType(SoundType.METAL)
    ...
    // 68,
    // "wall_sign",
    // (new BlockWallSign()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("sign")
    // .disableStats());
    // registerBlock(
    // 69,
    // "lever",
    // (new BlockLever()).setHardness(0.5F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 78,
    // "snow_layer",
    // (new BlockSnow()).setHardness(0.1F)
    ...
    // 82,
    // "clay",
    // (new BlockClay()).setHardness(0.6F)
    // .setSoundType(SoundType.GROUND)
    // .setUnlocalizedName("clay"));
    // registerBlock(
    // 83,
    // "reeds",
    // (new BlockReed()).setHardness(0.0F)
    // .setSoundType(SoundType.PLANT)
    ...
    // 84,
    // "jukebox",
    // (new BlockJukebox()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 85,
    // "fence",
    // (new BlockFence(Material.WOOD, BlockPlanks.EnumType.OAK.getMapColor())).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("fence"));
    // Block block7 = (new BlockPumpkin()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 89,
    // "glowstone",
    // (new BlockGlowstone(Material.GLASS)).setHardness(0.3F)
    // .setSoundType(SoundType.GLASS)
    // .setLightLevel(1.0F)
    ...
    // 91,
    // "lit_pumpkin",
    // (new BlockPumpkin()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    // .setLightLevel(1.0F)
    ...
    // 92,
    // "cake",
    // (new BlockCake()).setHardness(0.5F)
    // .setSoundType(SoundType.CLOTH)
    ...
    // 95,
    // "stained_glass",
    // (new BlockStainedGlass(Material.GLASS)).setHardness(0.3F)
    // .setSoundType(SoundType.GLASS)
    ...
    // 97,
    // "monster_egg",
    // (new BlockSilverfish()).setHardness(0.75F)
    // .setUnlocalizedName("monsterStoneEgg"));
    // Block block8 = (new BlockStoneBrick()).setHardness(1.5F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // (new BlockHugeMushroom(Material.WOOD, MapColor.DIRT, block3)).setHardness(0.2F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("mushroom"));
    // registerBlock(
    // 100,
    // "red_mushroom_block",
    // (new BlockHugeMushroom(Material.WOOD, MapColor.RED, block4)).setHardness(0.2F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("mushroom"));
    // registerBlock(
    // 101,
    // "iron_bars",
    // (new BlockPane(Material.IRON, true)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 102,
    // "glass_pane",
    // (new BlockPane(Material.GLASS, false)).setHardness(0.3F)
    // .setSoundType(SoundType.GLASS)
    // .setUnlocalizedName("thinGlass"));
    // Block block9 = (new BlockMelon()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 104,
    // "pumpkin_stem",
    // (new BlockStem(block7)).setHardness(0.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("pumpkinStem"));
    // registerBlock(
    // 105,
    // "melon_stem",
    // (new BlockStem(block9)).setHardness(0.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("pumpkinStem"));
    // registerBlock(
    // 106,
    // "vine",
    // (new BlockVine()).setHardness(0.2F)
    // .setSoundType(SoundType.PLANT)
    // .setUnlocalizedName("vine"));
    // registerBlock(
    // 107,
    // "fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.OAK)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // Block block10 = (new BlockNetherBrick()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 113,
    // "nether_brick_fence",
    // (new BlockFence(Material.ROCK, MapColor.NETHERRACK)).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 117,
    // "brewing_stand",
    // (new BlockBrewingStand()).setHardness(0.5F)
    // .setLightLevel(0.125F)
    // .setUnlocalizedName("brewingStand"));
    // registerBlock(
    // 118,
    // "cauldron",
    // (new BlockCauldron()).setHardness(2.0F)
    // .setUnlocalizedName("cauldron"));
    // registerBlock(
    // 119,
    // "end_portal",
    // (new BlockEndPortal(Material.PORTAL)).setHardness(-1.0F)
    // .setResistance(6000000.0F));
    // registerBlock(
    // 120,
    // "end_portal_frame",
    // (new BlockEndPortalFrame()).setSoundType(SoundType.GLASS)
    // .setLightLevel(0.125F)
    // .setHardness(-1.0F)
    ...
    // 121,
    // "end_stone",
    // (new Block(Material.ROCK, MapColor.SAND)).setHardness(3.0F)
    // .setResistance(15.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 122,
    // "dragon_egg",
    // (new BlockDragonEgg()).setHardness(3.0F)
    // .setResistance(15.0F)
    // .setSoundType(SoundType.STONE)
    // .setLightLevel(0.125F)
    ...
    // 125,
    // "double_wooden_slab",
    // (new BlockDoubleWoodSlab()).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 126,
    // "wooden_slab",
    // (new BlockHalfWoodSlab()).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("woodSlab"));
    // registerBlock(
    // 127,
    // "cocoa",
    // (new BlockCocoa()).setHardness(0.2F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 130,
    // "ender_chest",
    // (new BlockEnderChest()).setHardness(22.5F)
    ...
    // 133,
    // "emerald_block",
    // (new Block(Material.IRON, MapColor.EMERALD)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 137,
    // "command_block",
    // (new BlockCommandBlock(MapColor.BROWN)).setBlockUnbreakable()
    // .setResistance(6000000.0F)
    // .setUnlocalizedName("commandBlock"));
    // registerBlock(
    // 138,
    // "beacon",
    // (new BlockBeacon()).setUnlocalizedName("beacon")
    // .setLightLevel(1.0F));
    ...
    // 145,
    // "anvil",
    // (new BlockAnvil()).setHardness(5.0F)
    ...
    // 146,
    // "trapped_chest",
    // (new BlockChest(BlockChest.Type.TRAP)).setHardness(2.5F)
    // .setSoundType(SoundType.WOOD)
    ...
    // (new BlockPressurePlateWeighted(Material.IRON, 150)).setHardness(0.5F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 152,
    // "redstone_block",
    // (new BlockCompressedPowered(Material.IRON, MapColor.TNT)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 153,
    // "quartz_ore",
    // (new BlockOre(MapColor.NETHERRACK)).setHardness(3.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 154,
    // "hopper",
    // (new BlockHopper()).setHardness(3.0F)
    // .setResistance(8.0F)
    // .setSoundType(SoundType.METAL)
    // .setUnlocalizedName("hopper"));
    // Block block11 = (new BlockQuartz()).setSoundType(SoundType.STONE)
    // .setHardness(0.8F)
    ...
    // "quartz_stairs",
    // (new BlockStairs(
    // block11.getDefaultState()
    // .withProperty(BlockQuartz.VARIANT, BlockQuartz.EnumType.DEFAULT)))
    // .setUnlocalizedName("stairsQuartz"));
    // registerBlock(
    // 157,
    // "activator_rail",
    // (new BlockRailPowered(true)).setHardness(0.7F)
    // .setSoundType(SoundType.METAL)
    ...
    // (new BlockStainedHardenedClay()).setHardness(1.25F)
    // .setResistance(7.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 165,
    // "slime",
    // (new BlockSlime()).setUnlocalizedName("slime")
    // .setSoundType(SoundType.SLIME));
    // registerBlock(166, "barrier", (new BlockBarrier()).setUnlocalizedName("barrier"));
    // registerBlock(
    // 167,
    // "iron_trapdoor",
    // (new BlockTrapDoor(Material.IRON)).setHardness(5.0F)
    // .setSoundType(SoundType.METAL)
    ...
    // 168,
    // "prismarine",
    // (new BlockPrismarine()).setHardness(1.5F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 169,
    // "sea_lantern",
    // (new BlockSeaLantern(Material.GLASS)).setHardness(0.3F)
    // .setSoundType(SoundType.GLASS)
    // .setLightLevel(1.0F)
    ...
    // 172,
    // "hardened_clay",
    // (new BlockHardenedClay()).setHardness(1.25F)
    // .setResistance(7.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 173,
    // "coal_block",
    // (new Block(Material.ROCK, MapColor.BLACK)).setHardness(5.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 176,
    // "standing_banner",
    // (new BlockBanner.BlockBannerStanding()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 177,
    // "wall_banner",
    // (new BlockBanner.BlockBannerHanging()).setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("banner")
    // .disableStats());
    // registerBlock(178, "daylight_detector_inverted", new BlockDaylightDetector(true));
    // Block block12 = (new BlockRedSandstone()).setSoundType(SoundType.STONE)
    // .setHardness(0.8F)
    ...
    // (new BlockStairs(
    // block12.getDefaultState()
    // .withProperty(BlockRedSandstone.TYPE, BlockRedSandstone.EnumType.SMOOTH)))
    // .setUnlocalizedName("stairsRedSandStone"));
    // registerBlock(
    // 181,
    // "double_stone_slab2",
    // (new BlockDoubleStoneSlabNew()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 182,
    // "stone_slab2",
    // (new BlockHalfStoneSlabNew()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("stoneSlab2"));
    // registerBlock(
    // 183,
    // "spruce_fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.SPRUCE)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 184,
    // "birch_fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.BIRCH)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 185,
    // "jungle_fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.JUNGLE)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 186,
    // "dark_oak_fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.DARK_OAK)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 187,
    // "acacia_fence_gate",
    // (new BlockFenceGate(BlockPlanks.EnumType.ACACIA)).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 188,
    // "spruce_fence",
    // (new BlockFence(Material.WOOD, BlockPlanks.EnumType.SPRUCE.getMapColor())).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 189,
    // "birch_fence",
    // (new BlockFence(Material.WOOD, BlockPlanks.EnumType.BIRCH.getMapColor())).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 190,
    // "jungle_fence",
    // (new BlockFence(Material.WOOD, BlockPlanks.EnumType.JUNGLE.getMapColor())).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 192,
    // "acacia_fence",
    // (new BlockFence(Material.WOOD, BlockPlanks.EnumType.ACACIA.getMapColor())).setHardness(2.0F)
    // .setResistance(5.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 198,
    // "end_rod",
    // (new BlockEndRod()).setHardness(0.0F)
    // .setLightLevel(0.9375F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 199,
    // "chorus_plant",
    // (new BlockChorusPlant()).setHardness(0.4F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("chorusPlant"));
    // registerBlock(
    // 200,
    // "chorus_flower",
    // (new BlockChorusFlower()).setHardness(0.4F)
    // .setSoundType(SoundType.WOOD)
    // .setUnlocalizedName("chorusFlower"));
    // Block block13 = (new Block(Material.ROCK, MapColor.MAGENTA)).setHardness(1.5F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    ...
    // 202,
    // "purpur_pillar",
    // (new BlockRotatedPillar(Material.ROCK, MapColor.MAGENTA)).setHardness(1.5F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    ...
    // 204,
    // "purpur_double_slab",
    // (new BlockPurpurSlab.Double()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 205,
    // "purpur_slab",
    // (new BlockPurpurSlab.Half()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("purpurSlab"));
    // registerBlock(
    // 206,
    // "end_bricks",
    // (new Block(Material.ROCK, MapColor.SAND)).setSoundType(SoundType.STONE)
    // .setHardness(0.8F)
    // .setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    // .setUnlocalizedName("endBricks"));
    // registerBlock(207, "beetroots", (new BlockBeetroot()).setUnlocalizedName("beetroots"));
    // Block block14 = (new BlockGrassPath()).setHardness(0.65F)
    // .setSoundType(SoundType.PLANT)
    ...
    // 209,
    // "end_gateway",
    // (new BlockEndGateway(Material.PORTAL)).setHardness(-1.0F)
    // .setResistance(6000000.0F));
    // registerBlock(
    // 210,
    // "repeating_command_block",
    // (new BlockCommandBlock(MapColor.PURPLE)).setBlockUnbreakable()
    // .setResistance(6000000.0F)
    // .setUnlocalizedName("repeatingCommandBlock"));
    // registerBlock(
    // 211,
    // "chain_command_block",
    // (new BlockCommandBlock(MapColor.GREEN)).setBlockUnbreakable()
    // .setResistance(6000000.0F)
    // .setUnlocalizedName("chainCommandBlock"));
    // registerBlock(
    // 212,
    // "frosted_ice",
    // (new BlockFrostedIce()).setHardness(0.5F)
    // .setLightOpacity(3)
    // .setSoundType(SoundType.GLASS)
    ...
    // 213,
    // "magma",
    // (new BlockMagma()).setHardness(0.5F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("magma"));
    // registerBlock(
    // 214,
    // "nether_wart_block",
    // (new Block(Material.GRASS, MapColor.RED)).setCreativeTab(CreativeTabs.BUILDING_BLOCKS)
    // .setHardness(1.0F)
    // .setSoundType(SoundType.WOOD)
    ...
    // 215,
    // "red_nether_brick",
    // (new BlockNetherBrick()).setHardness(2.0F)
    // .setResistance(10.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 218,
    // "observer",
    // (new BlockObserver()).setHardness(3.0F)
    // .setUnlocalizedName("observer"));
    // registerBlock(
    // 219,
    // "white_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.WHITE)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxWhite"));
    // registerBlock(
    // 220,
    // "orange_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.ORANGE)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxOrange"));
    // registerBlock(
    // 221,
    // "magenta_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.MAGENTA)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxMagenta"));
    // registerBlock(
    // 222,
    // "light_blue_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.LIGHT_BLUE)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxLightBlue"));
    // registerBlock(
    // 223,
    // "yellow_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.YELLOW)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxYellow"));
    // registerBlock(
    // 224,
    // "lime_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.LIME)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxLime"));
    // registerBlock(
    // 225,
    // "pink_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.PINK)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxPink"));
    // registerBlock(
    // 226,
    // "gray_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.GRAY)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxGray"));
    // registerBlock(
    // 227,
    // "silver_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.SILVER)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxSilver"));
    // registerBlock(
    // 228,
    // "cyan_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.CYAN)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxCyan"));
    // registerBlock(
    // 229,
    // "purple_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.PURPLE)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxPurple"));
    // registerBlock(
    // 230,
    // "blue_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.BLUE)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxBlue"));
    // registerBlock(
    // 231,
    // "brown_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.BROWN)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxBrown"));
    // registerBlock(
    // 232,
    // "green_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.GREEN)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxGreen"));
    // registerBlock(
    // 233,
    // "red_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.RED)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("shulkerBoxRed"));
    // registerBlock(
    // 234,
    // "black_shulker_box",
    // (new BlockShulkerBox(EnumDyeColor.BLACK)).setHardness(2.0F)
    // .setSoundType(SoundType.STONE)
    ...
    // 251,
    // "concrete",
    // (new BlockColored(Material.ROCK)).setHardness(1.8F)
    // .setSoundType(SoundType.STONE)
    // .setUnlocalizedName("concrete"));
    // registerBlock(
    // 252,
    // "concrete_powder",
    // (new BlockConcretePowder()).setHardness(0.5F)
    // .setSoundType(SoundType.SAND)
    // .setUnlocalizedName("concretePowder"));
    // registerBlock(
    // 255,
    // "structure_block",
    // (new BlockStructure()).setBlockUnbreakable()
    // .setResistance(6000000.0F)

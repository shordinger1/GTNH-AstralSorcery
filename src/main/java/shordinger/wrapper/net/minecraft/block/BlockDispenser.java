...
import shordinger.wrapper.net.minecraft.dispenser.PositionImpl;
...
import shordinger.wrapper.net.minecraft.util.registry.RegistryDefaulted;
...
public class BlockDispenser extends BlockContainer {
    ...
    private void setDefaultDirection(World worldIn, BlockPos pos, IBlockState state) {
        if (!worldIn.isRemote) {
            ...
            boolean flag = worldIn.getBlockState(pos.north())
                .isFullBlock();
            boolean flag1 = worldIn.getBlockState(pos.south())
                .isFullBlock();
            ...
            if (enumfacing == EnumFacing.NORTH && flag && !flag1) {
                ...
                boolean flag2 = worldIn.getBlockState(pos.west())
                    .isFullBlock();
                boolean flag3 = worldIn.getBlockState(pos.east())
                    .isFullBlock();
            ...
            worldIn.setBlockState(
                pos,
                state.withProperty(FACING, enumfacing)
                    .withProperty(TRIGGERED, Boolean.valueOf(false)),
                2);
        }
    }
        ...
        if (tileentitydispenser != null) {
            ...
            if (i < 0) {
                ...
                if (ibehaviordispenseitem != IBehaviorDispenseItem.DEFAULT_BEHAVIOR) {
                    tileentitydispenser
                        .setInventorySlotContents(i, ibehaviordispenseitem.dispense(blocksourceimpl, itemstack));
                }
            }
        }
    }

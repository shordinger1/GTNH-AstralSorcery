...
public class BlockTNT extends Block {
    ...
    public BlockTNT() {
        ...
        this.setDefaultState(
            this.blockState.getBaseState()
                .withProperty(EXPLODE, Boolean.valueOf(false)));
    ...
    public void onBlockDestroyedByExplosion(World worldIn, BlockPos pos, Explosion explosionIn) {
        if (!worldIn.isRemote) {
            ...
            entitytntprimed
                .setFuse((short) (worldIn.rand.nextInt(entitytntprimed.getFuse() / 4) + entitytntprimed.getFuse() / 8));
            ...
            if (entityarrow.isBurning()) {
                this.explode(
                    ...
                    worldIn.getBlockState(pos)
                        .withProperty(EXPLODE, Boolean.valueOf(true)),
    ...
    public IBlockState getStateFromMeta(int meta) {
        return this.getDefaultState()
            .withProperty(EXPLODE, Boolean.valueOf((meta & 1) > 0));
    }

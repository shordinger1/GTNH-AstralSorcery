...
public class TextComponentTranslation extends TextComponentBase {
    ...
    public TextComponentTranslation(String translationKey, Object... args) {
        ...
        for (Object object : args) {
            if (object instanceof ITextComponent) {
                ((ITextComponent) object).getStyle()
            ...
            for (; matcher.find(j); j = l) {
                ...
                if (k > j) {
                    TextComponentString textcomponentstring = new TextComponentString(
                        String.format(format.substring(j, k)));
    ...
    public Iterator<ITextComponent> iterator() {
        ...
        return Iterators
            .<ITextComponent>concat(createDeepCopyIterator(this.children), createDeepCopyIterator(this.siblings));
    }
    ...
    public TextComponentTranslation createCopy() {
        ...
        textcomponenttranslation.setStyle(
            this.getStyle()
                .createShallowCopy());
    ...
    public boolean equals(Object p_equals_1_) {
        if (this == p_equals_1_) {
            ...
            return Arrays.equals(this.formatArgs, textcomponenttranslation.formatArgs)
                && this.key.equals(textcomponenttranslation.key)
    ...
    public String toString() {
        return "TranslatableComponent{key='" + this.key
            + '\''
            + ", args="

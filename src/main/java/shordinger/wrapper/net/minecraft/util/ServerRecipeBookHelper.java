...
import shordinger.wrapper.net.minecraft.inventory.InventoryCraftResult;
...
public class ServerRecipeBookHelper {
    ...
    public void func_194327_a(EntityPlayerMP p_194327_1_, @Nullable IRecipe p_194327_2_, boolean p_194327_3_) {
        if (p_194327_2_ != null && p_194327_1_.getRecipeBook()
            .isUnlocked(p_194327_2_)) {
            ...
            if (container instanceof ContainerWorkbench) {
                ...
                this.field_194335_f = ((net.minecraftforge.common.crafting.IRecipeContainer) container)
                    .getCraftResult();
                this.field_194336_g = ((net.minecraftforge.common.crafting.IRecipeContainer) container)
                    .getCraftMatrix();
            }
            ...
            if (this.field_194335_f != null && this.field_194336_g != null) {
                if (this.func_194328_c() || p_194327_1_.isCreative()) {
                    ...
                    if (this.field_194331_b.canCraft(p_194327_2_, (IntList) null)) {
                        ...
                        this.func_194326_a();
                        p_194327_1_.connection
                            .sendPacket(new SPacketPlaceGhostRecipe(p_194327_1_.openContainer.windowId, p_194327_2_));
                    }
    ...
    private void func_194329_b() {
        ...
        if (this.field_194331_b.canCraft(this.field_194333_d, intlist, i1)) {
            ...
            while (intlistiterator.hasNext()) {
                ...
                int l = RecipeItemHelper.unpack(k)
                    .getMaxStackSize();
    ...
    private void func_194325_a(Slot p_194325_1_, ItemStack p_194325_2_) {
        ...
        if (i != -1) {
            ...
            if (!itemstack.isEmpty()) {
                ...
                if (p_194325_1_.getStack()
                    .isEmpty()) {
                    p_194325_1_.putStack(itemstack);
                } else {
                    p_194325_1_.getStack()
                        .grow(1);
                }
            }
        }

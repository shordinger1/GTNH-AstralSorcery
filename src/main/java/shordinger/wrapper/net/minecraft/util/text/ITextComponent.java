...
public interface ITextComponent extends IChatComponent {
    ...
    public static class Serializer implements JsonDeserializer<ITextComponent>, JsonSerializer<ITextComponent> {
            ...
            if (p_deserialize_1_.isJsonPrimitive()) {
                ...
                if (p_deserialize_1_.isJsonArray()) {
                    ...
                    for (JsonElement jsonelement : jsonarray1) {
                        ITextComponent itextcomponent2 = this
                            .deserialize(jsonelement, jsonelement.getClass(), p_deserialize_3_);
                ...
                if (jsonobject.has("text")) {
                    ...
                    String s = jsonobject.get("translate")
                        .getAsString();
                    ...
                    if (jsonobject.has("with")) {
                        ...
                        for (int i = 0; i < aobject.length; ++i) {
                            ...
                            if (aobject[i] instanceof TextComponentString) {
                                ...
                                if (textcomponentstring.getStyle()
                                    .isEmpty()
                                    && textcomponentstring.getSiblings()
                                    .isEmpty()) {
                    ...
                    itextcomponent = new TextComponentScore(
        ...
        public JsonElement serialize(ITextComponent p_serialize_1_, Type p_serialize_2_,
                                     JsonSerializationContext p_serialize_3_) {
            JsonObject jsonobject = new JsonObject();

            if (!p_serialize_1_.getStyle()
                .isEmpty()) {
                this.serializeChatStyle(p_serialize_1_.getStyle(), jsonobject, p_serialize_3_);
            }

            if (!p_serialize_1_.getSiblings()
                .isEmpty()) {

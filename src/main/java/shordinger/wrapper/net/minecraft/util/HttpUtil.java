...
public class HttpUtil {
    ...
    public static ListenableFuture<Object> downloadResourcePack(final File saveFile, final String packUrl,
                                                                final Map<String, String> p_180192_2_, final int maxSize, @Nullable final IProgressUpdate p_180192_4_,
            ...
            public void run() {
                ...
                try {
                    try {
                        ...
                        float f = 0.0F;
                        float f1 = (float) p_180192_2_.entrySet()
                            .size();
                        ...
                        if (p_180192_4_ != null) {
                            p_180192_4_.displayLoadingString(
                                I18n.translateToLocalFormatted(
                                    "resourcepack.progress",
                                    String.format("%.2f", f1 / 1000.0F / 1000.0F)));
                        }
                        ...
                        if (saveFile.exists()) {
                            ...
                            HttpUtil.LOGGER.warn(
                                "Deleting {} as it does not match what we currently have ({} vs our {}).",
                                saveFile,
                                Integer.valueOf(i),
                                Long.valueOf(j));
                        ...
                        if (maxSize > 0 && f1 > (float) maxSize) {
                            ...
                            throw new IOException(
                                "Filesize is bigger than maximum allowed (file is " + f
                                    + ", limit is "
                                    + maxSize
                                    + ")");
                        }
                        ...
                        while ((k = inputstream.read(abyte)) >= 0) {
                            ...
                            if (maxSize > 0 && f > (float) maxSize) {
                                ...
                                throw new IOException(
                                    "Filesize was bigger than maximum allowed (got >= " + f
                                        + ", limit was "
                                        + maxSize
                                        + ")");
                            }

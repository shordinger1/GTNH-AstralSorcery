...
public class EntityDamageSourceIndirect extends EntityDamageSource {
    ...
    public ITextComponent getDeathMessage(EntityLivingBase entityLivingBaseIn) {
        ITextComponent itextcomponent = this.indirectEntity == null ? this.damageSourceEntity.getDisplayName()
        ...
        return !itemstack.isEmpty() && itemstack.hasDisplayName() && I18n.canTranslate(s1)
            ...
            s1,
            new Object[]{entityLivingBaseIn.getDisplayName(), itextcomponent, itemstack.getTextComponent()})

...
public class RealmsScreen {
    ...
    public void drawCenteredString(String p_drawCenteredString_1_, int p_drawCenteredString_2_,
        ...
        this.proxy.drawCenteredString(
            p_drawCenteredString_1_,
            p_drawCenteredString_2_,
            p_drawCenteredString_3_,
    ...
    public void render(int p_render_1_, int p_render_2_, float p_render_3_) {
        for (int i = 0; i < this.proxy.buttons()
            .size(); ++i) {
            ((RealmsButton) this.proxy.buttons()
                .get(i)).render(p_render_1_, p_render_2_, p_render_3_);
        }
    }
    ...
    public RealmsAnvilLevelStorageSource getLevelStorageSource() {
        return new RealmsAnvilLevelStorageSource(
            Minecraft.getMinecraft()
                .getSaveLoader());
    }
